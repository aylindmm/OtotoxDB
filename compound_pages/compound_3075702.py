...
st.set_page_config(page_title="Tebanicline", layout="wide")
st.title("Tebanicline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3075702.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3075702](https://pubchem.ncbi.nlm.nih.gov/compound/3075702)")
st.markdown(f"IUPAC Name: 5-[[(2R)-azetidin-2-yl]methoxy]-2-chloropyridine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3075702) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3075702) ]
