...
st.set_page_config(page_title="Pyridostigmine", layout="wide")
st.title("Pyridostigmine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4991.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4991](https://pubchem.ncbi.nlm.nih.gov/compound/4991)")
st.markdown(f"IUPAC Name: (1-methylpyridin-1-ium-3-yl) N,N-dimethylcarbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 4991) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4991) ]
