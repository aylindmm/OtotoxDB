...
st.image(f"compound_structures/compound_6398764.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 6398764) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6398764) ]
