...
st.set_page_config(page_title="Cefuroxime axetil", layout="wide")
st.title("Cefuroxime axetil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6321416.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6321416](https://pubchem.ncbi.nlm.nih.gov/compound/6321416)")
st.markdown(f"IUPAC Name: 1-acetyloxyethyl (6R,7R)-3-(carbamoyloxymethyl)-7-[[(2Z)-2-(furan-2-yl)-2-methoxyiminoacetyl]amino]-8-oxo-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6321416) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6321416) ]
