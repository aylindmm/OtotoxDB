...
st.set_page_config(page_title="Propofol", layout="wide")
st.title("Propofol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4943.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4943](https://pubchem.ncbi.nlm.nih.gov/compound/4943)")
st.markdown(f"IUPAC Name: 2,6-di(propan-2-yl)phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 4943) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4943) ]
