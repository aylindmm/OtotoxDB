...
st.set_page_config(page_title="Cnqx", layout="wide")
st.title("Cnqx")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3721046.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3721046](https://pubchem.ncbi.nlm.nih.gov/compound/3721046)")
st.markdown(f"IUPAC Name: 7-nitro-2,3-dioxo-1,4-dihydroquinoxaline-6-carbonitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 3721046) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3721046) ]
