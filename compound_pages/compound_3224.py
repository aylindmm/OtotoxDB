...
st.set_page_config(page_title="Endosulfan", layout="wide")
st.title("Endosulfan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3224.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3224](https://pubchem.ncbi.nlm.nih.gov/compound/3224)")
st.markdown(f"IUPAC Name: 1,9,10,11,12,12-hexachloro-4,6-dioxa-5lambda4-thiatricyclo[7.2.1.02,8]dodec-10-ene 5-oxide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3224) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3224) ]
