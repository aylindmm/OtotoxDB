...
st.set_page_config(page_title="Nitrendipine", layout="wide")
st.title("Nitrendipine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4507.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4507](https://pubchem.ncbi.nlm.nih.gov/compound/4507)")
st.markdown(f"IUPAC Name: 5-O-ethyl 3-O-methyl 2,6-dimethyl-4-(3-nitrophenyl)-1,4-dihydropyridine-3,5-dicarboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 4507) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4507) ]
