...
st.image(f"compound_structures/compound_22476743.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 22476743) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 22476743) ]
