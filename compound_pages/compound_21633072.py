...
st.set_page_config(page_title="Pseudoginsenoside f11", layout="wide")
st.title("Pseudoginsenoside f11")
# Display the image in Streamlit
st.image(f"compound_structures/compound_21633072.jpg", width=300)
st.markdown(f"PubChem Compound ID: [21633072](https://pubchem.ncbi.nlm.nih.gov/compound/21633072)")
st.markdown(f"IUPAC Name: (2S,3R,4R,5R,6S)-2-[(2R,3R,4S,5S,6R)-2-[[(3S,5R,6S,8R,9R,10R,12R,13R,14R,17S)-3,12-dihydroxy-17-[(2S,5R)-5-(2-hydroxypropan-2-yl)-2-methyloxolan-2-yl]-4,4,8,10,14-pentamethyl-2,3,5,6,7,9,11,12,13,15,16,17-dodecahydro-1H-cyclopenta[a]phenanthren-6-yl]oxy]-4,5-dihydroxy-6-(hydroxymethyl)oxan-3-yl]oxy-6-methyloxane-3,4,5-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 21633072) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 21633072) ]
