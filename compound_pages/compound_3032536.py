...
st.markdown(f"IUPAC Name: cobalt(2+) dichloride")


# 4. Display the image in Streamlit
st.image(f"compound_structures/compound_3032536.jpg", caption=f"SMILES: [Co+2]")
...
df_filtered = sources[(sources["PubChem_CID"] == 3032536) ]
