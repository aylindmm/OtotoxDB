...
st.set_page_config(page_title="Disulfiram", layout="wide")
st.title("Disulfiram")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3117.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3117](https://pubchem.ncbi.nlm.nih.gov/compound/3117)")
st.markdown(f"IUPAC Name: diethylcarbamothioylsulfanyl N,N-diethylcarbamodithioate")
...
df_filtered = sources[(sources["PubChem_CID"] == 3117) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3117) ]
