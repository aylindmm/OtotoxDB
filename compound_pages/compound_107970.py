...
st.set_page_config(page_title="Fingolimod", layout="wide")
st.title("Fingolimod")
# Display the image in Streamlit
st.image(f"compound_structures/compound_107970.jpg", width=300)
st.markdown(f"PubChem Compound ID: [107970](https://pubchem.ncbi.nlm.nih.gov/compound/107970)")
st.markdown(f"IUPAC Name: 2-amino-2-[2-(4-octylphenyl)ethyl]propane-1,3-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 107970) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 107970) ]
