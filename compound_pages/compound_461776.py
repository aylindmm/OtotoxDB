...
st.set_page_config(page_title="Leu-enkephalin", layout="wide")
st.title("Leu-enkephalin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_461776.jpg", width=300)
st.markdown(f"PubChem Compound ID: [461776](https://pubchem.ncbi.nlm.nih.gov/compound/461776)")
st.markdown(f"IUPAC Name: (2S)-2-[[(2S)-2-[[2-[[2-[[(2S)-2-amino-3-(4-hydroxyphenyl)propanoyl]amino]acetyl]amino]acetyl]amino]-3-phenylpropanoyl]amino]-4-methylpentanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 461776) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 461776) ]
