...
st.set_page_config(page_title="Medroxyprogesterone acetate", layout="wide")
st.title("Medroxyprogesterone acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6279.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6279](https://pubchem.ncbi.nlm.nih.gov/compound/6279)")
st.markdown(f"IUPAC Name: [(6S,8R,9S,10R,13S,14S,17R)-17-acetyl-6,10,13-trimethyl-3-oxo-2,6,7,8,9,11,12,14,15,16-decahydro-1H-cyclopenta[a]phenanthren-17-yl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6279) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6279) ]
