...
st.image(f"compound_structures/compound_71469.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 71469) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71469) ]
