...
st.set_page_config(page_title="Valpromide", layout="wide")
st.title("Valpromide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71113.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71113](https://pubchem.ncbi.nlm.nih.gov/compound/71113)")
st.markdown(f"IUPAC Name: 2-propylpentanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 71113) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71113) ]
