...
st.set_page_config(page_title="Potassium", layout="wide")
st.title("Potassium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5462222.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5462222](https://pubchem.ncbi.nlm.nih.gov/compound/5462222)")
st.markdown(f"IUPAC Name: potassium")
...
df_filtered = sources[(sources["PubChem_CID"] == 5462222) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5462222) ]
