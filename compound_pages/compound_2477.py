...
st.set_page_config(page_title="Buspirone", layout="wide")
st.title("Buspirone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2477.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2477](https://pubchem.ncbi.nlm.nih.gov/compound/2477)")
st.markdown(f"IUPAC Name: 8-[4-(4-pyrimidin-2-ylpiperazin-1-yl)butyl]-8-azaspiro[4.5]decane-7,9-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 2477) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2477) ]
