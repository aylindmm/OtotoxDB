...
st.set_page_config(page_title="Quetiapine", layout="wide")
st.title("Quetiapine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5002.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5002](https://pubchem.ncbi.nlm.nih.gov/compound/5002)")
st.markdown(f"IUPAC Name: 2-[2-(4-benzo[b][1,4]benzothiazepin-6-ylpiperazin-1-yl)ethoxy]ethanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5002) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5002) ]
