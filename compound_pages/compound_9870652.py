...
st.set_page_config(page_title="Fimasartan", layout="wide")
st.title("Fimasartan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9870652.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9870652](https://pubchem.ncbi.nlm.nih.gov/compound/9870652)")
st.markdown(f"IUPAC Name: 2-[2-butyl-4-methyl-6-oxo-1-[[4-[2-(2H-tetrazol-5-yl)phenyl]phenyl]methyl]pyrimidin-5-yl]-N,N-dimethylethanethioamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9870652) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9870652) ]
