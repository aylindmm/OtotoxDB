...
st.set_page_config(page_title="Duo-cotecxin", layout="wide")
st.title("Duo-cotecxin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11977455.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11977455](https://pubchem.ncbi.nlm.nih.gov/compound/11977455)")
st.markdown(f"IUPAC Name: 7-chloro-4-[4-[3-[4-(7-chloroquinolin-4-yl)piperazin-1-yl]propyl]piperazin-1-yl]quinoline;(1R,4S,5R,8S,9R,10S,12R,13R)-1,5,9-trimethyl-11,14,15,16-tetraoxatetracyclo[10.3.1.04,13.08,13]hexadecan-10-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 11977455) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11977455) ]
