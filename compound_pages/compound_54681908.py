...
st.set_page_config(page_title="Sarecycline", layout="wide")
st.title("Sarecycline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54681908.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54681908](https://pubchem.ncbi.nlm.nih.gov/compound/54681908)")
st.markdown(f"IUPAC Name: (4S,4aS,5aR,12aR)-4-(dimethylamino)-1,10,11,12a-tetrahydroxy-7-[[methoxy(methyl)amino]methyl]-3,12-dioxo-4a,5,5a,6-tetrahydro-4H-tetracene-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54681908) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54681908) ]
