...
st.set_page_config(page_title="Metopimazine", layout="wide")
st.title("Metopimazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_26388.jpg", width=300)
st.markdown(f"PubChem Compound ID: [26388](https://pubchem.ncbi.nlm.nih.gov/compound/26388)")
st.markdown(f"IUPAC Name: 1-[3-(2-methylsulfonylphenothiazin-10-yl)propyl]piperidine-4-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 26388) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 26388) ]
