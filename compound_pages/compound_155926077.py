...
st.image(f"compound_structures/compound_155926077.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 155926077) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 155926077) ]
