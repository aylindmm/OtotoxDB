...
st.set_page_config(page_title="Metoclopramide", layout="wide")
st.title("Metoclopramide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4168.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4168](https://pubchem.ncbi.nlm.nih.gov/compound/4168)")
st.markdown(f"IUPAC Name: 4-amino-5-chloro-N-[2-(diethylamino)ethyl]-2-methoxybenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 4168) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4168) ]
