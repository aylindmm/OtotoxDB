...
st.set_page_config(page_title="(1r,2s,3s,4r)-5-methylenecyclohexane-1,2,3,4-tetraol", layout="wide")
st.title("(1r,2s,3s,4r)-5-methylenecyclohexane-1,2,3,4-tetraol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16122560.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16122560](https://pubchem.ncbi.nlm.nih.gov/compound/16122560)")
st.markdown(f"IUPAC Name: (1R,2S,3S,4R)-5-methylidenecyclohexane-1,2,3,4-tetrol")
...
df_filtered = sources[(sources["PubChem_CID"] == 16122560) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16122560) ]
