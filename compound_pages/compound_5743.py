...
st.image(f"compound_structures/compound_5743.jpg", width=300)
...
st.markdown(f"Score: -0.842176183257538")
...
df_filtered = sources[(sources["PubChem_CID"] == 5743) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5743) ]
