...
st.set_page_config(page_title="Cyanide", layout="wide")
st.title("Cyanide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5975.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5975](https://pubchem.ncbi.nlm.nih.gov/compound/5975)")
st.markdown(f"IUPAC Name: cyanide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5975) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5975) ]
