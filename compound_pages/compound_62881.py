...
st.set_page_config(page_title="Deferoxamine mesylate", layout="wide")
st.title("Deferoxamine mesylate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_62881.jpg", width=300)
st.markdown(f"PubChem Compound ID: [62881](https://pubchem.ncbi.nlm.nih.gov/compound/62881)")
st.markdown(f"IUPAC Name: N-[5-[[4-[5-[acetyl(hydroxy)amino]pentylamino]-4-oxobutanoyl]-hydroxyamino]pentyl]-N'-(5-aminopentyl)-N'-hydroxybutanediamide;methanesulfonic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 62881) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 62881) ]
