...
st.set_page_config(page_title="Moexipril", layout="wide")
st.title("Moexipril")
# Display the image in Streamlit
st.image(f"compound_structures/compound_91270.jpg", width=300)
st.markdown(f"PubChem Compound ID: [91270](https://pubchem.ncbi.nlm.nih.gov/compound/91270)")
st.markdown(f"IUPAC Name: (3S)-2-[(2S)-2-[[(2S)-1-ethoxy-1-oxo-4-phenylbutan-2-yl]amino]propanoyl]-6,7-dimethoxy-3,4-dihydro-1H-isoquinoline-3-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 91270) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 91270) ]
