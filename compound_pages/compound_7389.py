...
st.set_page_config(page_title="Arsanilic acid", layout="wide")
st.title("Arsanilic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7389.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7389](https://pubchem.ncbi.nlm.nih.gov/compound/7389)")
st.markdown(f"IUPAC Name: (4-aminophenyl)arsonic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 7389) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7389) ]
