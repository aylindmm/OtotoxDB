...
st.set_page_config(page_title="Trimethylstannane", layout="wide")
st.title("Trimethylstannane")
...
df_filtered = sources[(sources["PubChem_CID"] == 12623) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 12623) ]
