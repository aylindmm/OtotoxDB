...
st.set_page_config(page_title="Levonorgestrel", layout="wide")
st.title("Levonorgestrel")
# Display the image in Streamlit
st.image(f"compound_structures/compound_13109.jpg", width=300)
st.markdown(f"PubChem Compound ID: [13109](https://pubchem.ncbi.nlm.nih.gov/compound/13109)")
st.markdown(f"IUPAC Name: (8R,9S,10R,13S,14S,17R)-13-ethyl-17-ethynyl-17-hydroxy-1,2,6,7,8,9,10,11,12,14,15,16-dodecahydrocyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 13109) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 13109) ]
