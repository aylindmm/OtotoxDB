...
st.set_page_config(page_title="Midazolam", layout="wide")
st.title("Midazolam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4192.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4192](https://pubchem.ncbi.nlm.nih.gov/compound/4192)")
st.markdown(f"IUPAC Name: 8-chloro-6-(2-fluorophenyl)-1-methyl-4H-imidazo[1,5-a][1,4]benzodiazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4192) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4192) ]
