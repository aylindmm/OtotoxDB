...
st.set_page_config(page_title="Argon", layout="wide")
st.title("Argon")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23968.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23968](https://pubchem.ncbi.nlm.nih.gov/compound/23968)")
st.markdown(f"IUPAC Name: argon")
...
df_filtered = sources[(sources["PubChem_CID"] == 23968) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23968) ]
