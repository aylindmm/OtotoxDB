...
st.set_page_config(page_title="Lonidamine", layout="wide")
st.title("Lonidamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_39562.jpg", width=300)
st.markdown(f"PubChem Compound ID: [39562](https://pubchem.ncbi.nlm.nih.gov/compound/39562)")
st.markdown(f"IUPAC Name: 1-[(2,4-dichlorophenyl)methyl]indazole-3-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 39562) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 39562) ]
