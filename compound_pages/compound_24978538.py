...
st.set_page_config(page_title="Navitoclax", layout="wide")
st.title("Navitoclax")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24978538.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24978538](https://pubchem.ncbi.nlm.nih.gov/compound/24978538)")
st.markdown(f"IUPAC Name: 4-[4-[[2-(4-chlorophenyl)-5,5-dimethylcyclohexen-1-yl]methyl]piperazin-1-yl]-N-[4-[[(2R)-4-morpholin-4-yl-1-phenylsulfanylbutan-2-yl]amino]-3-(trifluoromethylsulfonyl)phenyl]sulfonylbenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 24978538) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24978538) ]
