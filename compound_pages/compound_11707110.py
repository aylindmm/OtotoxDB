...
st.set_page_config(page_title="Trametinib", layout="wide")
st.title("Trametinib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11707110.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11707110](https://pubchem.ncbi.nlm.nih.gov/compound/11707110)")
st.markdown(f"IUPAC Name: N-[3-[3-cyclopropyl-5-(2-fluoro-4-iodoanilino)-6,8-dimethyl-2,4,7-trioxopyrido[4,3-d]pyrimidin-1-yl]phenyl]acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 11707110) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11707110) ]
