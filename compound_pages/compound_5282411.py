...
st.set_page_config(page_title="Epoprostenol", layout="wide")
st.title("Epoprostenol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5282411.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5282411](https://pubchem.ncbi.nlm.nih.gov/compound/5282411)")
st.markdown(f"IUPAC Name: (5Z)-5-[(3aR,4R,5R,6aS)-5-hydroxy-4-[(E,3S)-3-hydroxyoct-1-enyl]-3,3a,4,5,6,6a-hexahydrocyclopenta[b]furan-2-ylidene]pentanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5282411) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5282411) ]
