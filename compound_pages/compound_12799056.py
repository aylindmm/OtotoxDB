...
st.set_page_config(page_title="Gentamicin c2a", layout="wide")
st.title("Gentamicin c2a")
# Display the image in Streamlit
st.image(f"compound_structures/compound_12799056.jpg", width=300)
st.markdown(f"PubChem Compound ID: [12799056](https://pubchem.ncbi.nlm.nih.gov/compound/12799056)")
st.markdown(f"IUPAC Name: (2R,3R,4R,5R)-2-[(1S,2S,3R,4S,6R)-4,6-diamino-3-[(2R,3R,6S)-3-amino-6-[(1S)-1-aminoethyl]oxan-2-yl]oxy-2-hydroxycyclohexyl]oxy-5-methyl-4-(methylamino)oxane-3,5-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 12799056) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 12799056) ]
