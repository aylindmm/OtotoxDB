...
st.set_page_config(page_title="4-nonylphenol", layout="wide")
st.title("4-nonylphenol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1752.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1752](https://pubchem.ncbi.nlm.nih.gov/compound/1752)")
st.markdown(f"IUPAC Name: 4-nonylphenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 1752) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1752) ]
