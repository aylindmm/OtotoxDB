...
st.set_page_config(page_title="Dithiothreitol", layout="wide")
st.title("Dithiothreitol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_439196.jpg", width=300)
st.markdown(f"PubChem Compound ID: [439196](https://pubchem.ncbi.nlm.nih.gov/compound/439196)")
st.markdown(f"IUPAC Name: (2R,3R)-1,4-bis(sulfanyl)butane-2,3-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 439196) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 439196) ]
