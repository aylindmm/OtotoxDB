...
st.set_page_config(page_title="5-fluoro-2'-deoxyuridine", layout="wide")
st.title("5-fluoro-2'-deoxyuridine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3363.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3363](https://pubchem.ncbi.nlm.nih.gov/compound/3363)")
st.markdown(f"IUPAC Name: 5-fluoro-1-[4-hydroxy-5-(hydroxymethyl)oxolan-2-yl]pyrimidine-2,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 3363) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3363) ]
