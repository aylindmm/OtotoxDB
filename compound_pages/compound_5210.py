...
st.set_page_config(page_title="Sibutramine", layout="wide")
st.title("Sibutramine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5210.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5210](https://pubchem.ncbi.nlm.nih.gov/compound/5210)")
st.markdown(f"IUPAC Name: 1-[1-(4-chlorophenyl)cyclobutyl]-N,N,3-trimethylbutan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5210) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5210) ]
