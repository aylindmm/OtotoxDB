...
st.set_page_config(page_title="4-methyl-n1-(3-phenylpropyl)benzene-1,2-diamine", layout="wide")
st.title("4-methyl-n1-(3-phenylpropyl)benzene-1,2-diamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16760588.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16760588](https://pubchem.ncbi.nlm.nih.gov/compound/16760588)")
st.markdown(f"IUPAC Name: 4-methyl-1-N-(3-phenylpropyl)benzene-1,2-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 16760588) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16760588) ]
