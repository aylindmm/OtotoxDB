...
st.set_page_config(page_title="Diethylcarbamazine", layout="wide")
st.title("Diethylcarbamazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3052.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3052](https://pubchem.ncbi.nlm.nih.gov/compound/3052)")
st.markdown(f"IUPAC Name: N,N-diethyl-4-methylpiperazine-1-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3052) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3052) ]
