...
st.set_page_config(page_title="Mesulergine hydrochloride", layout="wide")
st.title("Mesulergine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_155746.jpg", width=300)
st.markdown(f"PubChem Compound ID: [155746](https://pubchem.ncbi.nlm.nih.gov/compound/155746)")
st.markdown(f"IUPAC Name: (6aR,9S,10aR)-9-(dimethylsulfamoylamino)-4,7-dimethyl-6,6a,8,9,10,10a-hexahydroindolo[4,3-fg]quinoline;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 155746) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 155746) ]
