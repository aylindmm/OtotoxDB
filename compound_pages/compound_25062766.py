...
st.set_page_config(page_title="Momelotinib", layout="wide")
st.title("Momelotinib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25062766.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25062766](https://pubchem.ncbi.nlm.nih.gov/compound/25062766)")
st.markdown(f"IUPAC Name: N-(cyanomethyl)-4-[2-(4-morpholin-4-ylanilino)pyrimidin-4-yl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 25062766) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25062766) ]
