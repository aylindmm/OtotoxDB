...
st.set_page_config(page_title="Reboxetine", layout="wide")
st.title("Reboxetine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_127151.jpg", width=300)
st.markdown(f"PubChem Compound ID: [127151](https://pubchem.ncbi.nlm.nih.gov/compound/127151)")
st.markdown(f"IUPAC Name: (2R)-2-[(R)-(2-ethoxyphenoxy)-phenylmethyl]morpholine")
...
df_filtered = sources[(sources["PubChem_CID"] == 127151) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 127151) ]
