...
st.set_page_config(page_title="N-acetyl-dl-leucine", layout="wide")
st.title("N-acetyl-dl-leucine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1995.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1995](https://pubchem.ncbi.nlm.nih.gov/compound/1995)")
st.markdown(f"IUPAC Name: 2-acetamido-4-methylpentanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 1995) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1995) ]
