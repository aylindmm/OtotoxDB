...
st.set_page_config(page_title="Rizatriptan", layout="wide")
st.title("Rizatriptan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5078.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5078](https://pubchem.ncbi.nlm.nih.gov/compound/5078)")
st.markdown(f"IUPAC Name: N,N-dimethyl-2-[5-(1,2,4-triazol-1-ylmethyl)-1H-indol-3-yl]ethanamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5078) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5078) ]
