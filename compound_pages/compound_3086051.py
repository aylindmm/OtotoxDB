...
st.set_page_config(page_title="Bacillomycin", layout="wide")
st.title("Bacillomycin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3086051.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3086051](https://pubchem.ncbi.nlm.nih.gov/compound/3086051)")
st.markdown(f"IUPAC Name: 3-[(3R,6R,9S,16S,19R,22S,25S)-3,9-bis(2-amino-2-oxoethyl)-16-[(1R)-1-hydroxyethyl]-19-(hydroxymethyl)-6-[(4-hydroxyphenyl)methyl]-13-octyl-2,5,8,11,15,18,21,24-octaoxo-1,4,7,10,14,17,20,23-octazabicyclo[23.3.0]octacosan-22-yl]propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3086051) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3086051) ]
