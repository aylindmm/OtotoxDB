...
st.set_page_config(page_title="Cerivastatin", layout="wide")
st.title("Cerivastatin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_446156.jpg", width=300)
st.markdown(f"PubChem Compound ID: [446156](https://pubchem.ncbi.nlm.nih.gov/compound/446156)")
st.markdown(f"IUPAC Name: (E,3R,5S)-7-[4-(4-fluorophenyl)-5-(methoxymethyl)-2,6-di(propan-2-yl)-3-pyridinyl]-3,5-dihydroxyhept-6-enoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 446156) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 446156) ]
