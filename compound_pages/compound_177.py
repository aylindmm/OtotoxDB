...
st.set_page_config(page_title="Acetaldehyde", layout="wide")
st.title("Acetaldehyde")
# Display the image in Streamlit
st.image(f"compound_structures/compound_177.jpg", width=300)
st.markdown(f"PubChem Compound ID: [177](https://pubchem.ncbi.nlm.nih.gov/compound/177)")
st.markdown(f"IUPAC Name: acetaldehyde")
...
df_filtered = sources[(sources["PubChem_CID"] == 177) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 177) ]
