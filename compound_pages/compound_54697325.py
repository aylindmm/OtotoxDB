...
st.set_page_config(page_title="Omadacycline", layout="wide")
st.title("Omadacycline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54697325.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54697325](https://pubchem.ncbi.nlm.nih.gov/compound/54697325)")
st.markdown(f"IUPAC Name: (4S,4aS,5aR,12aR)-4,7-bis(dimethylamino)-9-[(2,2-dimethylpropylamino)methyl]-1,10,11,12a-tetrahydroxy-3,12-dioxo-4a,5,5a,6-tetrahydro-4H-tetracene-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54697325) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54697325) ]
