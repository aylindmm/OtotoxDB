...
st.set_page_config(page_title="Cipro hc", layout="wide")
st.title("Cipro hc")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9810224.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9810224](https://pubchem.ncbi.nlm.nih.gov/compound/9810224)")
st.markdown(f"IUPAC Name: 1-cyclopropyl-6-fluoro-4-oxo-7-piperazin-1-ylquinoline-3-carboxylic acid;(8S,9S,10R,11S,13S,14S,17R)-11,17-dihydroxy-17-(2-hydroxyacetyl)-10,13-dimethyl-2,6,7,8,9,11,12,14,15,16-decahydro-1H-cyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 9810224) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9810224) ]
