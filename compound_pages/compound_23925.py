...
st.image(f"compound_structures/compound_23925.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23925](https://pubchem.ncbi.nlm.nih.gov/compound/23925)")
st.markdown(f"IUPAC Name: iron")
...
df_filtered = sources[(sources["PubChem_CID"] == 23925) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23925) ]
