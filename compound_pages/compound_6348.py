...
st.set_page_config(page_title="Carbon disulfide", layout="wide")
st.title("Carbon disulfide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6348.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6348](https://pubchem.ncbi.nlm.nih.gov/compound/6348)")
st.markdown(f"IUPAC Name: methanedithione")
...
df_filtered = sources[(sources["PubChem_CID"] == 6348) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6348) ]
