...
st.set_page_config(page_title="Ethylene dimethanesulfonate", layout="wide")
st.title("Ethylene dimethanesulfonate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_20796.jpg", width=300)
st.markdown(f"PubChem Compound ID: [20796](https://pubchem.ncbi.nlm.nih.gov/compound/20796)")
st.markdown(f"IUPAC Name: 2-methylsulfonyloxyethyl methanesulfonate")
...
df_filtered = sources[(sources["PubChem_CID"] == 20796) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 20796) ]
