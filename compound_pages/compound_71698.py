...
st.set_page_config(page_title="Mepindolol", layout="wide")
st.title("Mepindolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71698.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71698](https://pubchem.ncbi.nlm.nih.gov/compound/71698)")
st.markdown(f"IUPAC Name: 1-[(2-methyl-1H-indol-4-yl)oxy]-3-(propan-2-ylamino)propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 71698) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71698) ]
