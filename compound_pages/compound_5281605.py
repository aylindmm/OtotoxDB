...
st.set_page_config(page_title="Baicalein", layout="wide")
st.title("Baicalein")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281605.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281605](https://pubchem.ncbi.nlm.nih.gov/compound/5281605)")
st.markdown(f"IUPAC Name: 5,6,7-trihydroxy-2-phenylchromen-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281605) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281605) ]
