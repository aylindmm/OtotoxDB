...
st.set_page_config(page_title="13752-51-7", layout="wide")
st.title("13752-51-7")
...
df_filtered = sources[(sources["PubChem_CID"] == 83700) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 83700) ]
