...
st.set_page_config(page_title="Diazoxide", layout="wide")
st.title("Diazoxide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3019.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3019](https://pubchem.ncbi.nlm.nih.gov/compound/3019)")
st.markdown(f"IUPAC Name: 7-chloro-3-methyl-4H-1lambda6,2,4-benzothiadiazine 1,1-dioxide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3019) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3019) ]
