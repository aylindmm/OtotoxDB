...
st.set_page_config(page_title="Iocarmate meglumine", layout="wide")
st.title("Iocarmate meglumine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23620992.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23620992](https://pubchem.ncbi.nlm.nih.gov/compound/23620992)")
st.markdown(f"IUPAC Name: 3-[[6-[3-carboxy-2,4,6-triiodo-5-(methylcarbamoyl)anilino]-6-oxohexanoyl]amino]-2,4,6-triiodo-5-(methylcarbamoyl)benzoic acid;bis((2R,3R,4R,5S)-6-(methylamino)hexane-1,2,3,4,5-pentol)")
...
df_filtered = sources[(sources["PubChem_CID"] == 23620992) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23620992) ]
