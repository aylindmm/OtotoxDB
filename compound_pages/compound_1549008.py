...
st.image(f"compound_structures/compound_1549008.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 1549008) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1549008) ]
