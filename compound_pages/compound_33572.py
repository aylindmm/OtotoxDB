...
st.set_page_config(page_title="Ritodrine", layout="wide")
st.title("Ritodrine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_33572.jpg", width=300)
st.markdown(f"PubChem Compound ID: [33572](https://pubchem.ncbi.nlm.nih.gov/compound/33572)")
st.markdown(f"IUPAC Name: 4-[2-[[(1R,2S)-1-hydroxy-1-(4-hydroxyphenyl)propan-2-yl]amino]ethyl]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 33572) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 33572) ]
