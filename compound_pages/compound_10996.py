...
st.set_page_config(page_title="Butyl nitrite", layout="wide")
st.title("Butyl nitrite")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10996.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10996](https://pubchem.ncbi.nlm.nih.gov/compound/10996)")
st.markdown(f"IUPAC Name: butyl nitrite")
...
df_filtered = sources[(sources["PubChem_CID"] == 10996) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10996) ]
