...
st.set_page_config(page_title="Maslinic acid", layout="wide")
st.title("Maslinic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_73659.jpg", width=300)
st.markdown(f"PubChem Compound ID: [73659](https://pubchem.ncbi.nlm.nih.gov/compound/73659)")
st.markdown(f"IUPAC Name: (4aS,6aR,6aS,6bR,8aR,10R,11R,12aR,14bS)-10,11-dihydroxy-2,2,6a,6b,9,9,12a-heptamethyl-1,3,4,5,6,6a,7,8,8a,10,11,12,13,14b-tetradecahydropicene-4a-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 73659) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 73659) ]
