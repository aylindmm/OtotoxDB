...
st.set_page_config(page_title="Telithromycin", layout="wide")
st.title("Telithromycin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3002190.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3002190](https://pubchem.ncbi.nlm.nih.gov/compound/3002190)")
st.markdown(f"IUPAC Name: (1S,2R,5R,7R,8R,9R,11R,13R,14R)-8-[(2S,3R,4S,6R)-4-(dimethylamino)-3-hydroxy-6-methyloxan-2-yl]oxy-2-ethyl-9-methoxy-1,5,7,9,11,13-hexamethyl-15-[4-(4-pyridin-3-ylimidazol-1-yl)butyl]-3,17-dioxa-15-azabicyclo[12.3.0]heptadecane-4,6,12,16-tetrone")
...
df_filtered = sources[(sources["PubChem_CID"] == 3002190) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3002190) ]
