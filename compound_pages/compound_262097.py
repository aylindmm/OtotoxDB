...
st.set_page_config(page_title="Dunnione", layout="wide")
st.title("Dunnione")
...
df_filtered = sources[(sources["PubChem_CID"] == 262097) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 262097) ]
