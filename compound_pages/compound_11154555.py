...
st.set_page_config(page_title="Cariprazine", layout="wide")
st.title("Cariprazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11154555.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11154555](https://pubchem.ncbi.nlm.nih.gov/compound/11154555)")
st.markdown(f"IUPAC Name: 3-[4-[2-[4-(2,3-dichlorophenyl)piperazin-1-yl]ethyl]cyclohexyl]-1,1-dimethylurea")
...
df_filtered = sources[(sources["PubChem_CID"] == 11154555) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11154555) ]
