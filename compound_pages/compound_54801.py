...
st.set_page_config(page_title="Dazopride", layout="wide")
st.title("Dazopride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54801.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54801](https://pubchem.ncbi.nlm.nih.gov/compound/54801)")
st.markdown(f"IUPAC Name: 4-amino-5-chloro-N-(1,2-diethylpyrazolidin-4-yl)-2-methoxybenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54801) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54801) ]
