...
st.set_page_config(page_title="Sant-1", layout="wide")
st.title("Sant-1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6878030.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6878030](https://pubchem.ncbi.nlm.nih.gov/compound/6878030)")
st.markdown(f"IUPAC Name: (E)-N-(4-benzylpiperazin-1-yl)-1-(3,5-dimethyl-1-phenylpyrazol-4-yl)methanimine")
...
df_filtered = sources[(sources["PubChem_CID"] == 6878030) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6878030) ]
