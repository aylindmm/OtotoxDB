...
st.set_page_config(page_title="Phytate", layout="wide")
st.title("Phytate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_890.jpg", width=300)
st.markdown(f"PubChem Compound ID: [890](https://pubchem.ncbi.nlm.nih.gov/compound/890)")
st.markdown(f"IUPAC Name: (2,3,4,5,6-pentaphosphonooxycyclohexyl) dihydrogen phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 890) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 890) ]
