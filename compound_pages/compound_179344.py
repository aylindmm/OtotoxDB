...
st.set_page_config(page_title="Eslicarbazepine acetate", layout="wide")
st.title("Eslicarbazepine acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_179344.jpg", width=300)
st.markdown(f"PubChem Compound ID: [179344](https://pubchem.ncbi.nlm.nih.gov/compound/179344)")
st.markdown(f"IUPAC Name: [(5S)-11-carbamoyl-5,6-dihydrobenzo[b][1]benzazepin-5-yl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 179344) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 179344) ]
