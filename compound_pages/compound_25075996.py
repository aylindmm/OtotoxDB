...
st.set_page_config(page_title="Dynorphin a (1-13)", layout="wide")
st.title("Dynorphin a (1-13)")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25075996.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25075996](https://pubchem.ncbi.nlm.nih.gov/compound/25075996)")
st.markdown(f"IUPAC Name: (2S)-6-amino-2-[[(2S)-2-[[(2S)-6-amino-2-[[(2S)-1-[(2S)-2-[[(2S,3S)-2-[[(2S)-2-[[(2S)-2-[[(2S)-2-[[(2S)-2-[[2-[[2-[[(2S)-2-amino-3-(4-hydroxyphenyl)propanoyl]amino]acetyl]amino]acetyl]amino]-3-phenylpropanoyl]amino]-4-methylpentanoyl]amino]-5-(diaminomethylideneamino)pentanoyl]amino]-5-(diaminomethylideneamino)pentanoyl]amino]-3-methylpentanoyl]amino]-5-(diaminomethylideneamino)pentanoyl]pyrrolidine-2-carbonyl]amino]hexanoyl]amino]-4-methylpentanoyl]amino]hexanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 25075996) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25075996) ]
