...
st.set_page_config(page_title="Sumatriptan", layout="wide")
st.title("Sumatriptan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5358.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5358](https://pubchem.ncbi.nlm.nih.gov/compound/5358)")
st.markdown(f"IUPAC Name: 1-[3-[2-(dimethylamino)ethyl]-1H-indol-5-yl]-N-methylmethanesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5358) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5358) ]
