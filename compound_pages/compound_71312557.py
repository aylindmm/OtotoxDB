...
st.set_page_config(page_title="Eleutheroside e", layout="wide")
st.title("Eleutheroside e")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71312557.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71312557](https://pubchem.ncbi.nlm.nih.gov/compound/71312557)")
st.markdown(f"IUPAC Name: (2S,3R,4S,5S,6R)-2-[4-[(3S,3aR,6R,6aS)-6-[3,5-dimethoxy-4-[(2S,3R,4S,5S,6R)-3,4,5-trihydroxy-6-(hydroxymethyl)oxan-2-yl]oxyphenyl]-1,3,3a,4,6,6a-hexahydrofuro[3,4-c]furan-3-yl]-2,6-dimethoxyphenoxy]-6-(hydroxymethyl)oxane-3,4,5-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 71312557) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71312557) ]
