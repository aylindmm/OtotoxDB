...
st.set_page_config(page_title="Moclobemide", layout="wide")
st.title("Moclobemide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4235.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4235](https://pubchem.ncbi.nlm.nih.gov/compound/4235)")
st.markdown(f"IUPAC Name: 4-chloro-N-(2-morpholin-4-ylethyl)benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 4235) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4235) ]
