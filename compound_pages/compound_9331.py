...
st.set_page_config(page_title="Piritramide", layout="wide")
st.title("Piritramide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9331.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9331](https://pubchem.ncbi.nlm.nih.gov/compound/9331)")
st.markdown(f"IUPAC Name: 1-(3-cyano-3,3-diphenylpropyl)-4-piperidin-1-ylpiperidine-4-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9331) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9331) ]
