...
st.set_page_config(page_title="Josamycin", layout="wide")
st.title("Josamycin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5282165.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5282165](https://pubchem.ncbi.nlm.nih.gov/compound/5282165)")
st.markdown(f"IUPAC Name: [(2S,3S,4R,6S)-6-[(2R,3S,4R,5R,6S)-6-[[(4R,5S,6S,7R,9R,10R,11E,13E,16R)-4-acetyloxy-10-hydroxy-5-methoxy-9,16-dimethyl-2-oxo-7-(2-oxoethyl)-1-oxacyclohexadeca-11,13-dien-6-yl]oxy]-4-(dimethylamino)-5-hydroxy-2-methyloxan-3-yl]oxy-4-hydroxy-2,4-dimethyloxan-3-yl] 3-methylbutanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5282165) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5282165) ]
