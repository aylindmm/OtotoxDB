...
st.set_page_config(page_title="Haloperidol", layout="wide")
st.title("Haloperidol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3559.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3559](https://pubchem.ncbi.nlm.nih.gov/compound/3559)")
st.markdown(f"IUPAC Name: 4-[4-(4-chlorophenyl)-4-hydroxypiperidin-1-yl]-1-(4-fluorophenyl)butan-1-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3559) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3559) ]
