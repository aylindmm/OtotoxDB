...
st.set_page_config(page_title="Ethoxzolamide", layout="wide")
st.title("Ethoxzolamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3295.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3295](https://pubchem.ncbi.nlm.nih.gov/compound/3295)")
st.markdown(f"IUPAC Name: 6-ethoxy-1,3-benzothiazole-2-sulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3295) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3295) ]
