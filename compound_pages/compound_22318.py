...
st.set_page_config(page_title="Sodium aurothiomalate", layout="wide")
st.title("Sodium aurothiomalate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_22318.jpg", width=300)
st.markdown(f"PubChem Compound ID: [22318](https://pubchem.ncbi.nlm.nih.gov/compound/22318)")
st.markdown(f"IUPAC Name: disodium;gold(1+);2-sulfidobutanedioate")
...
df_filtered = sources[(sources["PubChem_CID"] == 22318) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 22318) ]
