...
st.set_page_config(page_title="Arecoline", layout="wide")
st.title("Arecoline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2230.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2230](https://pubchem.ncbi.nlm.nih.gov/compound/2230)")
st.markdown(f"IUPAC Name: methyl 1-methyl-3,6-dihydro-2H-pyridine-5-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 2230) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2230) ]
