...
st.set_page_config(page_title="P-benzoquinone", layout="wide")
st.title("P-benzoquinone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4650.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4650](https://pubchem.ncbi.nlm.nih.gov/compound/4650)")
st.markdown(f"IUPAC Name: cyclohexa-2,5-diene-1,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 4650) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4650) ]
