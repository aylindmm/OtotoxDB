...
st.set_page_config(page_title="Pimozide", layout="wide")
st.title("Pimozide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16362.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16362](https://pubchem.ncbi.nlm.nih.gov/compound/16362)")
st.markdown(f"IUPAC Name: 3-[1-[4,4-bis(4-fluorophenyl)butyl]piperidin-4-yl]-1H-benzimidazol-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 16362) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16362) ]
