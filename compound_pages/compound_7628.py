...
st.set_page_config(page_title="Boric acid", layout="wide")
st.title("Boric acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7628.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7628](https://pubchem.ncbi.nlm.nih.gov/compound/7628)")
st.markdown(f"IUPAC Name: boric acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 7628) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7628) ]
