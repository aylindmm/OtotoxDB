...
st.set_page_config(page_title="1,2,3-trimethylbenzene", layout="wide")
st.title("1,2,3-trimethylbenzene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10686.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10686](https://pubchem.ncbi.nlm.nih.gov/compound/10686)")
st.markdown(f"IUPAC Name: 1,2,3-trimethylbenzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 10686) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10686) ]
