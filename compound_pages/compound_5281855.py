...
st.image(f"compound_structures/compound_5281855.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5281855) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281855) ]
