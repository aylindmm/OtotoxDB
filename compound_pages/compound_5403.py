...
st.set_page_config(page_title="Terbutaline", layout="wide")
st.title("Terbutaline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5403.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5403](https://pubchem.ncbi.nlm.nih.gov/compound/5403)")
st.markdown(f"IUPAC Name: 5-[2-(tert-butylamino)-1-hydroxyethyl]benzene-1,3-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5403) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5403) ]
