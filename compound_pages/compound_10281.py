...
st.set_page_config(page_title="Thymoquinone", layout="wide")
st.title("Thymoquinone")
...
df_filtered = sources[(sources["PubChem_CID"] == 10281) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10281) ]
