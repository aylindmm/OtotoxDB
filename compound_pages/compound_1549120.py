...
st.set_page_config(page_title="Epalrestat", layout="wide")
st.title("Epalrestat")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1549120.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 1549120) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1549120) ]
