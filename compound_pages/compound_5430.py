...
st.set_page_config(page_title="Thiabendazole", layout="wide")
st.title("Thiabendazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5430.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5430](https://pubchem.ncbi.nlm.nih.gov/compound/5430)")
st.markdown(f"IUPAC Name: 4-(1H-benzimidazol-2-yl)-1,3-thiazole")
...
df_filtered = sources[(sources["PubChem_CID"] == 5430) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5430) ]
