...
st.set_page_config(page_title="Isradipine", layout="wide")
st.title("Isradipine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3784.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3784](https://pubchem.ncbi.nlm.nih.gov/compound/3784)")
st.markdown(f"IUPAC Name: 3-O-methyl 5-O-propan-2-yl 4-(2,1,3-benzoxadiazol-4-yl)-2,6-dimethyl-1,4-dihydropyridine-3,5-dicarboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 3784) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3784) ]
