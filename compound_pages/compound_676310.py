...
st.set_page_config(page_title="7,8,3'-trihydroxyflavone", layout="wide")
st.title("7,8,3'-trihydroxyflavone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_676310.jpg", width=300)
st.markdown(f"PubChem Compound ID: [676310](https://pubchem.ncbi.nlm.nih.gov/compound/676310)")
st.markdown(f"IUPAC Name: 7,8-dihydroxy-2-(3-hydroxyphenyl)chromen-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 676310) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 676310) ]
