...
st.set_page_config(page_title="Zinc ion", layout="wide")
st.title("Zinc ion")
# Display the image in Streamlit
st.image(f"compound_structures/compound_32051.jpg", width=300)
st.markdown(f"PubChem Compound ID: [32051](https://pubchem.ncbi.nlm.nih.gov/compound/32051)")
st.markdown(f"IUPAC Name: zinc(2+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 32051) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 32051) ]
