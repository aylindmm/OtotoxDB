...
st.set_page_config(page_title="Trimipramine", layout="wide")
st.title("Trimipramine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5584.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5584](https://pubchem.ncbi.nlm.nih.gov/compound/5584)")
st.markdown(f"IUPAC Name: 3-(5,6-dihydrobenzo[b][1]benzazepin-11-yl)-N,N,2-trimethylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5584) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5584) ]
