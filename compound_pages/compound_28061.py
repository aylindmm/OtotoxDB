...
st.set_page_config(page_title="Ornidazole", layout="wide")
st.title("Ornidazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_28061.jpg", width=300)
st.markdown(f"PubChem Compound ID: [28061](https://pubchem.ncbi.nlm.nih.gov/compound/28061)")
st.markdown(f"IUPAC Name: 1-chloro-3-(2-methyl-5-nitroimidazol-1-yl)propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 28061) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 28061) ]
