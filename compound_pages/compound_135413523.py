...
st.set_page_config(page_title="Sildenafil citrate", layout="wide")
st.title("Sildenafil citrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135413523.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135413523](https://pubchem.ncbi.nlm.nih.gov/compound/135413523)")
st.markdown(f"IUPAC Name: 5-[2-ethoxy-5-(4-methylpiperazin-1-yl)sulfonylphenyl]-1-methyl-3-propyl-6H-pyrazolo[4,5-d]pyrimidin-7-one;2-hydroxypropane-1,2,3-tricarboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 135413523) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135413523) ]
