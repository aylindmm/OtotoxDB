...
st.set_page_config(page_title="Chlorpyrifos", layout="wide")
st.title("Chlorpyrifos")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2730.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2730](https://pubchem.ncbi.nlm.nih.gov/compound/2730)")
st.markdown(f"IUPAC Name: diethoxy-sulfanylidene-[(3,5,6-trichloro-2-pyridinyl)oxy]-lambda5-phosphane")
...
df_filtered = sources[(sources["PubChem_CID"] == 2730) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2730) ]
