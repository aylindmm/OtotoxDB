...
st.set_page_config(page_title="Acacetin", layout="wide")
st.title("Acacetin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5280442.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5280442](https://pubchem.ncbi.nlm.nih.gov/compound/5280442)")
st.markdown(f"IUPAC Name: 5,7-dihydroxy-2-(4-methoxyphenyl)chromen-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5280442) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5280442) ]
