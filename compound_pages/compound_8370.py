...
st.set_page_config(page_title="Hexachlorobenzene", layout="wide")
st.title("Hexachlorobenzene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_8370.jpg", width=300)
st.markdown(f"PubChem Compound ID: [8370](https://pubchem.ncbi.nlm.nih.gov/compound/8370)")
st.markdown(f"IUPAC Name: 1,2,3,4,5,6-hexachlorobenzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 8370) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 8370) ]
