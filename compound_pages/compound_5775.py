...
st.set_page_config(page_title="Phentolamine", layout="wide")
st.title("Phentolamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5775.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5775](https://pubchem.ncbi.nlm.nih.gov/compound/5775)")
st.markdown(f"IUPAC Name: 3-[N-(4,5-dihydro-1H-imidazol-2-ylmethyl)-4-methylanilino]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5775) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5775) ]
