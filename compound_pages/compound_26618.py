...
st.image(f"compound_structures/compound_26618.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 26618) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 26618) ]
