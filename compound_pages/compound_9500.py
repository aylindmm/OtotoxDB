...
st.set_page_config(page_title="6-aminonicotinamide", layout="wide")
st.title("6-aminonicotinamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9500.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9500](https://pubchem.ncbi.nlm.nih.gov/compound/9500)")
st.markdown(f"IUPAC Name: 6-aminopyridine-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9500) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9500) ]
