...
st.set_page_config(page_title="Norgestimate", layout="wide")
st.title("Norgestimate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6540478.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6540478](https://pubchem.ncbi.nlm.nih.gov/compound/6540478)")
st.markdown(f"IUPAC Name: [(3E,8R,9S,10R,13S,14S,17R)-13-ethyl-17-ethynyl-3-hydroxyimino-1,2,6,7,8,9,10,11,12,14,15,16-dodecahydrocyclopenta[a]phenanthren-17-yl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6540478) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6540478) ]
