...
st.set_page_config(page_title="Clotrimazole", layout="wide")
st.title("Clotrimazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2812.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2812](https://pubchem.ncbi.nlm.nih.gov/compound/2812)")
st.markdown(f"IUPAC Name: 1-[(2-chlorophenyl)-diphenylmethyl]imidazole")
...
df_filtered = sources[(sources["PubChem_CID"] == 2812) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2812) ]
