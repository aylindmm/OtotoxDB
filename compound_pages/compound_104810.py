...
st.set_page_config(page_title="Barium(2+)", layout="wide")
st.title("Barium(2+)")
# Display the image in Streamlit
st.image(f"compound_structures/compound_104810.jpg", width=300)
st.markdown(f"PubChem Compound ID: [104810](https://pubchem.ncbi.nlm.nih.gov/compound/104810)")
st.markdown(f"IUPAC Name: barium(2+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 104810) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 104810) ]
