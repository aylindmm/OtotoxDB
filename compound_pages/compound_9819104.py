...
st.image(f"compound_structures/compound_9819104.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 9819104) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9819104) ]
