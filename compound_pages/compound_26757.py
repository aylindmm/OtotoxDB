...
st.set_page_config(page_title="Selegiline", layout="wide")
st.title("Selegiline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_26757.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 26757) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 26757) ]
