...
st.set_page_config(page_title="Dtxsid501016982", layout="wide")
st.title("Dtxsid501016982")
# Display the image in Streamlit
st.image(f"compound_structures/compound_114770.jpg", width=300)
st.markdown(f"PubChem Compound ID: [114770](https://pubchem.ncbi.nlm.nih.gov/compound/114770)")
st.markdown(f"IUPAC Name: 2-[3-(methylamino)propylidene]tricyclo[9.4.0.03,8]pentadeca-1(15),3,5,7,11,13-hexaen-9-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 114770) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 114770) ]
