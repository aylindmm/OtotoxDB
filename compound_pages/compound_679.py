...
st.set_page_config(page_title="Dimethyl sulfoxide", layout="wide")
st.title("Dimethyl sulfoxide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_679.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 679) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 679) ]
