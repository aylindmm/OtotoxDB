...
st.set_page_config(page_title="33854-16-9", layout="wide")
st.title("33854-16-9")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5283102.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5283102](https://pubchem.ncbi.nlm.nih.gov/compound/5283102)")
st.markdown(f"IUPAC Name: methyl (Z)-7-[(1R,2R,3R,5S)-3,5-dihydroxy-2-[(E,3S)-3-hydroxyoct-1-enyl]cyclopentyl]hept-5-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5283102) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5283102) ]
