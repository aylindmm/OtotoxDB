...
st.set_page_config(page_title="Methylmercury(1+)", layout="wide")
st.title("Methylmercury(1+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 6860) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6860) ]
