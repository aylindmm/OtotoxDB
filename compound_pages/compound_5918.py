...
st.set_page_config(page_title="3,4-diaminopyridine", layout="wide")
st.title("3,4-diaminopyridine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5918.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5918](https://pubchem.ncbi.nlm.nih.gov/compound/5918)")
st.markdown(f"IUPAC Name: pyridine-3,4-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5918) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5918) ]
