...
st.set_page_config(page_title="Kenpaullone", layout="wide")
st.title("Kenpaullone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3820.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3820](https://pubchem.ncbi.nlm.nih.gov/compound/3820)")
st.markdown(f"IUPAC Name: 9-bromo-7,12-dihydro-5H-indolo[3,2-d][1]benzazepin-6-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3820) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3820) ]
