...
st.set_page_config(page_title="Adjudin", layout="wide")
st.title("Adjudin")
...
df_filtered = sources[(sources["PubChem_CID"] == 9819086) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9819086) ]
