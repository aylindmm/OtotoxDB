...
st.set_page_config(page_title="Imatinib mesylate", layout="wide")
st.title("Imatinib mesylate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_123596.jpg", width=300)
st.markdown(f"PubChem Compound ID: [123596](https://pubchem.ncbi.nlm.nih.gov/compound/123596)")
st.markdown(f"IUPAC Name: methanesulfonic acid;4-[(4-methylpiperazin-1-yl)methyl]-N-[4-methyl-3-[(4-pyridin-3-ylpyrimidin-2-yl)amino]phenyl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 123596) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 123596) ]
