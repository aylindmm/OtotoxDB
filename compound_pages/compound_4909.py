...
st.set_page_config(page_title="Primidone", layout="wide")
st.title("Primidone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4909.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4909](https://pubchem.ncbi.nlm.nih.gov/compound/4909)")
st.markdown(f"IUPAC Name: 5-ethyl-5-phenyl-1,3-diazinane-4,6-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 4909) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4909) ]
