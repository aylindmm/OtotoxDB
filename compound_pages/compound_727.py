...
st.set_page_config(page_title="1,2,3,4,5,6-hexachlorocyclohexane", layout="wide")
st.title("1,2,3,4,5,6-hexachlorocyclohexane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_727.jpg", width=300)
st.markdown(f"PubChem Compound ID: [727](https://pubchem.ncbi.nlm.nih.gov/compound/727)")
st.markdown(f"IUPAC Name: 1,2,3,4,5,6-hexachlorocyclohexane")
...
df_filtered = sources[(sources["PubChem_CID"] == 727) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 727) ]
