...
st.set_page_config(page_title="Lipofectamine", layout="wide")
st.title("Lipofectamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_100984821.jpg", width=300)
st.markdown(f"PubChem Compound ID: [100984821](https://pubchem.ncbi.nlm.nih.gov/compound/100984821)")
st.markdown(f"IUPAC Name: 2-[2,5-bis(3-aminopropylamino)pentanoylamino]ethyl-[2,3-bis[[(Z)-octadec-9-enoyl]oxy]propyl]-dimethylazanium")
...
df_filtered = sources[(sources["PubChem_CID"] == 100984821) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 100984821) ]
