...
st.set_page_config(page_title="Lomefloxacin", layout="wide")
st.title("Lomefloxacin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3948.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3948](https://pubchem.ncbi.nlm.nih.gov/compound/3948)")
st.markdown(f"IUPAC Name: 1-ethyl-6,8-difluoro-7-(3-methylpiperazin-1-yl)-4-oxoquinoline-3-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3948) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3948) ]
