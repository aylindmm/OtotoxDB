...
st.set_page_config(page_title="Penclomedine", layout="wide")
st.title("Penclomedine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60203.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60203](https://pubchem.ncbi.nlm.nih.gov/compound/60203)")
st.markdown(f"IUPAC Name: 3,5-dichloro-2,4-dimethoxy-6-(trichloromethyl)pyridine")
...
df_filtered = sources[(sources["PubChem_CID"] == 60203) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60203) ]
