...
st.set_page_config(page_title="Tigecycline", layout="wide")
st.title("Tigecycline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54686904.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54686904](https://pubchem.ncbi.nlm.nih.gov/compound/54686904)")
st.markdown(f"IUPAC Name: (4S,4aS,5aR,12aR)-9-[[2-(tert-butylamino)acetyl]amino]-4,7-bis(dimethylamino)-1,10,11,12a-tetrahydroxy-3,12-dioxo-4a,5,5a,6-tetrahydro-4H-tetracene-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54686904) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54686904) ]
