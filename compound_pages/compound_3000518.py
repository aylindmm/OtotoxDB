...
st.set_page_config(page_title="Artenimol", layout="wide")
st.title("Artenimol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3000518.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3000518](https://pubchem.ncbi.nlm.nih.gov/compound/3000518)")
st.markdown(f"IUPAC Name: (1R,4S,5R,8S,9R,10S,12R,13R)-1,5,9-trimethyl-11,14,15,16-tetraoxatetracyclo[10.3.1.04,13.08,13]hexadecan-10-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3000518) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3000518) ]
