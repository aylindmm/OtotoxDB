...
st.set_page_config(page_title="8-bromo-cgmp", layout="wide")
st.title("8-bromo-cgmp")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135419186.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135419186](https://pubchem.ncbi.nlm.nih.gov/compound/135419186)")
st.markdown(f"IUPAC Name: 9-[(4aR,6R,7R,7aS)-2,7-dihydroxy-2-oxo-4a,6,7,7a-tetrahydro-4H-furo[3,2-d][1,3,2]dioxaphosphinin-6-yl]-2-amino-8-bromo-1H-purin-6-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 135419186) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135419186) ]
