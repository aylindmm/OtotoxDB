...
st.set_page_config(page_title="Loxapine", layout="wide")
st.title("Loxapine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3964.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3964](https://pubchem.ncbi.nlm.nih.gov/compound/3964)")
st.markdown(f"IUPAC Name: 8-chloro-6-(4-methylpiperazin-1-yl)benzo[b][1,4]benzoxazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3964) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3964) ]
