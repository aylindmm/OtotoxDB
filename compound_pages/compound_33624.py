...
st.set_page_config(page_title="Timolol", layout="wide")
st.title("Timolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_33624.jpg", width=300)
st.markdown(f"PubChem Compound ID: [33624](https://pubchem.ncbi.nlm.nih.gov/compound/33624)")
st.markdown(f"IUPAC Name: (2S)-1-(tert-butylamino)-3-[(4-morpholin-4-yl-1,2,5-thiadiazol-3-yl)oxy]propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 33624) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 33624) ]
