...
st.set_page_config(page_title="1973494-16-4", layout="wide")
st.title("1973494-16-4")
# Display the image in Streamlit
st.image(f"compound_structures/compound_122428084.jpg", width=300)
st.markdown(f"PubChem Compound ID: [122428084](https://pubchem.ncbi.nlm.nih.gov/compound/122428084)")
st.markdown(f"IUPAC Name: (1R)-1-(1-isoquinolin-5-ylsulfonylpiperidin-4-yl)ethanamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 122428084) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 122428084) ]
