...
st.set_page_config(page_title="Creatine phosphate", layout="wide")
st.title("Creatine phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 9548602) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9548602) ]
