...
st.set_page_config(page_title="Ticagrelor", layout="wide")
st.title("Ticagrelor")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9871419.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9871419](https://pubchem.ncbi.nlm.nih.gov/compound/9871419)")
st.markdown(f"IUPAC Name: (1S,2S,3R,5S)-3-[7-[[(1R,2S)-2-(3,4-difluorophenyl)cyclopropyl]amino]-5-propylsulfanyltriazolo[4,5-d]pyrimidin-3-yl]-5-(2-hydroxyethoxy)cyclopentane-1,2-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 9871419) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9871419) ]
