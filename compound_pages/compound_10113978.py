...
st.set_page_config(page_title="Pazopanib", layout="wide")
st.title("Pazopanib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10113978.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10113978](https://pubchem.ncbi.nlm.nih.gov/compound/10113978)")
st.markdown(f"IUPAC Name: 5-[[4-[(2,3-dimethylindazol-6-yl)-methylamino]pyrimidin-2-yl]amino]-2-methylbenzenesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 10113978) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10113978) ]
