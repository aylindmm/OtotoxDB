...
st.set_page_config(page_title="Novasil", layout="wide")
st.title("Novasil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_44144394.jpg", width=300)
st.markdown(f"PubChem Compound ID: [44144394](https://pubchem.ncbi.nlm.nih.gov/compound/44144394)")
st.markdown(f"IUPAC Name: aluminum;calcium;sodium;silicate")
...
df_filtered = sources[(sources["PubChem_CID"] == 44144394) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 44144394) ]
