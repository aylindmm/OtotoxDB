...
st.set_page_config(page_title="Etifoxine", layout="wide")
st.title("Etifoxine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135413553.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135413553](https://pubchem.ncbi.nlm.nih.gov/compound/135413553)")
st.markdown(f"IUPAC Name: 6-chloro-N-ethyl-4-methyl-4-phenyl-1H-3,1-benzoxazin-2-imine")
...
df_filtered = sources[(sources["PubChem_CID"] == 135413553) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135413553) ]
