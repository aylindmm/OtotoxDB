...
st.set_page_config(page_title="Promazine", layout="wide")
st.title("Promazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4926.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4926](https://pubchem.ncbi.nlm.nih.gov/compound/4926)")
st.markdown(f"IUPAC Name: N,N-dimethyl-3-phenothiazin-10-ylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4926) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4926) ]
