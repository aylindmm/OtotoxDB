...
st.set_page_config(page_title="Tetraethylammonium", layout="wide")
st.title("Tetraethylammonium")
...
df_filtered = sources[(sources["PubChem_CID"] == 5413) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5413) ]
