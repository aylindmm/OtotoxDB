...
st.set_page_config(page_title="Gallium nitrate", layout="wide")
st.title("Gallium nitrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_61635.jpg", width=300)
st.markdown(f"PubChem Compound ID: [61635](https://pubchem.ncbi.nlm.nih.gov/compound/61635)")
st.markdown(f"IUPAC Name: gallium trinitrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 61635) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 61635) ]
