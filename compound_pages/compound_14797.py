...
st.set_page_config(page_title="Potassium hydroxide", layout="wide")
st.title("Potassium hydroxide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_14797.jpg", width=300)
st.markdown(f"PubChem Compound ID: [14797](https://pubchem.ncbi.nlm.nih.gov/compound/14797)")
st.markdown(f"IUPAC Name: potassium hydroxide")
...
df_filtered = sources[(sources["PubChem_CID"] == 14797) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 14797) ]
