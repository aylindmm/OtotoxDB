...
st.set_page_config(page_title="Tert-butylhydroquinone", layout="wide")
st.title("Tert-butylhydroquinone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16043.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16043](https://pubchem.ncbi.nlm.nih.gov/compound/16043)")
st.markdown(f"IUPAC Name: 2-tert-butylbenzene-1,4-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 16043) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16043) ]
