...
st.set_page_config(page_title="Caffeine", layout="wide")
st.title("Caffeine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2519.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2519](https://pubchem.ncbi.nlm.nih.gov/compound/2519)")
st.markdown(f"IUPAC Name: 1,3,7-trimethylpurine-2,6-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 2519) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2519) ]
