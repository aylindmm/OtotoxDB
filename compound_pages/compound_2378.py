...
st.set_page_config(page_title="Bifonazole", layout="wide")
st.title("Bifonazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2378.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2378](https://pubchem.ncbi.nlm.nih.gov/compound/2378)")
st.markdown(f"IUPAC Name: 1-[phenyl-(4-phenylphenyl)methyl]imidazole")
...
df_filtered = sources[(sources["PubChem_CID"] == 2378) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2378) ]
