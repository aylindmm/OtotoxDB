...
st.set_page_config(page_title="Osthole", layout="wide")
st.title("Osthole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10228.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10228](https://pubchem.ncbi.nlm.nih.gov/compound/10228)")
st.markdown(f"IUPAC Name: 7-methoxy-8-(3-methylbut-2-enyl)chromen-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 10228) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10228) ]
