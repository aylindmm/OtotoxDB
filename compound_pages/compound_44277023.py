...
st.set_page_config(page_title="Pyriplatin", layout="wide")
st.title("Pyriplatin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_44277023.jpg", width=300)
st.markdown(f"PubChem Compound ID: [44277023](https://pubchem.ncbi.nlm.nih.gov/compound/44277023)")
st.markdown(f"IUPAC Name: azane;chloroplatinum;pyridine;chloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 44277023) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 44277023) ]
