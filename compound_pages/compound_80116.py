...
st.set_page_config(page_title="Creatine monohydrate", layout="wide")
st.title("Creatine monohydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_80116.jpg", width=300)
st.markdown(f"PubChem Compound ID: [80116](https://pubchem.ncbi.nlm.nih.gov/compound/80116)")
st.markdown(f"IUPAC Name: 2-[carbamimidoyl(methyl)amino]acetic acid;hydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 80116) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 80116) ]
