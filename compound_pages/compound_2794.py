...
st.set_page_config(page_title="Clofazimine", layout="wide")
st.title("Clofazimine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2794.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2794](https://pubchem.ncbi.nlm.nih.gov/compound/2794)")
st.markdown(f"IUPAC Name: N,5-bis(4-chlorophenyl)-3-propan-2-yliminophenazin-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2794) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2794) ]
