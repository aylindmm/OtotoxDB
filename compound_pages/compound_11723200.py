...
st.image(f"compound_structures/compound_11723200.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 11723200) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11723200) ]
