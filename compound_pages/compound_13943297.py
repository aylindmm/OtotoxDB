...
st.set_page_config(page_title="Astragaloside iv", layout="wide")
st.title("Astragaloside iv")
# Display the image in Streamlit
st.image(f"compound_structures/compound_13943297.jpg", width=300)
st.markdown(f"PubChem Compound ID: [13943297](https://pubchem.ncbi.nlm.nih.gov/compound/13943297)")
st.markdown(f"IUPAC Name: (2R,3R,4S,5S,6R)-2-[[(1S,3R,6S,8R,9S,11S,12S,14S,15R,16R)-14-hydroxy-15-[(2R,5S)-5-(2-hydroxypropan-2-yl)-2-methyloxolan-2-yl]-7,7,12,16-tetramethyl-6-[(2S,3R,4S,5R)-3,4,5-trihydroxyoxan-2-yl]oxy-9-pentacyclo[9.7.0.01,3.03,8.012,16]octadecanyl]oxy]-6-(hydroxymethyl)oxane-3,4,5-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 13943297) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 13943297) ]
