...
st.set_page_config(page_title="Nitrogen", layout="wide")
st.title("Nitrogen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_947.jpg", width=300)
st.markdown(f"PubChem Compound ID: [947](https://pubchem.ncbi.nlm.nih.gov/compound/947)")
st.markdown(f"IUPAC Name: molecular nitrogen")
...
df_filtered = sources[(sources["PubChem_CID"] == 947) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 947) ]
