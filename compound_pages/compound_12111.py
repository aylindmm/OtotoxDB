...
st.set_page_config(page_title="4,4'-methylenediphenol", layout="wide")
st.title("4,4'-methylenediphenol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_12111.jpg", width=300)
st.markdown(f"PubChem Compound ID: [12111](https://pubchem.ncbi.nlm.nih.gov/compound/12111)")
st.markdown(f"IUPAC Name: 4-[(4-hydroxyphenyl)methyl]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 12111) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 12111) ]
