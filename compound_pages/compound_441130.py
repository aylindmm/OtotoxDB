...
st.set_page_config(page_title="Meropenem", layout="wide")
st.title("Meropenem")
# Display the image in Streamlit
st.image(f"compound_structures/compound_441130.jpg", width=300)
st.markdown(f"PubChem Compound ID: [441130](https://pubchem.ncbi.nlm.nih.gov/compound/441130)")
st.markdown(f"IUPAC Name: (4R,5S,6S)-3-[(3S,5S)-5-(dimethylcarbamoyl)pyrrolidin-3-yl]sulfanyl-6-[(1R)-1-hydroxyethyl]-4-methyl-7-oxo-1-azabicyclo[3.2.0]hept-2-ene-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 441130) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 441130) ]
