...
st.set_page_config(page_title="Ondansetron", layout="wide")
st.title("Ondansetron")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4595.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4595](https://pubchem.ncbi.nlm.nih.gov/compound/4595)")
st.markdown(f"IUPAC Name: 9-methyl-3-[(2-methylimidazol-1-yl)methyl]-2,3-dihydro-1H-carbazol-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 4595) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4595) ]
