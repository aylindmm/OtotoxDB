...
st.set_page_config(page_title="Bisdemethoxycurcumin", layout="wide")
st.title("Bisdemethoxycurcumin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5315472.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5315472](https://pubchem.ncbi.nlm.nih.gov/compound/5315472)")
st.markdown(f"IUPAC Name: (1E,6E)-1,7-bis(4-hydroxyphenyl)hepta-1,6-diene-3,5-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 5315472) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5315472) ]
