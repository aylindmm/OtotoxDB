...
st.set_page_config(page_title="Carteolol", layout="wide")
st.title("Carteolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2583.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2583](https://pubchem.ncbi.nlm.nih.gov/compound/2583)")
st.markdown(f"IUPAC Name: 5-[3-(tert-butylamino)-2-hydroxypropoxy]-3,4-dihydro-1H-quinolin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 2583) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2583) ]
