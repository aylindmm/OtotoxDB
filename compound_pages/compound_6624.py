...
st.set_page_config(page_title="Chlorfenethol", layout="wide")
st.title("Chlorfenethol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6624.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6624](https://pubchem.ncbi.nlm.nih.gov/compound/6624)")
st.markdown(f"IUPAC Name: 1,1-bis(4-chlorophenyl)ethanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 6624) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6624) ]
