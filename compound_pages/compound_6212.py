...
st.set_page_config(page_title="Chloroform", layout="wide")
st.title("Chloroform")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6212.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6212](https://pubchem.ncbi.nlm.nih.gov/compound/6212)")
st.markdown(f"IUPAC Name: chloroform")
...
df_filtered = sources[(sources["PubChem_CID"] == 6212) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6212) ]
