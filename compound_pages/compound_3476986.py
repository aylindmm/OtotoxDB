...
st.set_page_config(page_title="Blebbistatin", layout="wide")
st.title("Blebbistatin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3476986.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 3476986) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3476986) ]
