...
st.set_page_config(page_title="Grp94", layout="wide")
st.title("Grp94")
# Display the image in Streamlit
st.image(f"compound_structures/compound_156588658.jpg", width=300)
st.markdown(f"PubChem Compound ID: [156588658](https://pubchem.ncbi.nlm.nih.gov/compound/156588658)")
...
df_filtered = sources[(sources["PubChem_CID"] == 156588658) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 156588658) ]
