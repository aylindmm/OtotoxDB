...
st.set_page_config(page_title="Ginsenoside rg3", layout="wide")
st.title("Ginsenoside rg3")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9918693.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9918693](https://pubchem.ncbi.nlm.nih.gov/compound/9918693)")
st.markdown(f"IUPAC Name: (2S,3R,4S,5S,6R)-2-[(2R,3R,4S,5S,6R)-4,5-dihydroxy-2-[[(3S,5R,8R,9R,10R,12R,13R,14R,17S)-12-hydroxy-17-[(2S)-2-hydroxy-6-methylhept-5-en-2-yl]-4,4,8,10,14-pentamethyl-2,3,5,6,7,9,11,12,13,15,16,17-dodecahydro-1H-cyclopenta[a]phenanthren-3-yl]oxy]-6-(hydroxymethyl)oxan-3-yl]oxy-6-(hydroxymethyl)oxane-3,4,5-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 9918693) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9918693) ]
