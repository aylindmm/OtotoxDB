...
st.set_page_config(page_title="Pindolol", layout="wide")
st.title("Pindolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4828.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4828](https://pubchem.ncbi.nlm.nih.gov/compound/4828)")
st.markdown(f"IUPAC Name: 1-(1H-indol-4-yloxy)-3-(propan-2-ylamino)propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 4828) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4828) ]
