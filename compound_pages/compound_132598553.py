...
st.image(f"compound_structures/compound_132598553.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 132598553) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 132598553) ]
