...
st.set_page_config(page_title="Cp-dpm-ga", layout="wide")
st.title("Cp-dpm-ga")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4447.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4447](https://pubchem.ncbi.nlm.nih.gov/compound/4447)")
st.markdown(f"IUPAC Name: 2-[[(benzhydrylamino)-(4-cyanoanilino)methylidene]amino]acetic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 4447) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4447) ]
