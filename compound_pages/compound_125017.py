...
st.set_page_config(page_title="Desvenlafaxine", layout="wide")
st.title("Desvenlafaxine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_125017.jpg", width=300)
st.markdown(f"PubChem Compound ID: [125017](https://pubchem.ncbi.nlm.nih.gov/compound/125017)")
st.markdown(f"IUPAC Name: 4-[2-(dimethylamino)-1-(1-hydroxycyclohexyl)ethyl]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 125017) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 125017) ]
