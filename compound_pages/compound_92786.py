...
st.set_page_config(page_title="Allopregnanolone", layout="wide")
st.title("Allopregnanolone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_92786.jpg", width=300)
st.markdown(f"PubChem Compound ID: [92786](https://pubchem.ncbi.nlm.nih.gov/compound/92786)")
st.markdown(f"IUPAC Name: 1-[(3R,5S,8R,9S,10S,13S,14S,17S)-3-hydroxy-10,13-dimethyl-2,3,4,5,6,7,8,9,11,12,14,15,16,17-tetradecahydro-1H-cyclopenta[a]phenanthren-17-yl]ethanone")
...
df_filtered = sources[(sources["PubChem_CID"] == 92786) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 92786) ]
