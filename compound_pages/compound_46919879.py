...
st.set_page_config(page_title="Laninamivir octanoate monohydrate", layout="wide")
st.title("Laninamivir octanoate monohydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_46919879.jpg", width=300)
st.markdown(f"PubChem Compound ID: [46919879](https://pubchem.ncbi.nlm.nih.gov/compound/46919879)")
st.markdown(f"IUPAC Name: (2R,3R,4S)-3-acetamido-4-(diaminomethylideneamino)-2-[(1R,2R)-2-hydroxy-1-methoxy-3-octanoyloxypropyl]-3,4-dihydro-2H-pyran-6-carboxylic acid;hydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 46919879) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 46919879) ]
