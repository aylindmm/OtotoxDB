...
st.set_page_config(page_title="Colchicine", layout="wide")
st.title("Colchicine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6167.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6167](https://pubchem.ncbi.nlm.nih.gov/compound/6167)")
st.markdown(f"IUPAC Name: N-[(7S)-1,2,3,10-tetramethoxy-9-oxo-6,7-dihydro-5H-benzo[a]heptalen-7-yl]acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 6167) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6167) ]
