...
st.set_page_config(page_title="Leucovorin calcium", layout="wide")
st.title("Leucovorin calcium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135403647.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135403647](https://pubchem.ncbi.nlm.nih.gov/compound/135403647)")
st.markdown(f"IUPAC Name: calcium (2S)-2-[[4-[(2-amino-5-formyl-4-oxo-3,6,7,8-tetrahydropteridin-6-yl)methylamino]benzoyl]amino]pentanedioate")
...
df_filtered = sources[(sources["PubChem_CID"] == 135403647) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135403647) ]
