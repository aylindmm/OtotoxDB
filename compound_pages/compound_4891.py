...
st.set_page_config(page_title="Praziquantel", layout="wide")
st.title("Praziquantel")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4891.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4891](https://pubchem.ncbi.nlm.nih.gov/compound/4891)")
st.markdown(f"IUPAC Name: 2-(cyclohexanecarbonyl)-3,6,7,11b-tetrahydro-1H-pyrazino[2,1-a]isoquinolin-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 4891) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4891) ]
