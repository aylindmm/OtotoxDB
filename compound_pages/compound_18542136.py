...
st.image(f"compound_structures/compound_18542136.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 18542136) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 18542136) ]
