...
st.set_page_config(page_title="Atomoxetine", layout="wide")
st.title("Atomoxetine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54841.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54841](https://pubchem.ncbi.nlm.nih.gov/compound/54841)")
st.markdown(f"IUPAC Name: (3R)-N-methyl-3-(2-methylphenoxy)-3-phenylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 54841) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54841) ]
