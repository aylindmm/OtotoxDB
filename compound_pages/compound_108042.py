...
st.image(f"compound_structures/compound_108042.jpg", width=300)
st.markdown(f"PubChem Compound ID: [108042](https://pubchem.ncbi.nlm.nih.gov/compound/108042)")
st.markdown(f"IUPAC Name: 2-phenylethyl 3-(3,4-dihydroxyphenyl)prop-2-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 108042) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 108042) ]
