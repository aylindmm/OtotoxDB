...
st.set_page_config(page_title="Tinidazole", layout="wide")
st.title("Tinidazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5479.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5479](https://pubchem.ncbi.nlm.nih.gov/compound/5479)")
st.markdown(f"IUPAC Name: 1-(2-ethylsulfonylethyl)-2-methyl-5-nitroimidazole")
...
df_filtered = sources[(sources["PubChem_CID"] == 5479) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5479) ]
