...
st.set_page_config(page_title="Zolmitriptan", layout="wide")
st.title("Zolmitriptan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60857.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60857](https://pubchem.ncbi.nlm.nih.gov/compound/60857)")
st.markdown(f"IUPAC Name: (4S)-4-[[3-[2-(dimethylamino)ethyl]-1H-indol-5-yl]methyl]-1,3-oxazolidin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 60857) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60857) ]
