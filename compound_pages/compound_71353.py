...
st.set_page_config(page_title="Dapoxetine", layout="wide")
st.title("Dapoxetine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71353.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71353](https://pubchem.ncbi.nlm.nih.gov/compound/71353)")
st.markdown(f"IUPAC Name: (1S)-N,N-dimethyl-3-naphthalen-1-yloxy-1-phenylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 71353) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71353) ]
