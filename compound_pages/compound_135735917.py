...
st.set_page_config(page_title="Liproxstatin-1", layout="wide")
st.title("Liproxstatin-1")
...
df_filtered = sources[(sources["PubChem_CID"] == 135735917) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135735917) ]
