...
st.set_page_config(page_title="Fosphenytoin", layout="wide")
st.title("Fosphenytoin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_56339.jpg", width=300)
st.markdown(f"PubChem Compound ID: [56339](https://pubchem.ncbi.nlm.nih.gov/compound/56339)")
st.markdown(f"IUPAC Name: (2,5-dioxo-4,4-diphenylimidazolidin-1-yl)methyl dihydrogen phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 56339) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 56339) ]
