...
st.set_page_config(page_title="Ciclopirox", layout="wide")
st.title("Ciclopirox")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2749.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2749](https://pubchem.ncbi.nlm.nih.gov/compound/2749)")
st.markdown(f"IUPAC Name: 6-cyclohexyl-1-hydroxy-4-methylpyridin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 2749) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2749) ]
