...
st.set_page_config(page_title="Etonogestrel", layout="wide")
st.title("Etonogestrel")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6917715.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6917715](https://pubchem.ncbi.nlm.nih.gov/compound/6917715)")
st.markdown(f"IUPAC Name: (8S,9S,10R,13S,14S,17R)-13-ethyl-17-ethynyl-17-hydroxy-11-methylidene-2,6,7,8,9,10,12,14,15,16-decahydro-1H-cyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 6917715) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6917715) ]
