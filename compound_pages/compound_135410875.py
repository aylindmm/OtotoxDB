...
st.set_page_config(page_title="Pemetrexed", layout="wide")
st.title("Pemetrexed")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135410875.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135410875](https://pubchem.ncbi.nlm.nih.gov/compound/135410875)")
st.markdown(f"IUPAC Name: (2S)-2-[[4-[2-(2-amino-4-oxo-3,7-dihydropyrrolo[2,3-d]pyrimidin-5-yl)ethyl]benzoyl]amino]pentanedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 135410875) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135410875) ]
