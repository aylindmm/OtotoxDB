...
st.set_page_config(page_title="Amoxapine", layout="wide")
st.title("Amoxapine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2170.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2170](https://pubchem.ncbi.nlm.nih.gov/compound/2170)")
st.markdown(f"IUPAC Name: 8-chloro-6-piperazin-1-ylbenzo[b][1,4]benzoxazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2170) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2170) ]
