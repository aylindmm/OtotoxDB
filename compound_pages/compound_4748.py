...
st.set_page_config(page_title="Perphenazine", layout="wide")
st.title("Perphenazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4748.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4748](https://pubchem.ncbi.nlm.nih.gov/compound/4748)")
st.markdown(f"IUPAC Name: 2-[4-[3-(2-chlorophenothiazin-10-yl)propyl]piperazin-1-yl]ethanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 4748) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4748) ]
