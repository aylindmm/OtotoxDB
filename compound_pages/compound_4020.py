...
st.set_page_config(page_title="Mazindol", layout="wide")
st.title("Mazindol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4020.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4020](https://pubchem.ncbi.nlm.nih.gov/compound/4020)")
st.markdown(f"IUPAC Name: 5-(4-chlorophenyl)-2,3-dihydroimidazo[1,2-b]isoindol-5-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 4020) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4020) ]
