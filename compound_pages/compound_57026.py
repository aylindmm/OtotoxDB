...
st.set_page_config(page_title="Clentiazem", layout="wide")
st.title("Clentiazem")
# Display the image in Streamlit
st.image(f"compound_structures/compound_57026.jpg", width=300)
st.markdown(f"PubChem Compound ID: [57026](https://pubchem.ncbi.nlm.nih.gov/compound/57026)")
st.markdown(f"IUPAC Name: [(2S,3S)-8-chloro-5-[2-(dimethylamino)ethyl]-2-(4-methoxyphenyl)-4-oxo-2,3-dihydro-1,5-benzothiazepin-3-yl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 57026) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 57026) ]
