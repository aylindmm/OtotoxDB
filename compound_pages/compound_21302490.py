...
st.set_page_config(page_title="Lumateperone", layout="wide")
st.title("Lumateperone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_21302490.jpg", width=300)
st.markdown(f"PubChem Compound ID: [21302490](https://pubchem.ncbi.nlm.nih.gov/compound/21302490)")
st.markdown(f"IUPAC Name: 1-(4-fluorophenyl)-4-[(10R,15S)-4-methyl-1,4,12-triazatetracyclo[7.6.1.05,16.010,15]hexadeca-5,7,9(16)-trien-12-yl]butan-1-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 21302490) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 21302490) ]
