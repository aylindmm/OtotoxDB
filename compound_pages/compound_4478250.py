...
st.set_page_config(page_title="Mevalonate", layout="wide")
st.title("Mevalonate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4478250.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4478250](https://pubchem.ncbi.nlm.nih.gov/compound/4478250)")
st.markdown(f"IUPAC Name: 3,5-dihydroxy-3-methylpentanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 4478250) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4478250) ]
