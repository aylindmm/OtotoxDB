...
st.set_page_config(page_title="Darunavir", layout="wide")
st.title("Darunavir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_213039.jpg", width=300)
st.markdown(f"PubChem Compound ID: [213039](https://pubchem.ncbi.nlm.nih.gov/compound/213039)")
st.markdown(f"IUPAC Name: [(3aS,4R,6aR)-2,3,3a,4,5,6a-hexahydrofuro[2,3-b]furan-4-yl] N-[(2S,3R)-4-[(4-aminophenyl)sulfonyl-(2-methylpropyl)amino]-3-hydroxy-1-phenylbutan-2-yl]carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 213039) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 213039) ]
