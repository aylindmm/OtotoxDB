...
st.set_page_config(page_title="Gw4869", layout="wide")
st.title("Gw4869")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16078967.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16078967](https://pubchem.ncbi.nlm.nih.gov/compound/16078967)")
st.markdown(f"IUPAC Name: (E)-3-[4-[(E)-3-[4-(4,5-dihydro-1H-imidazol-2-yl)anilino]-3-oxoprop-1-enyl]phenyl]-N-[4-(4,5-dihydro-1H-imidazol-2-yl)phenyl]prop-2-enamide;dihydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 16078967) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16078967) ]
