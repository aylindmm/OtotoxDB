...
st.image(f"compound_structures/compound_164676.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 164676) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 164676) ]
