...
st.set_page_config(page_title="Fexofenadine", layout="wide")
st.title("Fexofenadine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3348.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3348](https://pubchem.ncbi.nlm.nih.gov/compound/3348)")
st.markdown(f"IUPAC Name: 2-[4-[1-hydroxy-4-[4-[hydroxy(diphenyl)methyl]piperidin-1-yl]butyl]phenyl]-2-methylpropanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3348) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3348) ]
