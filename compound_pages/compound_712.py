...
st.set_page_config(page_title="Formaldehyde", layout="wide")
st.title("Formaldehyde")
# Display the image in Streamlit
st.image(f"compound_structures/compound_712.jpg", width=300)
st.markdown(f"PubChem Compound ID: [712](https://pubchem.ncbi.nlm.nih.gov/compound/712)")
st.markdown(f"IUPAC Name: formaldehyde")
...
df_filtered = sources[(sources["PubChem_CID"] == 712) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 712) ]
