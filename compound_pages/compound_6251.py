...
st.set_page_config(page_title="D-mannitol", layout="wide")
st.title("D-mannitol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6251.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 6251) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6251) ]
