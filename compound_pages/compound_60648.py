...
st.set_page_config(page_title="Tiagabine", layout="wide")
st.title("Tiagabine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60648.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60648](https://pubchem.ncbi.nlm.nih.gov/compound/60648)")
st.markdown(f"IUPAC Name: (3R)-1-[4,4-bis(3-methylthiophen-2-yl)but-3-enyl]piperidine-3-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 60648) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60648) ]
