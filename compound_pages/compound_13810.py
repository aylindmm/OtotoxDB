...
st.set_page_config(page_title="Fentanyl citrate", layout="wide")
st.title("Fentanyl citrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_13810.jpg", width=300)
st.markdown(f"PubChem Compound ID: [13810](https://pubchem.ncbi.nlm.nih.gov/compound/13810)")
st.markdown(f"IUPAC Name: 2-hydroxypropane-1,2,3-tricarboxylic acid;N-phenyl-N-[1-(2-phenylethyl)piperidin-4-yl]propanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 13810) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 13810) ]
