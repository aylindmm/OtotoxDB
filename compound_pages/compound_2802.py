...
st.set_page_config(page_title="Clonazepam", layout="wide")
st.title("Clonazepam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2802.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2802](https://pubchem.ncbi.nlm.nih.gov/compound/2802)")
st.markdown(f"IUPAC Name: 5-(2-chlorophenyl)-7-nitro-1,3-dihydro-1,4-benzodiazepin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 2802) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2802) ]
