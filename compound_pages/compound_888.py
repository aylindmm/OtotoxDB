...
st.set_page_config(page_title="Magnesium ion", layout="wide")
st.title("Magnesium ion")
# Display the image in Streamlit
st.image(f"compound_structures/compound_888.jpg", width=300)
st.markdown(f"PubChem Compound ID: [888](https://pubchem.ncbi.nlm.nih.gov/compound/888)")
st.markdown(f"IUPAC Name: magnesium(2+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 888) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 888) ]
