...
st.set_page_config(page_title="Adx 10059", layout="wide")
st.title("Adx 10059")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10331863.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10331863](https://pubchem.ncbi.nlm.nih.gov/compound/10331863)")
st.markdown(f"IUPAC Name: 2-[2-(3-fluorophenyl)ethynyl]-4,6-dimethylpyridin-3-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 10331863) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10331863) ]
