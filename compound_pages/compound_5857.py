...
st.set_page_config(page_title="Lynestrenol", layout="wide")
st.title("Lynestrenol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5857.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5857](https://pubchem.ncbi.nlm.nih.gov/compound/5857)")
st.markdown(f"IUPAC Name: (8R,9S,10R,13S,14S,17R)-17-ethynyl-13-methyl-2,3,6,7,8,9,10,11,12,14,15,16-dodecahydro-1H-cyclopenta[a]phenanthren-17-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5857) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5857) ]
