...
st.set_page_config(page_title="Methoxyflurane", layout="wide")
st.title("Methoxyflurane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4116.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4116](https://pubchem.ncbi.nlm.nih.gov/compound/4116)")
st.markdown(f"IUPAC Name: 2,2-dichloro-1,1-difluoro-1-methoxyethane")
...
df_filtered = sources[(sources["PubChem_CID"] == 4116) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4116) ]
