...
st.set_page_config(page_title="Quinidine sulfate", layout="wide")
st.title("Quinidine sulfate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_441326.jpg", width=300)
st.markdown(f"PubChem Compound ID: [441326](https://pubchem.ncbi.nlm.nih.gov/compound/441326)")
st.markdown(f"IUPAC Name: bis((S)-[(2R,4S,5R)-5-ethenyl-1-azabicyclo[2.2.2]octan-2-yl]-(6-methoxyquinolin-4-yl)methanol);sulfuric acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 441326) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 441326) ]
