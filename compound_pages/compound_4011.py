...
st.set_page_config(page_title="Maprotiline", layout="wide")
st.title("Maprotiline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4011.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4011](https://pubchem.ncbi.nlm.nih.gov/compound/4011)")
st.markdown(f"IUPAC Name: N-methyl-3-(1-tetracyclo[6.6.2.02,7.09,14]hexadeca-2,4,6,9,11,13-hexaenyl)propan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4011) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4011) ]
