...
st.set_page_config(page_title="Maleic acid", layout="wide")
st.title("Maleic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_444266.jpg", width=300)
st.markdown(f"PubChem Compound ID: [444266](https://pubchem.ncbi.nlm.nih.gov/compound/444266)")
st.markdown(f"IUPAC Name: (Z)-but-2-enedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 444266) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 444266) ]
