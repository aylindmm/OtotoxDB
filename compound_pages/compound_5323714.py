...
st.set_page_config(page_title="Furazolidone", layout="wide")
st.title("Furazolidone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5323714.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5323714](https://pubchem.ncbi.nlm.nih.gov/compound/5323714)")
st.markdown(f"IUPAC Name: 3-[(E)-(5-nitrofuran-2-yl)methylideneamino]-1,3-oxazolidin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5323714) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5323714) ]
