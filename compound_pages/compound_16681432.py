...
st.set_page_config(page_title="Carbetocin", layout="wide")
st.title("Carbetocin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16681432.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16681432](https://pubchem.ncbi.nlm.nih.gov/compound/16681432)")
st.markdown(f"IUPAC Name: (2S)-N-[(2S)-1-[(2-amino-2-oxoethyl)amino]-4-methyl-1-oxopentan-2-yl]-1-[(3R,6S,9S,12S,15S)-6-(2-amino-2-oxoethyl)-9-(3-amino-3-oxopropyl)-12-[(2S)-butan-2-yl]-15-[(4-methoxyphenyl)methyl]-5,8,11,14,17-pentaoxo-1-thia-4,7,10,13,16-pentazacycloicosane-3-carbonyl]pyrrolidine-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 16681432) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16681432) ]
