...
st.set_page_config(page_title="Latanoprost", layout="wide")
st.title("Latanoprost")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5311221.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5311221](https://pubchem.ncbi.nlm.nih.gov/compound/5311221)")
st.markdown(f"IUPAC Name: propan-2-yl (Z)-7-[(1R,2R,3R,5S)-3,5-dihydroxy-2-[(3R)-3-hydroxy-5-phenylpentyl]cyclopentyl]hept-5-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5311221) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5311221) ]
