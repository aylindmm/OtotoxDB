...
st.set_page_config(page_title="Biperiden", layout="wide")
st.title("Biperiden")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2381.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2381](https://pubchem.ncbi.nlm.nih.gov/compound/2381)")
st.markdown(f"IUPAC Name: 1-(2-bicyclo[2.2.1]hept-5-enyl)-1-phenyl-3-piperidin-1-ylpropan-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 2381) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2381) ]
