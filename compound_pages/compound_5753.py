...
st.set_page_config(page_title="Corticosterone", layout="wide")
st.title("Corticosterone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5753.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5753](https://pubchem.ncbi.nlm.nih.gov/compound/5753)")
st.markdown(f"IUPAC Name: (8S,9S,10R,11S,13S,14S,17S)-11-hydroxy-17-(2-hydroxyacetyl)-10,13-dimethyl-1,2,6,7,8,9,11,12,14,15,16,17-dodecahydrocyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5753) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5753) ]
