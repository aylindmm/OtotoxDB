...
st.set_page_config(page_title="3,3',4,4',5-pentachlorobiphenyl", layout="wide")
st.title("3,3',4,4',5-pentachlorobiphenyl")
# Display the image in Streamlit
st.image(f"compound_structures/compound_63090.jpg", width=300)
st.markdown(f"PubChem Compound ID: [63090](https://pubchem.ncbi.nlm.nih.gov/compound/63090)")
st.markdown(f"IUPAC Name: 1,2,3-trichloro-5-(3,4-dichlorophenyl)benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 63090) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 63090) ]
