...
st.set_page_config(page_title="Veratridine", layout="wide")
st.title("Veratridine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6280.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6280](https://pubchem.ncbi.nlm.nih.gov/compound/6280)")
st.markdown(f"IUPAC Name: [(1R,2S,6S,9S,10R,11S,12S,14R,15S,18S,19S,22S,23S,25R)-1,10,11,12,14,23-hexahydroxy-6,10,19-trimethyl-24-oxa-4-azaheptacyclo[12.12.0.02,11.04,9.015,25.018,23.019,25]hexacosan-22-yl] 3,4-dimethoxybenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6280) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6280) ]
