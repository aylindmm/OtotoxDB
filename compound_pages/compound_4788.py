...
st.set_page_config(page_title="Phloretin", layout="wide")
st.title("Phloretin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4788.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 4788) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4788) ]
