...
st.set_page_config(page_title="Nitro-l-arginine methyl ester", layout="wide")
st.title("Nitro-l-arginine methyl ester")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135959571.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135959571](https://pubchem.ncbi.nlm.nih.gov/compound/135959571)")
st.markdown(f"IUPAC Name: methyl (2S)-2-amino-5-[[(Z)-N'-nitrocarbamimidoyl]amino]pentanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 135959571) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135959571) ]
