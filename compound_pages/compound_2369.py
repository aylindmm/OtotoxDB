...
st.set_page_config(page_title="Betaxolol", layout="wide")
st.title("Betaxolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2369.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2369](https://pubchem.ncbi.nlm.nih.gov/compound/2369)")
st.markdown(f"IUPAC Name: 1-[4-[2-(cyclopropylmethoxy)ethyl]phenoxy]-3-(propan-2-ylamino)propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 2369) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2369) ]
