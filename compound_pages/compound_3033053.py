...
st.set_page_config(page_title="Dezocine", layout="wide")
st.title("Dezocine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3033053.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3033053](https://pubchem.ncbi.nlm.nih.gov/compound/3033053)")
st.markdown(f"IUPAC Name: (1R,9S,15S)-15-amino-1-methyltricyclo[7.5.1.02,7]pentadeca-2(7),3,5-trien-4-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3033053) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3033053) ]
