...
st.set_page_config(page_title="Repotrectinib", layout="wide")
st.title("Repotrectinib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135565923.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135565923](https://pubchem.ncbi.nlm.nih.gov/compound/135565923)")
st.markdown(f"IUPAC Name: (3R,11S)-6-fluoro-3,11-dimethyl-10-oxa-2,13,17,18,21-pentazatetracyclo[13.5.2.04,9.018,22]docosa-1(21),4(9),5,7,15(22),16,19-heptaen-14-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 135565923) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135565923) ]
