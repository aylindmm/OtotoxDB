...
st.set_page_config(page_title="Pentobarbital", layout="wide")
st.title("Pentobarbital")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4737.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4737](https://pubchem.ncbi.nlm.nih.gov/compound/4737)")
st.markdown(f"IUPAC Name: 5-ethyl-5-pentan-2-yl-1,3-diazinane-2,4,6-trione")
...
df_filtered = sources[(sources["PubChem_CID"] == 4737) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4737) ]
