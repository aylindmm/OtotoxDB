...
st.set_page_config(page_title="Abecarnil", layout="wide")
st.title("Abecarnil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_65914.jpg", width=300)
st.markdown(f"PubChem Compound ID: [65914](https://pubchem.ncbi.nlm.nih.gov/compound/65914)")
st.markdown(f"IUPAC Name: propan-2-yl 4-(methoxymethyl)-6-phenylmethoxy-9H-pyrido[3,4-b]indole-3-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 65914) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 65914) ]
