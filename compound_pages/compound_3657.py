...
st.set_page_config(page_title="Hydroxyurea", layout="wide")
st.title("Hydroxyurea")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3657.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3657](https://pubchem.ncbi.nlm.nih.gov/compound/3657)")
st.markdown(f"IUPAC Name: hydroxyurea")
...
df_filtered = sources[(sources["PubChem_CID"] == 3657) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3657) ]
