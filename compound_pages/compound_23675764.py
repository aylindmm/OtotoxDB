...
st.set_page_config(page_title="Sodium iodate", layout="wide")
st.title("Sodium iodate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23675764.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23675764](https://pubchem.ncbi.nlm.nih.gov/compound/23675764)")
st.markdown(f"IUPAC Name: sodium iodate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23675764) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23675764) ]
