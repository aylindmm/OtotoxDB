...
st.set_page_config(page_title="Indole", layout="wide")
st.title("Indole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_798.jpg", width=300)
st.markdown(f"PubChem Compound ID: [798](https://pubchem.ncbi.nlm.nih.gov/compound/798)")
st.markdown(f"IUPAC Name: 1H-indole")
...
df_filtered = sources[(sources["PubChem_CID"] == 798) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 798) ]
