...
st.set_page_config(page_title="Hypericin", layout="wide")
st.title("Hypericin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3663.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3663](https://pubchem.ncbi.nlm.nih.gov/compound/3663)")
st.markdown(f"IUPAC Name: 9,11,13,16,18,20-hexahydroxy-5,24-dimethyloctacyclo[13.11.1.12,10.03,8.04,25.019,27.021,26.014,28]octacosa-1(26),2,4(25),5,8,10,12,14(28),15(27),16,18,20,23-tridecaene-7,22-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 3663) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3663) ]
