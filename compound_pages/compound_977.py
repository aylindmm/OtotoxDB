...
st.set_page_config(page_title="Oxygen", layout="wide")
st.title("Oxygen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_977.jpg", width=300)
st.markdown(f"PubChem Compound ID: [977](https://pubchem.ncbi.nlm.nih.gov/compound/977)")
st.markdown(f"IUPAC Name: molecular oxygen")
...
df_filtered = sources[(sources["PubChem_CID"] == 977) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 977) ]
