...
st.set_page_config(page_title="Beta-glucan", layout="wide")
st.title("Beta-glucan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_439262.jpg", width=300)
st.markdown(f"PubChem Compound ID: [439262](https://pubchem.ncbi.nlm.nih.gov/compound/439262)")
st.markdown(f"IUPAC Name: (2S,3R,4S,5S,6R)-2-[(2R,4R,5R,6S)-4,5-dihydroxy-2-(hydroxymethyl)-6-[(2R,4R,5R,6S)-4,5,6-trihydroxy-2-(hydroxymethyl)oxan-3-yl]oxyoxan-3-yl]oxy-6-(hydroxymethyl)oxane-3,4,5-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 439262) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 439262) ]
