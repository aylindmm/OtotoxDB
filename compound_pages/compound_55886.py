...
st.set_page_config(page_title="Trospectomycin", layout="wide")
st.title("Trospectomycin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_55886.jpg", width=300)
st.markdown(f"PubChem Compound ID: [55886](https://pubchem.ncbi.nlm.nih.gov/compound/55886)")
st.markdown(f"IUPAC Name: (1R,3S,5R,8R,10R,11S,12S,13R,14S)-5-butyl-8,12,14-trihydroxy-11,13-bis(methylamino)-2,4,9-trioxatricyclo[8.4.0.03,8]tetradecan-7-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 55886) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 55886) ]
