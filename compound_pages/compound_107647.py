...
st.set_page_config(page_title="Fluorocitric acid", layout="wide")
st.title("Fluorocitric acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_107647.jpg", width=300)
st.markdown(f"PubChem Compound ID: [107647](https://pubchem.ncbi.nlm.nih.gov/compound/107647)")
st.markdown(f"IUPAC Name: 1-fluoro-2-hydroxypropane-1,2,3-tricarboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 107647) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 107647) ]
