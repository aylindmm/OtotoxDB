...
st.set_page_config(page_title="Ticlopidine", layout="wide")
st.title("Ticlopidine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5472.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5472](https://pubchem.ncbi.nlm.nih.gov/compound/5472)")
st.markdown(f"IUPAC Name: 5-[(2-chlorophenyl)methyl]-6,7-dihydro-4H-thieno[3,2-c]pyridine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5472) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5472) ]
