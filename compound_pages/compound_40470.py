...
st.set_page_config(page_title="2,2',3,3',4-pentachlorobiphenyl", layout="wide")
st.title("2,2',3,3',4-pentachlorobiphenyl")
# Display the image in Streamlit
st.image(f"compound_structures/compound_40470.jpg", width=300)
st.markdown(f"PubChem Compound ID: [40470](https://pubchem.ncbi.nlm.nih.gov/compound/40470)")
st.markdown(f"IUPAC Name: 1,2,3-trichloro-4-(2,3-dichlorophenyl)benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 40470) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 40470) ]
