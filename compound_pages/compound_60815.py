...
st.set_page_config(page_title="Remifentanil", layout="wide")
st.title("Remifentanil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60815.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60815](https://pubchem.ncbi.nlm.nih.gov/compound/60815)")
st.markdown(f"IUPAC Name: methyl 1-(3-methoxy-3-oxopropyl)-4-(N-propanoylanilino)piperidine-4-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 60815) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60815) ]
