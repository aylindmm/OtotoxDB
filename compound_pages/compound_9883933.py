...
st.set_page_config(page_title="Gabapentin enacarbil", layout="wide")
st.title("Gabapentin enacarbil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9883933.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9883933](https://pubchem.ncbi.nlm.nih.gov/compound/9883933)")
st.markdown(f"IUPAC Name: 2-[1-[[1-(2-methylpropanoyloxy)ethoxycarbonylamino]methyl]cyclohexyl]acetic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 9883933) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9883933) ]
