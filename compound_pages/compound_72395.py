...
st.set_page_config(page_title="Gentamicin c1", layout="wide")
st.title("Gentamicin c1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_72395.jpg", width=300)
st.markdown(f"PubChem Compound ID: [72395](https://pubchem.ncbi.nlm.nih.gov/compound/72395)")
st.markdown(f"IUPAC Name: (2R,3R,4R,5R)-2-[(1S,2S,3R,4S,6R)-4,6-diamino-3-[(2R,3R,6S)-3-amino-6-[(1R)-1-(methylamino)ethyl]oxan-2-yl]oxy-2-hydroxycyclohexyl]oxy-5-methyl-4-(methylamino)oxane-3,5-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 72395) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 72395) ]
