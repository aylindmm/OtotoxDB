...
st.set_page_config(page_title="58962-34-8", layout="wide")
st.title("58962-34-8")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5280888.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5280888](https://pubchem.ncbi.nlm.nih.gov/compound/5280888)")
st.markdown(f"IUPAC Name: 7-[(1R,2R,3R,5S)-3,5-dihydroxy-2-[(E,3S)-3-hydroxyoct-1-enyl]cyclopentyl]-6-oxoheptanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5280888) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5280888) ]
