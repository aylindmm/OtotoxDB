...
st.set_page_config(page_title="4-aminosalicylic acid", layout="wide")
st.title("4-aminosalicylic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4649.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4649](https://pubchem.ncbi.nlm.nih.gov/compound/4649)")
st.markdown(f"IUPAC Name: 4-amino-2-hydroxybenzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 4649) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4649) ]
