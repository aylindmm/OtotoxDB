...
st.set_page_config(page_title="Megestrol acetate", layout="wide")
st.title("Megestrol acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11683.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11683](https://pubchem.ncbi.nlm.nih.gov/compound/11683)")
st.markdown(f"IUPAC Name: [(8R,9S,10R,13S,14S,17R)-17-acetyl-6,10,13-trimethyl-3-oxo-2,8,9,11,12,14,15,16-octahydro-1H-cyclopenta[a]phenanthren-17-yl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 11683) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11683) ]
