...
st.set_page_config(page_title="5-hydroxytryptophan", layout="wide")
st.title("5-hydroxytryptophan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_144.jpg", width=300)
st.markdown(f"PubChem Compound ID: [144](https://pubchem.ncbi.nlm.nih.gov/compound/144)")
st.markdown(f"IUPAC Name: 2-amino-3-(5-hydroxy-1H-indol-3-yl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 144) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 144) ]
