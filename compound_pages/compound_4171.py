...
st.set_page_config(page_title="Metoprolol", layout="wide")
st.title("Metoprolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4171.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4171](https://pubchem.ncbi.nlm.nih.gov/compound/4171)")
st.markdown(f"IUPAC Name: 1-[4-(2-methoxyethyl)phenoxy]-3-(propan-2-ylamino)propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 4171) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4171) ]
