...
st.set_page_config(page_title="Buprenorphine", layout="wide")
st.title("Buprenorphine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_644073.jpg", width=300)
st.markdown(f"PubChem Compound ID: [644073](https://pubchem.ncbi.nlm.nih.gov/compound/644073)")
st.markdown(f"IUPAC Name: (1S,2S,6R,14R,15R,16R)-5-(cyclopropylmethyl)-16-[(2S)-2-hydroxy-3,3-dimethylbutan-2-yl]-15-methoxy-13-oxa-5-azahexacyclo[13.2.2.12,8.01,6.02,14.012,20]icosa-8(20),9,11-trien-11-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 644073) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 644073) ]
