...
st.set_page_config(page_title="Pergolide", layout="wide")
st.title("Pergolide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_47811.jpg", width=300)
st.markdown(f"PubChem Compound ID: [47811](https://pubchem.ncbi.nlm.nih.gov/compound/47811)")
st.markdown(f"IUPAC Name: (6aR,9R,10aR)-9-(methylsulfanylmethyl)-7-propyl-6,6a,8,9,10,10a-hexahydro-4H-indolo[4,3-fg]quinoline")
...
df_filtered = sources[(sources["PubChem_CID"] == 47811) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 47811) ]
