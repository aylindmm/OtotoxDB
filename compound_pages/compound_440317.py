...
st.set_page_config(page_title="Gamma-thio-atp", layout="wide")
st.title("Gamma-thio-atp")
# Display the image in Streamlit
st.image(f"compound_structures/compound_440317.jpg", width=300)
st.markdown(f"PubChem Compound ID: [440317](https://pubchem.ncbi.nlm.nih.gov/compound/440317)")
st.markdown(f"IUPAC Name: [[(2R,3S,4R,5R)-5-(6-aminopurin-9-yl)-3,4-dihydroxyoxolan-2-yl]methoxy-hydroxyphosphoryl] dihydroxyphosphinothioyl hydrogen phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 440317) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 440317) ]
