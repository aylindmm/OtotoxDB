...
st.set_page_config(page_title="D-cycloserine", layout="wide")
st.title("D-cycloserine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6234.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6234](https://pubchem.ncbi.nlm.nih.gov/compound/6234)")
st.markdown(f"IUPAC Name: (4R)-4-amino-1,2-oxazolidin-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 6234) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6234) ]
