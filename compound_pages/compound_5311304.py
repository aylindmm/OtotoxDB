...
st.set_page_config(page_title="Nalbuphine", layout="wide")
st.title("Nalbuphine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5311304.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5311304](https://pubchem.ncbi.nlm.nih.gov/compound/5311304)")
st.markdown(f"IUPAC Name: (4R,4aS,7S,7aR,12bS)-3-(cyclobutylmethyl)-1,2,4,5,6,7,7a,13-octahydro-4,12-methanobenzofuro[3,2-e]isoquinoline-4a,7,9-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5311304) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5311304) ]
