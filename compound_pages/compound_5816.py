...
st.set_page_config(page_title="Epinephrine", layout="wide")
st.title("Epinephrine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5816.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5816](https://pubchem.ncbi.nlm.nih.gov/compound/5816)")
st.markdown(f"IUPAC Name: 4-[(1R)-1-hydroxy-2-(methylamino)ethyl]benzene-1,2-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5816) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5816) ]
