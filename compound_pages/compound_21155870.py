...
st.set_page_config(page_title="Codeine sulfate", layout="wide")
st.title("Codeine sulfate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_21155870.jpg", width=300)
st.markdown(f"PubChem Compound ID: [21155870](https://pubchem.ncbi.nlm.nih.gov/compound/21155870)")
st.markdown(f"IUPAC Name: bis((4R,4aR,7S,7aR,12bS)-9-methoxy-3-methyl-2,4,4a,7,7a,13-hexahydro-1H-4,12-methanobenzofuro[3,2-e]isoquinolin-7-ol);sulfuric acid;trihydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 21155870) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 21155870) ]
