...
st.set_page_config(page_title="Hydrogen cyanide", layout="wide")
st.title("Hydrogen cyanide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_768.jpg", width=300)
st.markdown(f"PubChem Compound ID: [768](https://pubchem.ncbi.nlm.nih.gov/compound/768)")
st.markdown(f"IUPAC Name: formonitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 768) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 768) ]
