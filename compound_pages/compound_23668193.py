...
st.set_page_config(page_title="Sodium nitrite", layout="wide")
st.title("Sodium nitrite")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23668193.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23668193](https://pubchem.ncbi.nlm.nih.gov/compound/23668193)")
st.markdown(f"IUPAC Name: sodium nitrite")
...
df_filtered = sources[(sources["PubChem_CID"] == 23668193) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23668193) ]
