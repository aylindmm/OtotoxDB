...
st.set_page_config(page_title="Sodium bicarbonate", layout="wide")
st.title("Sodium bicarbonate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_516892.jpg", width=300)
st.markdown(f"PubChem Compound ID: [516892](https://pubchem.ncbi.nlm.nih.gov/compound/516892)")
st.markdown(f"IUPAC Name: sodium hydrogen carbonate")
...
df_filtered = sources[(sources["PubChem_CID"] == 516892) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 516892) ]
