...
st.set_page_config(page_title="Salicylamide", layout="wide")
st.title("Salicylamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5147.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5147](https://pubchem.ncbi.nlm.nih.gov/compound/5147)")
st.markdown(f"IUPAC Name: 2-hydroxybenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5147) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5147) ]
