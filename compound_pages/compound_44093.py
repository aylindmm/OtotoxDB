...
st.set_page_config(page_title="Captopril", layout="wide")
st.title("Captopril")
# Display the image in Streamlit
st.image(f"compound_structures/compound_44093.jpg", width=300)
st.markdown(f"PubChem Compound ID: [44093](https://pubchem.ncbi.nlm.nih.gov/compound/44093)")
st.markdown(f"IUPAC Name: (2S)-1-[(2S)-2-methyl-3-sulfanylpropanoyl]pyrrolidine-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 44093) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 44093) ]
