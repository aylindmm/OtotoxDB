...
st.set_page_config(page_title="Levonantradol", layout="wide")
st.title("Levonantradol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5361881.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5361881](https://pubchem.ncbi.nlm.nih.gov/compound/5361881)")
st.markdown(f"IUPAC Name: [(6S,6aR,9R,10aR)-9-hydroxy-6-methyl-3-[(2R)-5-phenylpentan-2-yl]oxy-5,6,6a,7,8,9,10,10a-octahydrophenanthridin-1-yl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5361881) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5361881) ]
