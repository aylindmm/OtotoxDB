...
st.set_page_config(page_title="Tycolet", layout="wide")
st.title("Tycolet")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5748525.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5748525](https://pubchem.ncbi.nlm.nih.gov/compound/5748525)")
st.markdown(f"IUPAC Name: (4R,4aR,7aR,12bS)-9-methoxy-3-methyl-1,2,4,4a,5,6,7a,13-octahydro-4,12-methanobenzofuro[3,2-e]isoquinolin-7-one;(2R,3R)-2,3-dihydroxybutanedioic acid;N-(4-hydroxyphenyl)acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5748525) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5748525) ]
