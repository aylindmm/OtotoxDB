...
st.set_page_config(page_title="Mifepristone", layout="wide")
st.title("Mifepristone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_55245.jpg", width=300)
st.markdown(f"PubChem Compound ID: [55245](https://pubchem.ncbi.nlm.nih.gov/compound/55245)")
st.markdown(f"IUPAC Name: (8S,11R,13S,14S,17S)-11-[4-(dimethylamino)phenyl]-17-hydroxy-13-methyl-17-prop-1-ynyl-1,2,6,7,8,11,12,14,15,16-decahydrocyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 55245) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 55245) ]
