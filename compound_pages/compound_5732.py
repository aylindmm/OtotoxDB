...
st.set_page_config(page_title="Zolpidem", layout="wide")
st.title("Zolpidem")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5732.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5732](https://pubchem.ncbi.nlm.nih.gov/compound/5732)")
st.markdown(f"IUPAC Name: N,N-dimethyl-2-[6-methyl-2-(4-methylphenyl)imidazo[1,2-a]pyridin-3-yl]acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5732) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5732) ]
