...
st.image(f"compound_structures/compound_5282199.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5282199) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5282199) ]
