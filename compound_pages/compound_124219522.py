...
st.image(f"compound_structures/compound_124219522.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 124219522) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 124219522) ]
