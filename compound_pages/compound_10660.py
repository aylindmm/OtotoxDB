...
st.set_page_config(page_title="Dimenhydrinate", layout="wide")
st.title("Dimenhydrinate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10660.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10660](https://pubchem.ncbi.nlm.nih.gov/compound/10660)")
st.markdown(f"IUPAC Name: 2-benzhydryloxy-N,N-dimethylethanamine;8-chloro-1,3-dimethyl-7H-purine-2,6-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 10660) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10660) ]
