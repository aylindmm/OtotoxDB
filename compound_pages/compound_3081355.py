...
st.set_page_config(page_title="192703-06-3", layout="wide")
st.title("192703-06-3")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3081355.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3081355](https://pubchem.ncbi.nlm.nih.gov/compound/3081355)")
st.markdown(f"IUPAC Name: 5-(4-chloro-3-methylphenyl)-1-[(4-methylphenyl)methyl]-N-[(1S,2S,4R)-1,3,3-trimethyl-2-bicyclo[2.2.1]heptanyl]pyrazole-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3081355) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3081355) ]
