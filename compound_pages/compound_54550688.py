...
st.set_page_config(page_title="2-cyano-butyl-acrylate", layout="wide")
st.title("2-cyano-butyl-acrylate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54550688.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54550688](https://pubchem.ncbi.nlm.nih.gov/compound/54550688)")
st.markdown(f"IUPAC Name: 2-cyanobutyl prop-2-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 54550688) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54550688) ]
