...
st.set_page_config(page_title="Warfarin", layout="wide")
st.title("Warfarin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54678486.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54678486](https://pubchem.ncbi.nlm.nih.gov/compound/54678486)")
st.markdown(f"IUPAC Name: 4-hydroxy-3-(3-oxo-1-phenylbutyl)chromen-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 54678486) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54678486) ]
