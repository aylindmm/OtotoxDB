...
st.set_page_config(page_title="Indoramin", layout="wide")
st.title("Indoramin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_33625.jpg", width=300)
st.markdown(f"PubChem Compound ID: [33625](https://pubchem.ncbi.nlm.nih.gov/compound/33625)")
st.markdown(f"IUPAC Name: N-[1-[2-(1H-indol-3-yl)ethyl]piperidin-4-yl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 33625) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 33625) ]
