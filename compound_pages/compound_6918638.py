...
st.set_page_config(page_title="Belinostat", layout="wide")
st.title("Belinostat")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6918638.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6918638](https://pubchem.ncbi.nlm.nih.gov/compound/6918638)")
st.markdown(f"IUPAC Name: (E)-N-hydroxy-3-[3-(phenylsulfamoyl)phenyl]prop-2-enamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 6918638) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6918638) ]
