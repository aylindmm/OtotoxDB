...
st.set_page_config(page_title="Podophyllotoxin", layout="wide")
st.title("Podophyllotoxin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10607.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10607](https://pubchem.ncbi.nlm.nih.gov/compound/10607)")
st.markdown(f"IUPAC Name: (5R,5aR,8aR,9R)-5-hydroxy-9-(3,4,5-trimethoxyphenyl)-5a,6,8a,9-tetrahydro-5H-[2]benzofuro[5,6-f][1,3]benzodioxol-8-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 10607) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10607) ]
