...
st.set_page_config(page_title="Propiverine", layout="wide")
st.title("Propiverine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4942.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4942](https://pubchem.ncbi.nlm.nih.gov/compound/4942)")
st.markdown(f"IUPAC Name: (1-methylpiperidin-4-yl) 2,2-diphenyl-2-propoxyacetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 4942) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4942) ]
