...
st.set_page_config(page_title="Alprazolam", layout="wide")
st.title("Alprazolam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2118.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2118](https://pubchem.ncbi.nlm.nih.gov/compound/2118)")
st.markdown(f"IUPAC Name: 8-chloro-1-methyl-6-phenyl-4H-[1,2,4]triazolo[4,3-a][1,4]benzodiazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2118) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2118) ]
