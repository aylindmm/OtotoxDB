...
st.set_page_config(page_title="1-chloro-4-[2,2,2-trichloro-1-(4-chlorophenyl)ethyl]benzene", layout="wide")
st.title("1-chloro-4-[2,2,2-trichloro-1-(4-chlorophenyl)ethyl]benzene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3036.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3036](https://pubchem.ncbi.nlm.nih.gov/compound/3036)")
st.markdown(f"IUPAC Name: 1-chloro-4-[2,2,2-trichloro-1-(4-chlorophenyl)ethyl]benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 3036) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3036) ]
