...
st.set_page_config(page_title="Acetylcholine", layout="wide")
st.title("Acetylcholine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_187.jpg", width=300)
st.markdown(f"PubChem Compound ID: [187](https://pubchem.ncbi.nlm.nih.gov/compound/187)")
st.markdown(f"IUPAC Name: 2-acetyloxyethyl(trimethyl)azanium")
...
df_filtered = sources[(sources["PubChem_CID"] == 187) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 187) ]
