...
st.set_page_config(page_title="Mebendazole", layout="wide")
st.title("Mebendazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4030.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4030](https://pubchem.ncbi.nlm.nih.gov/compound/4030)")
st.markdown(f"IUPAC Name: methyl N-(6-benzoyl-1H-benzimidazol-2-yl)carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 4030) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4030) ]
