...
st.set_page_config(page_title="Fesoterodine", layout="wide")
st.title("Fesoterodine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6918558.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6918558](https://pubchem.ncbi.nlm.nih.gov/compound/6918558)")
st.markdown(f"IUPAC Name: [2-[(1R)-3-[di(propan-2-yl)amino]-1-phenylpropyl]-4-(hydroxymethyl)phenyl] 2-methylpropanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6918558) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6918558) ]
