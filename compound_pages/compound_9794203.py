...
st.set_page_config(page_title="Lanicemine", layout="wide")
st.title("Lanicemine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9794203.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9794203](https://pubchem.ncbi.nlm.nih.gov/compound/9794203)")
st.markdown(f"IUPAC Name: (1S)-1-phenyl-2-pyridin-2-ylethanamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 9794203) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9794203) ]
