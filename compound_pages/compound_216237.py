...
st.set_page_config(page_title="Tolvaptan", layout="wide")
st.title("Tolvaptan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_216237.jpg", width=300)
st.markdown(f"PubChem Compound ID: [216237](https://pubchem.ncbi.nlm.nih.gov/compound/216237)")
st.markdown(f"IUPAC Name: N-[4-(7-chloro-5-hydroxy-2,3,4,5-tetrahydro-1-benzazepine-1-carbonyl)-3-methylphenyl]-2-methylbenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 216237) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 216237) ]
