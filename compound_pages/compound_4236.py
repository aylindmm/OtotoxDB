...
st.set_page_config(page_title="Modafinil", layout="wide")
st.title("Modafinil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4236.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4236](https://pubchem.ncbi.nlm.nih.gov/compound/4236)")
st.markdown(f"IUPAC Name: 2-benzhydrylsulfinylacetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 4236) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4236) ]
