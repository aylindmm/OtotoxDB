...
st.set_page_config(page_title="Tungsten", layout="wide")
st.title("Tungsten")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23964.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23964](https://pubchem.ncbi.nlm.nih.gov/compound/23964)")
st.markdown(f"IUPAC Name: tungsten")
...
df_filtered = sources[(sources["PubChem_CID"] == 23964) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23964) ]
