...
st.image(f"compound_structures/compound_37542.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 37542) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 37542) ]
