...
st.set_page_config(page_title="Pyrethrins", layout="wide")
st.title("Pyrethrins")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60202781.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60202781](https://pubchem.ncbi.nlm.nih.gov/compound/60202781)")
st.markdown(f"IUPAC Name: cis-[(1S)-2-methyl-4-oxo-3-[(2Z)-penta-2,4-dienyl]cyclopent-2-en-1-yl] (1R,3R)-2,2-dimethyl-3-(2-methylprop-1-enyl)cyclopropane-1-carboxylate;cis-[(1S)-2-methyl-4-oxo-3-[(2Z)-penta-2,4-dienyl]cyclopent-2-en-1-yl] (1R,3R)-3-[(E)-3-methoxy-2-methyl-3-oxoprop-1-enyl]-2,2-dimethylcyclopropane-1-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 60202781) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60202781) ]
