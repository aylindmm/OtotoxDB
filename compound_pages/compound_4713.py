...
st.set_page_config(page_title="167869-21-8", layout="wide")
st.title("167869-21-8")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4713.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4713](https://pubchem.ncbi.nlm.nih.gov/compound/4713)")
st.markdown(f"IUPAC Name: 2-(2-amino-3-methoxyphenyl)chromen-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 4713) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4713) ]
