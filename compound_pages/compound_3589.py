...
st.set_page_config(page_title="Heptachlor", layout="wide")
st.title("Heptachlor")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3589.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3589](https://pubchem.ncbi.nlm.nih.gov/compound/3589)")
st.markdown(f"IUPAC Name: 1,5,7,8,9,10,10-heptachlorotricyclo[5.2.1.02,6]deca-3,8-diene")
...
df_filtered = sources[(sources["PubChem_CID"] == 3589) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3589) ]
