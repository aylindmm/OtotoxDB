...
st.set_page_config(page_title="Methylphenidate", layout="wide")
st.title("Methylphenidate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4158.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4158](https://pubchem.ncbi.nlm.nih.gov/compound/4158)")
st.markdown(f"IUPAC Name: methyl 2-phenyl-2-piperidin-2-ylacetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 4158) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4158) ]
