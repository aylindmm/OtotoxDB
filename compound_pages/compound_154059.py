...
st.set_page_config(page_title="Solifenacin", layout="wide")
st.title("Solifenacin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_154059.jpg", width=300)
st.markdown(f"PubChem Compound ID: [154059](https://pubchem.ncbi.nlm.nih.gov/compound/154059)")
st.markdown(f"IUPAC Name: [(3R)-1-azabicyclo[2.2.2]octan-3-yl] (1S)-1-phenyl-3,4-dihydro-1H-isoquinoline-2-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 154059) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 154059) ]
