...
st.set_page_config(page_title="Closantel", layout="wide")
st.title("Closantel")
# Display the image in Streamlit
st.image(f"compound_structures/compound_42574.jpg", width=300)
st.markdown(f"PubChem Compound ID: [42574](https://pubchem.ncbi.nlm.nih.gov/compound/42574)")
st.markdown(f"IUPAC Name: N-[5-chloro-4-[(4-chlorophenyl)-cyanomethyl]-2-methylphenyl]-2-hydroxy-3,5-diiodobenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 42574) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 42574) ]
