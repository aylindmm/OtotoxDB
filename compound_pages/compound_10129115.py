...
st.set_page_config(page_title="Bax inhibitor peptide v5", layout="wide")
st.title("Bax inhibitor peptide v5")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10129115.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10129115](https://pubchem.ncbi.nlm.nih.gov/compound/10129115)")
st.markdown(f"IUPAC Name: (2S)-6-amino-2-[[(2S)-2-[[(2S)-2-[[(2S)-1-[(2S)-2-amino-3-methylbutanoyl]pyrrolidine-2-carbonyl]amino]-4-methylsulfanylbutanoyl]amino]-4-methylpentanoyl]amino]hexanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 10129115) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10129115) ]
