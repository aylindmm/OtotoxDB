...
st.set_page_config(page_title="Selitrectinib", layout="wide")
st.title("Selitrectinib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_129103609.jpg", width=300)
st.markdown(f"PubChem Compound ID: [129103609](https://pubchem.ncbi.nlm.nih.gov/compound/129103609)")
st.markdown(f"IUPAC Name: (6R,15R)-9-fluoro-15-methyl-2,11,16,20,21,24-hexazapentacyclo[16.5.2.02,6.07,12.021,25]pentacosa-1(24),7(12),8,10,18(25),19,22-heptaen-17-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 129103609) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 129103609) ]
