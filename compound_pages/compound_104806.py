...
st.set_page_config(page_title="Peroxynitrite", layout="wide")
st.title("Peroxynitrite")
# Display the image in Streamlit
st.image(f"compound_structures/compound_104806.jpg", width=300)
st.markdown(f"PubChem Compound ID: [104806](https://pubchem.ncbi.nlm.nih.gov/compound/104806)")
st.markdown(f"IUPAC Name: oxido nitrite")
...
df_filtered = sources[(sources["PubChem_CID"] == 104806) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 104806) ]
