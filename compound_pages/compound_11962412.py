...
st.set_page_config(page_title="Cenobamate", layout="wide")
st.title("Cenobamate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11962412.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11962412](https://pubchem.ncbi.nlm.nih.gov/compound/11962412)")
st.markdown(f"IUPAC Name: [(1R)-1-(2-chlorophenyl)-2-(tetrazol-2-yl)ethyl] carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 11962412) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11962412) ]
