...
st.set_page_config(page_title="Salvinorin a", layout="wide")
st.title("Salvinorin a")
# Display the image in Streamlit
st.image(f"compound_structures/compound_128563.jpg", width=300)
st.markdown(f"PubChem Compound ID: [128563](https://pubchem.ncbi.nlm.nih.gov/compound/128563)")
st.markdown(f"IUPAC Name: methyl (2S,4aR,6aR,7R,9S,10aS,10bR)-9-acetyloxy-2-(furan-3-yl)-6a,10b-dimethyl-4,10-dioxo-2,4a,5,6,7,8,9,10a-octahydro-1H-benzo[f]isochromene-7-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 128563) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 128563) ]
