...
st.set_page_config(page_title="Sorafenib", layout="wide")
st.title("Sorafenib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_216239.jpg", width=300)
st.markdown(f"PubChem Compound ID: [216239](https://pubchem.ncbi.nlm.nih.gov/compound/216239)")
st.markdown(f"IUPAC Name: 4-[4-[[4-chloro-3-(trifluoromethyl)phenyl]carbamoylamino]phenoxy]-N-methylpyridine-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 216239) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 216239) ]
