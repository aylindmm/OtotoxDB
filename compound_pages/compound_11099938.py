...
st.set_page_config(page_title="Dimethyldiphenylphosphonium iodide", layout="wide")
st.title("Dimethyldiphenylphosphonium iodide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11099938.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11099938](https://pubchem.ncbi.nlm.nih.gov/compound/11099938)")
st.markdown(f"IUPAC Name: dimethyl(diphenyl)phosphanium iodide")
...
df_filtered = sources[(sources["PubChem_CID"] == 11099938) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11099938) ]
