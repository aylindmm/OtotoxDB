...
st.set_page_config(page_title="Kainic acid", layout="wide")
st.title("Kainic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10255.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10255](https://pubchem.ncbi.nlm.nih.gov/compound/10255)")
st.markdown(f"IUPAC Name: (2S,3S,4S)-3-(carboxymethyl)-4-prop-1-en-2-ylpyrrolidine-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 10255) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10255) ]
