...
st.set_page_config(page_title="Ammonium chloride", layout="wide")
st.title("Ammonium chloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25517.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25517](https://pubchem.ncbi.nlm.nih.gov/compound/25517)")
st.markdown(f"IUPAC Name: azanium chloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 25517) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25517) ]
