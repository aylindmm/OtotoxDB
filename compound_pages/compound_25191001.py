...
st.set_page_config(page_title="Donafenib", layout="wide")
st.title("Donafenib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25191001.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25191001](https://pubchem.ncbi.nlm.nih.gov/compound/25191001)")
st.markdown(f"IUPAC Name: 4-[4-[[4-chloro-3-(trifluoromethyl)phenyl]carbamoylamino]phenoxy]-N-(trideuteriomethyl)pyridine-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 25191001) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25191001) ]
