...
st.set_page_config(page_title="Org 25935", layout="wide")
st.title("Org 25935")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11740218.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11740218](https://pubchem.ncbi.nlm.nih.gov/compound/11740218)")
st.markdown(f"IUPAC Name: 2-[[(1R,2S)-6-methoxy-1-phenyl-1,2,3,4-tetrahydronaphthalen-2-yl]methyl-methylamino]acetic acid;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 11740218) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11740218) ]
