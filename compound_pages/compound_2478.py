...
st.set_page_config(page_title="Busulfan", layout="wide")
st.title("Busulfan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2478.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2478](https://pubchem.ncbi.nlm.nih.gov/compound/2478)")
st.markdown(f"IUPAC Name: 4-methylsulfonyloxybutyl methanesulfonate")
...
df_filtered = sources[(sources["PubChem_CID"] == 2478) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2478) ]
