...
st.set_page_config(page_title="Lomerizine", layout="wide")
st.title("Lomerizine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3949.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3949](https://pubchem.ncbi.nlm.nih.gov/compound/3949)")
st.markdown(f"IUPAC Name: 1-[bis(4-fluorophenyl)methyl]-4-[(2,3,4-trimethoxyphenyl)methyl]piperazine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3949) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3949) ]
