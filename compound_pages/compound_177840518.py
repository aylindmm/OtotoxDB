...
st.set_page_config(page_title="Gmdtc", layout="wide")
st.title("Gmdtc")
# Display the image in Streamlit
st.image(f"compound_structures/compound_177840518.jpg", width=300)
st.markdown(f"PubChem Compound ID: [177840518](https://pubchem.ncbi.nlm.nih.gov/compound/177840518)")
st.markdown(f"IUPAC Name: disodium;(2S)-4-methylsulfanyl-2-[[(2S,3R,4R,5R)-2,3,4,5,6-pentahydroxyhexyl]-sulfidocarbothioylamino]butanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 177840518) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 177840518) ]
