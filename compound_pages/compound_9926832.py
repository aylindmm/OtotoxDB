...
st.set_page_config(page_title="Mavoglurant", layout="wide")
st.title("Mavoglurant")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9926832.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9926832](https://pubchem.ncbi.nlm.nih.gov/compound/9926832)")
st.markdown(f"IUPAC Name: methyl (3aR,4S,7aR)-4-hydroxy-4-[2-(3-methylphenyl)ethynyl]-3,3a,5,6,7,7a-hexahydro-2H-indole-1-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 9926832) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9926832) ]
