...
st.set_page_config(page_title="Rosoxacin", layout="wide")
st.title("Rosoxacin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_287180.jpg", width=300)
st.markdown(f"PubChem Compound ID: [287180](https://pubchem.ncbi.nlm.nih.gov/compound/287180)")
st.markdown(f"IUPAC Name: 1-ethyl-4-oxo-7-pyridin-4-ylquinoline-3-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 287180) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 287180) ]
