...
st.set_page_config(page_title="Olanzapine pamoate", layout="wide")
st.title("Olanzapine pamoate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135566032.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135566032](https://pubchem.ncbi.nlm.nih.gov/compound/135566032)")
st.markdown(f"IUPAC Name: 4-[(3-carboxy-2-hydroxynaphthalen-1-yl)methyl]-3-hydroxynaphthalene-2-carboxylic acid;2-methyl-4-(4-methylpiperazin-1-yl)-10H-thieno[2,3-b][1,5]benzodiazepine;hydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 135566032) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135566032) ]
