...
st.set_page_config(page_title="701-54-2", layout="wide")
st.title("701-54-2")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5526.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5526](https://pubchem.ncbi.nlm.nih.gov/compound/5526)")
st.markdown(f"IUPAC Name: 4-(aminomethyl)cyclohexane-1-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5526) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5526) ]
