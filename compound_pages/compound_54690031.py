...
st.set_page_config(page_title="Lornoxicam", layout="wide")
st.title("Lornoxicam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54690031.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54690031](https://pubchem.ncbi.nlm.nih.gov/compound/54690031)")
st.markdown(f"IUPAC Name: 6-chloro-4-hydroxy-2-methyl-1,1-dioxo-N-pyridin-2-ylthieno[2,3-e]thiazine-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54690031) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54690031) ]
