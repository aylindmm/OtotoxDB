...
st.set_page_config(page_title="Schizantherin b", layout="wide")
st.title("Schizantherin b")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71307574.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71307574](https://pubchem.ncbi.nlm.nih.gov/compound/71307574)")
st.markdown(f"IUPAC Name: [(1S,8S,9S,10S,11Z)-9-hydroxy-3,4,5,19-tetramethoxy-9,10-dimethyl-15,17-dioxatetracyclo[10.7.0.02,7.014,18]nonadeca-2,4,6,11,13,18-hexaen-8-yl] (Z)-2-methylbut-2-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 71307574) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71307574) ]
