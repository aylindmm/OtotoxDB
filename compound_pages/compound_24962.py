...
st.set_page_config(page_title="Cadmium sulfate", layout="wide")
st.title("Cadmium sulfate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24962.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24962](https://pubchem.ncbi.nlm.nih.gov/compound/24962)")
st.markdown(f"IUPAC Name: cadmium(2+) sulfate")
...
df_filtered = sources[(sources["PubChem_CID"] == 24962) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24962) ]
