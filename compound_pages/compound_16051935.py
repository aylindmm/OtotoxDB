...
st.set_page_config(page_title="Morphine sulfate", layout="wide")
st.title("Morphine sulfate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16051935.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16051935](https://pubchem.ncbi.nlm.nih.gov/compound/16051935)")
st.markdown(f"IUPAC Name: bis((4R,4aR,7S,7aR,12bS)-3-methyl-2,4,4a,7,7a,13-hexahydro-1H-4,12-methanobenzofuro[3,2-e]isoquinoline-7,9-diol);sulfuric acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 16051935) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16051935) ]
