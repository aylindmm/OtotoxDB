...
st.set_page_config(page_title="Prostaglandin e2", layout="wide")
st.title("Prostaglandin e2")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5280360.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5280360](https://pubchem.ncbi.nlm.nih.gov/compound/5280360)")
st.markdown(f"IUPAC Name: (Z)-7-[(1R,2R,3R)-3-hydroxy-2-[(E,3S)-3-hydroxyoct-1-enyl]-5-oxocyclopentyl]hept-5-enoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5280360) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5280360) ]
