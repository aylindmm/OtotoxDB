...
st.set_page_config(page_title="76326-31-3", layout="wide")
st.title("76326-31-3")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1216.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1216](https://pubchem.ncbi.nlm.nih.gov/compound/1216)")
st.markdown(f"IUPAC Name: 2-amino-5-phosphonopentanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 1216) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1216) ]
