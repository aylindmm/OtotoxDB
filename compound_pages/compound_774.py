...
st.set_page_config(page_title="Histamine", layout="wide")
st.title("Histamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_774.jpg", width=300)
st.markdown(f"PubChem Compound ID: [774](https://pubchem.ncbi.nlm.nih.gov/compound/774)")
st.markdown(f"IUPAC Name: 2-(1H-imidazol-5-yl)ethanamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 774) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 774) ]
