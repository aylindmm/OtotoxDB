...
st.set_page_config(page_title="Famotidine", layout="wide")
st.title("Famotidine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5702160.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5702160](https://pubchem.ncbi.nlm.nih.gov/compound/5702160)")
st.markdown(f"IUPAC Name: 3-[[2-(diaminomethylideneamino)-1,3-thiazol-4-yl]methylsulfanyl]-N'-sulfamoylpropanimidamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5702160) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5702160) ]
