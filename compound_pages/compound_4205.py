...
st.set_page_config(page_title="Mirtazapine", layout="wide")
st.title("Mirtazapine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4205.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4205](https://pubchem.ncbi.nlm.nih.gov/compound/4205)")
st.markdown(f"IUPAC Name: 5-methyl-2,5,19-triazatetracyclo[13.4.0.02,7.08,13]nonadeca-1(15),8,10,12,16,18-hexaene")
...
df_filtered = sources[(sources["PubChem_CID"] == 4205) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4205) ]
