...
st.image(f"compound_structures/compound_23665410.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 23665410) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23665410) ]
