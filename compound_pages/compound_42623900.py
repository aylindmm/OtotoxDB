...
st.image(f"compound_structures/compound_42623900.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 42623900) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 42623900) ]
