...
st.set_page_config(page_title="602306-29-6", layout="wide")
st.title("602306-29-6")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16747683.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 16747683) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16747683) ]
