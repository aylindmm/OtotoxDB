...
st.set_page_config(page_title="Dothiepin", layout="wide")
st.title("Dothiepin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3155.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3155](https://pubchem.ncbi.nlm.nih.gov/compound/3155)")
st.markdown(f"IUPAC Name: 3-(6H-benzo[c][1]benzothiepin-11-ylidene)-N,N-dimethylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3155) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3155) ]
