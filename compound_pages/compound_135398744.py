...
st.image(f"compound_structures/compound_135398744.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 135398744) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135398744) ]
