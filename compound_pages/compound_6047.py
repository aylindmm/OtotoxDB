...
st.set_page_config(page_title="Levodopa", layout="wide")
st.title("Levodopa")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6047.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6047](https://pubchem.ncbi.nlm.nih.gov/compound/6047)")
st.markdown(f"IUPAC Name: (2S)-2-amino-3-(3,4-dihydroxyphenyl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 6047) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6047) ]
