...
st.set_page_config(page_title="Methoxsalen", layout="wide")
st.title("Methoxsalen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4114.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4114](https://pubchem.ncbi.nlm.nih.gov/compound/4114)")
st.markdown(f"IUPAC Name: 9-methoxyfuro[3,2-g]chromen-7-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 4114) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4114) ]
