...
st.set_page_config(page_title="Delamanid", layout="wide")
st.title("Delamanid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6480466.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6480466](https://pubchem.ncbi.nlm.nih.gov/compound/6480466)")
st.markdown(f"IUPAC Name: (2R)-2-methyl-6-nitro-2-[[4-[4-[4-(trifluoromethoxy)phenoxy]piperidin-1-yl]phenoxy]methyl]-3H-imidazo[2,1-b][1,3]oxazole")
...
df_filtered = sources[(sources["PubChem_CID"] == 6480466) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6480466) ]
