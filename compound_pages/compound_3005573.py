...
st.set_page_config(page_title="Toremifene", layout="wide")
st.title("Toremifene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3005573.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3005573](https://pubchem.ncbi.nlm.nih.gov/compound/3005573)")
st.markdown(f"IUPAC Name: 2-[4-[(Z)-4-chloro-1,2-diphenylbut-1-enyl]phenoxy]-N,N-dimethylethanamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3005573) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3005573) ]
