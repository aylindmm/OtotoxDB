...
st.set_page_config(page_title="Tert-butyl methyl ether", layout="wide")
st.title("Tert-butyl methyl ether")
# Display the image in Streamlit
st.image(f"compound_structures/compound_15413.jpg", width=300)
st.markdown(f"PubChem Compound ID: [15413](https://pubchem.ncbi.nlm.nih.gov/compound/15413)")
st.markdown(f"IUPAC Name: 2-methoxy-2-methylpropane")
...
df_filtered = sources[(sources["PubChem_CID"] == 15413) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 15413) ]
