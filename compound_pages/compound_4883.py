...
st.set_page_config(page_title="Practolol", layout="wide")
st.title("Practolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4883.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4883](https://pubchem.ncbi.nlm.nih.gov/compound/4883)")
st.markdown(f"IUPAC Name: N-[4-[2-hydroxy-3-(propan-2-ylamino)propoxy]phenyl]acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 4883) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4883) ]
