...
st.image(f"compound_structures/compound_5353853.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5353853) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5353853) ]
