...
st.set_page_config(page_title="Ceftriaxone sodium", layout="wide")
st.title("Ceftriaxone sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23715082.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23715082](https://pubchem.ncbi.nlm.nih.gov/compound/23715082)")
st.markdown(f"IUPAC Name: disodium;(6R,7R)-7-[[(2Z)-2-(2-amino-1,3-thiazol-4-yl)-2-methoxyiminoacetyl]amino]-3-[(2-methyl-5,6-dioxo-2,4-diaza-1-azanidacyclohex-3-en-3-yl)sulfanylmethyl]-8-oxo-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23715082) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23715082) ]
