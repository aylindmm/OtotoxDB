...
st.set_page_config(page_title="Ketoconazole", layout="wide")
st.title("Ketoconazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_47576.jpg", width=300)
st.markdown(f"PubChem Compound ID: [47576](https://pubchem.ncbi.nlm.nih.gov/compound/47576)")
st.markdown(f"IUPAC Name: 1-[4-[4-[[(2S,4R)-2-(2,4-dichlorophenyl)-2-(imidazol-1-ylmethyl)-1,3-dioxolan-4-yl]methoxy]phenyl]piperazin-1-yl]ethanone")
...
df_filtered = sources[(sources["PubChem_CID"] == 47576) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 47576) ]
