...
st.set_page_config(page_title="Carisoprodol", layout="wide")
st.title("Carisoprodol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2576.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2576](https://pubchem.ncbi.nlm.nih.gov/compound/2576)")
st.markdown(f"IUPAC Name: [2-(carbamoyloxymethyl)-2-methylpentyl] N-propan-2-ylcarbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 2576) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2576) ]
