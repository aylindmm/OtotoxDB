...
st.set_page_config(page_title="Dl-alpha-tocopherol", layout="wide")
st.title("Dl-alpha-tocopherol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2116.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2116](https://pubchem.ncbi.nlm.nih.gov/compound/2116)")
st.markdown(f"IUPAC Name: 2,5,7,8-tetramethyl-2-(4,8,12-trimethyltridecyl)-3,4-dihydrochromen-6-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 2116) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2116) ]
