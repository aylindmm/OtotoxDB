...
st.set_page_config(page_title="Citalopram", layout="wide")
st.title("Citalopram")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2771.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2771](https://pubchem.ncbi.nlm.nih.gov/compound/2771)")
st.markdown(f"IUPAC Name: 1-[3-(dimethylamino)propyl]-1-(4-fluorophenyl)-3H-2-benzofuran-5-carbonitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 2771) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2771) ]
