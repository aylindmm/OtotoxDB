...
st.image(f"compound_structures/compound_11618368.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 11618368) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11618368) ]
