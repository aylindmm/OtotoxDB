...
st.set_page_config(page_title="Fenbufen", layout="wide")
st.title("Fenbufen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3335.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3335](https://pubchem.ncbi.nlm.nih.gov/compound/3335)")
st.markdown(f"IUPAC Name: 4-oxo-4-(4-phenylphenyl)butanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3335) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3335) ]
