...
st.set_page_config(page_title="Ethambutol", layout="wide")
st.title("Ethambutol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_14052.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 14052) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 14052) ]
