...
st.set_page_config(page_title="Meclizine", layout="wide")
st.title("Meclizine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4034.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4034](https://pubchem.ncbi.nlm.nih.gov/compound/4034)")
st.markdown(f"IUPAC Name: 1-[(4-chlorophenyl)-phenylmethyl]-4-[(3-methylphenyl)methyl]piperazine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4034) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4034) ]
