...
st.set_page_config(page_title="Bromfenac sodium sesquihydrate", layout="wide")
st.title("Bromfenac sodium sesquihydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11954316.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11954316](https://pubchem.ncbi.nlm.nih.gov/compound/11954316)")
st.markdown(f"IUPAC Name: disodium;bis(2-[2-amino-3-(4-bromobenzoyl)phenyl]acetate);trihydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 11954316) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11954316) ]
