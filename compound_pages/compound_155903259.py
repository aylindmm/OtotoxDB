...
st.set_page_config(page_title="Nirmatrelvir", layout="wide")
st.title("Nirmatrelvir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_155903259.jpg", width=300)
st.markdown(f"PubChem Compound ID: [155903259](https://pubchem.ncbi.nlm.nih.gov/compound/155903259)")
st.markdown(f"IUPAC Name: (1R,2S,5S)-N-[(1S)-1-cyano-2-[(3S)-2-oxopyrrolidin-3-yl]ethyl]-3-[(2S)-3,3-dimethyl-2-[(2,2,2-trifluoroacetyl)amino]butanoyl]-6,6-dimethyl-3-azabicyclo[3.1.0]hexane-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 155903259) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 155903259) ]
