...
st.set_page_config(page_title="Silodosin", layout="wide")
st.title("Silodosin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5312125.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5312125](https://pubchem.ncbi.nlm.nih.gov/compound/5312125)")
st.markdown(f"IUPAC Name: 1-(3-hydroxypropyl)-5-[(2R)-2-[2-[2-(2,2,2-trifluoroethoxy)phenoxy]ethylamino]propyl]-2,3-dihydroindole-7-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5312125) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5312125) ]
