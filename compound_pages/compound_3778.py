...
st.set_page_config(page_title="Propyphenazone", layout="wide")
st.title("Propyphenazone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3778.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3778](https://pubchem.ncbi.nlm.nih.gov/compound/3778)")
st.markdown(f"IUPAC Name: 1,5-dimethyl-2-phenyl-4-propan-2-ylpyrazol-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3778) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3778) ]
