...
st.set_page_config(page_title="D-aminophosphonovaleric acid", layout="wide")
st.title("D-aminophosphonovaleric acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 24794417) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24794417) ]
