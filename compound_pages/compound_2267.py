...
st.set_page_config(page_title="Azelastine", layout="wide")
st.title("Azelastine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2267.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2267](https://pubchem.ncbi.nlm.nih.gov/compound/2267)")
st.markdown(f"IUPAC Name: 4-[(4-chlorophenyl)methyl]-2-(1-methylazepan-4-yl)phthalazin-1-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 2267) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2267) ]
