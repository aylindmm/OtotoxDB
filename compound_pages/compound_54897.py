...
st.set_page_config(page_title="Alpidem", layout="wide")
st.title("Alpidem")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54897.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54897](https://pubchem.ncbi.nlm.nih.gov/compound/54897)")
st.markdown(f"IUPAC Name: 2-[6-chloro-2-(4-chlorophenyl)imidazo[1,2-a]pyridin-3-yl]-N,N-dipropylacetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54897) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54897) ]
