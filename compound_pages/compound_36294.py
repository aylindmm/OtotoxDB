...
st.image(f"compound_structures/compound_36294.jpg", width=300)
...
st.markdown(f"Score: 2.01748486886348")
...
df_filtered = sources[(sources["PubChem_CID"] == 36294) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 36294) ]
