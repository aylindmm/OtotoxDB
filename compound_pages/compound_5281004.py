...
st.set_page_config(page_title="Budesonide", layout="wide")
st.title("Budesonide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281004.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281004](https://pubchem.ncbi.nlm.nih.gov/compound/5281004)")
st.markdown(f"IUPAC Name: (1S,2S,4R,8S,9S,11S,12S,13R)-11-hydroxy-8-(2-hydroxyacetyl)-9,13-dimethyl-6-propyl-5,7-dioxapentacyclo[10.8.0.02,9.04,8.013,18]icosa-14,17-dien-16-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281004) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281004) ]
