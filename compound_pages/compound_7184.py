...
st.set_page_config(page_title="Butylparaben", layout="wide")
st.title("Butylparaben")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7184.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7184](https://pubchem.ncbi.nlm.nih.gov/compound/7184)")
st.markdown(f"IUPAC Name: butyl 4-hydroxybenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 7184) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7184) ]
