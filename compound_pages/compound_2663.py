...
st.set_page_config(page_title="Celiprolol", layout="wide")
st.title("Celiprolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2663.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2663](https://pubchem.ncbi.nlm.nih.gov/compound/2663)")
st.markdown(f"IUPAC Name: 3-[3-acetyl-4-[3-(tert-butylamino)-2-hydroxypropoxy]phenyl]-1,1-diethylurea")
...
df_filtered = sources[(sources["PubChem_CID"] == 2663) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2663) ]
