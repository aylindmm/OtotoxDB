...
st.set_page_config(page_title="Methyl 4-hydroxybenzoate", layout="wide")
st.title("Methyl 4-hydroxybenzoate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7456.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7456](https://pubchem.ncbi.nlm.nih.gov/compound/7456)")
st.markdown(f"IUPAC Name: methyl 4-hydroxybenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 7456) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7456) ]
