...
st.set_page_config(page_title="5-fluoro-adb, (s)-", layout="wide")
st.title("5-fluoro-adb, (s)-")
# Display the image in Streamlit
st.image(f"compound_structures/compound_121491649.jpg", width=300)
st.markdown(f"PubChem Compound ID: [121491649](https://pubchem.ncbi.nlm.nih.gov/compound/121491649)")
st.markdown(f"IUPAC Name: methyl (2S)-2-[[1-(5-fluoropentyl)indazole-3-carbonyl]amino]-3,3-dimethylbutanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 121491649) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 121491649) ]
