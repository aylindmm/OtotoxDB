...
st.set_page_config(page_title="Mozavaptan", layout="wide")
st.title("Mozavaptan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_119369.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 119369) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 119369) ]
