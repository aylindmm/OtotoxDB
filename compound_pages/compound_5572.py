...
st.set_page_config(page_title="Trihexyphenidyl", layout="wide")
st.title("Trihexyphenidyl")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5572.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5572](https://pubchem.ncbi.nlm.nih.gov/compound/5572)")
st.markdown(f"IUPAC Name: 1-cyclohexyl-1-phenyl-3-piperidin-1-ylpropan-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5572) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5572) ]
