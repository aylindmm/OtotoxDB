...
st.set_page_config(page_title="Alpha-amino-3-hydroxy-5-methyl-4-isoxazolepropionic acid", layout="wide")
st.title("Alpha-amino-3-hydroxy-5-methyl-4-isoxazolepropionic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1221.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1221](https://pubchem.ncbi.nlm.nih.gov/compound/1221)")
st.markdown(f"IUPAC Name: 2-amino-3-(5-methyl-3-oxo-1,2-oxazol-4-yl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 1221) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1221) ]
