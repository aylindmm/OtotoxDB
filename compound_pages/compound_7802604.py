...
st.set_page_config(page_title="870762-83-7", layout="wide")
st.title("870762-83-7")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7802604.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 7802604) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7802604) ]
