...
st.set_page_config(page_title="Pseudoephedrine", layout="wide")
st.title("Pseudoephedrine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7028.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7028](https://pubchem.ncbi.nlm.nih.gov/compound/7028)")
st.markdown(f"IUPAC Name: (1S,2S)-2-(methylamino)-1-phenylpropan-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 7028) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7028) ]
