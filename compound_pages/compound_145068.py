...
st.set_page_config(page_title="Nitric oxide", layout="wide")
st.title("Nitric oxide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_145068.jpg", width=300)
st.markdown(f"PubChem Compound ID: [145068](https://pubchem.ncbi.nlm.nih.gov/compound/145068)")
st.markdown(f"IUPAC Name: nitric oxide")
...
df_filtered = sources[(sources["PubChem_CID"] == 145068) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 145068) ]
