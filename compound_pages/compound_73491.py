...
st.set_page_config(page_title="Fosfomycin disodium salt", layout="wide")
st.title("Fosfomycin disodium salt")
# Display the image in Streamlit
st.image(f"compound_structures/compound_73491.jpg", width=300)
st.markdown(f"PubChem Compound ID: [73491](https://pubchem.ncbi.nlm.nih.gov/compound/73491)")
st.markdown(f"IUPAC Name: disodium;[(2R,3S)-3-methyloxiran-2-yl]-dioxido-oxo-lambda5-phosphane")
...
df_filtered = sources[(sources["PubChem_CID"] == 73491) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 73491) ]
