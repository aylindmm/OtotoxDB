...
st.set_page_config(page_title="Sodium", layout="wide")
st.title("Sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5360545.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5360545](https://pubchem.ncbi.nlm.nih.gov/compound/5360545)")
st.markdown(f"IUPAC Name: sodium")
...
df_filtered = sources[(sources["PubChem_CID"] == 5360545) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5360545) ]
