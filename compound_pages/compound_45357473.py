...
st.set_page_config(page_title="Climopax", layout="wide")
st.title("Climopax")
# Display the image in Streamlit
st.image(f"compound_structures/compound_45357473.jpg", width=300)
st.markdown(f"PubChem Compound ID: [45357473](https://pubchem.ncbi.nlm.nih.gov/compound/45357473)")
st.markdown(f"IUPAC Name: sodium [(13S)-13-methyl-17-oxo-7,8,9,11,12,14,15,16-octahydro-6H-cyclopenta[a]phenanthren-3-yl] sulfate")
...
df_filtered = sources[(sources["PubChem_CID"] == 45357473) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 45357473) ]
