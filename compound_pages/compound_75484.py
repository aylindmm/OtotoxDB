...
st.set_page_config(page_title="Methyl 2,3-dihydroxybenzoate", layout="wide")
st.title("Methyl 2,3-dihydroxybenzoate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_75484.jpg", width=300)
st.markdown(f"PubChem Compound ID: [75484](https://pubchem.ncbi.nlm.nih.gov/compound/75484)")
st.markdown(f"IUPAC Name: methyl 2,3-dihydroxybenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 75484) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 75484) ]
