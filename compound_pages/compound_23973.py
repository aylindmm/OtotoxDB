...
st.set_page_config(page_title="Cadmium", layout="wide")
st.title("Cadmium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23973.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23973](https://pubchem.ncbi.nlm.nih.gov/compound/23973)")
st.markdown(f"IUPAC Name: cadmium")
...
df_filtered = sources[(sources["PubChem_CID"] == 23973) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23973) ]
