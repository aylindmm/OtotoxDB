...
st.set_page_config(page_title="Fenoterol", layout="wide")
st.title("Fenoterol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3343.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3343](https://pubchem.ncbi.nlm.nih.gov/compound/3343)")
st.markdown(f"IUPAC Name: 5-[1-hydroxy-2-[1-(4-hydroxyphenyl)propan-2-ylamino]ethyl]benzene-1,3-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3343) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3343) ]
