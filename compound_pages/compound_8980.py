...
st.set_page_config(page_title="Diphenhydramine hydrochloride", layout="wide")
st.title("Diphenhydramine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_8980.jpg", width=300)
st.markdown(f"PubChem Compound ID: [8980](https://pubchem.ncbi.nlm.nih.gov/compound/8980)")
st.markdown(f"IUPAC Name: 2-benzhydryloxy-N,N-dimethylethanamine;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 8980) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 8980) ]
