...
st.set_page_config(page_title="Ramosetron", layout="wide")
st.title("Ramosetron")
# Display the image in Streamlit
st.image(f"compound_structures/compound_108000.jpg", width=300)
st.markdown(f"PubChem Compound ID: [108000](https://pubchem.ncbi.nlm.nih.gov/compound/108000)")
st.markdown(f"IUPAC Name: (1-methylindol-3-yl)-[(5R)-4,5,6,7-tetrahydro-3H-benzimidazol-5-yl]methanone")
...
df_filtered = sources[(sources["PubChem_CID"] == 108000) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 108000) ]
