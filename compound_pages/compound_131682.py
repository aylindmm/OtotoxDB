...
st.set_page_config(page_title="Safinamide", layout="wide")
st.title("Safinamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_131682.jpg", width=300)
st.markdown(f"PubChem Compound ID: [131682](https://pubchem.ncbi.nlm.nih.gov/compound/131682)")
st.markdown(f"IUPAC Name: (2S)-2-[[4-[(3-fluorophenyl)methoxy]phenyl]methylamino]propanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 131682) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 131682) ]
