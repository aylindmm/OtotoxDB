...
st.set_page_config(page_title="Sodium picosulfate", layout="wide")
st.title("Sodium picosulfate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68654.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68654](https://pubchem.ncbi.nlm.nih.gov/compound/68654)")
st.markdown(f"IUPAC Name: disodium;[4-[pyridin-2-yl-(4-sulfonatooxyphenyl)methyl]phenyl] sulfate")
...
df_filtered = sources[(sources["PubChem_CID"] == 68654) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68654) ]
