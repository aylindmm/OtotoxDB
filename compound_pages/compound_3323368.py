...
st.set_page_config(page_title="Cx717", layout="wide")
st.title("Cx717")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3323368.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3323368](https://pubchem.ncbi.nlm.nih.gov/compound/3323368)")
st.markdown(f"IUPAC Name: 2,1,3-benzoxadiazol-5-yl(morpholin-4-yl)methanone")
...
df_filtered = sources[(sources["PubChem_CID"] == 3323368) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3323368) ]
