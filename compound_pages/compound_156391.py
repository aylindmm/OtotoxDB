...
st.image(f"compound_structures/compound_156391.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 156391) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 156391) ]
