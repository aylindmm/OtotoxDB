...
st.set_page_config(page_title="Ferrostatin-1", layout="wide")
st.title("Ferrostatin-1")
...
df_filtered = sources[(sources["PubChem_CID"] == 4068248) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4068248) ]
