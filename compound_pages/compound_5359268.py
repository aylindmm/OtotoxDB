...
st.set_page_config(page_title="Aluminum", layout="wide")
st.title("Aluminum")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5359268.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5359268](https://pubchem.ncbi.nlm.nih.gov/compound/5359268)")
st.markdown(f"IUPAC Name: aluminum")
...
df_filtered = sources[(sources["PubChem_CID"] == 5359268) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5359268) ]
