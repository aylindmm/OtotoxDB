...
st.set_page_config(page_title="Finasteride", layout="wide")
st.title("Finasteride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_57363.jpg", width=300)
st.markdown(f"PubChem Compound ID: [57363](https://pubchem.ncbi.nlm.nih.gov/compound/57363)")
st.markdown(f"IUPAC Name: (1S,3aS,3bS,5aR,9aR,9bS,11aS)-N-tert-butyl-9a,11a-dimethyl-7-oxo-1,2,3,3a,3b,4,5,5a,6,9b,10,11-dodecahydroindeno[5,4-f]quinoline-1-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 57363) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 57363) ]
