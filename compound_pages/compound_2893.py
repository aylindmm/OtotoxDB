...
st.set_page_config(page_title="Cyclandelate", layout="wide")
st.title("Cyclandelate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2893.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2893](https://pubchem.ncbi.nlm.nih.gov/compound/2893)")
st.markdown(f"IUPAC Name: (3,3,5-trimethylcyclohexyl) 2-hydroxy-2-phenylacetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 2893) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2893) ]
