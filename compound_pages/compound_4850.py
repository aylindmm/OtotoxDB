...
st.set_page_config(page_title="Piribedil", layout="wide")
st.title("Piribedil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4850.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4850](https://pubchem.ncbi.nlm.nih.gov/compound/4850)")
st.markdown(f"IUPAC Name: 2-[4-(1,3-benzodioxol-5-ylmethyl)piperazin-1-yl]pyrimidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4850) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4850) ]
