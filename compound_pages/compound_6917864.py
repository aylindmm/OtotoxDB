...
st.set_page_config(page_title="Artesunate", layout="wide")
st.title("Artesunate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6917864.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6917864](https://pubchem.ncbi.nlm.nih.gov/compound/6917864)")
st.markdown(f"IUPAC Name: 4-oxo-4-[[(1R,4S,5R,8S,9R,10S,12R,13R)-1,5,9-trimethyl-11,14,15,16-tetraoxatetracyclo[10.3.1.04,13.08,13]hexadecan-10-yl]oxy]butanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 6917864) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6917864) ]
