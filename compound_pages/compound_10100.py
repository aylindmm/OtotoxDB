...
st.set_page_config(page_title="Dextropropoxyphene", layout="wide")
st.title("Dextropropoxyphene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10100.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10100](https://pubchem.ncbi.nlm.nih.gov/compound/10100)")
st.markdown(f"IUPAC Name: [(2S,3R)-4-(dimethylamino)-3-methyl-1,2-diphenylbutan-2-yl] propanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 10100) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10100) ]
