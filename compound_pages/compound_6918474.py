...
st.set_page_config(page_title="Carisbamate", layout="wide")
st.title("Carisbamate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6918474.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6918474](https://pubchem.ncbi.nlm.nih.gov/compound/6918474)")
st.markdown(f"IUPAC Name: [(2S)-2-(2-chlorophenyl)-2-hydroxyethyl] carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6918474) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6918474) ]
