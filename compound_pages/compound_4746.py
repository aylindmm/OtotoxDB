...
st.set_page_config(page_title="Perhexiline", layout="wide")
st.title("Perhexiline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4746.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4746](https://pubchem.ncbi.nlm.nih.gov/compound/4746)")
st.markdown(f"IUPAC Name: 2-(2,2-dicyclohexylethyl)piperidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4746) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4746) ]
