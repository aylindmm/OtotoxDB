...
st.set_page_config(page_title="Regadenoson", layout="wide")
st.title("Regadenoson")
# Display the image in Streamlit
st.image(f"compound_structures/compound_219024.jpg", width=300)
st.markdown(f"PubChem Compound ID: [219024](https://pubchem.ncbi.nlm.nih.gov/compound/219024)")
st.markdown(f"IUPAC Name: 1-[6-amino-9-[(2R,3R,4S,5R)-3,4-dihydroxy-5-(hydroxymethyl)oxolan-2-yl]purin-2-yl]-N-methylpyrazole-4-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 219024) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 219024) ]
