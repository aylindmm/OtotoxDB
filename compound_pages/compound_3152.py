...
st.set_page_config(page_title="Donepezil", layout="wide")
st.title("Donepezil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3152.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3152](https://pubchem.ncbi.nlm.nih.gov/compound/3152)")
st.markdown(f"IUPAC Name: 2-[(1-benzylpiperidin-4-yl)methyl]-5,6-dimethoxy-2,3-dihydroinden-1-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3152) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3152) ]
