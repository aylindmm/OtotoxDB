...
st.set_page_config(page_title="Alfentanil", layout="wide")
st.title("Alfentanil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_51263.jpg", width=300)
st.markdown(f"PubChem Compound ID: [51263](https://pubchem.ncbi.nlm.nih.gov/compound/51263)")
st.markdown(f"IUPAC Name: N-[1-[2-(4-ethyl-5-oxotetrazol-1-yl)ethyl]-4-(methoxymethyl)piperidin-4-yl]-N-phenylpropanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 51263) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 51263) ]
