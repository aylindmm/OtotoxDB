...
st.set_page_config(page_title="Jp-8", layout="wide")
st.title("Jp-8")
# Display the image in Streamlit
st.image(f"compound_structures/compound_56840896.jpg", width=300)
st.markdown(f"PubChem Compound ID: [56840896](https://pubchem.ncbi.nlm.nih.gov/compound/56840896)")
st.markdown(f"IUPAC Name: hexacyclo[9.2.1.02,10.03,8.04,6.05,9]tetradecane;methylcyclohexane;(1S,2R,6S,7R)-tricyclo[5.2.1.02,6]decane")
...
df_filtered = sources[(sources["PubChem_CID"] == 56840896) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 56840896) ]
