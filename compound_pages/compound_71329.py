...
st.set_page_config(page_title="Dofetilide", layout="wide")
st.title("Dofetilide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71329.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71329](https://pubchem.ncbi.nlm.nih.gov/compound/71329)")
st.markdown(f"IUPAC Name: N-[4-[2-[2-[4-(methanesulfonamido)phenoxy]ethyl-methylamino]ethyl]phenyl]methanesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 71329) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71329) ]
