...
st.set_page_config(page_title="Guanabenz", layout="wide")
st.title("Guanabenz")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5702063.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5702063](https://pubchem.ncbi.nlm.nih.gov/compound/5702063)")
st.markdown(f"IUPAC Name: 2-[(E)-(2,6-dichlorophenyl)methylideneamino]guanidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5702063) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5702063) ]
