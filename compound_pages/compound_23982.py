...
st.set_page_config(page_title="Gadolinium", layout="wide")
st.title("Gadolinium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23982.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 23982) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23982) ]
