...
st.set_page_config(page_title="Oxybenzone", layout="wide")
st.title("Oxybenzone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4632.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4632](https://pubchem.ncbi.nlm.nih.gov/compound/4632)")
st.markdown(f"IUPAC Name: (2-hydroxy-4-methoxyphenyl)-phenylmethanone")
...
df_filtered = sources[(sources["PubChem_CID"] == 4632) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4632) ]
