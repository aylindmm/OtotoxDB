...
st.set_page_config(page_title="Famciclovir", layout="wide")
st.title("Famciclovir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3324.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3324](https://pubchem.ncbi.nlm.nih.gov/compound/3324)")
st.markdown(f"IUPAC Name: [2-(acetyloxymethyl)-4-(2-aminopurin-9-yl)butyl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 3324) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3324) ]
