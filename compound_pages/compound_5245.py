...
st.set_page_config(page_title="Risedronic acid", layout="wide")
st.title("Risedronic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5245) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5245) ]
