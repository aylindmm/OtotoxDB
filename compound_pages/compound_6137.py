...
st.set_page_config(page_title="L-methionine", layout="wide")
st.title("L-methionine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6137.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 6137) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6137) ]
