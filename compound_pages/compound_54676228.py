...
st.set_page_config(page_title="Piroxicam", layout="wide")
st.title("Piroxicam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54676228.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54676228](https://pubchem.ncbi.nlm.nih.gov/compound/54676228)")
st.markdown(f"IUPAC Name: 4-hydroxy-2-methyl-1,1-dioxo-N-pyridin-2-yl-1lambda6,2-benzothiazine-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54676228) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54676228) ]
