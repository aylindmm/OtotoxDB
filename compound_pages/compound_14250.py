...
st.set_page_config(page_title="1119-97-7", layout="wide")
st.title("1119-97-7")
# Display the image in Streamlit
st.image(f"compound_structures/compound_14250.jpg", width=300)
st.markdown(f"PubChem Compound ID: [14250](https://pubchem.ncbi.nlm.nih.gov/compound/14250)")
st.markdown(f"IUPAC Name: trimethyl(tetradecyl)azanium bromide")
...
df_filtered = sources[(sources["PubChem_CID"] == 14250) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 14250) ]
