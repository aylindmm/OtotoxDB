...
st.set_page_config(page_title="Etilefrine", layout="wide")
st.title("Etilefrine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3306.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3306](https://pubchem.ncbi.nlm.nih.gov/compound/3306)")
st.markdown(f"IUPAC Name: 3-[2-(ethylamino)-1-hydroxyethyl]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3306) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3306) ]
