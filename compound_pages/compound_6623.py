...
st.set_page_config(page_title="Bisphenol a", layout="wide")
st.title("Bisphenol a")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6623.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6623](https://pubchem.ncbi.nlm.nih.gov/compound/6623)")
st.markdown(f"IUPAC Name: 4-[2-(4-hydroxyphenyl)propan-2-yl]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 6623) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6623) ]
