...
st.set_page_config(page_title="Stannane, tributyl-", layout="wide")
st.title("Stannane, tributyl-")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5948.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5948](https://pubchem.ncbi.nlm.nih.gov/compound/5948)")
st.markdown(f"IUPAC Name: tributylstannane")
...
df_filtered = sources[(sources["PubChem_CID"] == 5948) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5948) ]
