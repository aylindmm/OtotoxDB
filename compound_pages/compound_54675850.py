...
st.image(f"compound_structures/compound_54675850.jpg", width=300)
...
st.markdown(f"Score: 0.403496973772697")
...
df_filtered = sources[(sources["PubChem_CID"] == 54675850) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54675850) ]
