...
st.set_page_config(page_title="3-methyladenine", layout="wide")
st.title("3-methyladenine")
...
df_filtered = sources[(sources["PubChem_CID"] == 135398661) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135398661) ]
