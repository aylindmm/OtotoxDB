...
st.set_page_config(page_title="Quinagolide", layout="wide")
st.title("Quinagolide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3086401.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3086401](https://pubchem.ncbi.nlm.nih.gov/compound/3086401)")
st.markdown(f"IUPAC Name: (3S,4aS,10aR)-3-(diethylsulfamoylamino)-6-hydroxy-1-propyl-3,4,4a,5,10,10a-hexahydro-2H-benzo[g]quinoline")
...
df_filtered = sources[(sources["PubChem_CID"] == 3086401) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3086401) ]
