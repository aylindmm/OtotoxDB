...
st.set_page_config(page_title="Thiamine", layout="wide")
st.title("Thiamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1130.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1130](https://pubchem.ncbi.nlm.nih.gov/compound/1130)")
st.markdown(f"IUPAC Name: 2-[3-[(4-amino-2-methylpyrimidin-5-yl)methyl]-4-methyl-1,3-thiazol-3-ium-5-yl]ethanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 1130) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1130) ]
