...
st.set_page_config(page_title="4-methylthiobenzoic acid", layout="wide")
st.title("4-methylthiobenzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 11815952) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11815952) ]
