...
st.set_page_config(page_title="Elemental carbon", layout="wide")
st.title("Elemental carbon")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5462310.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5462310](https://pubchem.ncbi.nlm.nih.gov/compound/5462310)")
st.markdown(f"IUPAC Name: methane")
...
df_filtered = sources[(sources["PubChem_CID"] == 5462310) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5462310) ]
