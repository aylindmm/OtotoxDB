...
st.set_page_config(page_title="D-galactopyranose", layout="wide")
st.title("D-galactopyranose")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6036.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6036](https://pubchem.ncbi.nlm.nih.gov/compound/6036)")
st.markdown(f"IUPAC Name: (3R,4S,5R,6R)-6-(hydroxymethyl)oxane-2,3,4,5-tetrol")
...
df_filtered = sources[(sources["PubChem_CID"] == 6036) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6036) ]
