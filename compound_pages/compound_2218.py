...
st.set_page_config(page_title="Aprindine", layout="wide")
st.title("Aprindine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2218.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2218](https://pubchem.ncbi.nlm.nih.gov/compound/2218)")
st.markdown(f"IUPAC Name: N'-(2,3-dihydro-1H-inden-2-yl)-N,N-diethyl-N'-phenylpropane-1,3-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2218) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2218) ]
