...
st.set_page_config(page_title="L-cysteine", layout="wide")
st.title("L-cysteine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5862.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5862](https://pubchem.ncbi.nlm.nih.gov/compound/5862)")
st.markdown(f"IUPAC Name: (2R)-2-amino-3-sulfanylpropanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5862) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5862) ]
