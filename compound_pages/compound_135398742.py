...
st.set_page_config(page_title="Valacyclovir", layout="wide")
st.title("Valacyclovir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135398742.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135398742](https://pubchem.ncbi.nlm.nih.gov/compound/135398742)")
st.markdown(f"IUPAC Name: 2-[(2-amino-6-oxo-1H-purin-9-yl)methoxy]ethyl (2S)-2-amino-3-methylbutanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 135398742) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135398742) ]
