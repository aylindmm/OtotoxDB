...
st.set_page_config(page_title="1,2,4-trimethylbenzene", layout="wide")
st.title("1,2,4-trimethylbenzene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7247.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7247](https://pubchem.ncbi.nlm.nih.gov/compound/7247)")
st.markdown(f"IUPAC Name: 1,2,4-trimethylbenzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 7247) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7247) ]
