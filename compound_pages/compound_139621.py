...
st.set_page_config(page_title="Dichloroboron", layout="wide")
st.title("Dichloroboron")
# Display the image in Streamlit
st.image(f"compound_structures/compound_139621.jpg", width=300)
st.markdown(f"PubChem Compound ID: [139621](https://pubchem.ncbi.nlm.nih.gov/compound/139621)")
...
df_filtered = sources[(sources["PubChem_CID"] == 139621) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 139621) ]
