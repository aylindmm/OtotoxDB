...
st.set_page_config(page_title="6-aminohexanoic acid", layout="wide")
st.title("6-aminohexanoic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_564.jpg", width=300)
st.markdown(f"PubChem Compound ID: [564](https://pubchem.ncbi.nlm.nih.gov/compound/564)")
st.markdown(f"IUPAC Name: 6-aminohexanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 564) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 564) ]
