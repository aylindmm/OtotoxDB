...
st.set_page_config(page_title="N,n-dimethylformamide", layout="wide")
st.title("N,n-dimethylformamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6228.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6228](https://pubchem.ncbi.nlm.nih.gov/compound/6228)")
st.markdown(f"IUPAC Name: N,N-dimethylformamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 6228) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6228) ]
