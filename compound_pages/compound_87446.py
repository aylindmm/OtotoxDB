...
st.set_page_config(page_title="18076-61-4", layout="wide")
st.title("18076-61-4")
# Display the image in Streamlit
st.image(f"compound_structures/compound_87446.jpg", width=300)
st.markdown(f"PubChem Compound ID: [87446](https://pubchem.ncbi.nlm.nih.gov/compound/87446)")
st.markdown(f"IUPAC Name: 2H-benzotriazol-4-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 87446) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 87446) ]
