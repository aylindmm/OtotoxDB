...
st.set_page_config(page_title="Seletalisib", layout="wide")
st.title("Seletalisib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_56928390.jpg", width=300)
st.markdown(f"PubChem Compound ID: [56928390](https://pubchem.ncbi.nlm.nih.gov/compound/56928390)")
st.markdown(f"IUPAC Name: N-[(1R)-1-[8-chloro-2-(1-oxidopyridin-1-ium-3-yl)quinolin-3-yl]-2,2,2-trifluoroethyl]pyrido[3,2-d]pyrimidin-4-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 56928390) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 56928390) ]
