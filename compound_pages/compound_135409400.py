...
st.set_page_config(page_title="Anagrelide", layout="wide")
st.title("Anagrelide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135409400.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135409400](https://pubchem.ncbi.nlm.nih.gov/compound/135409400)")
st.markdown(f"IUPAC Name: 6,7-dichloro-3,5-dihydro-1H-imidazo[2,1-b]quinazolin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 135409400) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135409400) ]
