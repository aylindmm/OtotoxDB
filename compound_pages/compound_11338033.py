...
st.set_page_config(page_title="Refchem:560289", layout="wide")
st.title("Refchem:560289")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11338033.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11338033](https://pubchem.ncbi.nlm.nih.gov/compound/11338033)")
st.markdown(f"IUPAC Name: 4-[(2,6-dichlorobenzoyl)amino]-N-piperidin-4-yl-1H-pyrazole-5-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 11338033) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11338033) ]
