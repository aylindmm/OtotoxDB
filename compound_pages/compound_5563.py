...
st.set_page_config(page_title="Triclofos", layout="wide")
st.title("Triclofos")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5563.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5563](https://pubchem.ncbi.nlm.nih.gov/compound/5563)")
st.markdown(f"IUPAC Name: 2,2,2-trichloroethyl dihydrogen phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5563) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5563) ]
