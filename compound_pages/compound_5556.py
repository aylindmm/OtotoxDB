...
st.set_page_config(page_title="Triazolam", layout="wide")
st.title("Triazolam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5556.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5556](https://pubchem.ncbi.nlm.nih.gov/compound/5556)")
st.markdown(f"IUPAC Name: 8-chloro-6-(2-chlorophenyl)-1-methyl-4H-[1,2,4]triazolo[4,3-a][1,4]benzodiazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5556) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5556) ]
