...
st.set_page_config(page_title="Diphenidol", layout="wide")
st.title("Diphenidol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3055.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3055](https://pubchem.ncbi.nlm.nih.gov/compound/3055)")
st.markdown(f"IUPAC Name: 1,1-diphenyl-4-piperidin-1-ylbutan-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3055) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3055) ]
