...
st.set_page_config(page_title="Oxiracetam", layout="wide")
st.title("Oxiracetam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4626.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4626](https://pubchem.ncbi.nlm.nih.gov/compound/4626)")
st.markdown(f"IUPAC Name: 2-(4-hydroxy-2-oxopyrrolidin-1-yl)acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 4626) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4626) ]
