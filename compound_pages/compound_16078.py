...
st.set_page_config(page_title="Dronabinol", layout="wide")
st.title("Dronabinol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16078.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16078](https://pubchem.ncbi.nlm.nih.gov/compound/16078)")
st.markdown(f"IUPAC Name: (6aR,10aR)-6,6,9-trimethyl-3-pentyl-6a,7,8,10a-tetrahydrobenzo[c]chromen-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 16078) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16078) ]
