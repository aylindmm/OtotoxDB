...
st.set_page_config(page_title="8059-24-3", layout="wide")
st.title("8059-24-3")
# Display the image in Streamlit
st.image(f"compound_structures/compound_104817.jpg", width=300)
st.markdown(f"PubChem Compound ID: [104817](https://pubchem.ncbi.nlm.nih.gov/compound/104817)")
st.markdown(f"IUPAC Name: (5-hydroxy-4,6-dimethyl-3-pyridinyl)methyl phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 104817) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 104817) ]
