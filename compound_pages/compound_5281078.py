...
st.set_page_config(page_title="Mycophenolate mofetil", layout="wide")
st.title("Mycophenolate mofetil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281078.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281078](https://pubchem.ncbi.nlm.nih.gov/compound/5281078)")
st.markdown(f"IUPAC Name: 2-morpholin-4-ylethyl (E)-6-(4-hydroxy-6-methoxy-7-methyl-3-oxo-1H-2-benzofuran-5-yl)-4-methylhex-4-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281078) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281078) ]
