...
st.set_page_config(page_title="Physostigmine", layout="wide")
st.title("Physostigmine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5983.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5983](https://pubchem.ncbi.nlm.nih.gov/compound/5983)")
st.markdown(f"IUPAC Name: [(3aR,8bS)-3,4,8b-trimethyl-2,3a-dihydro-1H-pyrrolo[2,3-b]indol-7-yl] N-methylcarbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5983) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5983) ]
