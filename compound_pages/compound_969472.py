...
st.set_page_config(page_title="Eszopiclone", layout="wide")
st.title("Eszopiclone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_969472.jpg", width=300)
st.markdown(f"PubChem Compound ID: [969472](https://pubchem.ncbi.nlm.nih.gov/compound/969472)")
st.markdown(f"IUPAC Name: [(7S)-6-(5-chloro-2-pyridinyl)-5-oxo-7H-pyrrolo[3,4-b]pyrazin-7-yl] 4-methylpiperazine-1-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 969472) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 969472) ]
