...
st.image(f"compound_structures/compound_1175.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 1175) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1175) ]
