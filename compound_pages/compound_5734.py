...
st.set_page_config(page_title="Zonisamide", layout="wide")
st.title("Zonisamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5734.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5734](https://pubchem.ncbi.nlm.nih.gov/compound/5734)")
st.markdown(f"IUPAC Name: 1,2-benzoxazol-3-ylmethanesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5734) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5734) ]
