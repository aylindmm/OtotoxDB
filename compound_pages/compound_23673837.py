...
st.set_page_config(page_title="Docusate sodium", layout="wide")
st.title("Docusate sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23673837.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 23673837) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23673837) ]
