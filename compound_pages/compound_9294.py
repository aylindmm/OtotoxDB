...
st.set_page_config(page_title="Ephedrine", layout="wide")
st.title("Ephedrine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9294.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9294](https://pubchem.ncbi.nlm.nih.gov/compound/9294)")
st.markdown(f"IUPAC Name: (1R,2S)-2-(methylamino)-1-phenylpropan-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 9294) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9294) ]
