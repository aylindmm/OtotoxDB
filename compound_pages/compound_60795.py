...
st.set_page_config(page_title="Aripiprazole", layout="wide")
st.title("Aripiprazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60795.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60795](https://pubchem.ncbi.nlm.nih.gov/compound/60795)")
st.markdown(f"IUPAC Name: 7-[4-[4-(2,3-dichlorophenyl)piperazin-1-yl]butoxy]-3,4-dihydro-1H-quinolin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 60795) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60795) ]
