...
st.set_page_config(page_title="Butalbital", layout="wide")
st.title("Butalbital")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2481.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2481](https://pubchem.ncbi.nlm.nih.gov/compound/2481)")
st.markdown(f"IUPAC Name: 5-(2-methylpropyl)-5-prop-2-enyl-1,3-diazinane-2,4,6-trione")
...
df_filtered = sources[(sources["PubChem_CID"] == 2481) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2481) ]
