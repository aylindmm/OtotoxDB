...
st.set_page_config(page_title="Perhexiline maleate", layout="wide")
st.title("Perhexiline maleate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284439.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284439](https://pubchem.ncbi.nlm.nih.gov/compound/5284439)")
st.markdown(f"IUPAC Name: (Z)-but-2-enedioic acid;2-(2,2-dicyclohexylethyl)piperidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284439) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284439) ]
