...
st.set_page_config(page_title="Ciprodex", layout="wide")
st.title("Ciprodex")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9961920.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9961920](https://pubchem.ncbi.nlm.nih.gov/compound/9961920)")
st.markdown(f"IUPAC Name: 1-cyclopropyl-6-fluoro-4-oxo-7-piperazin-1-ylquinoline-3-carboxylic acid;(8S,9R,10S,11S,13S,14S,16R,17R)-9-fluoro-11,17-dihydroxy-17-(2-hydroxyacetyl)-10,13,16-trimethyl-6,7,8,11,12,14,15,16-octahydrocyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 9961920) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9961920) ]
