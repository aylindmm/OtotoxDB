...
st.set_page_config(page_title="Naloxone", layout="wide")
st.title("Naloxone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284596.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284596](https://pubchem.ncbi.nlm.nih.gov/compound/5284596)")
st.markdown(f"IUPAC Name: (4R,4aS,7aR,12bS)-4a,9-dihydroxy-3-prop-2-enyl-2,4,5,6,7a,13-hexahydro-1H-4,12-methanobenzofuro[3,2-e]isoquinolin-7-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284596) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284596) ]
