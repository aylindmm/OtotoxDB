...
st.set_page_config(page_title="Memantine", layout="wide")
st.title("Memantine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4054.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 4054) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4054) ]
