...
st.set_page_config(page_title="2,3,7,8-tetrachlorodibenzo-p-dioxin", layout="wide")
st.title("2,3,7,8-tetrachlorodibenzo-p-dioxin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_15625.jpg", width=300)
st.markdown(f"PubChem Compound ID: [15625](https://pubchem.ncbi.nlm.nih.gov/compound/15625)")
st.markdown(f"IUPAC Name: 2,3,7,8-tetrachlorodibenzo-p-dioxin")
...
df_filtered = sources[(sources["PubChem_CID"] == 15625) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 15625) ]
