...
st.set_page_config(page_title="Refchem:560342", layout="wide")
st.title("Refchem:560342")
# Display the image in Streamlit
st.image(f"compound_structures/compound_173924.jpg", width=300)
st.markdown(f"PubChem Compound ID: [173924](https://pubchem.ncbi.nlm.nih.gov/compound/173924)")
st.markdown(f"IUPAC Name: 1,5-dimethyl-2-phenylpyrazol-3-one;ethyl 4-aminobenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 173924) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 173924) ]
