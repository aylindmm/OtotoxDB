...
st.set_page_config(page_title="Neramexane", layout="wide")
st.title("Neramexane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6433106.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6433106](https://pubchem.ncbi.nlm.nih.gov/compound/6433106)")
st.markdown(f"IUPAC Name: 1,3,3,5,5-pentamethylcyclohexan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 6433106) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6433106) ]
