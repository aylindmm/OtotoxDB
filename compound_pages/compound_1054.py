...
st.set_page_config(page_title="Pyridoxine", layout="wide")
st.title("Pyridoxine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1054.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1054](https://pubchem.ncbi.nlm.nih.gov/compound/1054)")
st.markdown(f"IUPAC Name: 4,5-bis(hydroxymethyl)-2-methylpyridin-3-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 1054) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1054) ]
