...
st.set_page_config(page_title="L-768673", layout="wide")
st.title("L-768673")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9851380.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9851380](https://pubchem.ncbi.nlm.nih.gov/compound/9851380)")
st.markdown(f"IUPAC Name: 2-[2,4-bis(trifluoromethyl)phenyl]-N-[(3R)-2-oxo-5-phenyl-1-(2,2,2-trifluoroethyl)-3H-1,4-benzodiazepin-3-yl]acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9851380) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9851380) ]
