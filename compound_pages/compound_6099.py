...
st.set_page_config(page_title="Methylene blue", layout="wide")
st.title("Methylene blue")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6099.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6099](https://pubchem.ncbi.nlm.nih.gov/compound/6099)")
st.markdown(f"IUPAC Name: [7-(dimethylamino)phenothiazin-3-ylidene]-dimethylazanium chloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 6099) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6099) ]
