...
st.set_page_config(page_title="Triphenyl phosphite", layout="wide")
st.title("Triphenyl phosphite")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7540.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7540](https://pubchem.ncbi.nlm.nih.gov/compound/7540)")
st.markdown(f"IUPAC Name: triphenyl phosphite")
...
df_filtered = sources[(sources["PubChem_CID"] == 7540) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7540) ]
