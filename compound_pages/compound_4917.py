...
st.set_page_config(page_title="Prochlorperazine", layout="wide")
st.title("Prochlorperazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4917.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4917](https://pubchem.ncbi.nlm.nih.gov/compound/4917)")
st.markdown(f"IUPAC Name: 2-chloro-10-[3-(4-methylpiperazin-1-yl)propyl]phenothiazine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4917) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4917) ]
