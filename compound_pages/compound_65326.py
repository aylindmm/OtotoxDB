...
st.set_page_config(page_title="Ephedrine hydrochloride", layout="wide")
st.title("Ephedrine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_65326.jpg", width=300)
st.markdown(f"PubChem Compound ID: [65326](https://pubchem.ncbi.nlm.nih.gov/compound/65326)")
st.markdown(f"IUPAC Name: (1R,2S)-2-(methylamino)-1-phenylpropan-1-ol;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 65326) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 65326) ]
