...
st.set_page_config(page_title="2-amino-6-chloro-alpha-cyano-3-(ethoxycarbonyl)-4h-1-benzopyran-4-acetic acid ethyl ester", layout="wide")
st.title("2-amino-6-chloro-alpha-cyano-3-(ethoxycarbonyl)-4h-1-benzopyran-4-acetic acid ethyl ester")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2810830.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2810830](https://pubchem.ncbi.nlm.nih.gov/compound/2810830)")
st.markdown(f"IUPAC Name: ethyl 2-amino-6-chloro-4-(1-cyano-2-ethoxy-2-oxoethyl)-4H-chromene-3-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 2810830) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2810830) ]
