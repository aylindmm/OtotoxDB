...
st.set_page_config(page_title="Ketotifen", layout="wide")
st.title("Ketotifen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3827.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3827](https://pubchem.ncbi.nlm.nih.gov/compound/3827)")
st.markdown(f"IUPAC Name: 2-(1-methylpiperidin-4-ylidene)-6-thiatricyclo[8.4.0.03,7]tetradeca-1(14),3(7),4,10,12-pentaen-8-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3827) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3827) ]
