...
st.set_page_config(page_title="Diclofenac sodium", layout="wide")
st.title("Diclofenac sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5018304.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5018304](https://pubchem.ncbi.nlm.nih.gov/compound/5018304)")
st.markdown(f"IUPAC Name: sodium 2-[2-(2,6-dichloroanilino)phenyl]acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5018304) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5018304) ]
