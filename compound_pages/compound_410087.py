...
st.set_page_config(page_title="Povidone iodine", layout="wide")
st.title("Povidone iodine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_410087.jpg", width=300)
st.markdown(f"PubChem Compound ID: [410087](https://pubchem.ncbi.nlm.nih.gov/compound/410087)")
st.markdown(f"IUPAC Name: 1-ethenylpyrrolidin-2-one;molecular iodine")
...
df_filtered = sources[(sources["PubChem_CID"] == 410087) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 410087) ]
