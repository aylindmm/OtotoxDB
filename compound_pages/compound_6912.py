...
st.set_page_config(page_title="(2s,4r)-pentane-1,2,3,4,5-pentol", layout="wide")
st.title("(2s,4r)-pentane-1,2,3,4,5-pentol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6912.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6912](https://pubchem.ncbi.nlm.nih.gov/compound/6912)")
st.markdown(f"IUPAC Name: (2R,4S)-pentane-1,2,3,4,5-pentol")
...
df_filtered = sources[(sources["PubChem_CID"] == 6912) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6912) ]
