...
st.set_page_config(page_title="Econazole", layout="wide")
st.title("Econazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3198.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3198](https://pubchem.ncbi.nlm.nih.gov/compound/3198)")
st.markdown(f"IUPAC Name: 1-[2-[(4-chlorophenyl)methoxy]-2-(2,4-dichlorophenyl)ethyl]imidazole")
...
df_filtered = sources[(sources["PubChem_CID"] == 3198) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3198) ]
