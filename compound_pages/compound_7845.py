...
st.set_page_config(page_title="1,3-butadiene", layout="wide")
st.title("1,3-butadiene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7845.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7845](https://pubchem.ncbi.nlm.nih.gov/compound/7845)")
st.markdown(f"IUPAC Name: buta-1,3-diene")
...
df_filtered = sources[(sources["PubChem_CID"] == 7845) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7845) ]
