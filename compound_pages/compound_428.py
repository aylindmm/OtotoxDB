...
st.set_page_config(page_title="1,3-diaminopropane", layout="wide")
st.title("1,3-diaminopropane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_428.jpg", width=300)
st.markdown(f"PubChem Compound ID: [428](https://pubchem.ncbi.nlm.nih.gov/compound/428)")
st.markdown(f"IUPAC Name: propane-1,3-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 428) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 428) ]
