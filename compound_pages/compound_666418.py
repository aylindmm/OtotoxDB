...
st.set_page_config(page_title="Protionamide", layout="wide")
st.title("Protionamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_666418.jpg", width=300)
st.markdown(f"PubChem Compound ID: [666418](https://pubchem.ncbi.nlm.nih.gov/compound/666418)")
st.markdown(f"IUPAC Name: 2-propylpyridine-4-carbothioamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 666418) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 666418) ]
