...
st.set_page_config(page_title="Napqi", layout="wide")
st.title("Napqi")
# Display the image in Streamlit
st.image(f"compound_structures/compound_39763.jpg", width=300)
st.markdown(f"PubChem Compound ID: [39763](https://pubchem.ncbi.nlm.nih.gov/compound/39763)")
st.markdown(f"IUPAC Name: N-(4-oxocyclohexa-2,5-dien-1-ylidene)acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 39763) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 39763) ]
