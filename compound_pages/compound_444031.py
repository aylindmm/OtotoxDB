...
st.set_page_config(page_title="Darifenacin", layout="wide")
st.title("Darifenacin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_444031.jpg", width=300)
st.markdown(f"PubChem Compound ID: [444031](https://pubchem.ncbi.nlm.nih.gov/compound/444031)")
st.markdown(f"IUPAC Name: 2-[(3S)-1-[2-(2,3-dihydro-1-benzofuran-5-yl)ethyl]pyrrolidin-3-yl]-2,2-diphenylacetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 444031) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 444031) ]
