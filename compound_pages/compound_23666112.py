...
st.set_page_config(page_title="Levothyroxine sodium", layout="wide")
st.title("Levothyroxine sodium")
...
df_filtered = sources[(sources["PubChem_CID"] == 23666112) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23666112) ]
