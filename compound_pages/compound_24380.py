...
st.set_page_config(page_title="Ferric chloride", layout="wide")
st.title("Ferric chloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24380.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24380](https://pubchem.ncbi.nlm.nih.gov/compound/24380)")
st.markdown(f"IUPAC Name: trichloroiron")
...
df_filtered = sources[(sources["PubChem_CID"] == 24380) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24380) ]
