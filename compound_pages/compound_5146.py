...
st.image(f"compound_structures/compound_5146.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5146) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5146) ]
