...
st.set_page_config(page_title="Chebi:36257", layout="wide")
st.title("Chebi:36257")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9548794.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9548794](https://pubchem.ncbi.nlm.nih.gov/compound/9548794)")
st.markdown(f"IUPAC Name: 2-[[(4R)-4-[(3R,5S,7R,8R,9S,10S,12S,13R,14S,17R)-3,7,12-trihydroxy-10,13-dimethyl-2,3,4,5,6,7,8,9,11,12,14,15,16,17-tetradecahydro-1H-cyclopenta[a]phenanthren-17-yl]pentanoyl]amino]ethanesulfonate")
...
df_filtered = sources[(sources["PubChem_CID"] == 9548794) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9548794) ]
