...
st.set_page_config(page_title="Papaverine hydrochloride", layout="wide")
st.title("Papaverine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6084.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6084](https://pubchem.ncbi.nlm.nih.gov/compound/6084)")
st.markdown(f"IUPAC Name: 1-[(3,4-dimethoxyphenyl)methyl]-6,7-dimethoxyisoquinoline;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 6084) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6084) ]
