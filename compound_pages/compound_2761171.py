...
st.set_page_config(page_title="Ethionamide", layout="wide")
st.title("Ethionamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2761171.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2761171](https://pubchem.ncbi.nlm.nih.gov/compound/2761171)")
st.markdown(f"IUPAC Name: 2-ethylpyridine-4-carbothioamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2761171) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2761171) ]
