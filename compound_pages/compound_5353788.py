...
st.image(f"compound_structures/compound_5353788.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5353788) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5353788) ]
