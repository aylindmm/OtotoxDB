...
st.set_page_config(page_title="Minoxidil", layout="wide")
st.title("Minoxidil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4201.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4201](https://pubchem.ncbi.nlm.nih.gov/compound/4201)")
st.markdown(f"IUPAC Name: 3-hydroxy-2-imino-6-piperidin-1-ylpyrimidin-4-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4201) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4201) ]
