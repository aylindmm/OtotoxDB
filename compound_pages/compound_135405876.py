...
st.set_page_config(page_title="Vitamin b-11", layout="wide")
st.title("Vitamin b-11")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135405876.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135405876](https://pubchem.ncbi.nlm.nih.gov/compound/135405876)")
st.markdown(f"IUPAC Name: (2R)-2-[[4-[(2-amino-4-oxo-3H-pteridin-6-yl)methylamino]benzoyl]amino]pentanedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 135405876) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135405876) ]
