...
st.set_page_config(page_title="Atorvastatin", layout="wide")
st.title("Atorvastatin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60823.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 60823) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60823) ]
