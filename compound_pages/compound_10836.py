...
st.set_page_config(page_title="Methamphetamine", layout="wide")
st.title("Methamphetamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10836.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10836](https://pubchem.ncbi.nlm.nih.gov/compound/10836)")
st.markdown(f"IUPAC Name: (2S)-N-methyl-1-phenylpropan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 10836) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10836) ]
