...
st.set_page_config(page_title="Ketamine", layout="wide")
st.title("Ketamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3821.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3821](https://pubchem.ncbi.nlm.nih.gov/compound/3821)")
st.markdown(f"IUPAC Name: 2-(2-chlorophenyl)-2-(methylamino)cyclohexan-1-one")
st.markdown(f"Score: 0.311605187805289")
...
df_filtered = sources[(sources["PubChem_CID"] == 3821) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3821) ]
