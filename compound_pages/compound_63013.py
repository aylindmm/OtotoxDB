...
st.set_page_config(page_title="Tramadol hydrochloride", layout="wide")
st.title("Tramadol hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_63013.jpg", width=300)
st.markdown(f"PubChem Compound ID: [63013](https://pubchem.ncbi.nlm.nih.gov/compound/63013)")
st.markdown(f"IUPAC Name: cis-(1R,2R)-2-[(dimethylamino)methyl]-1-(3-methoxyphenyl)cyclohexan-1-ol;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 63013) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 63013) ]
