...
st.set_page_config(page_title="Vinorelbine", layout="wide")
st.title("Vinorelbine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5311497.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5311497](https://pubchem.ncbi.nlm.nih.gov/compound/5311497)")
st.markdown(f"IUPAC Name: methyl (1R,9R,10S,11R,12R,19R)-11-acetyloxy-12-ethyl-4-[(12S,14R)-16-ethyl-12-methoxycarbonyl-1,10-diazatetracyclo[12.3.1.03,11.04,9]octadeca-3(11),4,6,8,15-pentaen-12-yl]-10-hydroxy-5-methoxy-8-methyl-8,16-diazapentacyclo[10.6.1.01,9.02,7.016,19]nonadeca-2,4,6,13-tetraene-10-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5311497) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5311497) ]
