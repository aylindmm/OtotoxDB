...
st.set_page_config(page_title="Tanshinone i", layout="wide")
st.title("Tanshinone i")
# Display the image in Streamlit
st.image(f"compound_structures/compound_114917.jpg", width=300)
st.markdown(f"PubChem Compound ID: [114917](https://pubchem.ncbi.nlm.nih.gov/compound/114917)")
st.markdown(f"IUPAC Name: 1,6-dimethylnaphtho[1,2-g][1]benzofuran-10,11-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 114917) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 114917) ]
