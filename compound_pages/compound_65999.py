...
st.set_page_config(page_title="Telmisartan", layout="wide")
st.title("Telmisartan")
...
df_filtered = sources[(sources["PubChem_CID"] == 65999) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 65999) ]
