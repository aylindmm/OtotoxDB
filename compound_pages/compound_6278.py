...
st.set_page_config(page_title="1,1,1-trichloroethane", layout="wide")
st.title("1,1,1-trichloroethane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6278.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6278](https://pubchem.ncbi.nlm.nih.gov/compound/6278)")
st.markdown(f"IUPAC Name: 1,1,1-trichloroethane")
...
df_filtered = sources[(sources["PubChem_CID"] == 6278) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6278) ]
