...
st.set_page_config(page_title="Galanthamine", layout="wide")
st.title("Galanthamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9651.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9651](https://pubchem.ncbi.nlm.nih.gov/compound/9651)")
st.markdown(f"IUPAC Name: (1S,12S,14R)-9-methoxy-4-methyl-11-oxa-4-azatetracyclo[8.6.1.01,12.06,17]heptadeca-6(17),7,9,15-tetraen-14-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 9651) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9651) ]
