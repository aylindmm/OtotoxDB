...
st.set_page_config(page_title="Zopiclone", layout="wide")
st.title("Zopiclone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5735.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5735](https://pubchem.ncbi.nlm.nih.gov/compound/5735)")
st.markdown(f"IUPAC Name: [6-(5-chloro-2-pyridinyl)-5-oxo-7H-pyrrolo[3,4-b]pyrazin-7-yl] 4-methylpiperazine-1-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5735) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5735) ]
