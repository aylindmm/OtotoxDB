...
st.set_page_config(page_title="Triamcinolone diacetate", layout="wide")
st.title("Triamcinolone diacetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6216.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6216](https://pubchem.ncbi.nlm.nih.gov/compound/6216)")
st.markdown(f"IUPAC Name: [2-[(8S,9R,10S,11S,13S,14S,16R,17S)-16-acetyloxy-9-fluoro-11,17-dihydroxy-10,13-dimethyl-3-oxo-6,7,8,11,12,14,15,16-octahydrocyclopenta[a]phenanthren-17-yl]-2-oxoethyl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6216) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6216) ]
