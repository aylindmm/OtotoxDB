...
st.set_page_config(page_title="Bismuth", layout="wide")
st.title("Bismuth")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5359367.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5359367](https://pubchem.ncbi.nlm.nih.gov/compound/5359367)")
st.markdown(f"IUPAC Name: bismuth")
...
df_filtered = sources[(sources["PubChem_CID"] == 5359367) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5359367) ]
