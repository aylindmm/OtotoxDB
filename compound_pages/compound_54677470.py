...
st.set_page_config(page_title="Meloxicam", layout="wide")
st.title("Meloxicam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54677470.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54677470](https://pubchem.ncbi.nlm.nih.gov/compound/54677470)")
st.markdown(f"IUPAC Name: 4-hydroxy-2-methyl-N-(5-methyl-1,3-thiazol-2-yl)-1,1-dioxo-1lambda6,2-benzothiazine-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54677470) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54677470) ]
