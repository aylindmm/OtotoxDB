...
st.set_page_config(page_title="9015-82-1", layout="wide")
st.title("9015-82-1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_37056.jpg", width=300)
st.markdown(f"PubChem Compound ID: [37056](https://pubchem.ncbi.nlm.nih.gov/compound/37056)")
st.markdown(f"IUPAC Name: 1-[1-[2-[[5-amino-2-[[1-[5-(diaminomethylideneamino)-2-[[1-[3-(1H-indol-3-yl)-2-[(5-oxopyrrolidine-2-carbonyl)amino]propanoyl]pyrrolidine-2-carbonyl]amino]pentanoyl]pyrrolidine-2-carbonyl]amino]-5-oxopentanoyl]amino]-3-methylpentanoyl]pyrrolidine-2-carbonyl]pyrrolidine-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 37056) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 37056) ]
