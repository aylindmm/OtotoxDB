...
st.set_page_config(page_title="Bongkrekic acid", layout="wide")
st.title("Bongkrekic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6433556.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6433556](https://pubchem.ncbi.nlm.nih.gov/compound/6433556)")
st.markdown(f"IUPAC Name: (2E,4Z,6R,8Z,10E,14E,17S,18E,20Z)-20-(carboxymethyl)-6-methoxy-2,5,17-trimethyldocosa-2,4,8,10,14,18,20-heptaenedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 6433556) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6433556) ]
