...
st.set_page_config(page_title="O-1602", layout="wide")
st.title("O-1602")
# Display the image in Streamlit
st.image(f"compound_structures/compound_45073499.jpg", width=300)
st.markdown(f"PubChem Compound ID: [45073499](https://pubchem.ncbi.nlm.nih.gov/compound/45073499)")
st.markdown(f"IUPAC Name: 5-methyl-4-[(1R,6R)-3-methyl-6-prop-1-en-2-ylcyclohex-2-en-1-yl]benzene-1,3-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 45073499) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 45073499) ]
