...
st.image(f"compound_structures/compound_11427553.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 11427553) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11427553) ]
