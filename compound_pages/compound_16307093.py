...
st.image(f"compound_structures/compound_16307093.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 16307093) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16307093) ]
