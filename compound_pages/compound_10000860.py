...
st.image(f"compound_structures/compound_10000860.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 10000860) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10000860) ]
