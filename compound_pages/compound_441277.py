...
st.set_page_config(page_title="Talwin 50", layout="wide")
st.title("Talwin 50")
# Display the image in Streamlit
st.image(f"compound_structures/compound_441277.jpg", width=300)
st.markdown(f"PubChem Compound ID: [441277](https://pubchem.ncbi.nlm.nih.gov/compound/441277)")
st.markdown(f"IUPAC Name: (1R,9R,13R)-1,13-dimethyl-10-(3-methylbut-2-enyl)-10-azatricyclo[7.3.1.02,7]trideca-2(7),3,5-trien-4-ol;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 441277) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 441277) ]
