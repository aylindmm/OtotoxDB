...
st.set_page_config(page_title="Etidocaine", layout="wide")
st.title("Etidocaine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_37497.jpg", width=300)
st.markdown(f"PubChem Compound ID: [37497](https://pubchem.ncbi.nlm.nih.gov/compound/37497)")
st.markdown(f"IUPAC Name: N-(2,6-dimethylphenyl)-2-[ethyl(propyl)amino]butanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 37497) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 37497) ]
