...
st.set_page_config(page_title="Sulphenazone", layout="wide")
st.title("Sulphenazone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23683220.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23683220](https://pubchem.ncbi.nlm.nih.gov/compound/23683220)")
st.markdown(f"IUPAC Name: sodium (1,5-dimethyl-3-oxo-2-phenylpyrazol-4-yl)-[4-[(6-methoxypyridazin-3-yl)sulfamoyl]anilino]methanesulfonate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23683220) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23683220) ]
