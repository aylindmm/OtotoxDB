...
st.set_page_config(page_title="Chlorothiazide", layout="wide")
st.title("Chlorothiazide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2720.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2720](https://pubchem.ncbi.nlm.nih.gov/compound/2720)")
st.markdown(f"IUPAC Name: 6-chloro-1,1-dioxo-4H-1lambda6,2,4-benzothiadiazine-7-sulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2720) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2720) ]
