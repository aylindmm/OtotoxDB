...
st.set_page_config(page_title="Copper", layout="wide")
st.title("Copper")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23978.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23978](https://pubchem.ncbi.nlm.nih.gov/compound/23978)")
st.markdown(f"IUPAC Name: copper")
...
df_filtered = sources[(sources["PubChem_CID"] == 23978) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23978) ]
