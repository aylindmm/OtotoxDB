...
st.set_page_config(page_title="Lorcaserin", layout="wide")
st.title("Lorcaserin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11658860.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11658860](https://pubchem.ncbi.nlm.nih.gov/compound/11658860)")
st.markdown(f"IUPAC Name: (5R)-7-chloro-5-methyl-2,3,4,5-tetrahydro-1H-3-benzazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 11658860) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11658860) ]
