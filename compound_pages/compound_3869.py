...
st.set_page_config(page_title="Labetalol", layout="wide")
st.title("Labetalol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3869.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3869](https://pubchem.ncbi.nlm.nih.gov/compound/3869)")
st.markdown(f"IUPAC Name: 2-hydroxy-5-[1-hydroxy-2-(4-phenylbutan-2-ylamino)ethyl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3869) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3869) ]
