...
st.set_page_config(page_title="870773-76-5", layout="wide")
st.title("870773-76-5")
...
df_filtered = sources[(sources["PubChem_CID"] == 11530459) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11530459) ]
