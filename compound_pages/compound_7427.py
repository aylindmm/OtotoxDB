...
st.image(f"compound_structures/compound_7427.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 7427) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7427) ]
