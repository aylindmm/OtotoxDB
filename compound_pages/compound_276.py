...
st.set_page_config(page_title="Carbamate", layout="wide")
st.title("Carbamate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_276.jpg", width=300)
st.markdown(f"PubChem Compound ID: [276](https://pubchem.ncbi.nlm.nih.gov/compound/276)")
st.markdown(f"IUPAC Name: carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 276) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 276) ]
