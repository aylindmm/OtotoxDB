...
st.set_page_config(page_title="Geranylgeraniol", layout="wide")
st.title("Geranylgeraniol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281365.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281365](https://pubchem.ncbi.nlm.nih.gov/compound/5281365)")
st.markdown(f"IUPAC Name: (2E,6E,10E)-3,7,11,15-tetramethylhexadeca-2,6,10,14-tetraen-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281365) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281365) ]
