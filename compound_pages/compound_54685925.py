...
st.image(f"compound_structures/compound_54685925.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 54685925) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54685925) ]
