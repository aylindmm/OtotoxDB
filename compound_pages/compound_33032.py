...
st.set_page_config(page_title="L-glutamic acid", layout="wide")
st.title("L-glutamic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_33032.jpg", width=300)
st.markdown(f"PubChem Compound ID: [33032](https://pubchem.ncbi.nlm.nih.gov/compound/33032)")
st.markdown(f"IUPAC Name: (2S)-2-aminopentanedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 33032) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 33032) ]
