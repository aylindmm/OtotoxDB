...
st.set_page_config(page_title="Flumequine", layout="wide")
st.title("Flumequine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3374.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3374](https://pubchem.ncbi.nlm.nih.gov/compound/3374)")
st.markdown(f"IUPAC Name: 7-fluoro-12-methyl-4-oxo-1-azatricyclo[7.3.1.05,13]trideca-2,5,7,9(13)-tetraene-3-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3374) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3374) ]
