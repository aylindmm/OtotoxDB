...
st.set_page_config(page_title="Tilidine hydrochloride", layout="wide")
st.title("Tilidine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71393.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71393](https://pubchem.ncbi.nlm.nih.gov/compound/71393)")
st.markdown(f"IUPAC Name: ethyl (1S,2R)-2-(dimethylamino)-1-phenylcyclohex-3-ene-1-carboxylate;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 71393) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71393) ]
