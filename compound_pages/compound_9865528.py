...
st.set_page_config(page_title="Mirabegron", layout="wide")
st.title("Mirabegron")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9865528.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9865528](https://pubchem.ncbi.nlm.nih.gov/compound/9865528)")
st.markdown(f"IUPAC Name: 2-(2-amino-1,3-thiazol-4-yl)-N-[4-[2-[[(2R)-2-hydroxy-2-phenylethyl]amino]ethyl]phenyl]acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9865528) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9865528) ]
