...
st.set_page_config(page_title="Guanadrel", layout="wide")
st.title("Guanadrel")
# Display the image in Streamlit
st.image(f"compound_structures/compound_38521.jpg", width=300)
st.markdown(f"PubChem Compound ID: [38521](https://pubchem.ncbi.nlm.nih.gov/compound/38521)")
st.markdown(f"IUPAC Name: 2-(1,4-dioxaspiro[4.5]decan-3-ylmethyl)guanidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 38521) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 38521) ]
