...
st.set_page_config(page_title="Beta-cyclodextrin", layout="wide")
st.title("Beta-cyclodextrin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_444041.jpg", width=300)
st.markdown(f"PubChem Compound ID: [444041](https://pubchem.ncbi.nlm.nih.gov/compound/444041)")
...
df_filtered = sources[(sources["PubChem_CID"] == 444041) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 444041) ]
