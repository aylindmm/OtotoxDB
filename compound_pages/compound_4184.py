...
st.image(f"compound_structures/compound_4184.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 4184) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4184) ]
