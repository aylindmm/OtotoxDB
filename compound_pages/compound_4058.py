...
st.set_page_config(page_title="Meperidine", layout="wide")
st.title("Meperidine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4058.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4058](https://pubchem.ncbi.nlm.nih.gov/compound/4058)")
st.markdown(f"IUPAC Name: ethyl 1-methyl-4-phenylpiperidine-4-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 4058) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4058) ]
