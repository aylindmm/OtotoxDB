...
st.set_page_config(page_title="Aspartame", layout="wide")
st.title("Aspartame")
# Display the image in Streamlit
st.image(f"compound_structures/compound_134601.jpg", width=300)
st.markdown(f"PubChem Compound ID: [134601](https://pubchem.ncbi.nlm.nih.gov/compound/134601)")
st.markdown(f"IUPAC Name: (3S)-3-amino-4-[[(2S)-1-methoxy-1-oxo-3-phenylpropan-2-yl]amino]-4-oxobutanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 134601) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 134601) ]
