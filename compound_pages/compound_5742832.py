...
st.set_page_config(page_title="Aztreonam", layout="wide")
st.title("Aztreonam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5742832.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5742832](https://pubchem.ncbi.nlm.nih.gov/compound/5742832)")
st.markdown(f"IUPAC Name: 2-[(Z)-[1-(2-amino-1,3-thiazol-4-yl)-2-[[(2S,3S)-2-methyl-4-oxo-1-sulfoazetidin-3-yl]amino]-2-oxoethylidene]amino]oxy-2-methylpropanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5742832) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5742832) ]
