...
st.set_page_config(page_title="2-butanone", layout="wide")
st.title("2-butanone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6569.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6569](https://pubchem.ncbi.nlm.nih.gov/compound/6569)")
st.markdown(f"IUPAC Name: butan-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 6569) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6569) ]
