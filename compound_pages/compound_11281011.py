...
st.set_page_config(page_title="Arbaclofen placarbil", layout="wide")
st.title("Arbaclofen placarbil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11281011.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11281011](https://pubchem.ncbi.nlm.nih.gov/compound/11281011)")
st.markdown(f"IUPAC Name: (3R)-3-(4-chlorophenyl)-4-[[(1S)-2-methyl-1-(2-methylpropanoyloxy)propoxy]carbonylamino]butanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 11281011) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11281011) ]
