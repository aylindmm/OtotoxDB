...
st.set_page_config(page_title="Cefuroxime", layout="wide")
st.title("Cefuroxime")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5479529.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5479529](https://pubchem.ncbi.nlm.nih.gov/compound/5479529)")
st.markdown(f"IUPAC Name: (6R,7R)-3-(carbamoyloxymethyl)-7-[[(2Z)-2-(furan-2-yl)-2-methoxyiminoacetyl]amino]-8-oxo-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5479529) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5479529) ]
