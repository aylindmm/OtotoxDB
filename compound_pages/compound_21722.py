...
st.set_page_config(page_title="Iprindole", layout="wide")
st.title("Iprindole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_21722.jpg", width=300)
st.markdown(f"PubChem Compound ID: [21722](https://pubchem.ncbi.nlm.nih.gov/compound/21722)")
st.markdown(f"IUPAC Name: 3-(6,7,8,9,10,11-hexahydrocycloocta[b]indol-5-yl)-N,N-dimethylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 21722) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 21722) ]
