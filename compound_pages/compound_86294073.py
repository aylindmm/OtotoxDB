...
st.set_page_config(page_title="Zuranolone", layout="wide")
st.title("Zuranolone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_86294073.jpg", width=300)
st.markdown(f"PubChem Compound ID: [86294073](https://pubchem.ncbi.nlm.nih.gov/compound/86294073)")
st.markdown(f"IUPAC Name: 1-[2-[(3R,5R,8R,9R,10S,13S,14S,17S)-3-hydroxy-3,13-dimethyl-2,4,5,6,7,8,9,10,11,12,14,15,16,17-tetradecahydro-1H-cyclopenta[a]phenanthren-17-yl]-2-oxoethyl]pyrazole-4-carbonitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 86294073) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 86294073) ]
