...
st.set_page_config(page_title="D-glucopyranose", layout="wide")
st.title("D-glucopyranose")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5793.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5793](https://pubchem.ncbi.nlm.nih.gov/compound/5793)")
st.markdown(f"IUPAC Name: (3R,4S,5S,6R)-6-(hydroxymethyl)oxane-2,3,4,5-tetrol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5793) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5793) ]
