...
st.set_page_config(page_title="Daunorubicin", layout="wide")
st.title("Daunorubicin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_30323.jpg", width=300)
st.markdown(f"PubChem Compound ID: [30323](https://pubchem.ncbi.nlm.nih.gov/compound/30323)")
st.markdown(f"IUPAC Name: (7S,9S)-9-acetyl-7-[(2R,4S,5S,6S)-4-amino-5-hydroxy-6-methyloxan-2-yl]oxy-6,9,11-trihydroxy-4-methoxy-8,10-dihydro-7H-tetracene-5,12-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 30323) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 30323) ]
