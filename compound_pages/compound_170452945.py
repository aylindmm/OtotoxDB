...
st.set_page_config(page_title="Mercury chloride", layout="wide")
st.title("Mercury chloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_170452945.jpg", width=300)
st.markdown(f"PubChem Compound ID: [170452945](https://pubchem.ncbi.nlm.nih.gov/compound/170452945)")
st.markdown(f"IUPAC Name: mercury chloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 170452945) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 170452945) ]
