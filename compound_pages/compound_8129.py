...
st.set_page_config(page_title="1-heptanol", layout="wide")
st.title("1-heptanol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_8129.jpg", width=300)
st.markdown(f"PubChem Compound ID: [8129](https://pubchem.ncbi.nlm.nih.gov/compound/8129)")
st.markdown(f"IUPAC Name: heptan-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 8129) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 8129) ]
