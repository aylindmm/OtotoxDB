...
st.set_page_config(page_title="Ec2la", layout="wide")
st.title("Ec2la")
# Display the image in Streamlit
st.image(f"compound_structures/compound_137553165.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 137553165) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 137553165) ]
