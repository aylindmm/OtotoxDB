...
st.set_page_config(page_title="Phenylalanyl-glycyl-leucyl-methioninamide", layout="wide")
st.title("Phenylalanyl-glycyl-leucyl-methioninamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9941031.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9941031](https://pubchem.ncbi.nlm.nih.gov/compound/9941031)")
st.markdown(f"IUPAC Name: (2S)-N-[(2S)-1-amino-4-methylsulfanyl-1-oxobutan-2-yl]-2-[[2-[[(2S)-2-amino-3-phenylpropanoyl]amino]acetyl]amino]-4-methylpentanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9941031) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9941031) ]
