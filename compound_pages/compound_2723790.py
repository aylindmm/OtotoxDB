...
st.image(f"compound_structures/compound_2723790.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 2723790) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2723790) ]
