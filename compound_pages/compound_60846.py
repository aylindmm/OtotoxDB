...
st.set_page_config(page_title="Valsartan", layout="wide")
st.title("Valsartan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60846.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60846](https://pubchem.ncbi.nlm.nih.gov/compound/60846)")
st.markdown(f"IUPAC Name: (2S)-3-methyl-2-[pentanoyl-[[4-[2-(2H-tetrazol-5-yl)phenyl]phenyl]methyl]amino]butanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 60846) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60846) ]
