...
st.set_page_config(page_title="5o6cm4w76a", layout="wide")
st.title("5o6cm4w76a")
# Display the image in Streamlit
st.image(f"compound_structures/compound_90478414.jpg", width=300)
st.markdown(f"PubChem Compound ID: [90478414](https://pubchem.ncbi.nlm.nih.gov/compound/90478414)")
st.markdown(f"IUPAC Name: germanium(4+);bis(oxygen(2-))")
...
df_filtered = sources[(sources["PubChem_CID"] == 90478414) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 90478414) ]
