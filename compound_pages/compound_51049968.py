...
st.set_page_config(page_title="Rimegepant", layout="wide")
st.title("Rimegepant")
# Display the image in Streamlit
st.image(f"compound_structures/compound_51049968.jpg", width=300)
st.markdown(f"PubChem Compound ID: [51049968](https://pubchem.ncbi.nlm.nih.gov/compound/51049968)")
st.markdown(f"IUPAC Name: [(5S,6S,9R)-5-amino-6-(2,3-difluorophenyl)-6,7,8,9-tetrahydro-5H-cyclohepta[b]pyridin-9-yl] 4-(2-oxo-3H-imidazo[4,5-b]pyridin-1-yl)piperidine-1-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 51049968) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 51049968) ]
