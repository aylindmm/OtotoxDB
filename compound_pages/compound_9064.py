...
st.set_page_config(page_title="Cianidanol", layout="wide")
st.title("Cianidanol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9064.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 9064) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9064) ]
