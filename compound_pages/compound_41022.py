...
st.set_page_config(page_title="Flecainide acetate", layout="wide")
st.title("Flecainide acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_41022.jpg", width=300)
st.markdown(f"PubChem Compound ID: [41022](https://pubchem.ncbi.nlm.nih.gov/compound/41022)")
st.markdown(f"IUPAC Name: acetic acid;N-(piperidin-2-ylmethyl)-2,5-bis(2,2,2-trifluoroethoxy)benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 41022) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 41022) ]
