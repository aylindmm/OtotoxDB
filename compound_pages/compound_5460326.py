...
st.image(f"compound_structures/compound_5460326.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5460326) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5460326) ]
