...
st.set_page_config(page_title="Mirogabalin", layout="wide")
st.title("Mirogabalin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_59509752.jpg", width=300)
st.markdown(f"PubChem Compound ID: [59509752](https://pubchem.ncbi.nlm.nih.gov/compound/59509752)")
st.markdown(f"IUPAC Name: 2-[(1R,5S,6S)-6-(aminomethyl)-3-ethyl-6-bicyclo[3.2.0]hept-3-enyl]acetic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 59509752) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 59509752) ]
