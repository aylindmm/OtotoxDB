...
st.set_page_config(page_title="Debrisoquine", layout="wide")
st.title("Debrisoquine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2966.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2966](https://pubchem.ncbi.nlm.nih.gov/compound/2966)")
st.markdown(f"IUPAC Name: 3,4-dihydro-1H-isoquinoline-2-carboximidamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2966) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2966) ]
