...
st.set_page_config(page_title="Acrolein", layout="wide")
st.title("Acrolein")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7847.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7847](https://pubchem.ncbi.nlm.nih.gov/compound/7847)")
st.markdown(f"IUPAC Name: prop-2-enal")
...
df_filtered = sources[(sources["PubChem_CID"] == 7847) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7847) ]
