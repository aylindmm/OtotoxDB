...
st.set_page_config(page_title="Mildex", layout="wide")
st.title("Mildex")
# Display the image in Streamlit
st.image(f"compound_structures/compound_156614068.jpg", width=300)
st.markdown(f"PubChem Compound ID: [156614068](https://pubchem.ncbi.nlm.nih.gov/compound/156614068)")
st.markdown(f"IUPAC Name: (2-nitrophenyl) (E)-but-2-enoate;nitrous acid;octane")
...
df_filtered = sources[(sources["PubChem_CID"] == 156614068) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 156614068) ]
