...
st.set_page_config(page_title="Bempedoic acid", layout="wide")
st.title("Bempedoic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10472693.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10472693](https://pubchem.ncbi.nlm.nih.gov/compound/10472693)")
st.markdown(f"IUPAC Name: 8-hydroxy-2,2,14,14-tetramethylpentadecanedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 10472693) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10472693) ]
