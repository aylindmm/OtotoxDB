...
st.set_page_config(page_title="Fenquizone", layout="wide")
st.title("Fenquizone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68548.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68548](https://pubchem.ncbi.nlm.nih.gov/compound/68548)")
st.markdown(f"IUPAC Name: 7-chloro-4-oxo-2-phenyl-2,3-dihydro-1H-quinazoline-6-sulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 68548) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68548) ]
