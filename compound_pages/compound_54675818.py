...
st.set_page_config(page_title="2,3-dihydroxybenzoate", layout="wide")
st.title("2,3-dihydroxybenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 54675818) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54675818) ]
