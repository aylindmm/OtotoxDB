...
st.set_page_config(page_title="17alpha-estradiol", layout="wide")
st.title("17alpha-estradiol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68570.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68570](https://pubchem.ncbi.nlm.nih.gov/compound/68570)")
st.markdown(f"IUPAC Name: (8R,9S,13S,14S,17R)-13-methyl-6,7,8,9,11,12,14,15,16,17-decahydrocyclopenta[a]phenanthrene-3,17-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 68570) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68570) ]
