...
st.set_page_config(page_title="Nitroprusside ion", layout="wide")
st.title("Nitroprusside ion")
# Display the image in Streamlit
st.image(f"compound_structures/compound_166638194.jpg", width=300)
st.markdown(f"PubChem Compound ID: [166638194](https://pubchem.ncbi.nlm.nih.gov/compound/166638194)")
st.markdown(f"IUPAC Name: iron(5+);nitroxyl;pentacyanide")
...
df_filtered = sources[(sources["PubChem_CID"] == 166638194) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 166638194) ]
