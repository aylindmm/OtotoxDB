...
st.set_page_config(page_title="Mitometh", layout="wide")
st.title("Mitometh")
# Display the image in Streamlit
st.image(f"compound_structures/compound_129873.jpg", width=300)
st.markdown(f"PubChem Compound ID: [129873](https://pubchem.ncbi.nlm.nih.gov/compound/129873)")
st.markdown(f"IUPAC Name: 1-chloro-2-[2,2-dichloro-1-(4-chlorophenyl)propyl]benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 129873) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 129873) ]
