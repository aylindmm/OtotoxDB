...
st.set_page_config(page_title="Meptazinol", layout="wide")
st.title("Meptazinol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_41049.jpg", width=300)
st.markdown(f"PubChem Compound ID: [41049](https://pubchem.ncbi.nlm.nih.gov/compound/41049)")
st.markdown(f"IUPAC Name: 3-(3-ethyl-1-methylazepan-3-yl)phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 41049) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 41049) ]
