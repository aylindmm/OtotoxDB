...
st.set_page_config(page_title="Voglibose", layout="wide")
st.title("Voglibose")
# Display the image in Streamlit
st.image(f"compound_structures/compound_444020.jpg", width=300)
st.markdown(f"PubChem Compound ID: [444020](https://pubchem.ncbi.nlm.nih.gov/compound/444020)")
st.markdown(f"IUPAC Name: (1S,2S,3R,4S,5S)-5-(1,3-dihydroxypropan-2-ylamino)-1-(hydroxymethyl)cyclohexane-1,2,3,4-tetrol")
...
df_filtered = sources[(sources["PubChem_CID"] == 444020) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 444020) ]
