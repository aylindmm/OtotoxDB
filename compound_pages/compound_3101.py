...
st.set_page_config(page_title="Diphenyleneiodonium", layout="wide")
st.title("Diphenyleneiodonium")
...
df_filtered = sources[(sources["PubChem_CID"] == 3101) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3101) ]
