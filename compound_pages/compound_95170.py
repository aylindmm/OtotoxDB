...
st.set_page_config(page_title="5436-43-1", layout="wide")
st.title("5436-43-1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_95170.jpg", width=300)
st.markdown(f"PubChem Compound ID: [95170](https://pubchem.ncbi.nlm.nih.gov/compound/95170)")
st.markdown(f"IUPAC Name: 2,4-dibromo-1-(2,4-dibromophenoxy)benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 95170) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 95170) ]
