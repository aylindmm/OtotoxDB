...
st.set_page_config(page_title="N-ethylmaleimide", layout="wide")
st.title("N-ethylmaleimide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4362.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4362](https://pubchem.ncbi.nlm.nih.gov/compound/4362)")
st.markdown(f"IUPAC Name: 1-ethylpyrrole-2,5-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 4362) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4362) ]
