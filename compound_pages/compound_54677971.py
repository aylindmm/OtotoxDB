...
st.set_page_config(page_title="Tenoxicam", layout="wide")
st.title("Tenoxicam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54677971.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54677971](https://pubchem.ncbi.nlm.nih.gov/compound/54677971)")
st.markdown(f"IUPAC Name: 4-hydroxy-2-methyl-1,1-dioxo-N-pyridin-2-ylthieno[2,3-e]thiazine-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54677971) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54677971) ]
