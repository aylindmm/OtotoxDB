...
st.set_page_config(page_title="Dextromethadone", layout="wide")
st.title("Dextromethadone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_643985.jpg", width=300)
st.markdown(f"PubChem Compound ID: [643985](https://pubchem.ncbi.nlm.nih.gov/compound/643985)")
st.markdown(f"IUPAC Name: (6S)-6-(dimethylamino)-4,4-diphenylheptan-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 643985) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 643985) ]
