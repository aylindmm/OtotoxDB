...
st.set_page_config(page_title="Pilocarpine", layout="wide")
st.title("Pilocarpine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5910.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5910](https://pubchem.ncbi.nlm.nih.gov/compound/5910)")
st.markdown(f"IUPAC Name: (3S,4R)-3-ethyl-4-[(3-methylimidazol-4-yl)methyl]oxolan-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5910) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5910) ]
