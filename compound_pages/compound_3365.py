...
st.set_page_config(page_title="Fluconazole", layout="wide")
st.title("Fluconazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3365.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3365](https://pubchem.ncbi.nlm.nih.gov/compound/3365)")
st.markdown(f"IUPAC Name: 2-(2,4-difluorophenyl)-1,3-bis(1,2,4-triazol-1-yl)propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3365) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3365) ]
