...
st.set_page_config(page_title="Mercaptomethylimidazole", layout="wide")
st.title("Mercaptomethylimidazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_21989623.jpg", width=300)
st.markdown(f"PubChem Compound ID: [21989623](https://pubchem.ncbi.nlm.nih.gov/compound/21989623)")
st.markdown(f"IUPAC Name: 1H-imidazol-2-ylmethanethiol")
...
df_filtered = sources[(sources["PubChem_CID"] == 21989623) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 21989623) ]
