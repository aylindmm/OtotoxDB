...
st.set_page_config(page_title="Hydrocortisone acetate", layout="wide")
st.title("Hydrocortisone acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5744.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5744](https://pubchem.ncbi.nlm.nih.gov/compound/5744)")
st.markdown(f"IUPAC Name: [2-[(8S,9S,10R,11S,13S,14S,17R)-11,17-dihydroxy-10,13-dimethyl-3-oxo-2,6,7,8,9,11,12,14,15,16-decahydro-1H-cyclopenta[a]phenanthren-17-yl]-2-oxoethyl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5744) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5744) ]
