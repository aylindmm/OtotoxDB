...
st.set_page_config(page_title="Iohexol", layout="wide")
st.title("Iohexol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3730.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3730](https://pubchem.ncbi.nlm.nih.gov/compound/3730)")
st.markdown(f"IUPAC Name: 5-[acetyl(2,3-dihydroxypropyl)amino]-1-N,3-N-bis(2,3-dihydroxypropyl)-2,4,6-triiodobenzene-1,3-dicarboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3730) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3730) ]
