...
st.set_page_config(page_title="Molnupiravir", layout="wide")
st.title("Molnupiravir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_145996610.jpg", width=300)
st.markdown(f"PubChem Compound ID: [145996610](https://pubchem.ncbi.nlm.nih.gov/compound/145996610)")
st.markdown(f"IUPAC Name: [(2R,3S,4R,5R)-3,4-dihydroxy-5-[4-(hydroxyamino)-2-oxopyrimidin-1-yl]oxolan-2-yl]methyl 2-methylpropanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 145996610) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 145996610) ]
