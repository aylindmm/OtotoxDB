...
st.image(f"compound_structures/compound_55283.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 55283) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 55283) ]
