...
st.set_page_config(page_title="Grayanotoxin", layout="wide")
st.title("Grayanotoxin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_433104.jpg", width=300)
st.markdown(f"PubChem Compound ID: [433104](https://pubchem.ncbi.nlm.nih.gov/compound/433104)")
st.markdown(f"IUPAC Name: 5,5,9,14-tetramethyltetracyclo[11.2.1.01,10.04,8]hexadecane-3,4,6,14,16-pentol")
...
df_filtered = sources[(sources["PubChem_CID"] == 433104) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 433104) ]
