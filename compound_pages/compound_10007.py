...
st.set_page_config(page_title="Chlorphentermine", layout="wide")
st.title("Chlorphentermine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10007.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10007](https://pubchem.ncbi.nlm.nih.gov/compound/10007)")
st.markdown(f"IUPAC Name: 1-(4-chlorophenyl)-2-methylpropan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 10007) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10007) ]
