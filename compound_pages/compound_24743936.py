...
st.set_page_config(page_title="Encukalner", layout="wide")
st.title("Encukalner")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24743936.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24743936](https://pubchem.ncbi.nlm.nih.gov/compound/24743936)")
st.markdown(f"IUPAC Name: N-[4-(6-fluoro-3,4-dihydro-1H-isoquinolin-2-yl)-2,6-dimethylphenyl]-3,3-dimethylbutanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 24743936) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24743936) ]
