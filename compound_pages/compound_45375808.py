...
st.set_page_config(page_title="Sofosbuvir", layout="wide")
st.title("Sofosbuvir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_45375808.jpg", width=300)
st.markdown(f"PubChem Compound ID: [45375808](https://pubchem.ncbi.nlm.nih.gov/compound/45375808)")
st.markdown(f"IUPAC Name: propan-2-yl (2S)-2-[[[(2R,3R,4R,5R)-5-(2,4-dioxopyrimidin-1-yl)-4-fluoro-3-hydroxy-4-methyloxolan-2-yl]methoxy-phenoxyphosphoryl]amino]propanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 45375808) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 45375808) ]
