...
st.set_page_config(page_title="Primaquine", layout="wide")
st.title("Primaquine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4908.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4908](https://pubchem.ncbi.nlm.nih.gov/compound/4908)")
st.markdown(f"IUPAC Name: 4-N-(6-methoxyquinolin-8-yl)pentane-1,4-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4908) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4908) ]
