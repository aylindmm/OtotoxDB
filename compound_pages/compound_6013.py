...
st.set_page_config(page_title="Testosterone", layout="wide")
st.title("Testosterone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6013.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6013](https://pubchem.ncbi.nlm.nih.gov/compound/6013)")
st.markdown(f"IUPAC Name: (8R,9S,10R,13S,14S,17S)-17-hydroxy-10,13-dimethyl-1,2,6,7,8,9,11,12,14,15,16,17-dodecahydrocyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 6013) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6013) ]
