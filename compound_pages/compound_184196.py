...
st.set_page_config(page_title="Crlx101", layout="wide")
st.title("Crlx101")
# Display the image in Streamlit
st.image(f"compound_structures/compound_184196.jpg", width=300)
st.markdown(f"PubChem Compound ID: [184196](https://pubchem.ncbi.nlm.nih.gov/compound/184196)")
st.markdown(f"IUPAC Name: (19R)-19-ethyl-19-hydroxy-17-oxa-3,13-diazapentacyclo[11.8.0.02,11.04,9.015,20]henicosa-1(21),2,4,6,8,10,15(20)-heptaene-14,18-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 184196) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 184196) ]
