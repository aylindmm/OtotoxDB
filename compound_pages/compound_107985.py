...
st.set_page_config(page_title="Triptolide", layout="wide")
st.title("Triptolide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_107985.jpg", width=300)
st.markdown(f"PubChem Compound ID: [107985](https://pubchem.ncbi.nlm.nih.gov/compound/107985)")
st.markdown(f"IUPAC Name: (1S,2S,4S,5S,7R,8R,9S,11S,13S)-8-hydroxy-1-methyl-7-propan-2-yl-3,6,10,16-tetraoxaheptacyclo[11.7.0.02,4.02,9.05,7.09,11.014,18]icos-14(18)-en-17-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 107985) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 107985) ]
