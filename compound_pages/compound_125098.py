...
st.set_page_config(page_title="Icaridin", layout="wide")
st.title("Icaridin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_125098.jpg", width=300)
st.markdown(f"PubChem Compound ID: [125098](https://pubchem.ncbi.nlm.nih.gov/compound/125098)")
st.markdown(f"IUPAC Name: butan-2-yl 2-(2-hydroxyethyl)piperidine-1-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 125098) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 125098) ]
