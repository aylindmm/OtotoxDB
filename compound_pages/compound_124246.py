...
st.set_page_config(page_title="Iguratimod", layout="wide")
st.title("Iguratimod")
# Display the image in Streamlit
st.image(f"compound_structures/compound_124246.jpg", width=300)
st.markdown(f"PubChem Compound ID: [124246](https://pubchem.ncbi.nlm.nih.gov/compound/124246)")
st.markdown(f"IUPAC Name: N-[7-(methanesulfonamido)-4-oxo-6-phenoxychromen-3-yl]formamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 124246) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 124246) ]
