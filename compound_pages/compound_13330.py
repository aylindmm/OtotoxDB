...
st.set_page_config(page_title="Dipipanone hydrochloride", layout="wide")
st.title("Dipipanone hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_13330.jpg", width=300)
st.markdown(f"PubChem Compound ID: [13330](https://pubchem.ncbi.nlm.nih.gov/compound/13330)")
st.markdown(f"IUPAC Name: 4,4-diphenyl-6-piperidin-1-ylheptan-3-one;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 13330) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 13330) ]
