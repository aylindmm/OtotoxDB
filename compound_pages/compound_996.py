...
st.set_page_config(page_title="Phenol", layout="wide")
st.title("Phenol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_996.jpg", width=300)
st.markdown(f"PubChem Compound ID: [996](https://pubchem.ncbi.nlm.nih.gov/compound/996)")
st.markdown(f"IUPAC Name: phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 996) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 996) ]
