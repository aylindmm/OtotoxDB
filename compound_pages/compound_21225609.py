...
st.set_page_config(page_title="Sodium phosphate", layout="wide")
st.title("Sodium phosphate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_21225609.jpg", width=300)
st.markdown(f"PubChem Compound ID: [21225609](https://pubchem.ncbi.nlm.nih.gov/compound/21225609)")
st.markdown(f"IUPAC Name: sodium phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 21225609) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 21225609) ]
