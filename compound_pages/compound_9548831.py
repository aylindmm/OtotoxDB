...
st.set_page_config(page_title="Arsanilate(1-)", layout="wide")
st.title("Arsanilate(1-)")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9548831.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9548831](https://pubchem.ncbi.nlm.nih.gov/compound/9548831)")
st.markdown(f"IUPAC Name: (4-aminophenyl)-hydroxyarsinate")
...
df_filtered = sources[(sources["PubChem_CID"] == 9548831) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9548831) ]
