...
st.set_page_config(page_title="Dextromethorphan hydrobromide", layout="wide")
st.title("Dextromethorphan hydrobromide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5464025.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5464025](https://pubchem.ncbi.nlm.nih.gov/compound/5464025)")
st.markdown(f"IUPAC Name: (1S,9S,10S)-4-methoxy-17-methyl-17-azatetracyclo[7.5.3.01,10.02,7]heptadeca-2(7),3,5-triene;hydrobromide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5464025) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5464025) ]
