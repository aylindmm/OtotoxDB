...
st.set_page_config(page_title="Uxsi-9", layout="wide")
st.title("Uxsi-9")
# Display the image in Streamlit
st.image(f"compound_structures/compound_155804812.jpg", width=300)
st.markdown(f"PubChem Compound ID: [155804812](https://pubchem.ncbi.nlm.nih.gov/compound/155804812)")
st.markdown(f"IUPAC Name: disodium;2,2,4,4,6,6-hexaoxido-1,3,5,2,4,6-trioxatrisilinane;zirconium(4+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 155804812) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 155804812) ]
