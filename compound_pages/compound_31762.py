...
st.set_page_config(page_title="Dihydro-beta-erythroidine", layout="wide")
st.title("Dihydro-beta-erythroidine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_31762.jpg", width=300)
st.markdown(f"PubChem Compound ID: [31762](https://pubchem.ncbi.nlm.nih.gov/compound/31762)")
st.markdown(f"IUPAC Name: (1S,16S)-16-methoxy-5-oxa-10-azatetracyclo[8.7.0.01,13.02,7]heptadeca-2(7),13-dien-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 31762) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 31762) ]
