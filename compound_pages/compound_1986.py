...
st.set_page_config(page_title="Acetazolamide", layout="wide")
st.title("Acetazolamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1986.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1986](https://pubchem.ncbi.nlm.nih.gov/compound/1986)")
st.markdown(f"IUPAC Name: N-(5-sulfamoyl-1,3,4-thiadiazol-2-yl)acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 1986) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1986) ]
