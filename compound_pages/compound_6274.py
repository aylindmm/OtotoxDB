...
st.set_page_config(page_title="L-histidine", layout="wide")
st.title("L-histidine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6274.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6274](https://pubchem.ncbi.nlm.nih.gov/compound/6274)")
st.markdown(f"IUPAC Name: (2S)-2-amino-3-(1H-imidazol-5-yl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 6274) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6274) ]
