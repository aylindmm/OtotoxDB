...
st.set_page_config(page_title="Fansidar", layout="wide")
st.title("Fansidar")
# Display the image in Streamlit
st.image(f"compound_structures/compound_65404.jpg", width=300)
st.markdown(f"PubChem Compound ID: [65404](https://pubchem.ncbi.nlm.nih.gov/compound/65404)")
st.markdown(f"IUPAC Name: 4-amino-N-(5,6-dimethoxypyrimidin-4-yl)benzenesulfonamide;5-(4-chlorophenyl)-6-ethylpyrimidine-2,4-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 65404) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 65404) ]
