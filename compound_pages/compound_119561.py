...
st.set_page_config(page_title="Ampicillin and sulbactam", layout="wide")
st.title("Ampicillin and sulbactam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_119561.jpg", width=300)
st.markdown(f"PubChem Compound ID: [119561](https://pubchem.ncbi.nlm.nih.gov/compound/119561)")
st.markdown(f"IUPAC Name: (2S,5R,6R)-6-[[(2R)-2-amino-2-phenylacetyl]amino]-3,3-dimethyl-7-oxo-4-thia-1-azabicyclo[3.2.0]heptane-2-carboxylic acid;(1R,4S)-3,3-dimethyl-2,2,6-trioxo-2lambda6-thiabicyclo[3.2.0]heptane-4-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 119561) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 119561) ]
