...
st.image(f"compound_structures/compound_12560.jpg", width=300)
...
st.markdown(f"Score: 0.227387569479535")
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 12560) ]
