...
st.set_page_config(page_title="Cladribine", layout="wide")
st.title("Cladribine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_20279.jpg", width=300)
st.markdown(f"PubChem Compound ID: [20279](https://pubchem.ncbi.nlm.nih.gov/compound/20279)")
st.markdown(f"IUPAC Name: (2R,3S,5R)-5-(6-amino-2-chloropurin-9-yl)-2-(hydroxymethyl)oxolan-3-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 20279) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 20279) ]
