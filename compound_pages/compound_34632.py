...
st.set_page_config(page_title="Moricizine hydrochloride", layout="wide")
st.title("Moricizine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_34632.jpg", width=300)
st.markdown(f"PubChem Compound ID: [34632](https://pubchem.ncbi.nlm.nih.gov/compound/34632)")
st.markdown(f"IUPAC Name: ethyl N-[10-(3-morpholin-4-ylpropanoyl)phenothiazin-2-yl]carbamate;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 34632) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 34632) ]
