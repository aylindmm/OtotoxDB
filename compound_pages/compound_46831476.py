...
st.set_page_config(page_title="3-(1-(cyclohexyl(methyl)carbamoyl)-1h-imidazol-4-yl)pyridine 1-oxide", layout="wide")
st.title("3-(1-(cyclohexyl(methyl)carbamoyl)-1h-imidazol-4-yl)pyridine 1-oxide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_46831476.jpg", width=300)
st.markdown(f"PubChem Compound ID: [46831476](https://pubchem.ncbi.nlm.nih.gov/compound/46831476)")
st.markdown(f"IUPAC Name: N-cyclohexyl-N-methyl-4-(1-oxidopyridin-1-ium-3-yl)imidazole-1-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 46831476) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 46831476) ]
