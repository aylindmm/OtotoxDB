...
st.set_page_config(page_title="Indapamide", layout="wide")
st.title("Indapamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3702.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3702](https://pubchem.ncbi.nlm.nih.gov/compound/3702)")
st.markdown(f"IUPAC Name: 4-chloro-N-(2-methyl-2,3-dihydroindol-1-yl)-3-sulfamoylbenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3702) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3702) ]
