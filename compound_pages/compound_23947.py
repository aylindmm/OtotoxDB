...
st.set_page_config(page_title="Rhenium", layout="wide")
st.title("Rhenium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23947.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23947](https://pubchem.ncbi.nlm.nih.gov/compound/23947)")
st.markdown(f"IUPAC Name: rhenium")
...
df_filtered = sources[(sources["PubChem_CID"] == 23947) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23947) ]
