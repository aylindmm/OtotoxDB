...
st.set_page_config(page_title="Amonafide", layout="wide")
st.title("Amonafide")
...
df_filtered = sources[(sources["PubChem_CID"] == 50515) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 50515) ]
