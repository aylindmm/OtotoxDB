...
st.image(f"compound_structures/compound_439246.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 439246) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 439246) ]
