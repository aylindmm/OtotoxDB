...
st.set_page_config(page_title="Chromium", layout="wide")
st.title("Chromium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23976.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23976](https://pubchem.ncbi.nlm.nih.gov/compound/23976)")
st.markdown(f"IUPAC Name: chromium")
...
df_filtered = sources[(sources["PubChem_CID"] == 23976) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23976) ]
