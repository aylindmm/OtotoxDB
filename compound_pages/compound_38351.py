...
st.set_page_config(page_title="AMIKACIN SULFATE", layout="wide")
st.title("AMIKACIN SULFATE")
...
st.image(f"compound_structures/compound_38351.jpg", caption=f"SMILES: NCCC(O)C(=O)N[C@@H]1C[C@H](N)[C@@H](O[C@H]2O[C@H](CN)[C@@H](O)[C@H](O)[C@H]2O)[C@H](O)[C@H]1O[C@H]1O[C@H](CO)[C@@H](O)[C@H](N)[C@H]1O")
...
df_filtered = sources[(sources["PubChem_CID"] == 38351) ]
