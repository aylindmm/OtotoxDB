...
st.set_page_config(page_title="Sotalol", layout="wide")
st.title("Sotalol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5253.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5253](https://pubchem.ncbi.nlm.nih.gov/compound/5253)")
st.markdown(f"IUPAC Name: N-[4-[1-hydroxy-2-(propan-2-ylamino)ethyl]phenyl]methanesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5253) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5253) ]
