...
st.set_page_config(page_title="Bepridil", layout="wide")
st.title("Bepridil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2351.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2351](https://pubchem.ncbi.nlm.nih.gov/compound/2351)")
st.markdown(f"IUPAC Name: N-benzyl-N-[3-(2-methylpropoxy)-2-pyrrolidin-1-ylpropyl]aniline")
...
df_filtered = sources[(sources["PubChem_CID"] == 2351) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2351) ]
