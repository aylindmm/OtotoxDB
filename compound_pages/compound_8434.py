...
st.set_page_config(page_title="Ethylparaben", layout="wide")
st.title("Ethylparaben")
# Display the image in Streamlit
st.image(f"compound_structures/compound_8434.jpg", width=300)
st.markdown(f"PubChem Compound ID: [8434](https://pubchem.ncbi.nlm.nih.gov/compound/8434)")
st.markdown(f"IUPAC Name: ethyl 4-hydroxybenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 8434) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 8434) ]
