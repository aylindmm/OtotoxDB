...
st.set_page_config(page_title="Tp-434", layout="wide")
st.title("Tp-434")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54726192.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54726192](https://pubchem.ncbi.nlm.nih.gov/compound/54726192)")
st.markdown(f"IUPAC Name: (4S,4aS,5aR,12aR)-4-(dimethylamino)-7-fluoro-1,10,11,12a-tetrahydroxy-3,12-dioxo-9-[(2-pyrrolidin-1-ylacetyl)amino]-4a,5,5a,6-tetrahydro-4H-tetracene-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54726192) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54726192) ]
