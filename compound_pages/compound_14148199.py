...
st.set_page_config(page_title="Secobarbital sodium", layout="wide")
st.title("Secobarbital sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_14148199.jpg", width=300)
st.markdown(f"PubChem Compound ID: [14148199](https://pubchem.ncbi.nlm.nih.gov/compound/14148199)")
st.markdown(f"IUPAC Name: sodium 5-pentan-2-yl-5-prop-2-enylpyrimidin-3-ide-2,4,6-trione")
...
df_filtered = sources[(sources["PubChem_CID"] == 14148199) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 14148199) ]
