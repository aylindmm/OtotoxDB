...
st.set_page_config(page_title="Nitrofurantoin", layout="wide")
st.title("Nitrofurantoin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6604200.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6604200](https://pubchem.ncbi.nlm.nih.gov/compound/6604200)")
st.markdown(f"IUPAC Name: 1-[(E)-(5-nitrofuran-2-yl)methylideneamino]imidazolidine-2,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 6604200) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6604200) ]
