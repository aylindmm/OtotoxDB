...
st.set_page_config(page_title="Nintedanib", layout="wide")
st.title("Nintedanib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135423438.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135423438](https://pubchem.ncbi.nlm.nih.gov/compound/135423438)")
st.markdown(f"IUPAC Name: methyl 2-hydroxy-3-[N-[4-[methyl-[2-(4-methylpiperazin-1-yl)acetyl]amino]phenyl]-C-phenylcarbonimidoyl]-1H-indole-6-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 135423438) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135423438) ]
