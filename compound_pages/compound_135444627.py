...
st.set_page_config(page_title="Asoxime chloride", layout="wide")
st.title("Asoxime chloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135444627.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 135444627) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135444627) ]
