...
st.set_page_config(page_title="Ethylcholine aziridinium", layout="wide")
st.title("Ethylcholine aziridinium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_45414.jpg", width=300)
st.markdown(f"PubChem Compound ID: [45414](https://pubchem.ncbi.nlm.nih.gov/compound/45414)")
st.markdown(f"IUPAC Name: 2-(1-ethylaziridin-1-ium-1-yl)ethanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 45414) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 45414) ]
