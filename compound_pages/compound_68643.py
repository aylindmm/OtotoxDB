...
st.set_page_config(page_title="Betahistine hydrochloride", layout="wide")
st.title("Betahistine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68643.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68643](https://pubchem.ncbi.nlm.nih.gov/compound/68643)")
st.markdown(f"IUPAC Name: N-methyl-2-pyridin-2-ylethanamine;dihydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 68643) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68643) ]
