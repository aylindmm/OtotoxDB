...
st.image(f"compound_structures/compound_91820639.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 91820639) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 91820639) ]
