...
st.set_page_config(page_title="Etomidate", layout="wide")
st.title("Etomidate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_667484.jpg", width=300)
st.markdown(f"PubChem Compound ID: [667484](https://pubchem.ncbi.nlm.nih.gov/compound/667484)")
st.markdown(f"IUPAC Name: ethyl 3-[(1R)-1-phenylethyl]imidazole-4-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 667484) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 667484) ]
