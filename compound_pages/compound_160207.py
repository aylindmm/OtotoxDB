...
st.set_page_config(page_title="Glucarolactam", layout="wide")
st.title("Glucarolactam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_160207.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 160207) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 160207) ]
