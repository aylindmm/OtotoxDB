...
st.set_page_config(page_title="Apomorphine", layout="wide")
st.title("Apomorphine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6005.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6005](https://pubchem.ncbi.nlm.nih.gov/compound/6005)")
st.markdown(f"IUPAC Name: (6aR)-6-methyl-5,6,6a,7-tetrahydro-4H-dibenzo[de,g]quinoline-10,11-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 6005) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6005) ]
