...
st.set_page_config(page_title="Phorbol 12-myristate 13-acetate", layout="wide")
st.title("Phorbol 12-myristate 13-acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_27924.jpg", width=300)
st.markdown(f"PubChem Compound ID: [27924](https://pubchem.ncbi.nlm.nih.gov/compound/27924)")
st.markdown(f"IUPAC Name: [(1S,2S,6R,10S,11R,13S,14R,15R)-13-acetyloxy-1,6-dihydroxy-8-(hydroxymethyl)-4,12,12,15-tetramethyl-5-oxo-14-tetracyclo[8.5.0.02,6.011,13]pentadeca-3,8-dienyl] tetradecanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 27924) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 27924) ]
