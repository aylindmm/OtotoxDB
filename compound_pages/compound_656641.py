...
st.set_page_config(page_title="Polidocanol", layout="wide")
st.title("Polidocanol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_656641.jpg", width=300)
st.markdown(f"PubChem Compound ID: [656641](https://pubchem.ncbi.nlm.nih.gov/compound/656641)")
st.markdown(f"IUPAC Name: 2-[2-[2-[2-[2-[2-[2-[2-(2-dodecoxyethoxy)ethoxy]ethoxy]ethoxy]ethoxy]ethoxy]ethoxy]ethoxy]ethanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 656641) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 656641) ]
