...
st.set_page_config(page_title="Gacyclidine", layout="wide")
st.title("Gacyclidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 176265) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 176265) ]
