...
st.set_page_config(page_title="Canrenoic acid", layout="wide")
st.title("Canrenoic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_656615.jpg", width=300)
st.markdown(f"PubChem Compound ID: [656615](https://pubchem.ncbi.nlm.nih.gov/compound/656615)")
st.markdown(f"IUPAC Name: 3-[(8R,9S,10R,13S,14S,17R)-17-hydroxy-10,13-dimethyl-3-oxo-2,8,9,11,12,14,15,16-octahydro-1H-cyclopenta[a]phenanthren-17-yl]propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 656615) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 656615) ]
