...
st.set_page_config(page_title="Trifluoperazine", layout="wide")
st.title("Trifluoperazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5566.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5566](https://pubchem.ncbi.nlm.nih.gov/compound/5566)")
st.markdown(f"IUPAC Name: 10-[3-(4-methylpiperazin-1-yl)propyl]-2-(trifluoromethyl)phenothiazine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5566) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5566) ]
