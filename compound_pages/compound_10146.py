...
st.set_page_config(page_title="Nuciferine", layout="wide")
st.title("Nuciferine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10146.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10146](https://pubchem.ncbi.nlm.nih.gov/compound/10146)")
st.markdown(f"IUPAC Name: (6aR)-1,2-dimethoxy-6-methyl-5,6,6a,7-tetrahydro-4H-dibenzo[de,g]quinoline")
...
df_filtered = sources[(sources["PubChem_CID"] == 10146) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10146) ]
