...
st.set_page_config(page_title="P,p'-ddd", layout="wide")
st.title("P,p'-ddd")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6294.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6294](https://pubchem.ncbi.nlm.nih.gov/compound/6294)")
st.markdown(f"IUPAC Name: 1-chloro-4-[2,2-dichloro-1-(4-chlorophenyl)ethyl]benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 6294) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6294) ]
