...
st.set_page_config(page_title="Fumaric acid", layout="wide")
st.title("Fumaric acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_444972.jpg", width=300)
st.markdown(f"PubChem Compound ID: [444972](https://pubchem.ncbi.nlm.nih.gov/compound/444972)")
st.markdown(f"IUPAC Name: (E)-but-2-enedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 444972) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 444972) ]
