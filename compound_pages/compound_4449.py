...
st.set_page_config(page_title="Nefazodone", layout="wide")
st.title("Nefazodone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4449.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4449](https://pubchem.ncbi.nlm.nih.gov/compound/4449)")
st.markdown(f"IUPAC Name: 2-[3-[4-(3-chlorophenyl)piperazin-1-yl]propyl]-5-ethyl-4-(2-phenoxyethyl)-1,2,4-triazol-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 4449) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4449) ]
