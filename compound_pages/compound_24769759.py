...
st.set_page_config(page_title="Azvudine", layout="wide")
st.title("Azvudine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24769759.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24769759](https://pubchem.ncbi.nlm.nih.gov/compound/24769759)")
st.markdown(f"IUPAC Name: 4-amino-1-[(2R,3S,4R,5R)-5-azido-3-fluoro-4-hydroxy-5-(hydroxymethyl)oxolan-2-yl]pyrimidin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 24769759) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24769759) ]
