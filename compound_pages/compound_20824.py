...
st.set_page_config(page_title="Carbenicillin", layout="wide")
st.title("Carbenicillin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_20824.jpg", width=300)
st.markdown(f"PubChem Compound ID: [20824](https://pubchem.ncbi.nlm.nih.gov/compound/20824)")
st.markdown(f"IUPAC Name: (2S,5R,6R)-6-[(2-carboxy-2-phenylacetyl)amino]-3,3-dimethyl-7-oxo-4-thia-1-azabicyclo[3.2.0]heptane-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 20824) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 20824) ]
