...
st.set_page_config(page_title="Enbucrilate", layout="wide")
st.title("Enbucrilate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23087.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23087](https://pubchem.ncbi.nlm.nih.gov/compound/23087)")
st.markdown(f"IUPAC Name: butyl 2-cyanoprop-2-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23087) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23087) ]
