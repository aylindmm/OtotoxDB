...
st.set_page_config(page_title="Emtricitabine", layout="wide")
st.title("Emtricitabine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60877.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60877](https://pubchem.ncbi.nlm.nih.gov/compound/60877)")
st.markdown(f"IUPAC Name: 4-amino-5-fluoro-1-[(2R,5S)-2-(hydroxymethyl)-1,3-oxathiolan-5-yl]pyrimidin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 60877) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60877) ]
