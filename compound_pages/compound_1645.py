...
st.set_page_config(page_title="3-aminobenzamide", layout="wide")
st.title("3-aminobenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 1645) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1645) ]
