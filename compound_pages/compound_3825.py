...
st.set_page_config(page_title="Ketoprofen", layout="wide")
st.title("Ketoprofen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3825.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3825](https://pubchem.ncbi.nlm.nih.gov/compound/3825)")
st.markdown(f"IUPAC Name: 2-(3-benzoylphenyl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3825) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3825) ]
