...
st.set_page_config(page_title="Ormeloxifene", layout="wide")
st.title("Ormeloxifene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_35805.jpg", width=300)
st.markdown(f"PubChem Compound ID: [35805](https://pubchem.ncbi.nlm.nih.gov/compound/35805)")
st.markdown(f"IUPAC Name: 1-[2-[4-[(3R,4R)-7-methoxy-2,2-dimethyl-3-phenyl-3,4-dihydrochromen-4-yl]phenoxy]ethyl]pyrrolidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 35805) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 35805) ]
