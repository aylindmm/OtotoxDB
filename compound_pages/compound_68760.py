...
st.set_page_config(page_title="Brodimoprim", layout="wide")
st.title("Brodimoprim")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68760.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68760](https://pubchem.ncbi.nlm.nih.gov/compound/68760)")
st.markdown(f"IUPAC Name: 5-[(4-bromo-3,5-dimethoxyphenyl)methyl]pyrimidine-2,4-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 68760) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68760) ]
