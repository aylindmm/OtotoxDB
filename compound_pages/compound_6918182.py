...
st.set_page_config(page_title="Strontium ranelate", layout="wide")
st.title("Strontium ranelate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6918182.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6918182](https://pubchem.ncbi.nlm.nih.gov/compound/6918182)")
st.markdown(f"IUPAC Name: distrontium;5-[bis(carboxylatomethyl)amino]-3-(carboxylatomethyl)-4-cyanothiophene-2-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6918182) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6918182) ]
