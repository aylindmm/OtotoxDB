...
st.image(f"compound_structures/compound_135398738.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 135398738) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135398738) ]
