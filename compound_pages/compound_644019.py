...
st.set_page_config(page_title="Cannabidiol", layout="wide")
st.title("Cannabidiol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_644019.jpg", width=300)
st.markdown(f"PubChem Compound ID: [644019](https://pubchem.ncbi.nlm.nih.gov/compound/644019)")
st.markdown(f"IUPAC Name: 2-[(1R,6R)-3-methyl-6-prop-1-en-2-ylcyclohex-2-en-1-yl]-5-pentylbenzene-1,3-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 644019) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 644019) ]
