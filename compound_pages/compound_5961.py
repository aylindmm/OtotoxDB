...
st.set_page_config(page_title="L-glutamine", layout="wide")
st.title("L-glutamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5961.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5961](https://pubchem.ncbi.nlm.nih.gov/compound/5961)")
st.markdown(f"IUPAC Name: (2S)-2,5-diamino-5-oxopentanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5961) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5961) ]
