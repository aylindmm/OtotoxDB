...
st.set_page_config(page_title="Gatifloxacin", layout="wide")
st.title("Gatifloxacin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5379.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5379](https://pubchem.ncbi.nlm.nih.gov/compound/5379)")
st.markdown(f"IUPAC Name: 1-cyclopropyl-6-fluoro-8-methoxy-7-(3-methylpiperazin-1-yl)-4-oxoquinoline-3-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5379) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5379) ]
