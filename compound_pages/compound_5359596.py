...
st.set_page_config(page_title="Arsenic", layout="wide")
st.title("Arsenic")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5359596.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5359596](https://pubchem.ncbi.nlm.nih.gov/compound/5359596)")
st.markdown(f"IUPAC Name: arsenic")
...
df_filtered = sources[(sources["PubChem_CID"] == 5359596) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5359596) ]
