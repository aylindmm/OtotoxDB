...
st.set_page_config(page_title="Gadodiamide hydrate", layout="wide")
st.title("Gadodiamide hydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_76964236.jpg", width=300)
st.markdown(f"PubChem Compound ID: [76964236](https://pubchem.ncbi.nlm.nih.gov/compound/76964236)")
st.markdown(f"IUPAC Name: 2-[bis[2-[carboxylatomethyl-[2-(methylamino)-2-oxoethyl]amino]ethyl]amino]acetate;gadolinium(3+);trihydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 76964236) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 76964236) ]
