...
st.set_page_config(page_title="Proguanil", layout="wide")
st.title("Proguanil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6178111.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6178111](https://pubchem.ncbi.nlm.nih.gov/compound/6178111)")
st.markdown(f"IUPAC Name: (1E)-1-[amino-(4-chloroanilino)methylidene]-2-propan-2-ylguanidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 6178111) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6178111) ]
