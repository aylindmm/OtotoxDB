...
st.set_page_config(page_title="7,8-dihydroxyflavone", layout="wide")
st.title("7,8-dihydroxyflavone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1880.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1880](https://pubchem.ncbi.nlm.nih.gov/compound/1880)")
st.markdown(f"IUPAC Name: 7,8-dihydroxy-2-phenylchromen-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 1880) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1880) ]
