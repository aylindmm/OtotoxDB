...
st.set_page_config(page_title="Heptane", layout="wide")
st.title("Heptane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_8900.jpg", width=300)
st.markdown(f"PubChem Compound ID: [8900](https://pubchem.ncbi.nlm.nih.gov/compound/8900)")
st.markdown(f"IUPAC Name: heptane")
...
df_filtered = sources[(sources["PubChem_CID"] == 8900) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 8900) ]
