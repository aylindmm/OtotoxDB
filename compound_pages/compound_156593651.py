...
st.set_page_config(page_title="474922-77-5", layout="wide")
st.title("474922-77-5")
# Display the image in Streamlit
st.image(f"compound_structures/compound_156593651.jpg", width=300)
st.markdown(f"PubChem Compound ID: [156593651](https://pubchem.ncbi.nlm.nih.gov/compound/156593651)")
st.markdown(f"IUPAC Name: azane;[3-[hydroxy-[2-(2-methoxyethoxycarbonylamino)ethoxy]phosphoryl]oxy-2-octadecanoyloxypropyl] octadecanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 156593651) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 156593651) ]
