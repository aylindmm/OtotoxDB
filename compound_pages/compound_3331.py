...
st.set_page_config(page_title="Felbamate", layout="wide")
st.title("Felbamate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3331.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3331](https://pubchem.ncbi.nlm.nih.gov/compound/3331)")
st.markdown(f"IUPAC Name: (3-carbamoyloxy-2-phenylpropyl) carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 3331) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3331) ]
