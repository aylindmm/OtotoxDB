...
st.image(f"compound_structures/compound_9794159.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 9794159) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9794159) ]
