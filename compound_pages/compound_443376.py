...
st.set_page_config(page_title="Teprotide", layout="wide")
st.title("Teprotide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_443376.jpg", width=300)
st.markdown(f"PubChem Compound ID: [443376](https://pubchem.ncbi.nlm.nih.gov/compound/443376)")
st.markdown(f"IUPAC Name: (2S)-1-[(2S)-1-[(2S,3S)-2-[[(2S)-5-amino-2-[[(2S)-1-[(2S)-5-(diaminomethylideneamino)-2-[[(2S)-1-[(2S)-3-(1H-indol-3-yl)-2-[[(2S)-5-oxopyrrolidine-2-carbonyl]amino]propanoyl]pyrrolidine-2-carbonyl]amino]pentanoyl]pyrrolidine-2-carbonyl]amino]-5-oxopentanoyl]amino]-3-methylpentanoyl]pyrrolidine-2-carbonyl]pyrrolidine-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 443376) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 443376) ]
