...
st.set_page_config(page_title="Trigonelline", layout="wide")
st.title("Trigonelline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5570.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5570](https://pubchem.ncbi.nlm.nih.gov/compound/5570)")
st.markdown(f"IUPAC Name: 1-methylpyridin-1-ium-3-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5570) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5570) ]
