...
st.set_page_config(page_title="Hydroxycobalamin", layout="wide")
st.title("Hydroxycobalamin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16056828.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16056828](https://pubchem.ncbi.nlm.nih.gov/compound/16056828)")
st.markdown(f"IUPAC Name: cobalt(2+);[(2R,3S,4R,5S)-5-(5,6-dimethylbenzimidazol-1-yl)-4-hydroxy-2-(hydroxymethyl)oxolan-3-yl] [(2R)-1-[3-[(1R,2R,3R,4Z,7S,9Z,12S,13S,14Z,17S,18S,19R)-2,13,18-tris(2-amino-2-oxoethyl)-7,12,17-tris(3-amino-3-oxopropyl)-3,5,8,8,13,15,18,19-octamethyl-2,7,12,17-tetrahydro-1H-corrin-21-id-3-yl]propanoylamino]propan-2-yl] phosphate;hydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 16056828) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16056828) ]
