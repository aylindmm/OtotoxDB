...
st.set_page_config(page_title="Brexpiprazole", layout="wide")
st.title("Brexpiprazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11978813.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11978813](https://pubchem.ncbi.nlm.nih.gov/compound/11978813)")
st.markdown(f"IUPAC Name: 7-[4-[4-(1-benzothiophen-4-yl)piperazin-1-yl]butoxy]-1H-quinolin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 11978813) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11978813) ]
