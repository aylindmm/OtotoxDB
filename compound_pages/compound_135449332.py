...
st.set_page_config(page_title="Eltrombopag", layout="wide")
st.title("Eltrombopag")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135449332.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135449332](https://pubchem.ncbi.nlm.nih.gov/compound/135449332)")
st.markdown(f"IUPAC Name: 3-[3-[[2-(3,4-dimethylphenyl)-5-methyl-3-oxo-1H-pyrazol-4-yl]diazenyl]-2-hydroxyphenyl]benzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 135449332) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135449332) ]
