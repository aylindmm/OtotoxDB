...
st.set_page_config(page_title="Lisuride", layout="wide")
st.title("Lisuride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_28864.jpg", width=300)
st.markdown(f"PubChem Compound ID: [28864](https://pubchem.ncbi.nlm.nih.gov/compound/28864)")
st.markdown(f"IUPAC Name: 3-[(6aR,9S)-7-methyl-6,6a,8,9-tetrahydro-4H-indolo[4,3-fg]quinolin-9-yl]-1,1-diethylurea")
...
df_filtered = sources[(sources["PubChem_CID"] == 28864) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 28864) ]
