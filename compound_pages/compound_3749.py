...
st.set_page_config(page_title="Irbesartan", layout="wide")
st.title("Irbesartan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3749.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3749](https://pubchem.ncbi.nlm.nih.gov/compound/3749)")
st.markdown(f"IUPAC Name: 2-butyl-3-[[4-[2-(2H-tetrazol-5-yl)phenyl]phenyl]methyl]-1,3-diazaspiro[4.4]non-1-en-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3749) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3749) ]
