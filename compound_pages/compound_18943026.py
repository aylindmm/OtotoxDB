...
st.set_page_config(page_title="Enterosalil", layout="wide")
st.title("Enterosalil")
# Display the image in Streamlit
st.image(f"compound_structures/compound_18943026.jpg", width=300)
st.markdown(f"PubChem Compound ID: [18943026](https://pubchem.ncbi.nlm.nih.gov/compound/18943026)")
st.markdown(f"IUPAC Name: sodium 2-hydroxybenzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 18943026) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 18943026) ]
