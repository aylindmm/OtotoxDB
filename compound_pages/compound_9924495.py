...
st.set_page_config(page_title="Perampanel", layout="wide")
st.title("Perampanel")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9924495.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9924495](https://pubchem.ncbi.nlm.nih.gov/compound/9924495)")
st.markdown(f"IUPAC Name: 2-(2-oxo-1-phenyl-5-pyridin-2-yl-3-pyridinyl)benzonitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 9924495) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9924495) ]
