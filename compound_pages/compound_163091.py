...
st.set_page_config(page_title="Asenapine", layout="wide")
st.title("Asenapine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_163091.jpg", width=300)
st.markdown(f"PubChem Compound ID: [163091](https://pubchem.ncbi.nlm.nih.gov/compound/163091)")
st.markdown(f"IUPAC Name: (2S,6S)-9-chloro-4-methyl-13-oxa-4-azatetracyclo[12.4.0.02,6.07,12]octadeca-1(18),7(12),8,10,14,16-hexaene")
...
df_filtered = sources[(sources["PubChem_CID"] == 163091) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 163091) ]
