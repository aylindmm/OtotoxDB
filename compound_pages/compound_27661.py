...
st.set_page_config(page_title="Isosorbide mononitrate", layout="wide")
st.title("Isosorbide mononitrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_27661.jpg", width=300)
st.markdown(f"PubChem Compound ID: [27661](https://pubchem.ncbi.nlm.nih.gov/compound/27661)")
st.markdown(f"IUPAC Name: [(3S,3aR,6R,6aS)-3-hydroxy-2,3,3a,5,6,6a-hexahydrofuro[3,2-b]furan-6-yl] nitrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 27661) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 27661) ]
