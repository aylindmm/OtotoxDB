...
st.set_page_config(page_title="Ledipasvir and sofosbuvir", layout="wide")
st.title("Ledipasvir and sofosbuvir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_72734365.jpg", width=300)
st.markdown(f"PubChem Compound ID: [72734365](https://pubchem.ncbi.nlm.nih.gov/compound/72734365)")
st.markdown(f"IUPAC Name: methyl N-[(2S)-1-[(6S)-6-[5-[9,9-difluoro-7-[2-[(1R,3S,4S)-2-[(2S)-2-(methoxycarbonylamino)-3-methylbutanoyl]-2-azabicyclo[2.2.1]heptan-3-yl]-3H-benzimidazol-5-yl]fluoren-2-yl]-1H-imidazol-2-yl]-5-azaspiro[2.4]heptan-5-yl]-3-methyl-1-oxobutan-2-yl]carbamate;propan-2-yl (2S)-2-[[[(2R,3R,4R,5R)-5-(2,4-dioxopyrimidin-1-yl)-4-fluoro-3-hydroxy-4-methyloxolan-2-yl]methoxy-phenoxyphosphoryl]amino]propanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 72734365) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 72734365) ]
