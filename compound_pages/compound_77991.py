...
st.set_page_config(page_title="Rivastigmine", layout="wide")
st.title("Rivastigmine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_77991.jpg", width=300)
st.markdown(f"PubChem Compound ID: [77991](https://pubchem.ncbi.nlm.nih.gov/compound/77991)")
st.markdown(f"IUPAC Name: [3-[(1S)-1-(dimethylamino)ethyl]phenyl] N-ethyl-N-methylcarbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 77991) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 77991) ]
