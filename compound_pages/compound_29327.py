...
st.set_page_config(page_title="Streptozocin", layout="wide")
st.title("Streptozocin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_29327.jpg", width=300)
st.markdown(f"PubChem Compound ID: [29327](https://pubchem.ncbi.nlm.nih.gov/compound/29327)")
st.markdown(f"IUPAC Name: 1-methyl-1-nitroso-3-[(2S,3R,4R,5S,6R)-2,4,5-trihydroxy-6-(hydroxymethyl)oxan-3-yl]urea")
...
df_filtered = sources[(sources["PubChem_CID"] == 29327) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 29327) ]
