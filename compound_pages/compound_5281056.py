...
st.set_page_config(page_title="Timolol maleate", layout="wide")
st.title("Timolol maleate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281056.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281056](https://pubchem.ncbi.nlm.nih.gov/compound/5281056)")
st.markdown(f"IUPAC Name: (Z)-but-2-enedioic acid;(2S)-1-(tert-butylamino)-3-[(4-morpholin-4-yl-1,2,5-thiadiazol-3-yl)oxy]propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281056) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281056) ]
