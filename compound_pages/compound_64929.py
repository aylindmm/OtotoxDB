...
st.set_page_config(page_title="Fenofibric acid", layout="wide")
st.title("Fenofibric acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_64929.jpg", width=300)
st.markdown(f"PubChem Compound ID: [64929](https://pubchem.ncbi.nlm.nih.gov/compound/64929)")
st.markdown(f"IUPAC Name: 2-[4-(4-chlorobenzoyl)phenoxy]-2-methylpropanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 64929) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 64929) ]
