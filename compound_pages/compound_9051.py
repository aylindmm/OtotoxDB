...
st.set_page_config(page_title="Dydrogesterone", layout="wide")
st.title("Dydrogesterone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9051.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9051](https://pubchem.ncbi.nlm.nih.gov/compound/9051)")
st.markdown(f"IUPAC Name: (8S,9R,10S,13S,14S,17S)-17-acetyl-10,13-dimethyl-1,2,8,9,11,12,14,15,16,17-decahydrocyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 9051) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9051) ]
