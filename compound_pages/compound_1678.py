...
st.set_page_config(page_title="3-nitropropionic acid", layout="wide")
st.title("3-nitropropionic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1678.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1678](https://pubchem.ncbi.nlm.nih.gov/compound/1678)")
st.markdown(f"IUPAC Name: 3-nitropropanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 1678) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1678) ]
