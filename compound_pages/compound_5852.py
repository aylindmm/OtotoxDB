...
st.set_page_config(page_title="D-penicillamine", layout="wide")
st.title("D-penicillamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5852.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5852](https://pubchem.ncbi.nlm.nih.gov/compound/5852)")
st.markdown(f"IUPAC Name: (2S)-2-amino-3-methyl-3-sulfanylbutanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5852) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5852) ]
