...
st.set_page_config(page_title="Danazol", layout="wide")
st.title("Danazol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_28417.jpg", width=300)
st.markdown(f"PubChem Compound ID: [28417](https://pubchem.ncbi.nlm.nih.gov/compound/28417)")
st.markdown(f"IUPAC Name: (1S,2R,13R,14S,17R,18S)-17-ethynyl-2,18-dimethyl-7-oxa-6-azapentacyclo[11.7.0.02,10.04,8.014,18]icosa-4(8),5,9-trien-17-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 28417) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 28417) ]
