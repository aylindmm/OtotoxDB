...
st.set_page_config(page_title="Urea hydrogen peroxide", layout="wide")
st.title("Urea hydrogen peroxide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_31294.jpg", width=300)
st.markdown(f"PubChem Compound ID: [31294](https://pubchem.ncbi.nlm.nih.gov/compound/31294)")
st.markdown(f"IUPAC Name: hydrogen peroxide;urea")
...
df_filtered = sources[(sources["PubChem_CID"] == 31294) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 31294) ]
