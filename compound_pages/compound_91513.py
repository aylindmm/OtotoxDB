...
st.set_page_config(page_title="Hydroxyzine dihydrochloride", layout="wide")
st.title("Hydroxyzine dihydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_91513.jpg", width=300)
st.markdown(f"PubChem Compound ID: [91513](https://pubchem.ncbi.nlm.nih.gov/compound/91513)")
st.markdown(f"IUPAC Name: 2-[2-[4-[(4-chlorophenyl)-phenylmethyl]piperazin-1-yl]ethoxy]ethanol;dihydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 91513) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 91513) ]
