...
st.set_page_config(page_title="Thallium", layout="wide")
st.title("Thallium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5359464.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5359464](https://pubchem.ncbi.nlm.nih.gov/compound/5359464)")
st.markdown(f"IUPAC Name: thallium")
...
df_filtered = sources[(sources["PubChem_CID"] == 5359464) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5359464) ]
