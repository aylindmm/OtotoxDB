...
st.set_page_config(page_title="Bupropion hydrochloride", layout="wide")
st.title("Bupropion hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_62884.jpg", width=300)
st.markdown(f"PubChem Compound ID: [62884](https://pubchem.ncbi.nlm.nih.gov/compound/62884)")
st.markdown(f"IUPAC Name: 2-(tert-butylamino)-1-(3-chlorophenyl)propan-1-one;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 62884) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 62884) ]
