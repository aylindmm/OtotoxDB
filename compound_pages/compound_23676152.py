...
st.set_page_config(page_title="Pentobarbital sodium", layout="wide")
st.title("Pentobarbital sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23676152.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23676152](https://pubchem.ncbi.nlm.nih.gov/compound/23676152)")
st.markdown(f"IUPAC Name: sodium 5-ethyl-4,6-dioxo-5-pentan-2-yl-1H-pyrimidin-2-olate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23676152) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23676152) ]
