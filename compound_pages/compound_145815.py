...
st.set_page_config(page_title="D-glutamine", layout="wide")
st.title("D-glutamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 145815) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 145815) ]
