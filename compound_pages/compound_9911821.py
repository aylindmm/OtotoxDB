...
st.set_page_config(page_title="Psd502", layout="wide")
st.title("Psd502")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9911821.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9911821](https://pubchem.ncbi.nlm.nih.gov/compound/9911821)")
st.markdown(f"IUPAC Name: 2-(diethylamino)-N-(2,6-dimethylphenyl)acetamide;N-(2-methylphenyl)-2-(propylamino)propanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9911821) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9911821) ]
