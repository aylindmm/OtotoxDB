...
st.set_page_config(page_title="Tetraethyllead", layout="wide")
st.title("Tetraethyllead")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6511.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6511](https://pubchem.ncbi.nlm.nih.gov/compound/6511)")
st.markdown(f"IUPAC Name: tetraethylplumbane")
...
df_filtered = sources[(sources["PubChem_CID"] == 6511) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6511) ]
