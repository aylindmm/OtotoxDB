...
st.set_page_config(page_title="Etretinate", layout="wide")
st.title("Etretinate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5282375.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5282375](https://pubchem.ncbi.nlm.nih.gov/compound/5282375)")
st.markdown(f"IUPAC Name: ethyl (2E,4E,6E,8E)-9-(4-methoxy-2,3,6-trimethylphenyl)-3,7-dimethylnona-2,4,6,8-tetraenoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5282375) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5282375) ]
