...
st.set_page_config(page_title="Sulfisoxazole", layout="wide")
st.title("Sulfisoxazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5344.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5344](https://pubchem.ncbi.nlm.nih.gov/compound/5344)")
st.markdown(f"IUPAC Name: 4-amino-N-(3,4-dimethyl-1,2-oxazol-5-yl)benzenesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5344) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5344) ]
