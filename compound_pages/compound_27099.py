...
st.set_page_config(page_title="Cupric ion", layout="wide")
st.title("Cupric ion")
# Display the image in Streamlit
st.image(f"compound_structures/compound_27099.jpg", width=300)
st.markdown(f"PubChem Compound ID: [27099](https://pubchem.ncbi.nlm.nih.gov/compound/27099)")
st.markdown(f"IUPAC Name: copper(2+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 27099) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 27099) ]
