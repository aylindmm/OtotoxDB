...
st.set_page_config(page_title="Piperaquine", layout="wide")
st.title("Piperaquine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_122262.jpg", width=300)
st.markdown(f"PubChem Compound ID: [122262](https://pubchem.ncbi.nlm.nih.gov/compound/122262)")
st.markdown(f"IUPAC Name: 7-chloro-4-[4-[3-[4-(7-chloroquinolin-4-yl)piperazin-1-yl]propyl]piperazin-1-yl]quinoline")
...
df_filtered = sources[(sources["PubChem_CID"] == 122262) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 122262) ]
