...
st.set_page_config(page_title="Phenytoin sodium", layout="wide")
st.title("Phenytoin sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_657302.jpg", width=300)
st.markdown(f"PubChem Compound ID: [657302](https://pubchem.ncbi.nlm.nih.gov/compound/657302)")
st.markdown(f"IUPAC Name: sodium 5,5-diphenylimidazolidin-3-ide-2,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 657302) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 657302) ]
