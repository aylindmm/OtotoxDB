...
st.set_page_config(page_title="Helium", layout="wide")
st.title("Helium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23987.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23987](https://pubchem.ncbi.nlm.nih.gov/compound/23987)")
st.markdown(f"IUPAC Name: helium")
...
df_filtered = sources[(sources["PubChem_CID"] == 23987) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23987) ]
