...
st.set_page_config(page_title="182563-08-2", layout="wide")
st.title("182563-08-2")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5311258.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5311258](https://pubchem.ncbi.nlm.nih.gov/compound/5311258)")
st.markdown(f"IUPAC Name: 4-fluoro-N-[3-(1-methylpiperidin-4-yl)-1H-indol-5-yl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5311258) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5311258) ]
