...
st.set_page_config(page_title="Nefopam", layout="wide")
st.title("Nefopam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4450.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4450](https://pubchem.ncbi.nlm.nih.gov/compound/4450)")
st.markdown(f"IUPAC Name: 5-methyl-1-phenyl-1,3,4,6-tetrahydro-2,5-benzoxazocine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4450) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4450) ]
