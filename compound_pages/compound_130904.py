...
st.set_page_config(page_title="Ulipristal acetate", layout="wide")
st.title("Ulipristal acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_130904.jpg", width=300)
st.markdown(f"PubChem Compound ID: [130904](https://pubchem.ncbi.nlm.nih.gov/compound/130904)")
st.markdown(f"IUPAC Name: [(8S,11R,13S,14S,17R)-17-acetyl-11-[4-(dimethylamino)phenyl]-13-methyl-3-oxo-1,2,6,7,8,11,12,14,15,16-decahydrocyclopenta[a]phenanthren-17-yl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 130904) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 130904) ]
