...
st.set_page_config(page_title="Chlorpheniramine", layout="wide")
st.title("Chlorpheniramine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2725.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2725](https://pubchem.ncbi.nlm.nih.gov/compound/2725)")
st.markdown(f"IUPAC Name: 3-(4-chlorophenyl)-N,N-dimethyl-3-pyridin-2-ylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2725) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2725) ]
