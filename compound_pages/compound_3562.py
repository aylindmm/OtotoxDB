...
st.set_page_config(page_title="Halothane", layout="wide")
st.title("Halothane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3562.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3562](https://pubchem.ncbi.nlm.nih.gov/compound/3562)")
st.markdown(f"IUPAC Name: 2-bromo-2-chloro-1,1,1-trifluoroethane")
...
df_filtered = sources[(sources["PubChem_CID"] == 3562) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3562) ]
