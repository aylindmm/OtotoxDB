...
st.set_page_config(page_title="Imiquimod", layout="wide")
st.title("Imiquimod")
# Display the image in Streamlit
st.image(f"compound_structures/compound_57469.jpg", width=300)
st.markdown(f"PubChem Compound ID: [57469](https://pubchem.ncbi.nlm.nih.gov/compound/57469)")
st.markdown(f"IUPAC Name: 1-(2-methylpropyl)imidazo[4,5-c]quinolin-4-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 57469) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 57469) ]
