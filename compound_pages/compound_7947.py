...
st.set_page_config(page_title="Mesitylene", layout="wide")
st.title("Mesitylene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7947.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7947](https://pubchem.ncbi.nlm.nih.gov/compound/7947)")
st.markdown(f"IUPAC Name: 1,3,5-trimethylbenzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 7947) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7947) ]
