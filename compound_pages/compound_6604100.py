...
st.set_page_config(page_title="Dantrolene sodium", layout="wide")
st.title("Dantrolene sodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6604100.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6604100](https://pubchem.ncbi.nlm.nih.gov/compound/6604100)")
st.markdown(f"IUPAC Name: sodium 3-[(E)-[5-(4-nitrophenyl)furan-2-yl]methylideneamino]-2-oxo-4H-imidazol-5-olate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6604100) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6604100) ]
