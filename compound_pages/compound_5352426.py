...
st.set_page_config(page_title="7440-31-5", layout="wide")
st.title("7440-31-5")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5352426.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5352426](https://pubchem.ncbi.nlm.nih.gov/compound/5352426)")
st.markdown(f"IUPAC Name: tin")
...
df_filtered = sources[(sources["PubChem_CID"] == 5352426) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5352426) ]
