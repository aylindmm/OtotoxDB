...
st.set_page_config(page_title="2-aminopyridine", layout="wide")
st.title("2-aminopyridine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10439.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10439](https://pubchem.ncbi.nlm.nih.gov/compound/10439)")
st.markdown(f"IUPAC Name: pyridin-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 10439) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10439) ]
