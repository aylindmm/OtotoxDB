...
st.set_page_config(page_title="Ropivacaine", layout="wide")
st.title("Ropivacaine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_175805.jpg", width=300)
st.markdown(f"PubChem Compound ID: [175805](https://pubchem.ncbi.nlm.nih.gov/compound/175805)")
st.markdown(f"IUPAC Name: (2S)-N-(2,6-dimethylphenyl)-1-propylpiperidine-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 175805) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 175805) ]
