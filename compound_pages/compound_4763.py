...
st.set_page_config(page_title="Phenobarbital", layout="wide")
st.title("Phenobarbital")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4763.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4763](https://pubchem.ncbi.nlm.nih.gov/compound/4763)")
st.markdown(f"IUPAC Name: 5-ethyl-5-phenyl-1,3-diazinane-2,4,6-trione")
...
df_filtered = sources[(sources["PubChem_CID"] == 4763) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4763) ]
