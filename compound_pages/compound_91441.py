...
st.set_page_config(page_title="Chloroquine sulfate", layout="wide")
st.title("Chloroquine sulfate")
...
df_filtered = sources[(sources["PubChem_CID"] == 91441) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 91441) ]
