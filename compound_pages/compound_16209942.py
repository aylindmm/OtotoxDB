...
st.set_page_config(page_title="Sn50", layout="wide")
st.title("Sn50")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16209942.jpg", width=300)
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16209942) ]
