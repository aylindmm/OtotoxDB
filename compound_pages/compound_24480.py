...
st.set_page_config(page_title="Refchem:809821", layout="wide")
st.title("Refchem:809821")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24480.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24480](https://pubchem.ncbi.nlm.nih.gov/compound/24480)")
st.markdown(f"IUPAC Name: dichloromanganese")
...
df_filtered = sources[(sources["PubChem_CID"] == 24480) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24480) ]
