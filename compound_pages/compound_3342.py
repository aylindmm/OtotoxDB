...
st.set_page_config(page_title="Fenoprofen", layout="wide")
st.title("Fenoprofen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3342.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3342](https://pubchem.ncbi.nlm.nih.gov/compound/3342)")
st.markdown(f"IUPAC Name: 2-(3-phenoxyphenyl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3342) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3342) ]
