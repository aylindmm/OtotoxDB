...
st.set_page_config(page_title="Fenfluramine", layout="wide")
st.title("Fenfluramine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3337.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3337](https://pubchem.ncbi.nlm.nih.gov/compound/3337)")
st.markdown(f"IUPAC Name: N-ethyl-1-[3-(trifluoromethyl)phenyl]propan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3337) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3337) ]
