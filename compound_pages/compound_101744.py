...
st.image(f"compound_structures/compound_101744.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 101744) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 101744) ]
