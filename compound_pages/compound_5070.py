...
st.set_page_config(page_title="Riluzole", layout="wide")
st.title("Riluzole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5070.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5070](https://pubchem.ncbi.nlm.nih.gov/compound/5070)")
st.markdown(f"IUPAC Name: 6-(trifluoromethoxy)-1,3-benzothiazol-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5070) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5070) ]
