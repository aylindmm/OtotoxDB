...
st.set_page_config(page_title="Fluphenazine", layout="wide")
st.title("Fluphenazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3372.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3372](https://pubchem.ncbi.nlm.nih.gov/compound/3372)")
st.markdown(f"IUPAC Name: 2-[4-[3-[2-(trifluoromethyl)phenothiazin-10-yl]propyl]piperazin-1-yl]ethanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3372) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3372) ]
