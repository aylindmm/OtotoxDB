...
st.set_page_config(page_title="Nicotinamide riboside", layout="wide")
st.title("Nicotinamide riboside")
# Display the image in Streamlit
st.image(f"compound_structures/compound_439924.jpg", width=300)
st.markdown(f"PubChem Compound ID: [439924](https://pubchem.ncbi.nlm.nih.gov/compound/439924)")
st.markdown(f"IUPAC Name: 1-[(2R,3R,4S,5R)-3,4-dihydroxy-5-(hydroxymethyl)oxolan-2-yl]pyridin-1-ium-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 439924) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 439924) ]
