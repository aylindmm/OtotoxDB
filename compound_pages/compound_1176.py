...
st.set_page_config(page_title="Urea", layout="wide")
st.title("Urea")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1176.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1176](https://pubchem.ncbi.nlm.nih.gov/compound/1176)")
st.markdown(f"IUPAC Name: urea")
...
df_filtered = sources[(sources["PubChem_CID"] == 1176) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1176) ]
