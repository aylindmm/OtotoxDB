...
st.set_page_config(page_title="Miglitol", layout="wide")
st.title("Miglitol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_441314.jpg", width=300)
st.markdown(f"PubChem Compound ID: [441314](https://pubchem.ncbi.nlm.nih.gov/compound/441314)")
st.markdown(f"IUPAC Name: (2R,3R,4R,5S)-1-(2-hydroxyethyl)-2-(hydroxymethyl)piperidine-3,4,5-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 441314) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 441314) ]
