...
st.set_page_config(page_title="3,4-dihydroxybenzoic acid", layout="wide")
st.title("3,4-dihydroxybenzoic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_72.jpg", width=300)
st.markdown(f"PubChem Compound ID: [72](https://pubchem.ncbi.nlm.nih.gov/compound/72)")
st.markdown(f"IUPAC Name: 3,4-dihydroxybenzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 72) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 72) ]
