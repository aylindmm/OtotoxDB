...
st.set_page_config(page_title="Atenolol", layout="wide")
st.title("Atenolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2249.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2249](https://pubchem.ncbi.nlm.nih.gov/compound/2249)")
st.markdown(f"IUPAC Name: 2-[4-[2-hydroxy-3-(propan-2-ylamino)propoxy]phenyl]acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2249) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2249) ]
