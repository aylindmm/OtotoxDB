...
st.image(f"compound_structures/compound_6610341.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 6610341) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6610341) ]
