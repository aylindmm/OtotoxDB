...
st.set_page_config(page_title="Atropine sulfate", layout="wide")
st.title("Atropine sulfate")
...
df_filtered = sources[(sources["PubChem_CID"] == 60196398) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60196398) ]
