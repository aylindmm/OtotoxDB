...
st.set_page_config(page_title="Prototype ganglioside", layout="wide")
st.title("Prototype ganglioside")
# Display the image in Streamlit
st.image(f"compound_structures/compound_172642652.jpg", width=300)
st.markdown(f"PubChem Compound ID: [172642652](https://pubchem.ncbi.nlm.nih.gov/compound/172642652)")
st.markdown(f"IUPAC Name: sodium N-[(E,2S,3R)-1-[(2R,4R,5S)-5-[(2S,4R,5S)-5-[(2S,4R,5R)-3-acetamido-5-hydroxy-6-(hydroxymethyl)-4-[(2R,4S,5R)-3,4,5-trihydroxy-6-(hydroxymethyl)oxan-2-yl]oxyoxan-2-yl]oxy-4-[(2R,5R)-5-acetamido-4-hydroxy-2-methyl-6-[(2R)-1,2,3-trihydroxypropyl]oxan-2-yl]oxy-3-hydroxy-6-(hydroxymethyl)oxan-2-yl]oxy-3,4-dihydroxy-6-(hydroxymethyl)oxan-2-yl]oxy-3-hydroxyoctadec-4-en-2-yl]octadecanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 172642652) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 172642652) ]
