...
st.set_page_config(page_title="Propylparaben", layout="wide")
st.title("Propylparaben")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7175.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7175](https://pubchem.ncbi.nlm.nih.gov/compound/7175)")
st.markdown(f"IUPAC Name: propyl 4-hydroxybenzoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 7175) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7175) ]
