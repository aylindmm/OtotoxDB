...
st.set_page_config(page_title="Calcium citrate tetrahydrate", layout="wide")
st.title("Calcium citrate tetrahydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5282392.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5282392](https://pubchem.ncbi.nlm.nih.gov/compound/5282392)")
st.markdown(f"IUPAC Name: tricalcium;bis(2-hydroxypropane-1,2,3-tricarboxylate);tetrahydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5282392) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5282392) ]
