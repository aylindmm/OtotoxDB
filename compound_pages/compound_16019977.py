...
st.set_page_config(page_title="Thallous chloride tl-201", layout="wide")
st.title("Thallous chloride tl-201")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16019977.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16019977](https://pubchem.ncbi.nlm.nih.gov/compound/16019977)")
st.markdown(f"IUPAC Name: chloro(201Tl)thallium-201")
...
df_filtered = sources[(sources["PubChem_CID"] == 16019977) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16019977) ]
