...
st.set_page_config(page_title="Pirfenidone", layout="wide")
st.title("Pirfenidone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_40632.jpg", width=300)
st.markdown(f"PubChem Compound ID: [40632](https://pubchem.ncbi.nlm.nih.gov/compound/40632)")
st.markdown(f"IUPAC Name: 5-methyl-1-phenylpyridin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 40632) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 40632) ]
