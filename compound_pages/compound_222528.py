...
st.set_page_config(page_title="Deoxycholic acid", layout="wide")
st.title("Deoxycholic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_222528.jpg", width=300)
st.markdown(f"PubChem Compound ID: [222528](https://pubchem.ncbi.nlm.nih.gov/compound/222528)")
st.markdown(f"IUPAC Name: (4R)-4-[(3R,5R,8R,9S,10S,12S,13R,14S,17R)-3,12-dihydroxy-10,13-dimethyl-2,3,4,5,6,7,8,9,11,12,14,15,16,17-tetradecahydro-1H-cyclopenta[a]phenanthren-17-yl]pentanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 222528) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 222528) ]
