...
st.set_page_config(page_title="Amphetamine", layout="wide")
st.title("Amphetamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3007.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3007](https://pubchem.ncbi.nlm.nih.gov/compound/3007)")
st.markdown(f"IUPAC Name: 1-phenylpropan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3007) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3007) ]
