...
st.set_page_config(page_title="Propylbenzene", layout="wide")
st.title("Propylbenzene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7668.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7668](https://pubchem.ncbi.nlm.nih.gov/compound/7668)")
st.markdown(f"IUPAC Name: propylbenzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 7668) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7668) ]
