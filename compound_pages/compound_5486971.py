...
st.set_page_config(page_title="Pregabalin", layout="wide")
st.title("Pregabalin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5486971.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5486971](https://pubchem.ncbi.nlm.nih.gov/compound/5486971)")
st.markdown(f"IUPAC Name: (3S)-3-(aminomethyl)-5-methylhexanoic acid")
st.markdown(f"Score: 0.32844871147044")
...
df_filtered = sources[(sources["PubChem_CID"] == 5486971) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5486971) ]
