...
st.set_page_config(page_title="Pterostilbene", layout="wide")
st.title("Pterostilbene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281727.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281727](https://pubchem.ncbi.nlm.nih.gov/compound/5281727)")
st.markdown(f"IUPAC Name: 4-[(E)-2-(3,5-dimethoxyphenyl)ethenyl]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281727) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281727) ]
