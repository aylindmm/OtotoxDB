...
st.set_page_config(page_title="Benzodiazepine", layout="wide")
st.title("Benzodiazepine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_134664.jpg", width=300)
st.markdown(f"PubChem Compound ID: [134664](https://pubchem.ncbi.nlm.nih.gov/compound/134664)")
st.markdown(f"IUPAC Name: 1H-1,2-benzodiazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 134664) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 134664) ]
