...
st.set_page_config(page_title="4-aminopyridine", layout="wide")
st.title("4-aminopyridine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1727.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1727](https://pubchem.ncbi.nlm.nih.gov/compound/1727)")
st.markdown(f"IUPAC Name: pyridin-4-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 1727) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1727) ]
