...
st.set_page_config(page_title="Bensulide", layout="wide")
st.title("Bensulide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_12932.jpg", width=300)
st.markdown(f"PubChem Compound ID: [12932](https://pubchem.ncbi.nlm.nih.gov/compound/12932)")
st.markdown(f"IUPAC Name: N-[2-di(propan-2-yloxy)phosphinothioylsulfanylethyl]benzenesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 12932) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 12932) ]
