...
st.set_page_config(page_title="Tetrabutylammonium bromide", layout="wide")
st.title("Tetrabutylammonium bromide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_74236.jpg", width=300)
st.markdown(f"PubChem Compound ID: [74236](https://pubchem.ncbi.nlm.nih.gov/compound/74236)")
st.markdown(f"IUPAC Name: tetrabutylazanium bromide")
...
df_filtered = sources[(sources["PubChem_CID"] == 74236) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 74236) ]
