...
st.set_page_config(page_title="4345-03-3", layout="wide")
st.title("4345-03-3")
# Display the image in Streamlit
st.image(f"compound_structures/compound_20353.jpg", width=300)
st.markdown(f"PubChem Compound ID: [20353](https://pubchem.ncbi.nlm.nih.gov/compound/20353)")
st.markdown(f"IUPAC Name: 4-oxo-4-[[(2R)-2,5,7,8-tetramethyl-2-[(4R,8R)-4,8,12-trimethyltridecyl]-3,4-dihydrochromen-6-yl]oxy]butanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 20353) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 20353) ]
