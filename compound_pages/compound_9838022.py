...
st.set_page_config(page_title="Tapentadol", layout="wide")
st.title("Tapentadol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9838022.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9838022](https://pubchem.ncbi.nlm.nih.gov/compound/9838022)")
st.markdown(f"IUPAC Name: 3-[(2R,3R)-1-(dimethylamino)-2-methylpentan-3-yl]phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 9838022) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9838022) ]
