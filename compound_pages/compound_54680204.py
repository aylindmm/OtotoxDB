...
st.set_page_config(page_title="Sch-37224", layout="wide")
st.title("Sch-37224")
...
df_filtered = sources[(sources["PubChem_CID"] == 54680204) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54680204) ]
