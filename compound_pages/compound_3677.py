...
st.set_page_config(page_title="Mephentermine", layout="wide")
st.title("Mephentermine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3677.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3677](https://pubchem.ncbi.nlm.nih.gov/compound/3677)")
st.markdown(f"IUPAC Name: N,2-dimethyl-1-phenylpropan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3677) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3677) ]
