...
st.set_page_config(page_title="Leonurine", layout="wide")
st.title("Leonurine")
...
df_filtered = sources[(sources["PubChem_CID"] == 161464) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 161464) ]
