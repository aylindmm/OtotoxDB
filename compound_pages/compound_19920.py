...
st.set_page_config(page_title="Glycidyl isopropyl ether", layout="wide")
st.title("Glycidyl isopropyl ether")
# Display the image in Streamlit
st.image(f"compound_structures/compound_19920.jpg", width=300)
st.markdown(f"PubChem Compound ID: [19920](https://pubchem.ncbi.nlm.nih.gov/compound/19920)")
st.markdown(f"IUPAC Name: 2-(propan-2-yloxymethyl)oxirane")
...
df_filtered = sources[(sources["PubChem_CID"] == 19920) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 19920) ]
