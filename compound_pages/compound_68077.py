...
st.set_page_config(page_title="Tangeretin", layout="wide")
st.title("Tangeretin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68077.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68077](https://pubchem.ncbi.nlm.nih.gov/compound/68077)")
st.markdown(f"IUPAC Name: 5,6,7,8-tetramethoxy-2-(4-methoxyphenyl)chromen-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 68077) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68077) ]
