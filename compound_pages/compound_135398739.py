...
st.set_page_config(page_title="Didanosine", layout="wide")
st.title("Didanosine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135398739.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135398739](https://pubchem.ncbi.nlm.nih.gov/compound/135398739)")
st.markdown(f"IUPAC Name: 9-[(2R,5S)-5-(hydroxymethyl)oxolan-2-yl]-1H-purin-6-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 135398739) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135398739) ]
