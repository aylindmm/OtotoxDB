...
st.set_page_config(page_title="Fluperlapine", layout="wide")
st.title("Fluperlapine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_49381.jpg", width=300)
st.markdown(f"PubChem Compound ID: [49381](https://pubchem.ncbi.nlm.nih.gov/compound/49381)")
st.markdown(f"IUPAC Name: 3-fluoro-6-(4-methylpiperazin-1-yl)-11H-benzo[c][1]benzazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 49381) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 49381) ]
