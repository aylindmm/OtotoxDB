...
st.set_page_config(page_title="Hydromorphone", layout="wide")
st.title("Hydromorphone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284570.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284570](https://pubchem.ncbi.nlm.nih.gov/compound/5284570)")
st.markdown(f"IUPAC Name: (4R,4aR,7aR,12bS)-9-hydroxy-3-methyl-1,2,4,4a,5,6,7a,13-octahydro-4,12-methanobenzofuro[3,2-e]isoquinolin-7-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284570) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284570) ]
