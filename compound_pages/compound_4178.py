...
st.set_page_config(page_title="Mexiletine", layout="wide")
st.title("Mexiletine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4178.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4178](https://pubchem.ncbi.nlm.nih.gov/compound/4178)")
st.markdown(f"IUPAC Name: 1-(2,6-dimethylphenoxy)propan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4178) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4178) ]
