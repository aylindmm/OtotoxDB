...
st.set_page_config(page_title="Ubrogepant", layout="wide")
st.title("Ubrogepant")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68748835.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68748835](https://pubchem.ncbi.nlm.nih.gov/compound/68748835)")
st.markdown(f"IUPAC Name: (3S)-N-[(3S,5S,6R)-6-methyl-2-oxo-5-phenyl-1-(2,2,2-trifluoroethyl)piperidin-3-yl]-2-oxospiro[1H-pyrrolo[2,3-b]pyridine-3,6'-5,7-dihydrocyclopenta[b]pyridine]-3'-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 68748835) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68748835) ]
