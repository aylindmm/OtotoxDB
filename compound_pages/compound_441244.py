...
st.set_page_config(page_title="Silver sulfadiazine", layout="wide")
st.title("Silver sulfadiazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_441244.jpg", width=300)
st.markdown(f"PubChem Compound ID: [441244](https://pubchem.ncbi.nlm.nih.gov/compound/441244)")
st.markdown(f"IUPAC Name: silver (4-aminophenyl)sulfonyl-pyrimidin-2-ylazanide")
...
df_filtered = sources[(sources["PubChem_CID"] == 441244) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 441244) ]
