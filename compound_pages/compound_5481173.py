...
st.set_page_config(page_title="ceftazidime", layout="wide")
st.title("ceftazidime")
...
st.image(f"compound_structures/compound_5481173.jpg", caption=f"SMILES: CC(C)(ON=C(C(=O)NC1C(=O)N2C(C(=O)[O-])=C(C[n+]3ccccc3)CS[C@H]12)c1csc(N)n1)C(=O)O")
...
df_filtered = sources[(sources["PubChem_CID"] == 5481173) ]
