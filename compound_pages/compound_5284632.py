...
st.set_page_config(page_title="Trospium", layout="wide")
st.title("Trospium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284632.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284632](https://pubchem.ncbi.nlm.nih.gov/compound/5284632)")
st.markdown(f"IUPAC Name: [(1R,5S)-spiro[8-azoniabicyclo[3.2.1]octane-8,1'-azolidin-1-ium]-3-yl] 2-hydroxy-2,2-diphenylacetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284632) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284632) ]
