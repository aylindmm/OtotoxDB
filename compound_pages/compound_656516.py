...
st.set_page_config(page_title="Amygdalin", layout="wide")
st.title("Amygdalin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_656516.jpg", width=300)
st.markdown(f"PubChem Compound ID: [656516](https://pubchem.ncbi.nlm.nih.gov/compound/656516)")
st.markdown(f"IUPAC Name: (2R)-2-phenyl-2-[(2R,3R,4S,5S,6R)-3,4,5-trihydroxy-6-[[(2R,3R,4S,5S,6R)-3,4,5-trihydroxy-6-(hydroxymethyl)oxan-2-yl]oxymethyl]oxan-2-yl]oxyacetonitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 656516) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 656516) ]
