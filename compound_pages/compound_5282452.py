...
st.set_page_config(page_title="Pitavastatin", layout="wide")
st.title("Pitavastatin")
...
df_filtered = sources[(sources["PubChem_CID"] == 5282452) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5282452) ]
