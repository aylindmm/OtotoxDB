...
st.set_page_config(page_title="Pinacidil monohydrate", layout="wide")
st.title("Pinacidil monohydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_55329.jpg", width=300)
st.markdown(f"PubChem Compound ID: [55329](https://pubchem.ncbi.nlm.nih.gov/compound/55329)")
st.markdown(f"IUPAC Name: 1-cyano-2-(3,3-dimethylbutan-2-yl)-3-pyridin-4-ylguanidine;hydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 55329) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 55329) ]
