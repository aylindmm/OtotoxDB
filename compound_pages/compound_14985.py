...
st.image(f"compound_structures/compound_14985.jpg", width=300)
...
st.markdown(f"Score: -0.255548083389375")
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 14985) ]
