...
st.set_page_config(page_title="Amisulpride", layout="wide")
st.title("Amisulpride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2159.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2159](https://pubchem.ncbi.nlm.nih.gov/compound/2159)")
st.markdown(f"IUPAC Name: 4-amino-N-[(1-ethylpyrrolidin-2-yl)methyl]-5-ethylsulfonyl-2-methoxybenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2159) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2159) ]
