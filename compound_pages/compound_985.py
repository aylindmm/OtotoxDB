...
st.set_page_config(page_title="Palmitic acid", layout="wide")
st.title("Palmitic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_985.jpg", width=300)
st.markdown(f"PubChem Compound ID: [985](https://pubchem.ncbi.nlm.nih.gov/compound/985)")
st.markdown(f"IUPAC Name: hexadecanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 985) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 985) ]
