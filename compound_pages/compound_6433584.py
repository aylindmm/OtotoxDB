...
st.set_page_config(page_title="Propiram fumarate", layout="wide")
st.title("Propiram fumarate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6433584.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6433584](https://pubchem.ncbi.nlm.nih.gov/compound/6433584)")
st.markdown(f"IUPAC Name: (E)-but-2-enedioic acid;N-(1-piperidin-1-ylpropan-2-yl)-N-pyridin-2-ylpropanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 6433584) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6433584) ]
