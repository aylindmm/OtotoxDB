...
st.set_page_config(page_title="Isocarboxazid", layout="wide")
st.title("Isocarboxazid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3759.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3759](https://pubchem.ncbi.nlm.nih.gov/compound/3759)")
st.markdown(f"IUPAC Name: N'-benzyl-5-methyl-1,2-oxazole-3-carbohydrazide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3759) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3759) ]
