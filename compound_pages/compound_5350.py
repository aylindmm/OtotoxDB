...
st.image(f"compound_structures/compound_5350.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5350) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5350) ]
