...
st.image(f"compound_structures/compound_470999.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 470999) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 470999) ]
