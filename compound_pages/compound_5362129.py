...
st.set_page_config(page_title="Ramipril", layout="wide")
st.title("Ramipril")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5362129.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5362129](https://pubchem.ncbi.nlm.nih.gov/compound/5362129)")
st.markdown(f"IUPAC Name: (2S,3aS,6aS)-1-[(2S)-2-[[(2S)-1-ethoxy-1-oxo-4-phenylbutan-2-yl]amino]propanoyl]-3,3a,4,5,6,6a-hexahydro-2H-cyclopenta[b]pyrrole-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5362129) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5362129) ]
