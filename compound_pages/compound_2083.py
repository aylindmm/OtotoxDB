...
st.set_page_config(page_title="Salbutamol", layout="wide")
st.title("Salbutamol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2083.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2083](https://pubchem.ncbi.nlm.nih.gov/compound/2083)")
st.markdown(f"IUPAC Name: 4-[2-(tert-butylamino)-1-hydroxyethyl]-2-(hydroxymethyl)phenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 2083) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2083) ]
