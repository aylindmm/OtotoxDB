...
st.set_page_config(page_title="Remdesivir", layout="wide")
st.title("Remdesivir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_121304016.jpg", width=300)
st.markdown(f"PubChem Compound ID: [121304016](https://pubchem.ncbi.nlm.nih.gov/compound/121304016)")
st.markdown(f"IUPAC Name: 2-ethylbutyl (2S)-2-[[[(2R,3S,4R,5R)-5-(4-aminopyrrolo[2,1-f][1,2,4]triazin-7-yl)-5-cyano-3,4-dihydroxyoxolan-2-yl]methoxy-phenoxyphosphoryl]amino]propanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 121304016) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 121304016) ]
