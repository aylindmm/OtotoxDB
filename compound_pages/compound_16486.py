...
st.set_page_config(page_title="(s)-azetidine-2-carboxylic acid", layout="wide")
st.title("(s)-azetidine-2-carboxylic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_16486.jpg", width=300)
st.markdown(f"PubChem Compound ID: [16486](https://pubchem.ncbi.nlm.nih.gov/compound/16486)")
st.markdown(f"IUPAC Name: (2S)-azetidine-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 16486) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 16486) ]
