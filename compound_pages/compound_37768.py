...
st.image(f"compound_structures/compound_37768.jpg", width=300)
...
st.markdown(f"Score: 3.76597175521184")
...
df_filtered = sources[(sources["PubChem_CID"] == 37768) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 37768) ]
