...
st.set_page_config(page_title="Maxzide-25", layout="wide")
st.title("Maxzide-25")
# Display the image in Streamlit
st.image(f"compound_structures/compound_62940.jpg", width=300)
st.markdown(f"PubChem Compound ID: [62940](https://pubchem.ncbi.nlm.nih.gov/compound/62940)")
st.markdown(f"IUPAC Name: 6-chloro-1,1-dioxo-3,4-dihydro-2H-1lambda6,2,4-benzothiadiazine-7-sulfonamide;6-phenylpteridine-2,4,7-triamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 62940) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 62940) ]
