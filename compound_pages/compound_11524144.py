...
st.set_page_config(page_title="Dorsomorphin", layout="wide")
st.title("Dorsomorphin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11524144.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11524144](https://pubchem.ncbi.nlm.nih.gov/compound/11524144)")
st.markdown(f"IUPAC Name: 6-[4-(2-piperidin-1-ylethoxy)phenyl]-3-pyridin-4-ylpyrazolo[1,5-a]pyrimidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 11524144) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11524144) ]
