...
st.set_page_config(page_title="Fusidic acid", layout="wide")
st.title("Fusidic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3000226.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3000226](https://pubchem.ncbi.nlm.nih.gov/compound/3000226)")
st.markdown(f"IUPAC Name: (2Z)-2-[(3R,4S,5S,8S,9S,10S,11R,13R,14S,16S)-16-acetyloxy-3,11-dihydroxy-4,8,10,14-tetramethyl-2,3,4,5,6,7,9,11,12,13,15,16-dodecahydro-1H-cyclopenta[a]phenanthren-17-ylidene]-6-methylhept-5-enoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3000226) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3000226) ]
