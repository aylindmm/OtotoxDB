...
st.set_page_config(page_title="N,n-dimethylacetamide", layout="wide")
st.title("N,n-dimethylacetamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_31374.jpg", width=300)
st.markdown(f"PubChem Compound ID: [31374](https://pubchem.ncbi.nlm.nih.gov/compound/31374)")
st.markdown(f"IUPAC Name: N,N-dimethylacetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 31374) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 31374) ]
