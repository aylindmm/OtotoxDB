...
st.set_page_config(page_title="6-.alpha.-methylprednisolone", layout="wide")
st.title("6-.alpha.-methylprednisolone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4159.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4159](https://pubchem.ncbi.nlm.nih.gov/compound/4159)")
st.markdown(f"IUPAC Name: 11,17-dihydroxy-17-(2-hydroxyacetyl)-6,10,13-trimethyl-7,8,9,11,12,14,15,16-octahydro-6H-cyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 4159) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4159) ]
