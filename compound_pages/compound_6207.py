...
st.set_page_config(page_title="Egta", layout="wide")
st.title("Egta")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6207.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 6207) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6207) ]
