...
st.set_page_config(page_title="Copper sulfate", layout="wide")
st.title("Copper sulfate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24462.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24462](https://pubchem.ncbi.nlm.nih.gov/compound/24462)")
st.markdown(f"IUPAC Name: copper sulfate")
...
df_filtered = sources[(sources["PubChem_CID"] == 24462) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24462) ]
