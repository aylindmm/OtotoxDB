...
st.set_page_config(page_title="Encainide", layout="wide")
st.title("Encainide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_48041.jpg", width=300)
st.markdown(f"PubChem Compound ID: [48041](https://pubchem.ncbi.nlm.nih.gov/compound/48041)")
st.markdown(f"IUPAC Name: 4-methoxy-N-[2-[2-(1-methylpiperidin-2-yl)ethyl]phenyl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 48041) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 48041) ]
