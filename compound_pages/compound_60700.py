...
st.set_page_config(page_title="Topotecan", layout="wide")
st.title("Topotecan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60700.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60700](https://pubchem.ncbi.nlm.nih.gov/compound/60700)")
st.markdown(f"IUPAC Name: (19S)-8-[(dimethylamino)methyl]-19-ethyl-7,19-dihydroxy-17-oxa-3,13-diazapentacyclo[11.8.0.02,11.04,9.015,20]henicosa-1(21),2,4(9),5,7,10,15(20)-heptaene-14,18-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 60700) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60700) ]
