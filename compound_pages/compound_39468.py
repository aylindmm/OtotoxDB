...
st.set_page_config(page_title="Levobunolol", layout="wide")
st.title("Levobunolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_39468.jpg", width=300)
st.markdown(f"PubChem Compound ID: [39468](https://pubchem.ncbi.nlm.nih.gov/compound/39468)")
st.markdown(f"IUPAC Name: 5-[(2S)-3-(tert-butylamino)-2-hydroxypropoxy]-3,4-dihydro-2H-naphthalen-1-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 39468) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 39468) ]
