...
st.set_page_config(page_title="Amoxicillin and clavulanic acid", layout="wide")
st.title("Amoxicillin and clavulanic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6435924.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6435924](https://pubchem.ncbi.nlm.nih.gov/compound/6435924)")
st.markdown(f"IUPAC Name: (2S,5R,6R)-6-[[(2R)-2-amino-2-(4-hydroxyphenyl)acetyl]amino]-3,3-dimethyl-7-oxo-4-thia-1-azabicyclo[3.2.0]heptane-2-carboxylic acid;(2R,3Z,5R)-3-(2-hydroxyethylidene)-7-oxo-4-oxa-1-azabicyclo[3.2.0]heptane-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 6435924) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6435924) ]
