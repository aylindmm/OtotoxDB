...
st.set_page_config(page_title="Estrogen", layout="wide")
st.title("Estrogen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_21628493.jpg", width=300)
st.markdown(f"PubChem Compound ID: [21628493](https://pubchem.ncbi.nlm.nih.gov/compound/21628493)")
st.markdown(f"IUPAC Name: (8R,9S,13S,14S,17S)-13-methyl-17-prop-1-ynyl-7,8,9,11,12,14,15,16-octahydro-6H-cyclopenta[a]phenanthrene-3,17-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 21628493) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 21628493) ]
