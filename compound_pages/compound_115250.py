...
st.set_page_config(page_title="Taraxasterol", layout="wide")
st.title("Taraxasterol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_115250.jpg", width=300)
st.markdown(f"PubChem Compound ID: [115250](https://pubchem.ncbi.nlm.nih.gov/compound/115250)")
st.markdown(f"IUPAC Name: (3S,4aR,6aR,6aR,6bR,8aR,12S,12aR,14aR,14bR)-4,4,6a,6b,8a,12,14b-heptamethyl-11-methylidene-1,2,3,4a,5,6,6a,7,8,9,10,12,12a,13,14,14a-hexadecahydropicen-3-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 115250) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 115250) ]
