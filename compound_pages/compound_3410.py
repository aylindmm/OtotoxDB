...
st.set_page_config(page_title="Formoterol", layout="wide")
st.title("Formoterol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3410.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3410](https://pubchem.ncbi.nlm.nih.gov/compound/3410)")
st.markdown(f"IUPAC Name: N-[2-hydroxy-5-[1-hydroxy-2-[1-(4-methoxyphenyl)propan-2-ylamino]ethyl]phenyl]formamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3410) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3410) ]
