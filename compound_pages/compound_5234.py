...
st.set_page_config(page_title="Sodium chloride", layout="wide")
st.title("Sodium chloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5234.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5234](https://pubchem.ncbi.nlm.nih.gov/compound/5234)")
st.markdown(f"IUPAC Name: sodium chloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 5234) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5234) ]
