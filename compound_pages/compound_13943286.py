...
st.set_page_config(page_title="Cycloastragenol", layout="wide")
st.title("Cycloastragenol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_13943286.jpg", width=300)
st.markdown(f"PubChem Compound ID: [13943286](https://pubchem.ncbi.nlm.nih.gov/compound/13943286)")
st.markdown(f"IUPAC Name: (1S,3R,6S,8R,9S,11S,12S,14S,15R,16R)-15-[(2R,5S)-5-(2-hydroxypropan-2-yl)-2-methyloxolan-2-yl]-7,7,12,16-tetramethylpentacyclo[9.7.0.01,3.03,8.012,16]octadecane-6,9,14-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 13943286) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 13943286) ]
