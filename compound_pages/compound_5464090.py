...
st.set_page_config(page_title="Butorphanol tartrate", layout="wide")
st.title("Butorphanol tartrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5464090.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5464090](https://pubchem.ncbi.nlm.nih.gov/compound/5464090)")
st.markdown(f"IUPAC Name: (1S,9R,10S)-17-(cyclobutylmethyl)-17-azatetracyclo[7.5.3.01,10.02,7]heptadeca-2(7),3,5-triene-4,10-diol;(2S,3S)-2,3-dihydroxybutanedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5464090) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5464090) ]
