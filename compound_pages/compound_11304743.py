...
st.set_page_config(page_title="Riociguat", layout="wide")
st.title("Riociguat")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11304743.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11304743](https://pubchem.ncbi.nlm.nih.gov/compound/11304743)")
st.markdown(f"IUPAC Name: methyl N-[4,6-diamino-2-[1-[(2-fluorophenyl)methyl]pyrazolo[5,4-b]pyridin-3-yl]pyrimidin-5-yl]-N-methylcarbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 11304743) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11304743) ]
