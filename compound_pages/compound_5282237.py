...
st.set_page_config(page_title="Gemeprost", layout="wide")
st.title("Gemeprost")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5282237.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5282237](https://pubchem.ncbi.nlm.nih.gov/compound/5282237)")
st.markdown(f"IUPAC Name: methyl (E)-7-[(1R,2R,3R)-3-hydroxy-2-[(E,3R)-3-hydroxy-4,4-dimethyloct-1-enyl]-5-oxocyclopentyl]hept-2-enoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5282237) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5282237) ]
