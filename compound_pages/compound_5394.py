...
st.set_page_config(page_title="Temozolomide", layout="wide")
st.title("Temozolomide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5394.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5394](https://pubchem.ncbi.nlm.nih.gov/compound/5394)")
st.markdown(f"IUPAC Name: 3-methyl-4-oxoimidazo[5,1-d][1,2,3,5]tetrazine-8-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5394) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5394) ]
