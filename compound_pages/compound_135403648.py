...
st.image(f"compound_structures/compound_135403648.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 135403648) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135403648) ]
