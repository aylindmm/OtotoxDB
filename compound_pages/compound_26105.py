...
st.set_page_config(page_title="Misonidazole", layout="wide")
st.title("Misonidazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_26105.jpg", width=300)
st.markdown(f"PubChem Compound ID: [26105](https://pubchem.ncbi.nlm.nih.gov/compound/26105)")
st.markdown(f"IUPAC Name: 1-methoxy-3-(2-nitroimidazol-1-yl)propan-2-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 26105) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 26105) ]
