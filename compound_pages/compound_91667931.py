...
st.image(f"compound_structures/compound_91667931.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 91667931) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 91667931) ]
