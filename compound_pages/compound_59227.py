...
st.set_page_config(page_title="Rotigotine", layout="wide")
st.title("Rotigotine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_59227.jpg", width=300)
st.markdown(f"PubChem Compound ID: [59227](https://pubchem.ncbi.nlm.nih.gov/compound/59227)")
st.markdown(f"IUPAC Name: (6S)-6-[propyl(2-thiophen-2-ylethyl)amino]-5,6,7,8-tetrahydronaphthalen-1-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 59227) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 59227) ]
