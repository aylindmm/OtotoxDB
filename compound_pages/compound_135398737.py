...
st.set_page_config(page_title="Clozapine", layout="wide")
st.title("Clozapine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_135398737.jpg", width=300)
st.markdown(f"PubChem Compound ID: [135398737](https://pubchem.ncbi.nlm.nih.gov/compound/135398737)")
st.markdown(f"IUPAC Name: 3-chloro-6-(4-methylpiperazin-1-yl)-11H-benzo[b][1,4]benzodiazepine")
...
df_filtered = sources[(sources["PubChem_CID"] == 135398737) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 135398737) ]
