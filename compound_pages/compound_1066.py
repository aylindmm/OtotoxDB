...
st.set_page_config(page_title="Quinolinic acid", layout="wide")
st.title("Quinolinic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1066.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1066](https://pubchem.ncbi.nlm.nih.gov/compound/1066)")
st.markdown(f"IUPAC Name: pyridine-2,3-dicarboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 1066) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1066) ]
