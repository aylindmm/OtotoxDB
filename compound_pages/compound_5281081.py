...
st.set_page_config(page_title="Entacapone", layout="wide")
st.title("Entacapone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281081.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281081](https://pubchem.ncbi.nlm.nih.gov/compound/5281081)")
st.markdown(f"IUPAC Name: (E)-2-cyano-3-(3,4-dihydroxy-5-nitrophenyl)-N,N-diethylprop-2-enamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281081) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281081) ]
