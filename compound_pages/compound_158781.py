...
st.set_page_config(page_title="Olmesartan", layout="wide")
st.title("Olmesartan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_158781.jpg", width=300)
st.markdown(f"PubChem Compound ID: [158781](https://pubchem.ncbi.nlm.nih.gov/compound/158781)")
st.markdown(f"IUPAC Name: 5-(2-hydroxypropan-2-yl)-2-propyl-3-[[4-[2-(2H-tetrazol-5-yl)phenyl]phenyl]methyl]imidazole-4-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 158781) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 158781) ]
