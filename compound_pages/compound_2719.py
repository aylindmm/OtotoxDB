...
st.image(f"compound_structures/compound_2719.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 2719) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2719) ]
