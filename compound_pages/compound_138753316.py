...
st.set_page_config(page_title="Propylamycin", layout="wide")
st.title("Propylamycin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_138753316.jpg", width=300)
st.markdown(f"PubChem Compound ID: [138753316](https://pubchem.ncbi.nlm.nih.gov/compound/138753316)")
st.markdown(f"IUPAC Name: (2S,3S,4R,5R,6R)-5-amino-2-(aminomethyl)-6-[(2R,3S,4R,5S)-5-[(1R,2R,3S,5R,6S)-3,5-diamino-2-[(2R,3R,4S,5S,6S)-3-amino-4-hydroxy-6-(hydroxymethyl)-5-propyloxan-2-yl]oxy-6-hydroxycyclohexyl]oxy-4-hydroxy-2-(hydroxymethyl)oxolan-3-yl]oxyoxane-3,4-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 138753316) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 138753316) ]
