...
st.image(f"compound_structures/compound_6451084.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 6451084) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6451084) ]
