...
st.set_page_config(page_title="Cinnarizine", layout="wide")
st.title("Cinnarizine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1547484.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1547484](https://pubchem.ncbi.nlm.nih.gov/compound/1547484)")
st.markdown(f"IUPAC Name: 1-benzhydryl-4-[(E)-3-phenylprop-2-enyl]piperazine")
...
df_filtered = sources[(sources["PubChem_CID"] == 1547484) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1547484) ]
