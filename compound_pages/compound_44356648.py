...
st.set_page_config(page_title="Tnf-alpha", layout="wide")
st.title("Tnf-alpha")
# Display the image in Streamlit
st.image(f"compound_structures/compound_44356648.jpg", width=300)
st.markdown(f"PubChem Compound ID: [44356648](https://pubchem.ncbi.nlm.nih.gov/compound/44356648)")
st.markdown(f"IUPAC Name: (3S)-4-[[(2S)-1-[[(2S)-1-[[(1S)-1-carboxy-2-hydroxyethyl]amino]-4-methyl-1-oxopentan-2-yl]amino]-5-(diaminomethylideneamino)-1-oxopentan-2-yl]amino]-3-[[2-[[(2S)-2,6-diaminohexanoyl]amino]acetyl]amino]-4-oxobutanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 44356648) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 44356648) ]
