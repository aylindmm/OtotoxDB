...
st.set_page_config(page_title="Entrectinib", layout="wide")
st.title("Entrectinib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25141092.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25141092](https://pubchem.ncbi.nlm.nih.gov/compound/25141092)")
st.markdown(f"IUPAC Name: N-[5-[(3,5-difluorophenyl)methyl]-1H-indazol-3-yl]-4-(4-methylpiperazin-1-yl)-2-(oxan-4-ylamino)benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 25141092) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25141092) ]
