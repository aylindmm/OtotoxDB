...
st.set_page_config(page_title="Calcium ion", layout="wide")
st.title("Calcium ion")
# Display the image in Streamlit
st.image(f"compound_structures/compound_271.jpg", width=300)
st.markdown(f"PubChem Compound ID: [271](https://pubchem.ncbi.nlm.nih.gov/compound/271)")
st.markdown(f"IUPAC Name: calcium(2+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 271) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 271) ]
