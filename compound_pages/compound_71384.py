...
st.set_page_config(page_title="Dexrazoxane", layout="wide")
st.title("Dexrazoxane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71384.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71384](https://pubchem.ncbi.nlm.nih.gov/compound/71384)")
st.markdown(f"IUPAC Name: 4-[(2S)-2-(3,5-dioxopiperazin-1-yl)propyl]piperazine-2,6-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 71384) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71384) ]
