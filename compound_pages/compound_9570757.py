...
st.set_page_config(page_title="Cefmenoxime", layout="wide")
st.title("Cefmenoxime")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9570757.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9570757](https://pubchem.ncbi.nlm.nih.gov/compound/9570757)")
st.markdown(f"IUPAC Name: (6R,7R)-7-[[(2Z)-2-(2-amino-1,3-thiazol-4-yl)-2-methoxyiminoacetyl]amino]-3-[(1-methyltetrazol-5-yl)sulfanylmethyl]-8-oxo-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 9570757) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9570757) ]
