...
st.set_page_config(page_title="Lasmiditan", layout="wide")
st.title("Lasmiditan")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11610526.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11610526](https://pubchem.ncbi.nlm.nih.gov/compound/11610526)")
st.markdown(f"IUPAC Name: 2,4,6-trifluoro-N-[6-(1-methylpiperidine-4-carbonyl)-2-pyridinyl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 11610526) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11610526) ]
