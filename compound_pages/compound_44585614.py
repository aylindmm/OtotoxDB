...
st.image(f"compound_structures/compound_44585614.jpg", caption=f"SMILES: CCC(C)CCCCC(=O)NCCC1NC(=O)C(CC(C)C)NC(=O)C(CCN)NC(=O)C(CC(C)C)NC(=O)C(CCN)NC(=O)C(CCN)NC(=O)C(CCN)NC(=O)C([C@@H](C)O)NC1=O")
