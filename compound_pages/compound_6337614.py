...
st.set_page_config(page_title="Palonosetron", layout="wide")
st.title("Palonosetron")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6337614.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6337614](https://pubchem.ncbi.nlm.nih.gov/compound/6337614)")
st.markdown(f"IUPAC Name: (3aS)-2-[(3S)-1-azabicyclo[2.2.2]octan-3-yl]-3a,4,5,6-tetrahydro-3H-benzo[de]isoquinolin-1-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 6337614) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6337614) ]
