...
st.set_page_config(page_title="Papaverine", layout="wide")
st.title("Papaverine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4680.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4680](https://pubchem.ncbi.nlm.nih.gov/compound/4680)")
st.markdown(f"IUPAC Name: 1-[(3,4-dimethoxyphenyl)methyl]-6,7-dimethoxyisoquinoline")
...
df_filtered = sources[(sources["PubChem_CID"] == 4680) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4680) ]
