...
st.set_page_config(page_title="890842-28-1", layout="wide")
st.title("890842-28-1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25022668.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25022668](https://pubchem.ncbi.nlm.nih.gov/compound/25022668)")
st.markdown(f"IUPAC Name: 2-cyclopentyl-4-(5-phenyl-1H-pyrrolo[2,3-b]pyridin-3-yl)benzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 25022668) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25022668) ]
