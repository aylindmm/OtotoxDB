...
st.set_page_config(page_title="Sodium oxybate", layout="wide")
st.title("Sodium oxybate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23663870.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23663870](https://pubchem.ncbi.nlm.nih.gov/compound/23663870)")
st.markdown(f"IUPAC Name: sodium 4-hydroxybutanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23663870) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23663870) ]
