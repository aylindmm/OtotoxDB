...
st.set_page_config(page_title="Clobazam", layout="wide")
st.title("Clobazam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2789.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2789](https://pubchem.ncbi.nlm.nih.gov/compound/2789)")
st.markdown(f"IUPAC Name: 7-chloro-1-methyl-5-phenyl-1,5-benzodiazepine-2,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 2789) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2789) ]
