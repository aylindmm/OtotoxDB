...
st.set_page_config(page_title="Aminoglutethimide", layout="wide")
st.title("Aminoglutethimide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2145.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2145](https://pubchem.ncbi.nlm.nih.gov/compound/2145)")
st.markdown(f"IUPAC Name: 3-(4-aminophenyl)-3-ethylpiperidine-2,6-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 2145) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2145) ]
