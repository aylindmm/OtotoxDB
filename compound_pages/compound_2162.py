...
st.set_page_config(page_title="Amlodipine", layout="wide")
st.title("Amlodipine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2162.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2162](https://pubchem.ncbi.nlm.nih.gov/compound/2162)")
st.markdown(f"IUPAC Name: 3-O-ethyl 5-O-methyl 2-(2-aminoethoxymethyl)-4-(2-chlorophenyl)-6-methyl-1,4-dihydropyridine-3,5-dicarboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 2162) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2162) ]
