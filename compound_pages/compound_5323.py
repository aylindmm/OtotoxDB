...
st.set_page_config(page_title="Sulfadimethoxine", layout="wide")
st.title("Sulfadimethoxine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5323.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5323](https://pubchem.ncbi.nlm.nih.gov/compound/5323)")
st.markdown(f"IUPAC Name: 4-amino-N-(2,6-dimethoxypyrimidin-4-yl)benzenesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5323) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5323) ]
