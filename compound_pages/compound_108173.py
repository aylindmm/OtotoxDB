...
st.set_page_config(page_title="Tocainide hydrochloride", layout="wide")
st.title("Tocainide hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_108173.jpg", width=300)
st.markdown(f"PubChem Compound ID: [108173](https://pubchem.ncbi.nlm.nih.gov/compound/108173)")
st.markdown(f"IUPAC Name: 2-amino-N-(2,6-dimethylphenyl)propanamide;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 108173) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 108173) ]
