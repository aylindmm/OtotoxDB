...
st.set_page_config(page_title="Ceftiofur hydrochloride", layout="wide")
st.title("Ceftiofur hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9937686.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9937686](https://pubchem.ncbi.nlm.nih.gov/compound/9937686)")
st.markdown(f"IUPAC Name: (6R,7R)-7-[[(2Z)-2-(2-amino-1,3-thiazol-4-yl)-2-methoxyiminoacetyl]amino]-3-(furan-2-carbonylsulfanylmethyl)-8-oxo-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylic acid;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 9937686) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9937686) ]
