...
st.set_page_config(page_title="Rofecoxib", layout="wide")
st.title("Rofecoxib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5090.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5090](https://pubchem.ncbi.nlm.nih.gov/compound/5090)")
st.markdown(f"IUPAC Name: 3-(4-methylsulfonylphenyl)-4-phenyl-2H-furan-5-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5090) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5090) ]
