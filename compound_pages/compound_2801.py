...
st.set_page_config(page_title="Clomipramine", layout="wide")
st.title("Clomipramine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2801.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2801](https://pubchem.ncbi.nlm.nih.gov/compound/2801)")
st.markdown(f"IUPAC Name: 3-(2-chloro-5,6-dihydrobenzo[b][1]benzazepin-11-yl)-N,N-dimethylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2801) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2801) ]
