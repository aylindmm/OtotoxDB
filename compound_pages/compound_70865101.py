...
st.set_page_config(page_title="Chembl3354553", layout="wide")
st.title("Chembl3354553")
# Display the image in Streamlit
st.image(f"compound_structures/compound_70865101.jpg", width=300)
st.markdown(f"PubChem Compound ID: [70865101](https://pubchem.ncbi.nlm.nih.gov/compound/70865101)")
st.markdown(f"IUPAC Name: (2S)-N-(5-tert-butyl-1,2-oxazol-3-yl)-1-(1,1-dioxo-1,4-thiazinane-4-carbonyl)piperidine-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 70865101) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 70865101) ]
