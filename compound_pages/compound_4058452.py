...
st.set_page_config(page_title="722456-31-7", layout="wide")
st.title("722456-31-7")
...
df_filtered = sources[(sources["PubChem_CID"] == 4058452) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4058452) ]
