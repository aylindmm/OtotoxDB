...
st.image(f"compound_structures/compound_7237.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 7237) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7237) ]
