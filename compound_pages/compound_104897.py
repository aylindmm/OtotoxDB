...
st.set_page_config(page_title="Lanthanum cation (3+)", layout="wide")
st.title("Lanthanum cation (3+)")
# Display the image in Streamlit
st.image(f"compound_structures/compound_104897.jpg", width=300)
st.markdown(f"PubChem Compound ID: [104897](https://pubchem.ncbi.nlm.nih.gov/compound/104897)")
st.markdown(f"IUPAC Name: lanthanum(3+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 104897) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 104897) ]
