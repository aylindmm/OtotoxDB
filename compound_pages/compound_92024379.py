...
st.image(f"compound_structures/compound_92024379.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 92024379) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 92024379) ]
