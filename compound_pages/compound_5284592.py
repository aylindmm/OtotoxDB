...
st.set_page_config(page_title="Nabilone", layout="wide")
st.title("Nabilone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284592.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284592](https://pubchem.ncbi.nlm.nih.gov/compound/5284592)")
st.markdown(f"IUPAC Name: (6aR,10aR)-1-hydroxy-6,6-dimethyl-3-(2-methyloctan-2-yl)-7,8,10,10a-tetrahydro-6aH-benzo[c]chromen-9-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284592) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284592) ]
