...
st.set_page_config(page_title="Opioids", layout="wide")
st.title("Opioids")
# Display the image in Streamlit
st.image(f"compound_structures/compound_126961754.jpg", width=300)
st.markdown(f"PubChem Compound ID: [126961754](https://pubchem.ncbi.nlm.nih.gov/compound/126961754)")
st.markdown(f"IUPAC Name: (4R,4aS,7aR,12bS)-4a-hydroxy-9-methoxy-3-methyl-2,4,5,6,7a,13-hexahydro-1H-4,12-methanobenzofuro[3,2-e]isoquinolin-7-one;ethyl 1-methyl-4-phenylpiperidine-4-carboxylate;N-phenyl-N-[1-(2-phenylethyl)piperidin-4-yl]propanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 126961754) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 126961754) ]
