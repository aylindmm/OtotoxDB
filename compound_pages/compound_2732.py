...
st.set_page_config(page_title="Chlorthalidone", layout="wide")
st.title("Chlorthalidone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2732.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2732](https://pubchem.ncbi.nlm.nih.gov/compound/2732)")
st.markdown(f"IUPAC Name: 2-chloro-5-(1-hydroxy-3-oxo-2H-isoindol-1-yl)benzenesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2732) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2732) ]
