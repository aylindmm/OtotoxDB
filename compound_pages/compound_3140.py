...
st.set_page_config(page_title="114828-89-6", layout="wide")
st.title("114828-89-6")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3140.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3140](https://pubchem.ncbi.nlm.nih.gov/compound/3140)")
st.markdown(f"IUPAC Name: 6,7-dinitroquinoxaline-2,3-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 3140) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3140) ]
