...
st.set_page_config(page_title="Vermilion", layout="wide")
st.title("Vermilion")
...
df_filtered = sources[(sources["PubChem_CID"] == 10220267) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10220267) ]
