...
st.set_page_config(page_title="Psoralen", layout="wide")
st.title("Psoralen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6199.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6199](https://pubchem.ncbi.nlm.nih.gov/compound/6199)")
st.markdown(f"IUPAC Name: furo[3,2-g]chromen-7-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 6199) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6199) ]
