...
st.set_page_config(page_title="Edta disodium", layout="wide")
st.title("Edta disodium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9949814.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9949814](https://pubchem.ncbi.nlm.nih.gov/compound/9949814)")
...
df_filtered = sources[(sources["PubChem_CID"] == 9949814) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9949814) ]
