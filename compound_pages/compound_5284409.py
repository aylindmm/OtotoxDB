...
st.set_page_config(page_title="Levobunolol hydrochloride", layout="wide")
st.title("Levobunolol hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284409.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284409](https://pubchem.ncbi.nlm.nih.gov/compound/5284409)")
st.markdown(f"IUPAC Name: 5-[(2S)-3-(tert-butylamino)-2-hydroxypropoxy]-3,4-dihydro-2H-naphthalen-1-one;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284409) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284409) ]
