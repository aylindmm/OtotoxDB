...
st.set_page_config(page_title="Testosterone propionate", layout="wide")
st.title("Testosterone propionate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5995.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5995](https://pubchem.ncbi.nlm.nih.gov/compound/5995)")
st.markdown(f"IUPAC Name: [(8R,9S,10R,13S,14S,17S)-10,13-dimethyl-3-oxo-1,2,6,7,8,9,11,12,14,15,16,17-dodecahydrocyclopenta[a]phenanthren-17-yl] propanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5995) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5995) ]
