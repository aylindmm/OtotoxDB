...
st.image(f"compound_structures/compound_1011240.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 1011240) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1011240) ]
