...
st.set_page_config(page_title="(2s,3s,4s)-3-(carboxylatomethyl)-4-(prop-1-en-2-yl)pyrrolidine-2-carboxylate", layout="wide")
st.title("(2s,3s,4s)-3-(carboxylatomethyl)-4-(prop-1-en-2-yl)pyrrolidine-2-carboxylate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_73755076.jpg", width=300)
st.markdown(f"PubChem Compound ID: [73755076](https://pubchem.ncbi.nlm.nih.gov/compound/73755076)")
st.markdown(f"IUPAC Name: (2S,3S,4S)-3-(carboxylatomethyl)-4-prop-1-en-2-ylpyrrolidine-2-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 73755076) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 73755076) ]
