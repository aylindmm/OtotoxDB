...
st.set_page_config(page_title="Dexfenfluramine", layout="wide")
st.title("Dexfenfluramine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_66265.jpg", width=300)
st.markdown(f"PubChem Compound ID: [66265](https://pubchem.ncbi.nlm.nih.gov/compound/66265)")
st.markdown(f"IUPAC Name: (2S)-N-ethyl-1-[3-(trifluoromethyl)phenyl]propan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 66265) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 66265) ]
