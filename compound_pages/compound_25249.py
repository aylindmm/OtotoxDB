...
st.set_page_config(page_title="Stanozolol", layout="wide")
st.title("Stanozolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25249.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25249](https://pubchem.ncbi.nlm.nih.gov/compound/25249)")
st.markdown(f"IUPAC Name: (1S,2S,10S,13R,14S,17S,18S)-2,17,18-trimethyl-6,7-diazapentacyclo[11.7.0.02,10.04,8.014,18]icosa-4(8),5-dien-17-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 25249) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25249) ]
