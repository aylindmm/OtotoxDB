...
st.set_page_config(page_title="Celecoxib", layout="wide")
st.title("Celecoxib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2662.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2662](https://pubchem.ncbi.nlm.nih.gov/compound/2662)")
st.markdown(f"IUPAC Name: 4-[5-(4-methylphenyl)-3-(trifluoromethyl)pyrazol-1-yl]benzenesulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2662) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2662) ]
