...
st.set_page_config(page_title="Cabergoline", layout="wide")
st.title("Cabergoline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54746.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54746](https://pubchem.ncbi.nlm.nih.gov/compound/54746)")
st.markdown(f"IUPAC Name: (6aR,9R,10aR)-N-[3-(dimethylamino)propyl]-N-(ethylcarbamoyl)-7-prop-2-enyl-6,6a,8,9,10,10a-hexahydro-4H-indolo[4,3-fg]quinoline-9-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 54746) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54746) ]
