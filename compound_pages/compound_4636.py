...
st.set_page_config(page_title="Oxymetazoline", layout="wide")
st.title("Oxymetazoline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4636.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4636](https://pubchem.ncbi.nlm.nih.gov/compound/4636)")
st.markdown(f"IUPAC Name: 6-tert-butyl-3-(4,5-dihydro-1H-imidazol-2-ylmethyl)-2,4-dimethylphenol")
...
df_filtered = sources[(sources["PubChem_CID"] == 4636) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4636) ]
