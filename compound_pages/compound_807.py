...
st.set_page_config(page_title="Iodine", layout="wide")
st.title("Iodine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_807.jpg", width=300)
st.markdown(f"PubChem Compound ID: [807](https://pubchem.ncbi.nlm.nih.gov/compound/807)")
st.markdown(f"IUPAC Name: molecular iodine")
...
df_filtered = sources[(sources["PubChem_CID"] == 807) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 807) ]
