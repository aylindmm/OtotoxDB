...
st.set_page_config(page_title="Sodium bromate", layout="wide")
st.title("Sodium bromate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23668195.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23668195](https://pubchem.ncbi.nlm.nih.gov/compound/23668195)")
st.markdown(f"IUPAC Name: sodium bromate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23668195) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23668195) ]
