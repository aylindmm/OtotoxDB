...
st.set_page_config(page_title="Coumarin", layout="wide")
st.title("Coumarin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_323.jpg", width=300)
st.markdown(f"PubChem Compound ID: [323](https://pubchem.ncbi.nlm.nih.gov/compound/323)")
st.markdown(f"IUPAC Name: chromen-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 323) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 323) ]
