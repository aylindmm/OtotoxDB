...
st.set_page_config(page_title="Dextroamphetamine", layout="wide")
st.title("Dextroamphetamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5826.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5826](https://pubchem.ncbi.nlm.nih.gov/compound/5826)")
st.markdown(f"IUPAC Name: (2S)-1-phenylpropan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5826) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5826) ]
