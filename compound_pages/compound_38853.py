...
st.set_page_config(page_title="Methyldopa", layout="wide")
st.title("Methyldopa")
# Display the image in Streamlit
st.image(f"compound_structures/compound_38853.jpg", width=300)
st.markdown(f"PubChem Compound ID: [38853](https://pubchem.ncbi.nlm.nih.gov/compound/38853)")
st.markdown(f"IUPAC Name: (2S)-2-amino-3-(3,4-dihydroxyphenyl)-2-methylpropanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 38853) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 38853) ]
