...
st.set_page_config(page_title="945714-67-0", layout="wide")
st.title("945714-67-0")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24752728.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24752728](https://pubchem.ncbi.nlm.nih.gov/compound/24752728)")
st.markdown(f"IUPAC Name: N-benzyl-4-chloro-N-cyclohexylbenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 24752728) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24752728) ]
