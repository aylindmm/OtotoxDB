...
st.set_page_config(page_title="62031-54-3", layout="wide")
st.title("62031-54-3")
# Display the image in Streamlit
st.image(f"compound_structures/compound_133126676.jpg", width=300)
st.markdown(f"PubChem Compound ID: [133126676](https://pubchem.ncbi.nlm.nih.gov/compound/133126676)")
st.markdown(f"IUPAC Name: (2R)-N-[(2R)-1-[[(2R)-6-amino-1-[[(2R)-6-amino-1-[(2R)-2-(hydroxymethyl)pyrrolidin-1-yl]-1-oxohexan-2-yl]amino]-1-oxohexan-2-yl]amino]-3-(4-hydroxyphenyl)-1-oxopropan-2-yl]-2-[[2-[[(2R)-2-[[(2R)-1-[(2R)-2-[[(2R)-4-amino-2-[[(2R)-2-amino-3-phenylpropanoyl]amino]-4-oxobutanoyl]amino]-4-methylpentanoyl]pyrrolidine-2-carbonyl]amino]-4-methylpentanoyl]amino]acetyl]amino]butanediamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 133126676) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 133126676) ]
