...
st.set_page_config(page_title="Niclosamide", layout="wide")
st.title("Niclosamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4477.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4477](https://pubchem.ncbi.nlm.nih.gov/compound/4477)")
st.markdown(f"IUPAC Name: 5-chloro-N-(2-chloro-4-nitrophenyl)-2-hydroxybenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 4477) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4477) ]
