...
st.set_page_config(page_title="Dexketoprofen", layout="wide")
st.title("Dexketoprofen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_667550.jpg", width=300)
st.markdown(f"PubChem Compound ID: [667550](https://pubchem.ncbi.nlm.nih.gov/compound/667550)")
st.markdown(f"IUPAC Name: (2S)-2-(3-benzoylphenyl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 667550) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 667550) ]
