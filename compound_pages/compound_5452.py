...
st.set_page_config(page_title="Thioridazine", layout="wide")
st.title("Thioridazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5452.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5452](https://pubchem.ncbi.nlm.nih.gov/compound/5452)")
st.markdown(f"IUPAC Name: 10-[2-(1-methylpiperidin-2-yl)ethyl]-2-methylsulfanylphenothiazine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5452) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5452) ]
