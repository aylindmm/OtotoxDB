...
st.set_page_config(page_title="Isoflurane", layout="wide")
st.title("Isoflurane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3763.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3763](https://pubchem.ncbi.nlm.nih.gov/compound/3763)")
st.markdown(f"IUPAC Name: 2-chloro-2-(difluoromethoxy)-1,1,1-trifluoroethane")
...
df_filtered = sources[(sources["PubChem_CID"] == 3763) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3763) ]
