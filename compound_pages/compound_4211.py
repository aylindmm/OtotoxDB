...
st.set_page_config(page_title="Mitotane", layout="wide")
st.title("Mitotane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4211.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4211](https://pubchem.ncbi.nlm.nih.gov/compound/4211)")
st.markdown(f"IUPAC Name: 1-chloro-2-[2,2-dichloro-1-(4-chlorophenyl)ethyl]benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 4211) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4211) ]
