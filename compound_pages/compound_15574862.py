...
st.set_page_config(page_title="Gentamicin x2", layout="wide")
st.title("Gentamicin x2")
# Display the image in Streamlit
st.image(f"compound_structures/compound_15574862.jpg", width=300)
st.markdown(f"PubChem Compound ID: [15574862](https://pubchem.ncbi.nlm.nih.gov/compound/15574862)")
st.markdown(f"IUPAC Name: (2R,3R,4R,5R)-2-[(1S,2S,3R,4S,6R)-4,6-diamino-3-[(2S,3R,4R,5S,6R)-3-amino-4,5-dihydroxy-6-(hydroxymethyl)oxan-2-yl]oxy-2-hydroxycyclohexyl]oxy-5-methyl-4-(methylamino)oxane-3,5-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 15574862) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 15574862) ]
