...
st.set_page_config(page_title="Cephalexin", layout="wide")
st.title("Cephalexin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_27447.jpg", width=300)
st.markdown(f"PubChem Compound ID: [27447](https://pubchem.ncbi.nlm.nih.gov/compound/27447)")
st.markdown(f"IUPAC Name: (6R,7R)-7-[[(2R)-2-amino-2-phenylacetyl]amino]-3-methyl-8-oxo-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 27447) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 27447) ]
