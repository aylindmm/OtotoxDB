...
st.set_page_config(page_title="Co-trimoxazole", layout="wide")
st.title("Co-trimoxazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_358641.jpg", width=300)
st.markdown(f"PubChem Compound ID: [358641](https://pubchem.ncbi.nlm.nih.gov/compound/358641)")
st.markdown(f"IUPAC Name: 4-amino-N-(5-methyl-1,2-oxazol-3-yl)benzenesulfonamide;5-[(3,4,5-trimethoxyphenyl)methyl]pyrimidine-2,4-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 358641) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 358641) ]
