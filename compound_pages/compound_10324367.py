...
st.set_page_config(page_title="Boceprevir", layout="wide")
st.title("Boceprevir")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10324367.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10324367](https://pubchem.ncbi.nlm.nih.gov/compound/10324367)")
st.markdown(f"IUPAC Name: (1R,2S,5S)-N-(4-amino-1-cyclobutyl-3,4-dioxobutan-2-yl)-3-[(2S)-2-(tert-butylcarbamoylamino)-3,3-dimethylbutanoyl]-6,6-dimethyl-3-azabicyclo[3.1.0]hexane-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 10324367) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10324367) ]
