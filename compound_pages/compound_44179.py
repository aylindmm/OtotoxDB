...
st.set_page_config(page_title="Zidometacin", layout="wide")
st.title("Zidometacin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_44179.jpg", width=300)
st.markdown(f"PubChem Compound ID: [44179](https://pubchem.ncbi.nlm.nih.gov/compound/44179)")
st.markdown(f"IUPAC Name: 2-[1-(4-azidobenzoyl)-5-methoxy-2-methylindol-3-yl]acetic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 44179) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 44179) ]
