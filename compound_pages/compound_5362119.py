...
st.set_page_config(page_title="Lisinopril", layout="wide")
st.title("Lisinopril")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5362119.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5362119](https://pubchem.ncbi.nlm.nih.gov/compound/5362119)")
st.markdown(f"IUPAC Name: (2S)-1-[(2S)-6-amino-2-[[(1S)-1-carboxy-3-phenylpropyl]amino]hexanoyl]pyrrolidine-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5362119) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5362119) ]
