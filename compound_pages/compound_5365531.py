...
st.image(f"compound_structures/compound_5365531.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5365531) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5365531) ]
