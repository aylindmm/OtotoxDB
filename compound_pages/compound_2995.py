...
st.set_page_config(page_title="Desipramine", layout="wide")
st.title("Desipramine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2995.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2995](https://pubchem.ncbi.nlm.nih.gov/compound/2995)")
st.markdown(f"IUPAC Name: 3-(5,6-dihydrobenzo[b][1]benzazepin-11-yl)-N-methylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2995) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2995) ]
