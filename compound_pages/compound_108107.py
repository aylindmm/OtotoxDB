...
st.set_page_config(page_title="Benzamil", layout="wide")
st.title("Benzamil")
...
df_filtered = sources[(sources["PubChem_CID"] == 108107) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 108107) ]
