...
st.set_page_config(page_title="Morroniside", layout="wide")
st.title("Morroniside")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11228693.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11228693](https://pubchem.ncbi.nlm.nih.gov/compound/11228693)")
st.markdown(f"IUPAC Name: methyl (1S,3R,4aS,8S,8aS)-3-hydroxy-1-methyl-8-[(2S,3R,4S,5S,6R)-3,4,5-trihydroxy-6-(hydroxymethyl)oxan-2-yl]oxy-1,3,4,4a,8,8a-hexahydropyrano[3,4-c]pyran-5-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 11228693) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11228693) ]
