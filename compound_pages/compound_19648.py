...
st.image(f"compound_structures/compound_19648.jpg", width=300)
...
st.markdown(f"Score: 0.242098184263618")
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 19648) ]
