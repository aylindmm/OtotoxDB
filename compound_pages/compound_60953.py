...
st.set_page_config(page_title="Capecitabine", layout="wide")
st.title("Capecitabine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60953.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60953](https://pubchem.ncbi.nlm.nih.gov/compound/60953)")
st.markdown(f"IUPAC Name: pentyl N-[1-[(2R,3R,4S,5R)-3,4-dihydroxy-5-methyloxolan-2-yl]-5-fluoro-2-oxopyrimidin-4-yl]carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 60953) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60953) ]
