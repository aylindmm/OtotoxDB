...
st.set_page_config(page_title="Doxycycline hyclate", layout="wide")
st.title("Doxycycline hyclate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_54686183.jpg", width=300)
st.markdown(f"PubChem Compound ID: [54686183](https://pubchem.ncbi.nlm.nih.gov/compound/54686183)")
st.markdown(f"IUPAC Name: bis((4S,4aR,5S,5aR,6R,12aR)-4-(dimethylamino)-1,5,10,11,12a-pentahydroxy-6-methyl-3,12-dioxo-4a,5,5a,6-tetrahydro-4H-tetracene-2-carboxamide);ethanol;hydrate;dihydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 54686183) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 54686183) ]
