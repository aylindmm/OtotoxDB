...
st.set_page_config(page_title="Lidocaine hydrochloride", layout="wide")
st.title("Lidocaine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6314.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6314](https://pubchem.ncbi.nlm.nih.gov/compound/6314)")
st.markdown(f"IUPAC Name: 2-(diethylamino)-N-(2,6-dimethylphenyl)acetamide;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 6314) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6314) ]
