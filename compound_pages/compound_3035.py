...
st.set_page_config(page_title="P,p'-dde", layout="wide")
st.title("P,p'-dde")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3035.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3035](https://pubchem.ncbi.nlm.nih.gov/compound/3035)")
st.markdown(f"IUPAC Name: 1-chloro-4-[2,2-dichloro-1-(4-chlorophenyl)ethenyl]benzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 3035) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3035) ]
