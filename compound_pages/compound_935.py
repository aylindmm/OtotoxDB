...
st.set_page_config(page_title="Nickel", layout="wide")
st.title("Nickel")
# Display the image in Streamlit
st.image(f"compound_structures/compound_935.jpg", width=300)
st.markdown(f"PubChem Compound ID: [935](https://pubchem.ncbi.nlm.nih.gov/compound/935)")
st.markdown(f"IUPAC Name: nickel")
...
df_filtered = sources[(sources["PubChem_CID"] == 935) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 935) ]
