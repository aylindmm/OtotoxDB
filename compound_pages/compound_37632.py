...
st.set_page_config(page_title="Adinazolam", layout="wide")
st.title("Adinazolam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_37632.jpg", width=300)
st.markdown(f"PubChem Compound ID: [37632](https://pubchem.ncbi.nlm.nih.gov/compound/37632)")
st.markdown(f"IUPAC Name: 1-(8-chloro-6-phenyl-4H-[1,2,4]triazolo[4,3-a][1,4]benzodiazepin-1-yl)-N,N-dimethylmethanamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 37632) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 37632) ]
