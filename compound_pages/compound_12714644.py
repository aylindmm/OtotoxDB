...
st.set_page_config(page_title="Dapansutrile", layout="wide")
st.title("Dapansutrile")
# Display the image in Streamlit
st.image(f"compound_structures/compound_12714644.jpg", width=300)
st.markdown(f"PubChem Compound ID: [12714644](https://pubchem.ncbi.nlm.nih.gov/compound/12714644)")
st.markdown(f"IUPAC Name: 3-methylsulfonylpropanenitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 12714644) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 12714644) ]
