...
st.set_page_config(page_title="Strychnine", layout="wide")
st.title("Strychnine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_441071.jpg", width=300)
st.markdown(f"PubChem Compound ID: [441071](https://pubchem.ncbi.nlm.nih.gov/compound/441071)")
st.markdown(f"IUPAC Name: (4aR,5aS,8aR,13aS,15aS,15bR)-4a,5,5a,7,8,13a,15,15a,15b,16-decahydro-2H-4,6-methanoindolo[3,2,1-ij]oxepino[2,3,4-de]pyrrolo[2,3-h]quinolin-14-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 441071) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 441071) ]
