...
st.set_page_config(page_title="Cerovive", layout="wide")
st.title("Cerovive")
...
df_filtered = sources[(sources["PubChem_CID"] == 6440181) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6440181) ]
