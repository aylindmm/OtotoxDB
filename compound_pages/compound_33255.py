...
st.set_page_config(page_title="Cefazolin", layout="wide")
st.title("Cefazolin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_33255.jpg", width=300)
st.markdown(f"PubChem Compound ID: [33255](https://pubchem.ncbi.nlm.nih.gov/compound/33255)")
st.markdown(f"IUPAC Name: (6R,7R)-3-[(5-methyl-1,3,4-thiadiazol-2-yl)sulfanylmethyl]-8-oxo-7-[[2-(tetrazol-1-yl)acetyl]amino]-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 33255) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 33255) ]
