...
st.set_page_config(page_title="Betahistine mesilate", layout="wide")
st.title("Betahistine mesilate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_198334.jpg", width=300)
st.markdown(f"PubChem Compound ID: [198334](https://pubchem.ncbi.nlm.nih.gov/compound/198334)")
st.markdown(f"IUPAC Name: methanesulfonic acid;N-methyl-2-pyridin-2-ylethanamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 198334) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 198334) ]
