...
st.image(f"compound_structures/compound_154190.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 154190) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 154190) ]
