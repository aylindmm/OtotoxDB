...
st.set_page_config(page_title="Malic acid", layout="wide")
st.title("Malic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_525.jpg", width=300)
st.markdown(f"PubChem Compound ID: [525](https://pubchem.ncbi.nlm.nih.gov/compound/525)")
st.markdown(f"IUPAC Name: 2-hydroxybutanedioic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 525) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 525) ]
