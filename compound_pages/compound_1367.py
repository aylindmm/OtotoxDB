...
st.set_page_config(page_title="1-aminobenzotriazole", layout="wide")
st.title("1-aminobenzotriazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1367.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1367](https://pubchem.ncbi.nlm.nih.gov/compound/1367)")
st.markdown(f"IUPAC Name: benzotriazol-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 1367) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1367) ]
