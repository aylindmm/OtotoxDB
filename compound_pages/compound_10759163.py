...
st.image(f"compound_structures/compound_10759163.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 10759163) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10759163) ]
