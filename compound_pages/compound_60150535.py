...
st.set_page_config(page_title="Finerenone", layout="wide")
st.title("Finerenone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60150535.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60150535](https://pubchem.ncbi.nlm.nih.gov/compound/60150535)")
st.markdown(f"IUPAC Name: (4S)-4-(4-cyano-2-methoxyphenyl)-5-ethoxy-2,8-dimethyl-1,4-dihydro-1,6-naphthyridine-3-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 60150535) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60150535) ]
