...
st.set_page_config(page_title="Nabiximols", layout="wide")
st.title("Nabiximols")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9852188.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9852188](https://pubchem.ncbi.nlm.nih.gov/compound/9852188)")
st.markdown(f"IUPAC Name: (6aR,10aR)-6,6,9-trimethyl-3-pentyl-6a,7,8,10a-tetrahydrobenzo[c]chromen-1-ol;2-[(1R,6R)-3-methyl-6-prop-1-en-2-ylcyclohex-2-en-1-yl]-5-pentylbenzene-1,3-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 9852188) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9852188) ]
