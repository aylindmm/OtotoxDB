...
st.set_page_config(page_title="Propafenone", layout="wide")
st.title("Propafenone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4932.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4932](https://pubchem.ncbi.nlm.nih.gov/compound/4932)")
st.markdown(f"IUPAC Name: 1-[2-[2-hydroxy-3-(propylamino)propoxy]phenyl]-3-phenylpropan-1-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 4932) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4932) ]
