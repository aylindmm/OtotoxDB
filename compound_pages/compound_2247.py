...
st.set_page_config(page_title="Astemizole", layout="wide")
st.title("Astemizole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2247.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2247](https://pubchem.ncbi.nlm.nih.gov/compound/2247)")
st.markdown(f"IUPAC Name: 1-[(4-fluorophenyl)methyl]-N-[1-[2-(4-methoxyphenyl)ethyl]piperidin-4-yl]benzimidazol-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 2247) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2247) ]
