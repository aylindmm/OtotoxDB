...
st.set_page_config(page_title="Primidolol", layout="wide")
st.title("Primidolol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68563.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68563](https://pubchem.ncbi.nlm.nih.gov/compound/68563)")
st.markdown(f"IUPAC Name: 1-[2-[[2-hydroxy-3-(2-methylphenoxy)propyl]amino]ethyl]-5-methylpyrimidine-2,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 68563) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68563) ]
