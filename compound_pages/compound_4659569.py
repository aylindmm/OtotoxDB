...
st.set_page_config(page_title="Tolcapone", layout="wide")
st.title("Tolcapone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4659569.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4659569](https://pubchem.ncbi.nlm.nih.gov/compound/4659569)")
st.markdown(f"IUPAC Name: (3,4-dihydroxy-5-nitrophenyl)-(4-methylphenyl)methanone")
...
df_filtered = sources[(sources["PubChem_CID"] == 4659569) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4659569) ]
