...
st.set_page_config(page_title="202821-81-6", layout="wide")
st.title("202821-81-6")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10474339.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10474339](https://pubchem.ncbi.nlm.nih.gov/compound/10474339)")
st.markdown(f"IUPAC Name: 3-[(5-chloro-2-hydroxyphenyl)methyl]-5-[4-(trifluoromethyl)phenyl]-1,3,4-oxadiazol-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 10474339) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10474339) ]
