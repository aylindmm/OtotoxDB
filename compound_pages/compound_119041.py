...
st.set_page_config(page_title="Obacunone", layout="wide")
st.title("Obacunone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_119041.jpg", width=300)
st.markdown(f"PubChem Compound ID: [119041](https://pubchem.ncbi.nlm.nih.gov/compound/119041)")
st.markdown(f"IUPAC Name: (1R,2R,4S,7S,8S,11R,12R,18R)-7-(furan-3-yl)-1,8,12,17,17-pentamethyl-3,6,16-trioxapentacyclo[9.9.0.02,4.02,8.012,18]icos-13-ene-5,15,20-trione")
...
df_filtered = sources[(sources["PubChem_CID"] == 119041) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 119041) ]
