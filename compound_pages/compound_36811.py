...
st.set_page_config(page_title="Dobutamine", layout="wide")
st.title("Dobutamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_36811.jpg", width=300)
st.markdown(f"PubChem Compound ID: [36811](https://pubchem.ncbi.nlm.nih.gov/compound/36811)")
st.markdown(f"IUPAC Name: 4-[2-[4-(4-hydroxyphenyl)butan-2-ylamino]ethyl]benzene-1,2-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 36811) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 36811) ]
