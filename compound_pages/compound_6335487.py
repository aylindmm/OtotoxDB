...
st.set_page_config(page_title="Ringer's lactate", layout="wide")
st.title("Ringer's lactate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6335487.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6335487](https://pubchem.ncbi.nlm.nih.gov/compound/6335487)")
...
df_filtered = sources[(sources["PubChem_CID"] == 6335487) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6335487) ]
