...
st.set_page_config(page_title="Brivaracetam", layout="wide")
st.title("Brivaracetam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9837243.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9837243](https://pubchem.ncbi.nlm.nih.gov/compound/9837243)")
st.markdown(f"IUPAC Name: (2S)-2-[(4R)-2-oxo-4-propylpyrrolidin-1-yl]butanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9837243) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9837243) ]
