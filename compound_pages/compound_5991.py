...
st.set_page_config(page_title="Ethinyl estradiol", layout="wide")
st.title("Ethinyl estradiol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5991.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5991](https://pubchem.ncbi.nlm.nih.gov/compound/5991)")
st.markdown(f"IUPAC Name: (8R,9S,13S,14S,17R)-17-ethynyl-13-methyl-7,8,9,11,12,14,15,16-octahydro-6H-cyclopenta[a]phenanthrene-3,17-diol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5991) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5991) ]
