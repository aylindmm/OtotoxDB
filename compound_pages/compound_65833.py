...
st.set_page_config(page_title="Milnacipran", layout="wide")
st.title("Milnacipran")
# Display the image in Streamlit
st.image(f"compound_structures/compound_65833.jpg", width=300)
st.markdown(f"PubChem Compound ID: [65833](https://pubchem.ncbi.nlm.nih.gov/compound/65833)")
st.markdown(f"IUPAC Name: cis-(1R,2S)-2-(aminomethyl)-N,N-diethyl-1-phenylcyclopropane-1-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 65833) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 65833) ]
