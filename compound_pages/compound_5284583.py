...
st.set_page_config(page_title="Levetiracetam", layout="wide")
st.title("Levetiracetam")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284583.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284583](https://pubchem.ncbi.nlm.nih.gov/compound/5284583)")
st.markdown(f"IUPAC Name: (2S)-2-(2-oxopyrrolidin-1-yl)butanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284583) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284583) ]
