...
st.set_page_config(page_title="3,5,6-trichloro-2-pyridinol", layout="wide")
st.title("3,5,6-trichloro-2-pyridinol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23017.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23017](https://pubchem.ncbi.nlm.nih.gov/compound/23017)")
st.markdown(f"IUPAC Name: 3,5,6-trichloro-1H-pyridin-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 23017) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23017) ]
