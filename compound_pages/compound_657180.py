...
st.set_page_config(page_title="Leuprolide acetate", layout="wide")
st.title("Leuprolide acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_657180.jpg", width=300)
st.markdown(f"PubChem Compound ID: [657180](https://pubchem.ncbi.nlm.nih.gov/compound/657180)")
st.markdown(f"IUPAC Name: acetic acid;(2S)-N-[(2S)-1-[[(2S)-1-[[(2S)-1-[[(2S)-1-[[(2R)-1-[[(2S)-1-[[(2S)-5-(diaminomethylideneamino)-1-[(2S)-2-(ethylcarbamoyl)pyrrolidin-1-yl]-1-oxopentan-2-yl]amino]-4-methyl-1-oxopentan-2-yl]amino]-4-methyl-1-oxopentan-2-yl]amino]-3-(4-hydroxyphenyl)-1-oxopropan-2-yl]amino]-3-hydroxy-1-oxopropan-2-yl]amino]-3-(1H-indol-3-yl)-1-oxopropan-2-yl]amino]-3-(1H-imidazol-5-yl)-1-oxopropan-2-yl]-5-oxopyrrolidine-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 657180) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 657180) ]
