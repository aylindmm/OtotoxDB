...
st.set_page_config(page_title="Lipofundin s", layout="wide")
st.title("Lipofundin s")
# Display the image in Streamlit
st.image(f"compound_structures/compound_131750197.jpg", width=300)
st.markdown(f"PubChem Compound ID: [131750197](https://pubchem.ncbi.nlm.nih.gov/compound/131750197)")
st.markdown(f"IUPAC Name: 2-[[3-hexadecanoyloxy-2-[(E)-octadec-9-enoyl]oxypropoxy]-hydroxyphosphoryl]oxyethyl-trimethylazanium;(9Z,12Z)-octadeca-9,12-dienoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 131750197) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 131750197) ]
