...
st.set_page_config(page_title="Vanadium", layout="wide")
st.title("Vanadium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23990.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23990](https://pubchem.ncbi.nlm.nih.gov/compound/23990)")
st.markdown(f"IUPAC Name: vanadium")
...
df_filtered = sources[(sources["PubChem_CID"] == 23990) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23990) ]
