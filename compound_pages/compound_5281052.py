...
st.set_page_config(page_title="Kava", layout="wide")
st.title("Kava")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281052.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281052](https://pubchem.ncbi.nlm.nih.gov/compound/5281052)")
st.markdown(f"IUPAC Name: 2-[(E)-2-cyclohexa-1,5-dien-1-ylethenyl]-4-methoxy-2,3-dihydropyran-6-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281052) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281052) ]
