...
st.set_page_config(page_title="Tegafur", layout="wide")
st.title("Tegafur")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5386.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5386](https://pubchem.ncbi.nlm.nih.gov/compound/5386)")
st.markdown(f"IUPAC Name: 5-fluoro-1-(oxolan-2-yl)pyrimidine-2,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 5386) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5386) ]
