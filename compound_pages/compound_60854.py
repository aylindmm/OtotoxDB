...
st.set_page_config(page_title="Ziprasidone", layout="wide")
st.title("Ziprasidone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60854.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60854](https://pubchem.ncbi.nlm.nih.gov/compound/60854)")
st.markdown(f"IUPAC Name: 5-[2-[4-(1,2-benzothiazol-3-yl)piperazin-1-yl]ethyl]-6-chloro-1,3-dihydroindol-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 60854) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60854) ]
