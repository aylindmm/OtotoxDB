...
st.set_page_config(page_title="86227-47-6", layout="wide")
st.title("86227-47-6")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9831415.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9831415](https://pubchem.ncbi.nlm.nih.gov/compound/9831415)")
st.markdown(f"IUPAC Name: ethyl (5Z,8Z,11Z,14Z,17Z)-icosa-5,8,11,14,17-pentaenoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 9831415) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9831415) ]
