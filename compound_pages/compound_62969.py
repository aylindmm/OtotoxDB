...
st.set_page_config(page_title="Verapamil hydrochloride", layout="wide")
st.title("Verapamil hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_62969.jpg", width=300)
st.markdown(f"PubChem Compound ID: [62969](https://pubchem.ncbi.nlm.nih.gov/compound/62969)")
st.markdown(f"IUPAC Name: 2-(3,4-dimethoxyphenyl)-5-[2-(3,4-dimethoxyphenyl)ethyl-methylamino]-2-propan-2-ylpentanenitrile;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 62969) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 62969) ]
