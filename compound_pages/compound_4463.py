...
st.image(f"compound_structures/compound_4463.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 4463) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4463) ]
