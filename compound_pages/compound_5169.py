...
st.set_page_config(page_title="152121-30-7", layout="wide")
st.title("152121-30-7")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5169.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5169) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5169) ]
