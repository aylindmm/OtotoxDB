...
st.set_page_config(page_title="Trans-beta-methylstyrene", layout="wide")
st.title("Trans-beta-methylstyrene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_252325.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 252325) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 252325) ]
