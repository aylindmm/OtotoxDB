...
st.set_page_config(page_title="Cefodizime", layout="wide")
st.title("Cefodizime")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5361871.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5361871](https://pubchem.ncbi.nlm.nih.gov/compound/5361871)")
st.markdown(f"IUPAC Name: (6R,7R)-7-[[(2Z)-2-(2-amino-1,3-thiazol-4-yl)-2-methoxyiminoacetyl]amino]-3-[[5-(carboxymethyl)-4-methyl-1,3-thiazol-2-yl]sulfanylmethyl]-8-oxo-5-thia-1-azabicyclo[4.2.0]oct-2-ene-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5361871) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5361871) ]
