...
st.image(f"compound_structures/compound_10032582.jpg", caption=f"SMILES: COC(=O)CCC(NC(=O)C(CC(C)C)NC(=O)OCc1ccccc1)C(=O)NC(Cc1c[nH]cn1)C(=O)NC(CC(=O)OC)C(=O)CF")
