...
st.set_page_config(page_title="Tritec", layout="wide")
st.title("Tritec")
# Display the image in Streamlit
st.image(f"compound_structures/compound_62984.jpg", width=300)
st.markdown(f"PubChem Compound ID: [62984](https://pubchem.ncbi.nlm.nih.gov/compound/62984)")
st.markdown(f"IUPAC Name: bismuth;1-N'-[2-[[5-[(dimethylamino)methyl]furan-2-yl]methylsulfanyl]ethyl]-1-N-methyl-2-nitroethene-1,1-diamine;2-hydroxypropane-1,2,3-tricarboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 62984) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 62984) ]
