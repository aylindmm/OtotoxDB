...
st.set_page_config(page_title="Tizanidine", layout="wide")
st.title("Tizanidine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5487.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5487](https://pubchem.ncbi.nlm.nih.gov/compound/5487)")
st.markdown(f"IUPAC Name: 5-chloro-N-(4,5-dihydro-1H-imidazol-2-yl)-2,1,3-benzothiadiazol-4-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 5487) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5487) ]
