...
st.set_page_config(page_title="Isorhamnetin", layout="wide")
st.title("Isorhamnetin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5281654.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5281654](https://pubchem.ncbi.nlm.nih.gov/compound/5281654)")
st.markdown(f"IUPAC Name: 3,5,7-trihydroxy-2-(4-hydroxy-3-methoxyphenyl)chromen-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5281654) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5281654) ]
