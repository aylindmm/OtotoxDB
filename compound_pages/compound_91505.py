...
st.set_page_config(page_title="Oxybutynin chloride", layout="wide")
st.title("Oxybutynin chloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_91505.jpg", width=300)
st.markdown(f"PubChem Compound ID: [91505](https://pubchem.ncbi.nlm.nih.gov/compound/91505)")
st.markdown(f"IUPAC Name: 4-(diethylamino)but-2-ynyl 2-cyclohexyl-2-hydroxy-2-phenylacetate;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 91505) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 91505) ]
