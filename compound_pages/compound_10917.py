...
st.set_page_config(page_title="L-carnitine", layout="wide")
st.title("L-carnitine")
...
df_filtered = sources[(sources["PubChem_CID"] == 10917) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10917) ]
