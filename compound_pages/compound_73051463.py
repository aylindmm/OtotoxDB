...
st.set_page_config(page_title="Relacorilant", layout="wide")
st.title("Relacorilant")
# Display the image in Streamlit
st.image(f"compound_structures/compound_73051463.jpg", width=300)
st.markdown(f"PubChem Compound ID: [73051463](https://pubchem.ncbi.nlm.nih.gov/compound/73051463)")
st.markdown(f"IUPAC Name: [(4aR)-1-(4-fluorophenyl)-6-(1-methylpyrazol-4-yl)sulfonyl-4,5,7,8-tetrahydropyrazolo[5,4-g]isoquinolin-4a-yl]-[4-(trifluoromethyl)-2-pyridinyl]methanone")
...
df_filtered = sources[(sources["PubChem_CID"] == 73051463) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 73051463) ]
