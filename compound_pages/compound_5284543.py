...
st.set_page_config(page_title="Dihydrocodeine", layout="wide")
st.title("Dihydrocodeine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284543.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284543](https://pubchem.ncbi.nlm.nih.gov/compound/5284543)")
st.markdown(f"IUPAC Name: (4R,4aR,7S,7aR,12bS)-9-methoxy-3-methyl-2,4,4a,5,6,7,7a,13-octahydro-1H-4,12-methanobenzofuro[3,2-e]isoquinolin-7-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284543) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284543) ]
