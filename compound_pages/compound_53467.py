...
st.set_page_config(page_title="Fluzinamide", layout="wide")
st.title("Fluzinamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_53467.jpg", width=300)
st.markdown(f"PubChem Compound ID: [53467](https://pubchem.ncbi.nlm.nih.gov/compound/53467)")
st.markdown(f"IUPAC Name: N-methyl-3-[3-(trifluoromethyl)phenoxy]azetidine-1-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 53467) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 53467) ]
