...
st.set_page_config(page_title="Phentermine", layout="wide")
st.title("Phentermine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4771.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4771](https://pubchem.ncbi.nlm.nih.gov/compound/4771)")
st.markdown(f"IUPAC Name: 2-methyl-1-phenylpropan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4771) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4771) ]
