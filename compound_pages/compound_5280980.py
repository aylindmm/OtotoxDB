...
st.image(f"compound_structures/compound_5280980.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5280980) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5280980) ]
