...
st.set_page_config(page_title="Titanium", layout="wide")
st.title("Titanium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23963.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23963](https://pubchem.ncbi.nlm.nih.gov/compound/23963)")
st.markdown(f"IUPAC Name: titanium")
...
df_filtered = sources[(sources["PubChem_CID"] == 23963) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23963) ]
