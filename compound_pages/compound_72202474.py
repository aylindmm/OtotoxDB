...
st.set_page_config(page_title="1505514-27-1", layout="wide")
st.title("1505514-27-1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_72202474.jpg", width=300)
st.markdown(f"PubChem Compound ID: [72202474](https://pubchem.ncbi.nlm.nih.gov/compound/72202474)")
st.markdown(f"IUPAC Name: 3-[4-[(2R)-2-aminopropoxy]phenyl]-N-[(1R)-1-(3-fluorophenyl)ethyl]imidazo[1,2-b]pyridazin-6-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 72202474) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 72202474) ]
