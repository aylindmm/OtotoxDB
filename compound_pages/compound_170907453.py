...
st.set_page_config(page_title="Growth hormone", layout="wide")
st.title("Growth hormone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_170907453.jpg", width=300)
st.markdown(f"PubChem Compound ID: [170907453](https://pubchem.ncbi.nlm.nih.gov/compound/170907453)")
st.markdown(f"IUPAC Name: (2S)-2-[[(1R,4S,7S,13S,16R,21R,24R,27S,30S,33R,37S,43S)-21-[[(2S)-2-[[(2S)-4-amino-2-[[(2S)-2-[[(2S)-2-[[(2S)-2,4-diamino-4-oxobutanoyl]amino]-3-hydroxypropanoyl]amino]-3-hydroxypropanoyl]amino]-4-oxobutanoyl]amino]-3-(4-hydroxyphenyl)propanoyl]amino]-13-(2-amino-2-oxoethyl)-27-(2-carboxyethyl)-43-[(1R)-1-hydroxyethyl]-4-methyl-30-(2-methylpropyl)-3,6,12,15,22,25,28,31,39,42,45,50-dodecaoxo-18,19,35,36,47,48-hexathia-2,5,11,14,23,26,29,32,38,41,44,51-dodecazatetracyclo[22.21.4.216,33.07,11]henpentacontane-37-carbonyl]amino]-3-(4-hydroxyphenyl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 170907453) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 170907453) ]
