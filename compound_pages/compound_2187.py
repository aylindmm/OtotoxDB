...
st.set_page_config(page_title="Anastrozole", layout="wide")
st.title("Anastrozole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2187.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2187](https://pubchem.ncbi.nlm.nih.gov/compound/2187)")
st.markdown(f"IUPAC Name: 2-[3-(2-cyanopropan-2-yl)-5-(1,2,4-triazol-1-ylmethyl)phenyl]-2-methylpropanenitrile")
...
df_filtered = sources[(sources["PubChem_CID"] == 2187) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2187) ]
