...
st.set_page_config(page_title="Pirarubicin", layout="wide")
st.title("Pirarubicin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11296583.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11296583](https://pubchem.ncbi.nlm.nih.gov/compound/11296583)")
st.markdown(f"IUPAC Name: (7S,9S)-7-[(2R,4S,5S,6S)-4-amino-6-methyl-5-[(2R)-oxan-2-yl]oxyoxan-2-yl]oxy-6,9,11-trihydroxy-9-(2-hydroxyacetyl)-4-methoxy-8,10-dihydro-7H-tetracene-5,12-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 11296583) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11296583) ]
