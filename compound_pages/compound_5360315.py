...
st.image(f"compound_structures/compound_5360315.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 5360315) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5360315) ]
