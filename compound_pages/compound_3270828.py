...
st.set_page_config(page_title="1011-51-4", layout="wide")
st.title("1011-51-4")
...
df_filtered = sources[(sources["PubChem_CID"] == 3270828) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3270828) ]
