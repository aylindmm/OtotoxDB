...
st.set_page_config(page_title="Barium", layout="wide")
st.title("Barium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5355457.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5355457](https://pubchem.ncbi.nlm.nih.gov/compound/5355457)")
st.markdown(f"IUPAC Name: barium")
...
df_filtered = sources[(sources["PubChem_CID"] == 5355457) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5355457) ]
