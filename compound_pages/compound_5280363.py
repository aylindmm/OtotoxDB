...
st.set_page_config(page_title="Dinoprost", layout="wide")
st.title("Dinoprost")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5280363.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5280363](https://pubchem.ncbi.nlm.nih.gov/compound/5280363)")
st.markdown(f"IUPAC Name: (Z)-7-[(1R,2R,3R,5S)-3,5-dihydroxy-2-[(E,3S)-3-hydroxyoct-1-enyl]cyclopentyl]hept-5-enoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5280363) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5280363) ]
