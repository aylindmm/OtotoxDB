...
st.set_page_config(page_title="Nicotine", layout="wide")
st.title("Nicotine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_89594.jpg", width=300)
st.markdown(f"PubChem Compound ID: [89594](https://pubchem.ncbi.nlm.nih.gov/compound/89594)")
st.markdown(f"IUPAC Name: 3-[(2S)-1-methylpyrrolidin-2-yl]pyridine")
...
df_filtered = sources[(sources["PubChem_CID"] == 89594) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 89594) ]
