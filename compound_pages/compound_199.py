...
st.image(f"compound_structures/compound_199.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 199) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 199) ]
