...
st.set_page_config(page_title="Carbamimidamidomethanimidamide", layout="wide")
st.title("Carbamimidamidomethanimidamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_176517607.jpg", width=300)
st.markdown(f"PubChem Compound ID: [176517607](https://pubchem.ncbi.nlm.nih.gov/compound/176517607)")
st.markdown(f"IUPAC Name: 1-carbamimidoylguanidine")
...
df_filtered = sources[(sources["PubChem_CID"] == 176517607) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 176517607) ]
