...
st.set_page_config(page_title="Lacosamide", layout="wide")
st.title("Lacosamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_219078.jpg", width=300)
st.markdown(f"PubChem Compound ID: [219078](https://pubchem.ncbi.nlm.nih.gov/compound/219078)")
st.markdown(f"IUPAC Name: (2R)-2-acetamido-N-benzyl-3-methoxypropanamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 219078) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 219078) ]
