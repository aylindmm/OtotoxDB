...
st.image(f"compound_structures/compound_9433.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 9433) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9433) ]
