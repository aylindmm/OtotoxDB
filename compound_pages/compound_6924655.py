...
st.set_page_config(page_title="4-hydroxyquinoline-2-carboxylate", layout="wide")
st.title("4-hydroxyquinoline-2-carboxylate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6924655.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6924655](https://pubchem.ncbi.nlm.nih.gov/compound/6924655)")
st.markdown(f"IUPAC Name: 4-oxo-1H-quinoline-2-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6924655) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6924655) ]
