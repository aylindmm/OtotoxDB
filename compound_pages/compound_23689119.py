...
st.set_page_config(page_title="Msg monohydrate", layout="wide")
st.title("Msg monohydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23689119.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23689119](https://pubchem.ncbi.nlm.nih.gov/compound/23689119)")
st.markdown(f"IUPAC Name: sodium;(4S)-4-amino-5-hydroxy-5-oxopentanoate;hydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 23689119) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23689119) ]
