...
st.set_page_config(page_title="N-phenylhydroxylamine", layout="wide")
st.title("N-phenylhydroxylamine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7518.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7518](https://pubchem.ncbi.nlm.nih.gov/compound/7518)")
st.markdown(f"IUPAC Name: N-phenylhydroxylamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 7518) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7518) ]
