...
st.set_page_config(page_title="Potassium chloride", layout="wide")
st.title("Potassium chloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4873.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4873](https://pubchem.ncbi.nlm.nih.gov/compound/4873)")
st.markdown(f"IUPAC Name: potassium chloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 4873) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4873) ]
