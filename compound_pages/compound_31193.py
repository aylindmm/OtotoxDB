...
st.set_page_config(page_title="Cadmium ion", layout="wide")
st.title("Cadmium ion")
# Display the image in Streamlit
st.image(f"compound_structures/compound_31193.jpg", width=300)
st.markdown(f"PubChem Compound ID: [31193](https://pubchem.ncbi.nlm.nih.gov/compound/31193)")
st.markdown(f"IUPAC Name: cadmium(2+)")
...
df_filtered = sources[(sources["PubChem_CID"] == 31193) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 31193) ]
