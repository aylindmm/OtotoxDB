...
st.set_page_config(page_title="Larotrectinib", layout="wide")
st.title("Larotrectinib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_46188928.jpg", width=300)
st.markdown(f"PubChem Compound ID: [46188928](https://pubchem.ncbi.nlm.nih.gov/compound/46188928)")
st.markdown(f"IUPAC Name: (3S)-N-[5-[(2R)-2-(2,5-difluorophenyl)pyrrolidin-1-yl]pyrazolo[1,5-a]pyrimidin-3-yl]-3-hydroxypyrrolidine-1-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 46188928) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 46188928) ]
