...
st.set_page_config(page_title="Thalidomide", layout="wide")
st.title("Thalidomide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5426.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5426](https://pubchem.ncbi.nlm.nih.gov/compound/5426)")
st.markdown(f"IUPAC Name: 2-(2,6-dioxopiperidin-3-yl)isoindole-1,3-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 5426) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5426) ]
