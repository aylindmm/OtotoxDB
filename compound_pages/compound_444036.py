...
st.image(f"compound_structures/compound_444036.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 444036) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 444036) ]
