...
st.set_page_config(page_title="Gentamycin b1", layout="wide")
st.title("Gentamycin b1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_76970706.jpg", width=300)
st.markdown(f"PubChem Compound ID: [76970706](https://pubchem.ncbi.nlm.nih.gov/compound/76970706)")
st.markdown(f"IUPAC Name: (2R,3S,4S,5R,6S)-2-[(1R)-1-aminoethyl]-6-[(1R,2R,3S,4R,6S)-4,6-diamino-3-[(2R,3R,4R,5R)-3,5-dihydroxy-5-methyl-4-(methylamino)oxan-2-yl]oxy-2-hydroxycyclohexyl]oxyoxane-3,4,5-triol")
...
df_filtered = sources[(sources["PubChem_CID"] == 76970706) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 76970706) ]
