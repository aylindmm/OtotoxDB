...
st.set_page_config(page_title="Riluzole hydrochloride", layout="wide")
st.title("Riluzole hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6419992.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6419992](https://pubchem.ncbi.nlm.nih.gov/compound/6419992)")
st.markdown(f"IUPAC Name: 6-(trifluoromethoxy)-1,3-benzothiazol-2-amine;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 6419992) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6419992) ]
