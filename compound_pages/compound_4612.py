...
st.set_page_config(page_title="Oxamniquine", layout="wide")
st.title("Oxamniquine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4612.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4612](https://pubchem.ncbi.nlm.nih.gov/compound/4612)")
st.markdown(f"IUPAC Name: [7-nitro-2-[(propan-2-ylamino)methyl]-1,2,3,4-tetrahydroquinolin-6-yl]methanol")
...
df_filtered = sources[(sources["PubChem_CID"] == 4612) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4612) ]
