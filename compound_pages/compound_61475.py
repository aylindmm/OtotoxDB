...
st.set_page_config(page_title="Sodium thiosulfate pentahydrate", layout="wide")
st.title("Sodium thiosulfate pentahydrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_61475.jpg", width=300)
st.markdown(f"PubChem Compound ID: [61475](https://pubchem.ncbi.nlm.nih.gov/compound/61475)")
st.markdown(f"IUPAC Name: disodium;dioxido-oxo-sulfanylidene-lambda6-sulfane;pentahydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 61475) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 61475) ]
