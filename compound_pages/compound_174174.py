...
st.set_page_config(page_title="Refchem:1092872", layout="wide")
st.title("Refchem:1092872")
# Display the image in Streamlit
st.image(f"compound_structures/compound_174174.jpg", width=300)
st.markdown(f"PubChem Compound ID: [174174](https://pubchem.ncbi.nlm.nih.gov/compound/174174)")
st.markdown(f"IUPAC Name: [(1S,5R)-8-methyl-8-azabicyclo[3.2.1]octan-3-yl] 3-hydroxy-2-phenylpropanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 174174) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 174174) ]
