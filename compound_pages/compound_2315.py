...
st.set_page_config(page_title="Bendroflumethiazide", layout="wide")
st.title("Bendroflumethiazide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2315.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2315](https://pubchem.ncbi.nlm.nih.gov/compound/2315)")
st.markdown(f"IUPAC Name: 3-benzyl-1,1-dioxo-6-(trifluoromethyl)-3,4-dihydro-2H-1lambda6,2,4-benzothiadiazine-7-sulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 2315) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2315) ]
