...
st.set_page_config(page_title="Dorzolamide", layout="wide")
st.title("Dorzolamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5284549.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5284549](https://pubchem.ncbi.nlm.nih.gov/compound/5284549)")
st.markdown(f"IUPAC Name: (4S,6S)-4-(ethylamino)-6-methyl-7,7-dioxo-5,6-dihydro-4H-thieno[2,3-b]thiopyran-2-sulfonamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 5284549) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5284549) ]
