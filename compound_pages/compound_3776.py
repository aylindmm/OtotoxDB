...
st.set_page_config(page_title="Isopropyl alcohol", layout="wide")
st.title("Isopropyl alcohol")
...
df_filtered = sources[(sources["PubChem_CID"] == 3776) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3776) ]
