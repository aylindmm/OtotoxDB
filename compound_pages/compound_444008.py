...
st.set_page_config(page_title="Tibolone", layout="wide")
st.title("Tibolone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_444008.jpg", width=300)
st.markdown(f"PubChem Compound ID: [444008](https://pubchem.ncbi.nlm.nih.gov/compound/444008)")
st.markdown(f"IUPAC Name: (7R,8R,9S,13S,14S,17R)-17-ethynyl-17-hydroxy-7,13-dimethyl-1,2,4,6,7,8,9,11,12,14,15,16-dodecahydrocyclopenta[a]phenanthren-3-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 444008) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 444008) ]
