...
st.set_page_config(page_title="Procaine hydrochloride", layout="wide")
st.title("Procaine hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5795.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5795](https://pubchem.ncbi.nlm.nih.gov/compound/5795)")
st.markdown(f"IUPAC Name: 2-(diethylamino)ethyl 4-aminobenzoate;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 5795) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5795) ]
