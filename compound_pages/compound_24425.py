...
st.set_page_config(page_title="Chromic acid", layout="wide")
st.title("Chromic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24425.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24425](https://pubchem.ncbi.nlm.nih.gov/compound/24425)")
st.markdown(f"IUPAC Name: dihydroxy(dioxo)chromium")
...
df_filtered = sources[(sources["PubChem_CID"] == 24425) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24425) ]
