...
st.set_page_config(page_title="6'-sialyllactose", layout="wide")
st.title("6'-sialyllactose")
# Display the image in Streamlit
st.image(f"compound_structures/compound_643987.jpg", width=300)
st.markdown(f"PubChem Compound ID: [643987](https://pubchem.ncbi.nlm.nih.gov/compound/643987)")
st.markdown(f"IUPAC Name: (2R,4S,5R,6R)-5-acetamido-4-hydroxy-6-[(1R,2R)-1,2,3-trihydroxypropyl]-2-[[(2R,3R,4S,5R,6S)-3,4,5-trihydroxy-6-[(2R,3R,4R,5R)-1,2,4,5-tetrahydroxy-6-oxohexan-3-yl]oxyoxan-2-yl]methoxy]oxane-2-carboxylic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 643987) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 643987) ]
