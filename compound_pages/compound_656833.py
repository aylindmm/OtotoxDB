...
st.image(f"compound_structures/compound_656833.jpg", caption=f"SMILES: O=C(O)CCC(=O)OC[C@@H](NC(=O)C(Cl)Cl)[C@H](O)c1ccc([N+](=O)[O-])cc1")
...
df_filtered = sources[(sources["PubChem_CID"] == 656833) ]
