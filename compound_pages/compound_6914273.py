...
st.set_page_config(page_title="Dantrolene", layout="wide")
st.title("Dantrolene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6914273.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6914273](https://pubchem.ncbi.nlm.nih.gov/compound/6914273)")
st.markdown(f"IUPAC Name: 1-[(E)-[5-(4-nitrophenyl)furan-2-yl]methylideneamino]imidazolidine-2,4-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 6914273) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6914273) ]
