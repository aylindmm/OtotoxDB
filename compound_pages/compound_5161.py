...
st.set_page_config(page_title="Salsalate", layout="wide")
st.title("Salsalate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5161.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5161](https://pubchem.ncbi.nlm.nih.gov/compound/5161)")
st.markdown(f"IUPAC Name: 2-(2-hydroxybenzoyl)oxybenzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 5161) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5161) ]
