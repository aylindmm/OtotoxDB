...
st.set_page_config(page_title="Dilevalol", layout="wide")
st.title("Dilevalol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_134044.jpg", width=300)
st.markdown(f"PubChem Compound ID: [134044](https://pubchem.ncbi.nlm.nih.gov/compound/134044)")
st.markdown(f"IUPAC Name: 2-hydroxy-5-[(1R)-1-hydroxy-2-[[(2R)-4-phenylbutan-2-yl]amino]ethyl]benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 134044) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 134044) ]
