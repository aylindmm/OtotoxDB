...
st.set_page_config(page_title="4-hydroxybutanoic acid", layout="wide")
st.title("4-hydroxybutanoic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_10413.jpg", width=300)
st.markdown(f"PubChem Compound ID: [10413](https://pubchem.ncbi.nlm.nih.gov/compound/10413)")
st.markdown(f"IUPAC Name: 4-hydroxybutanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 10413) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 10413) ]
