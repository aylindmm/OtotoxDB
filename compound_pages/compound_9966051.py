...
st.set_page_config(page_title="Vortioxetine", layout="wide")
st.title("Vortioxetine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9966051.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9966051](https://pubchem.ncbi.nlm.nih.gov/compound/9966051)")
st.markdown(f"IUPAC Name: 1-[2-(2,4-dimethylphenyl)sulfanylphenyl]piperazine")
...
df_filtered = sources[(sources["PubChem_CID"] == 9966051) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9966051) ]
