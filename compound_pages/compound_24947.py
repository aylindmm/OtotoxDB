...
st.set_page_config(page_title="Dichlorocadmium", layout="wide")
st.title("Dichlorocadmium")
# Display the image in Streamlit
st.image(f"compound_structures/compound_24947.jpg", width=300)
st.markdown(f"PubChem Compound ID: [24947](https://pubchem.ncbi.nlm.nih.gov/compound/24947)")
st.markdown(f"IUPAC Name: dichlorocadmium")
...
df_filtered = sources[(sources["PubChem_CID"] == 24947) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 24947) ]
