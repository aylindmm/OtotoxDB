...
st.set_page_config(page_title="Prednisolone acetate", layout="wide")
st.title("Prednisolone acetate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5834.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5834](https://pubchem.ncbi.nlm.nih.gov/compound/5834)")
st.markdown(f"IUPAC Name: [2-[(8S,9S,10R,11S,13S,14S,17R)-11,17-dihydroxy-10,13-dimethyl-3-oxo-7,8,9,11,12,14,15,16-octahydro-6H-cyclopenta[a]phenanthren-17-yl]-2-oxoethyl] acetate")
...
df_filtered = sources[(sources["PubChem_CID"] == 5834) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5834) ]
