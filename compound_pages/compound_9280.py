...
st.set_page_config(page_title="Methylphenidate hydrochloride", layout="wide")
st.title("Methylphenidate hydrochloride")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9280.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9280](https://pubchem.ncbi.nlm.nih.gov/compound/9280)")
st.markdown(f"IUPAC Name: methyl 2-phenyl-2-piperidin-2-ylacetate;hydrochloride")
...
df_filtered = sources[(sources["PubChem_CID"] == 9280) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9280) ]
