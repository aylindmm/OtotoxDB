...
st.set_page_config(page_title="Nedaplatin", layout="wide")
st.title("Nedaplatin")
...
df_filtered = sources[(sources["PubChem_CID"] == 9796440) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9796440) ]
