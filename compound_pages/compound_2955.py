...
st.set_page_config(page_title="Dapsone", layout="wide")
st.title("Dapsone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2955.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2955](https://pubchem.ncbi.nlm.nih.gov/compound/2955)")
st.markdown(f"IUPAC Name: 4-(4-aminophenyl)sulfonylaniline")
...
df_filtered = sources[(sources["PubChem_CID"] == 2955) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2955) ]
