...
st.set_page_config(page_title="Isotetrandrine", layout="wide")
st.title("Isotetrandrine")
...
st.image(f"compound_structures/compound_457825.jpg", caption=f"SMILES: COc1ccc2cc1Oc1ccc(cc1)C[C@H]1c3cc(c(OC)cc3CCN1C)Oc1c(OC)c(OC)cc3c1[C@@H](C2)N(C)CC3")
...
df_filtered = sources[(sources["PubChem_CID"] == 457825) ]
