...
st.set_page_config(page_title="Flecainide", layout="wide")
st.title("Flecainide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3356.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3356](https://pubchem.ncbi.nlm.nih.gov/compound/3356)")
st.markdown(f"IUPAC Name: N-(piperidin-2-ylmethyl)-2,5-bis(2,2,2-trifluoroethoxy)benzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3356) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3356) ]
