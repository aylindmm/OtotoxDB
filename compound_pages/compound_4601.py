...
st.image(f"compound_structures/compound_4601.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 4601) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4601) ]
