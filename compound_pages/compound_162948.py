...
st.set_page_config(page_title="61711-37-3", layout="wide")
st.title("61711-37-3")
# Display the image in Streamlit
st.image(f"compound_structures/compound_162948.jpg", width=300)
st.markdown(f"PubChem Compound ID: [162948](https://pubchem.ncbi.nlm.nih.gov/compound/162948)")
st.markdown(f"IUPAC Name: 4-[2-(ethylamino)ethyl]-2-methyl-5-(methylsulfanylmethyl)pyridin-3-ol")
...
df_filtered = sources[(sources["PubChem_CID"] == 162948) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 162948) ]
