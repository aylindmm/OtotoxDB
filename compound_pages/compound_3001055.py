...
st.set_page_config(page_title="Ranitidine", layout="wide")
st.title("Ranitidine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3001055.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3001055](https://pubchem.ncbi.nlm.nih.gov/compound/3001055)")
st.markdown(f"IUPAC Name: (E)-1-N'-[2-[[5-[(dimethylamino)methyl]furan-2-yl]methylsulfanyl]ethyl]-1-N-methyl-2-nitroethene-1,1-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3001055) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3001055) ]
