...
st.set_page_config(page_title="Paliperidone", layout="wide")
st.title("Paliperidone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_115237.jpg", width=300)
st.markdown(f"PubChem Compound ID: [115237](https://pubchem.ncbi.nlm.nih.gov/compound/115237)")
st.markdown(f"IUPAC Name: 3-[2-[4-(6-fluoro-1,2-benzoxazol-3-yl)piperidin-1-yl]ethyl]-9-hydroxy-2-methyl-6,7,8,9-tetrahydropyrido[1,2-a]pyrimidin-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 115237) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 115237) ]
