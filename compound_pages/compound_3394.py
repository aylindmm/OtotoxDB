...
st.set_page_config(page_title="Flurbiprofen", layout="wide")
st.title("Flurbiprofen")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3394.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3394](https://pubchem.ncbi.nlm.nih.gov/compound/3394)")
st.markdown(f"IUPAC Name: 2-(3-fluoro-4-phenylphenyl)propanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 3394) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3394) ]
