...
st.set_page_config(page_title="Guanfacine", layout="wide")
st.title("Guanfacine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3519.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3519](https://pubchem.ncbi.nlm.nih.gov/compound/3519)")
st.markdown(f"IUPAC Name: N-(diaminomethylidene)-2-(2,6-dichlorophenyl)acetamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 3519) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3519) ]
