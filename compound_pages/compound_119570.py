...
st.set_page_config(page_title="Pramipexole", layout="wide")
st.title("Pramipexole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_119570.jpg", width=300)
st.markdown(f"PubChem Compound ID: [119570](https://pubchem.ncbi.nlm.nih.gov/compound/119570)")
st.markdown(f"IUPAC Name: (6S)-6-N-propyl-4,5,6,7-tetrahydro-1,3-benzothiazole-2,6-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 119570) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 119570) ]
