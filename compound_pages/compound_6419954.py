...
st.set_page_config(page_title="6209-17-2", layout="wide")
st.title("6209-17-2")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6419954.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6419954](https://pubchem.ncbi.nlm.nih.gov/compound/6419954)")
st.markdown(f"IUPAC Name: sodium;acetyl-(4-aminophenyl)sulfonylazanide;hydrate")
...
df_filtered = sources[(sources["PubChem_CID"] == 6419954) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6419954) ]
