...
st.set_page_config(page_title="Phenylbutazone", layout="wide")
st.title("Phenylbutazone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4781.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4781](https://pubchem.ncbi.nlm.nih.gov/compound/4781)")
st.markdown(f"IUPAC Name: 4-butyl-1,2-diphenylpyrazolidine-3,5-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 4781) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4781) ]
