...
st.set_page_config(page_title="Potassium cyanide", layout="wide")
st.title("Potassium cyanide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_9032.jpg", width=300)
st.markdown(f"PubChem Compound ID: [9032](https://pubchem.ncbi.nlm.nih.gov/compound/9032)")
st.markdown(f"IUPAC Name: potassium cyanide")
...
df_filtered = sources[(sources["PubChem_CID"] == 9032) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 9032) ]
