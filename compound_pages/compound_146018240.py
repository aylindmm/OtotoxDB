...
st.set_page_config(page_title="(7r)-n-benzyl-1,7-diethyl-2,3,6,7-tetrahydro-1h-1,4-diazepine-7-carboxamide", layout="wide")
st.title("(7r)-n-benzyl-1,7-diethyl-2,3,6,7-tetrahydro-1h-1,4-diazepine-7-carboxamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_146018240.jpg", width=300)
st.markdown(f"PubChem Compound ID: [146018240](https://pubchem.ncbi.nlm.nih.gov/compound/146018240)")
st.markdown(f"IUPAC Name: (5R)-N-benzyl-4,5-diethyl-3,6-dihydro-2H-1,4-diazepine-5-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 146018240) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 146018240) ]
