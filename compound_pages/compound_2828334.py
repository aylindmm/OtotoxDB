...
st.set_page_config(page_title="Necrostatin-1", layout="wide")
st.title("Necrostatin-1")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2828334.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2828334](https://pubchem.ncbi.nlm.nih.gov/compound/2828334)")
st.markdown(f"IUPAC Name: 5-(1H-indol-3-ylmethyl)-3-methyl-2-sulfanylideneimidazolidin-4-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 2828334) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2828334) ]
