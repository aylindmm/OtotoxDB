...
st.set_page_config(page_title="Albendazole", layout="wide")
st.title("Albendazole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2082.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2082](https://pubchem.ncbi.nlm.nih.gov/compound/2082)")
st.markdown(f"IUPAC Name: methyl N-(6-propylsulfanyl-1H-benzimidazol-2-yl)carbamate")
...
df_filtered = sources[(sources["PubChem_CID"] == 2082) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2082) ]
