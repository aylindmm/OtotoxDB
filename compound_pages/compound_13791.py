...
st.set_page_config(page_title="Estradiol valerate", layout="wide")
st.title("Estradiol valerate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_13791.jpg", width=300)
st.markdown(f"PubChem Compound ID: [13791](https://pubchem.ncbi.nlm.nih.gov/compound/13791)")
st.markdown(f"IUPAC Name: [(8R,9S,13S,14S,17S)-3-hydroxy-13-methyl-6,7,8,9,11,12,14,15,16,17-decahydrocyclopenta[a]phenanthren-17-yl] pentanoate")
...
df_filtered = sources[(sources["PubChem_CID"] == 13791) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 13791) ]
