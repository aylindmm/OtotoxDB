...
st.set_page_config(page_title="Ropinirole", layout="wide")
st.title("Ropinirole")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5095.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5095](https://pubchem.ncbi.nlm.nih.gov/compound/5095)")
st.markdown(f"IUPAC Name: 4-[2-(dipropylamino)ethyl]-1,3-dihydroindol-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 5095) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5095) ]
