...
st.set_page_config(page_title="Triptorelin", layout="wide")
st.title("Triptorelin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_25074470.jpg", width=300)
st.markdown(f"PubChem Compound ID: [25074470](https://pubchem.ncbi.nlm.nih.gov/compound/25074470)")
st.markdown(f"IUPAC Name: (2S)-N-[(2S)-1-[[(2S)-1-[[(2S)-1-[[(2S)-1-[[(2R)-1-[[(2S)-1-[[(2S)-1-[(2S)-2-[(2-amino-2-oxoethyl)carbamoyl]pyrrolidin-1-yl]-5-(diaminomethylideneamino)-1-oxopentan-2-yl]amino]-4-methyl-1-oxopentan-2-yl]amino]-3-(1H-indol-3-yl)-1-oxopropan-2-yl]amino]-3-(4-hydroxyphenyl)-1-oxopropan-2-yl]amino]-3-hydroxy-1-oxopropan-2-yl]amino]-3-(1H-indol-3-yl)-1-oxopropan-2-yl]amino]-3-(1H-imidazol-5-yl)-1-oxopropan-2-yl]-5-oxopyrrolidine-2-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 25074470) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 25074470) ]
