...
st.set_page_config(page_title="Mitoxantrone", layout="wide")
st.title("Mitoxantrone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4212.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4212](https://pubchem.ncbi.nlm.nih.gov/compound/4212)")
st.markdown(f"IUPAC Name: 1,4-dihydroxy-5,8-bis[2-(2-hydroxyethylamino)ethylamino]anthracene-9,10-dione")
...
df_filtered = sources[(sources["PubChem_CID"] == 4212) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4212) ]
