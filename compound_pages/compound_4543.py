...
st.set_page_config(page_title="Nortriptyline", layout="wide")
st.title("Nortriptyline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4543.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4543](https://pubchem.ncbi.nlm.nih.gov/compound/4543)")
st.markdown(f"IUPAC Name: N-methyl-3-(2-tricyclo[9.4.0.03,8]pentadeca-1(15),3,5,7,11,13-hexaenylidene)propan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4543) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4543) ]
