...
st.set_page_config(page_title="Pemafibrate", layout="wide")
st.title("Pemafibrate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_11526038.jpg", width=300)
st.markdown(f"PubChem Compound ID: [11526038](https://pubchem.ncbi.nlm.nih.gov/compound/11526038)")
st.markdown(f"IUPAC Name: (2R)-2-[3-[[1,3-benzoxazol-2-yl-[3-(4-methoxyphenoxy)propyl]amino]methyl]phenoxy]butanoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 11526038) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 11526038) ]
