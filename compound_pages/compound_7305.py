...
st.set_page_config(page_title="Soman", layout="wide")
st.title("Soman")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7305.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7305](https://pubchem.ncbi.nlm.nih.gov/compound/7305)")
st.markdown(f"IUPAC Name: 3-[fluoro(methyl)phosphoryl]oxy-2,2-dimethylbutane")
...
df_filtered = sources[(sources["PubChem_CID"] == 7305) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7305) ]
