...
st.set_page_config(page_title="Cinnabar", layout="wide")
st.title("Cinnabar")
# Display the image in Streamlit
st.image(f"compound_structures/compound_62402.jpg", width=300)
st.markdown(f"PubChem Compound ID: [62402](https://pubchem.ncbi.nlm.nih.gov/compound/62402)")
st.markdown(f"IUPAC Name: sulfanylidenemercury")
...
df_filtered = sources[(sources["PubChem_CID"] == 62402) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 62402) ]
