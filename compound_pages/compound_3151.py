...
st.set_page_config(page_title="Domperidone", layout="wide")
st.title("Domperidone")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3151.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3151](https://pubchem.ncbi.nlm.nih.gov/compound/3151)")
st.markdown(f"IUPAC Name: 6-chloro-3-[1-[3-(2-oxo-3H-benzimidazol-1-yl)propyl]piperidin-4-yl]-1H-benzimidazol-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3151) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3151) ]
