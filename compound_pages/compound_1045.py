...
st.set_page_config(page_title="1,4-diaminobutane", layout="wide")
st.title("1,4-diaminobutane")
# Display the image in Streamlit
st.image(f"compound_structures/compound_1045.jpg", width=300)
st.markdown(f"PubChem Compound ID: [1045](https://pubchem.ncbi.nlm.nih.gov/compound/1045)")
st.markdown(f"IUPAC Name: butane-1,4-diamine")
...
df_filtered = sources[(sources["PubChem_CID"] == 1045) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 1045) ]
