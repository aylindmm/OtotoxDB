...
st.set_page_config(page_title="4-hydroxynonenal", layout="wide")
st.title("4-hydroxynonenal")
# Display the image in Streamlit
st.image(f"compound_structures/compound_5283344.jpg", width=300)
st.markdown(f"PubChem Compound ID: [5283344](https://pubchem.ncbi.nlm.nih.gov/compound/5283344)")
st.markdown(f"IUPAC Name: (E)-4-hydroxynon-2-enal")
...
df_filtered = sources[(sources["PubChem_CID"] == 5283344) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 5283344) ]
