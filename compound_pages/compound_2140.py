...
st.set_page_config(page_title="Diatrizoic acid", layout="wide")
st.title("Diatrizoic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_2140.jpg", width=300)
st.markdown(f"PubChem Compound ID: [2140](https://pubchem.ncbi.nlm.nih.gov/compound/2140)")
st.markdown(f"IUPAC Name: 3,5-diacetamido-2,4,6-triiodobenzoic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 2140) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2140) ]
