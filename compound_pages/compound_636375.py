...
st.image(f"compound_structures/compound_636375.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 636375) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 636375) ]
