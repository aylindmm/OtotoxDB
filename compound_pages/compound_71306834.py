...
st.set_page_config(page_title="Interferon alfa-2b", layout="wide")
st.title("Interferon alfa-2b")
# Display the image in Streamlit
st.image(f"compound_structures/compound_71306834.jpg", width=300)
st.markdown(f"PubChem Compound ID: [71306834](https://pubchem.ncbi.nlm.nih.gov/compound/71306834)")
st.markdown(f"IUPAC Name: sodium;diiodomethanesulfonate;N-propyl-N-[2-(2,4,6-trichlorophenoxy)ethyl]imidazole-1-carboxamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 71306834) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 71306834) ]
