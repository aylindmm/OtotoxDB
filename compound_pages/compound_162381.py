...
st.set_page_config(page_title="Bioresmethrin", layout="wide")
st.title("Bioresmethrin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_162381.jpg", width=300)
st.markdown(f"PubChem Compound ID: [162381](https://pubchem.ncbi.nlm.nih.gov/compound/162381)")
st.markdown(f"IUPAC Name: cis-(5-benzylfuran-3-yl)methyl (1R,3R)-2,2-dimethyl-3-(2-methylprop-1-enyl)cyclopropane-1-carboxylate")
...
df_filtered = sources[(sources["PubChem_CID"] == 162381) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 162381) ]
