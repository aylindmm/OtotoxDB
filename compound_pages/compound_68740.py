...
st.set_page_config(page_title="Zoledronic acid", layout="wide")
st.title("Zoledronic acid")
# Display the image in Streamlit
st.image(f"compound_structures/compound_68740.jpg", width=300)
st.markdown(f"PubChem Compound ID: [68740](https://pubchem.ncbi.nlm.nih.gov/compound/68740)")
st.markdown(f"IUPAC Name: (1-hydroxy-2-imidazol-1-yl-1-phosphonoethyl)phosphonic acid")
...
df_filtered = sources[(sources["PubChem_CID"] == 68740) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 68740) ]
