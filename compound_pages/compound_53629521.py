...
st.set_page_config(page_title="Kaopectate", layout="wide")
st.title("Kaopectate")
# Display the image in Streamlit
st.image(f"compound_structures/compound_53629521.jpg", width=300)
st.markdown(f"PubChem Compound ID: [53629521](https://pubchem.ncbi.nlm.nih.gov/compound/53629521)")
st.markdown(f"IUPAC Name: bismuth;2-oxidobenzoate;hydroxide")
...
df_filtered = sources[(sources["PubChem_CID"] == 53629521) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 53629521) ]
