...
st.set_page_config(page_title="Molybdenum", layout="wide")
st.title("Molybdenum")
# Display the image in Streamlit
st.image(f"compound_structures/compound_23932.jpg", width=300)
st.markdown(f"PubChem Compound ID: [23932](https://pubchem.ncbi.nlm.nih.gov/compound/23932)")
st.markdown(f"IUPAC Name: molybdenum")
...
df_filtered = sources[(sources["PubChem_CID"] == 23932) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 23932) ]
