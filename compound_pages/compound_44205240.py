...
st.set_page_config(page_title="Baricitinib", layout="wide")
st.title("Baricitinib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_44205240.jpg", width=300)
...
df_filtered = sources[(sources["PubChem_CID"] == 44205240) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 44205240) ]
