...
st.set_page_config(page_title="Duloxetine", layout="wide")
st.title("Duloxetine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_60835.jpg", width=300)
st.markdown(f"PubChem Compound ID: [60835](https://pubchem.ncbi.nlm.nih.gov/compound/60835)")
st.markdown(f"IUPAC Name: (3S)-N-methyl-3-naphthalen-1-yloxy-3-thiophen-2-ylpropan-1-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 60835) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 60835) ]
