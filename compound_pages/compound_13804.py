...
st.set_page_config(page_title="Citicoline", layout="wide")
st.title("Citicoline")
# Display the image in Streamlit
st.image(f"compound_structures/compound_13804.jpg", width=300)
st.markdown(f"PubChem Compound ID: [13804](https://pubchem.ncbi.nlm.nih.gov/compound/13804)")
st.markdown(f"IUPAC Name: [[(2R,3S,4R,5R)-5-(4-amino-2-oxopyrimidin-1-yl)-3,4-dihydroxyoxolan-2-yl]methoxy-hydroxyphosphoryl] 2-(trimethylazaniumyl)ethyl phosphate")
...
df_filtered = sources[(sources["PubChem_CID"] == 13804) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 13804) ]
