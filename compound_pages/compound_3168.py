...
st.set_page_config(page_title="Droperidol", layout="wide")
st.title("Droperidol")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3168.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3168](https://pubchem.ncbi.nlm.nih.gov/compound/3168)")
st.markdown(f"IUPAC Name: 3-[1-[4-(4-fluorophenyl)-4-oxobutyl]-3,6-dihydro-2H-pyridin-4-yl]-1H-benzimidazol-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 3168) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3168) ]
