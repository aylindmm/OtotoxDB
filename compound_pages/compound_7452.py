...
st.set_page_config(page_title="1,3-dinitrobenzene", layout="wide")
st.title("1,3-dinitrobenzene")
# Display the image in Streamlit
st.image(f"compound_structures/compound_7452.jpg", width=300)
st.markdown(f"PubChem Compound ID: [7452](https://pubchem.ncbi.nlm.nih.gov/compound/7452)")
st.markdown(f"IUPAC Name: 1,3-dinitrobenzene")
...
df_filtered = sources[(sources["PubChem_CID"] == 7452) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 7452) ]
