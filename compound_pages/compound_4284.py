...
st.set_page_config(page_title="Diethyltoluamide", layout="wide")
st.title("Diethyltoluamide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4284.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4284](https://pubchem.ncbi.nlm.nih.gov/compound/4284)")
st.markdown(f"IUPAC Name: N,N-diethyl-3-methylbenzamide")
...
df_filtered = sources[(sources["PubChem_CID"] == 4284) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4284) ]
