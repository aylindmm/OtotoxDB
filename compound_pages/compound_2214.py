...
st.set_page_config(page_title="Acetovanillone", layout="wide")
st.title("Acetovanillone")
...
df_filtered = sources[(sources["PubChem_CID"] == 2214) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 2214) ]
