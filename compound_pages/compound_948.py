...
st.set_page_config(page_title="Nitrous oxide", layout="wide")
st.title("Nitrous oxide")
# Display the image in Streamlit
st.image(f"compound_structures/compound_948.jpg", width=300)
st.markdown(f"PubChem Compound ID: [948](https://pubchem.ncbi.nlm.nih.gov/compound/948)")
st.markdown(f"IUPAC Name: nitrous oxide")
...
df_filtered = sources[(sources["PubChem_CID"] == 948) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 948) ]
