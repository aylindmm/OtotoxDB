...
st.set_page_config(page_title="Vandetanib", layout="wide")
st.title("Vandetanib")
# Display the image in Streamlit
st.image(f"compound_structures/compound_3081361.jpg", width=300)
st.markdown(f"PubChem Compound ID: [3081361](https://pubchem.ncbi.nlm.nih.gov/compound/3081361)")
st.markdown(f"IUPAC Name: N-(4-bromo-2-fluorophenyl)-6-methoxy-7-[(1-methylpiperidin-4-yl)methoxy]quinazolin-4-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 3081361) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 3081361) ]
