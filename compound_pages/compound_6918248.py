...
st.set_page_config(page_title="Flibanserin", layout="wide")
st.title("Flibanserin")
# Display the image in Streamlit
st.image(f"compound_structures/compound_6918248.jpg", width=300)
st.markdown(f"PubChem Compound ID: [6918248](https://pubchem.ncbi.nlm.nih.gov/compound/6918248)")
st.markdown(f"IUPAC Name: 3-[2-[4-[3-(trifluoromethyl)phenyl]piperazin-1-yl]ethyl]-1H-benzimidazol-2-one")
...
df_filtered = sources[(sources["PubChem_CID"] == 6918248) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 6918248) ]
