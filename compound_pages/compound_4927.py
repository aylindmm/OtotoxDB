...
st.set_page_config(page_title="Promethazine", layout="wide")
st.title("Promethazine")
# Display the image in Streamlit
st.image(f"compound_structures/compound_4927.jpg", width=300)
st.markdown(f"PubChem Compound ID: [4927](https://pubchem.ncbi.nlm.nih.gov/compound/4927)")
st.markdown(f"IUPAC Name: N,N-dimethyl-1-phenothiazin-10-ylpropan-2-amine")
...
df_filtered = sources[(sources["PubChem_CID"] == 4927) ]
...
tar_filtered = target_info[(target_info["PubChem_CID"] == 4927) ]
