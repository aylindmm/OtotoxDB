...
st.set_page_config(page_title="CAH5B", layout="wide")
st.title("Carbonic anhydrase 5B, mitochondrial")
st.markdown(f"Uniprot ID: [Q9Y2D0](https://www.uniprot.org/uniprotkb/Q9Y2D0/)")
st.markdown(f"Protein symbol: CAH5B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2D0') ]
