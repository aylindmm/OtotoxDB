...
st.set_page_config(page_title="CAH5A", layout="wide")
st.title("Carbonic anhydrase 5A, mitochondrial")
st.markdown(f"Uniprot ID: [P35218](https://www.uniprot.org/uniprotkb/P35218/)")
st.markdown(f"Protein symbol: CAH5A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35218') ]
