...
st.set_page_config(page_title="NADK", layout="wide")
st.title("NAD kinase")
st.markdown(f"Uniprot ID: [O95544](https://www.uniprot.org/uniprotkb/O95544/)")
st.markdown(f"Protein symbol: NADK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95544') ]
