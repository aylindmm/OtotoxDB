...
st.set_page_config(page_title="FFAR2", layout="wide")
st.title("Free fatty acid receptor 2")
st.markdown(f"Uniprot ID: [O15552](https://www.uniprot.org/uniprotkb/O15552/)")
st.markdown(f"Protein symbol: FFAR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15552') ]
