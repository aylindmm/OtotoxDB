...
st.set_page_config(page_title="PPP5", layout="wide")
st.title("Serine/threonine-protein phosphatase 5")
st.markdown(f"Uniprot ID: [P53041](https://www.uniprot.org/uniprotkb/P53041/)")
st.markdown(f"Protein symbol: PPP5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53041') ]
