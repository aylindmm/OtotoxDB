...
st.set_page_config(page_title="P4HTM", layout="wide")
st.title("Transmembrane prolyl 4-hydroxylase")
st.markdown(f"Uniprot ID: [Q9NXG6](https://www.uniprot.org/uniprotkb/Q9NXG6/)")
st.markdown(f"Protein symbol: P4HTM")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NXG6') ]
