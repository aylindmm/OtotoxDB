...
st.set_page_config(page_title="DLK1", layout="wide")
st.title("Protein delta homolog 1")
st.markdown(f"Uniprot ID: [P80370](https://www.uniprot.org/uniprotkb/P80370/)")
st.markdown(f"Protein symbol: DLK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P80370') ]
