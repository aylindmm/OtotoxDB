...
st.set_page_config(page_title="COX2", layout="wide")
st.title("Cytochrome c oxidase subunit 2")
st.markdown(f"Uniprot ID: [P00403](https://www.uniprot.org/uniprotkb/P00403/)")
st.markdown(f"Protein symbol: COX2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00403') ]
