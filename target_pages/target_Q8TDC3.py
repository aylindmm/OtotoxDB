...
st.set_page_config(page_title="BRSK1", layout="wide")
st.title("Serine/threonine-protein kinase BRSK1")
st.markdown(f"Uniprot ID: [Q8TDC3](https://www.uniprot.org/uniprotkb/Q8TDC3/)")
st.markdown(f"Protein symbol: BRSK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TDC3') ]
