...
st.set_page_config(page_title="GALE", layout="wide")
st.title("UDP-glucose 4-epimerase")
st.markdown(f"Uniprot ID: [Q14376](https://www.uniprot.org/uniprotkb/Q14376/)")
st.markdown(f"Protein symbol: GALE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14376') ]
