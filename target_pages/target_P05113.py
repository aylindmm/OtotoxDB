...
st.set_page_config(page_title="IL5", layout="wide")
st.title("Interleukin-5")
st.markdown(f"Uniprot ID: [P05113](https://www.uniprot.org/uniprotkb/P05113/)")
st.markdown(f"Protein symbol: IL5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05113') ]
