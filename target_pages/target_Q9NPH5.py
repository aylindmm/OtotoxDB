...
st.set_page_config(page_title="NOX4", layout="wide")
st.title("NADPH oxidase 4")
st.markdown(f"Uniprot ID: [Q9NPH5](https://www.uniprot.org/uniprotkb/Q9NPH5/)")
st.markdown(f"Protein symbol: NOX4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NPH5') ]
