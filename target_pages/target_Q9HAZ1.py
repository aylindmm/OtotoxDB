...
st.set_page_config(page_title="CLK4", layout="wide")
st.title("Dual specificity protein kinase CLK4")
st.markdown(f"Uniprot ID: [Q9HAZ1](https://www.uniprot.org/uniprotkb/Q9HAZ1/)")
st.markdown(f"Protein symbol: CLK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HAZ1') ]
