...
st.set_page_config(page_title="TSSK1", layout="wide")
st.title("Testis-specific serine/threonine-protein kinase 1")
st.markdown(f"Uniprot ID: [Q9BXA7](https://www.uniprot.org/uniprotkb/Q9BXA7/)")
st.markdown(f"Protein symbol: TSSK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BXA7') ]
