...
st.set_page_config(page_title="KKCC1", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase kinase 1")
st.markdown(f"Uniprot ID: [Q8N5S9](https://www.uniprot.org/uniprotkb/Q8N5S9/)")
st.markdown(f"Protein symbol: KKCC1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8N5S9') ]
