...
st.set_page_config(page_title="ACHA4", layout="wide")
st.title("Neuronal acetylcholine receptor subunit alpha-4/beta-4")
st.markdown(f"Uniprot ID: [P43681](https://www.uniprot.org/uniprotkb/P43681/)")
st.markdown(f"Protein symbol: ACHA4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43681') ]
