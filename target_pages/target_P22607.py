...
st.set_page_config(page_title="FGFR3", layout="wide")
st.title("Fibroblast growth factor receptor 3")
st.markdown(f"Uniprot ID: [P22607](https://www.uniprot.org/uniprotkb/P22607/)")
st.markdown(f"Protein symbol: FGFR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22607') ]
