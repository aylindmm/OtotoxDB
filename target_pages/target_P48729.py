...
st.set_page_config(page_title="KC1A", layout="wide")
st.title("Casein kinase I isoform alpha")
st.markdown(f"Uniprot ID: [P48729](https://www.uniprot.org/uniprotkb/P48729/)")
st.markdown(f"Protein symbol: KC1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48729') ]
