...
st.set_page_config(page_title="CSKP", layout="wide")
st.title("Peripheral plasma membrane protein CASK")
st.markdown(f"Uniprot ID: [O14936](https://www.uniprot.org/uniprotkb/O14936/)")
st.markdown(f"Protein symbol: CSKP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14936') ]
