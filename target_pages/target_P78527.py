...
st.set_page_config(page_title="PRKDC", layout="wide")
st.title("DNA-dependent protein kinase catalytic subunit")
st.markdown(f"Uniprot ID: [P78527](https://www.uniprot.org/uniprotkb/P78527/)")
st.markdown(f"Protein symbol: PRKDC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P78527') ]
