...
st.set_page_config(page_title="SO1A2", layout="wide")
st.title("Solute carrier organic anion transporter family member 1A2")
st.markdown(f"Uniprot ID: [P46721](https://www.uniprot.org/uniprotkb/P46721/)")
st.markdown(f"Protein symbol: SO1A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P46721') ]
