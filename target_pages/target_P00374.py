...
st.set_page_config(page_title="DYR", layout="wide")
st.title("Dihydrofolate reductase")
st.markdown(f"Uniprot ID: [P00374](https://www.uniprot.org/uniprotkb/P00374/)")
st.markdown(f"Protein symbol: DYR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00374') ]
