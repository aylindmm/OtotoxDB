...
st.set_page_config(page_title="KCC1A", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase type 1")
st.markdown(f"Uniprot ID: [Q14012](https://www.uniprot.org/uniprotkb/Q14012/)")
st.markdown(f"Protein symbol: KCC1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14012') ]
