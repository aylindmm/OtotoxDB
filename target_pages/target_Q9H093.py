...
st.set_page_config(page_title="NUAK2", layout="wide")
st.title("NUAK family SNF1-like kinase 2")
st.markdown(f"Uniprot ID: [Q9H093](https://www.uniprot.org/uniprotkb/Q9H093/)")
st.markdown(f"Protein symbol: NUAK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H093') ]
