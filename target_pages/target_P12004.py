...
st.set_page_config(page_title="PCNA", layout="wide")
st.title("Proliferating cell nuclear antigen")
st.markdown(f"Uniprot ID: [P12004](https://www.uniprot.org/uniprotkb/P12004/)")
st.markdown(f"Protein symbol: PCNA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P12004') ]
