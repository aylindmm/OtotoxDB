...
st.set_page_config(page_title="FTO", layout="wide")
st.title("Alpha-ketoglutarate-dependent dioxygenase FTO")
st.markdown(f"Uniprot ID: [Q9C0B1](https://www.uniprot.org/uniprotkb/Q9C0B1/)")
st.markdown(f"Protein symbol: FTO")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9C0B1') ]
