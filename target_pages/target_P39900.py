...
st.set_page_config(page_title="MMP12", layout="wide")
st.title("Macrophage metalloelastase")
st.markdown(f"Uniprot ID: [P39900](https://www.uniprot.org/uniprotkb/P39900/)")
st.markdown(f"Protein symbol: MMP12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P39900') ]
