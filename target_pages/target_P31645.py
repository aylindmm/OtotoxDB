...
st.set_page_config(page_title="SC6A4", layout="wide")
st.title("Sodium-dependent serotonin transporter")
st.markdown(f"Uniprot ID: [P31645](https://www.uniprot.org/uniprotkb/P31645/)")
st.markdown(f"Protein symbol: SC6A4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P31645') ]
