...
st.set_page_config(page_title="GRM8", layout="wide")
st.title("Metabotropic glutamate receptor 8")
st.markdown(f"Uniprot ID: [O00222](https://www.uniprot.org/uniprotkb/O00222/)")
st.markdown(f"Protein symbol: GRM8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00222') ]
