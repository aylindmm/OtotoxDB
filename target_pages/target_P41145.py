...
st.set_page_config(page_title="OPRK", layout="wide")
st.title("Kappa-type opioid receptor")
st.markdown(f"Uniprot ID: [P41145](https://www.uniprot.org/uniprotkb/P41145/)")
st.markdown(f"Protein symbol: OPRK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41145') ]
