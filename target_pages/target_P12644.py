...
st.set_page_config(page_title="BMP4", layout="wide")
st.title("Bone morphogenetic protein 4")
st.markdown(f"Uniprot ID: [P12644](https://www.uniprot.org/uniprotkb/P12644/)")
st.markdown(f"Protein symbol: BMP4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P12644') ]
