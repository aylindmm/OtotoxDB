...
st.set_page_config(page_title="IMDH1", layout="wide")
st.title("Inosine-5'-monophosphate dehydrogenase 1")
st.markdown(f"Uniprot ID: [P20839](https://www.uniprot.org/uniprotkb/P20839/)")
st.markdown(f"Protein symbol: IMDH1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20839') ]
