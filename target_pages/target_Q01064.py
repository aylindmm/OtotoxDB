...
st.set_page_config(page_title="PDE1B", layout="wide")
st.title("Dual specificity calcium/calmodulin-dependent 3',5'-cyclic nucleotide phosphodiesterase 1B")
st.markdown(f"Uniprot ID: [Q01064](https://www.uniprot.org/uniprotkb/Q01064/)")
st.markdown(f"Protein symbol: PDE1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q01064') ]
