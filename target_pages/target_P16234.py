...
st.set_page_config(page_title="PGFRA", layout="wide")
st.title("Platelet-derived growth factor receptor alpha")
st.markdown(f"Uniprot ID: [P16234](https://www.uniprot.org/uniprotkb/P16234/)")
st.markdown(f"Protein symbol: PGFRA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16234') ]
