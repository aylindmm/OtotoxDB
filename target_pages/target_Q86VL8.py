...
st.set_page_config(page_title="S47A2", layout="wide")
st.title("Multidrug and toxin extrusion protein 2")
st.markdown(f"Uniprot ID: [Q86VL8](https://www.uniprot.org/uniprotkb/Q86VL8/)")
st.markdown(f"Protein symbol: S47A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86VL8') ]
