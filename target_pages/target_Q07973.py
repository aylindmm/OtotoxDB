...
st.set_page_config(page_title="CP24A", layout="wide")
st.title("1,25-dihydroxyvitamin D(3) 24-hydroxylase, mitochondrial")
st.markdown(f"Uniprot ID: [Q07973](https://www.uniprot.org/uniprotkb/Q07973/)")
st.markdown(f"Protein symbol: CP24A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q07973') ]
