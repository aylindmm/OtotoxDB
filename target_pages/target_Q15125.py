...
st.set_page_config(page_title="EBP", layout="wide")
st.title("3-beta-hydroxysteroid-Delta(8),Delta(7)-isomerase/7-dehydrocholesterol reductase")
st.markdown(f"Uniprot ID: [Q15125](https://www.uniprot.org/uniprotkb/Q15125/)")
st.markdown(f"Protein symbol: EBP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15125') ]
