...
st.set_page_config(page_title="RIPK2", layout="wide")
st.title("Receptor-interacting serine/threonine-protein kinase 2")
st.markdown(f"Uniprot ID: [O43353](https://www.uniprot.org/uniprotkb/O43353/)")
st.markdown(f"Protein symbol: RIPK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43353') ]
