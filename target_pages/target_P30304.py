...
st.set_page_config(page_title="MPIP1", layout="wide")
st.title("M-phase inducer phosphatase 1")
st.markdown(f"Uniprot ID: [P30304](https://www.uniprot.org/uniprotkb/P30304/)")
st.markdown(f"Protein symbol: MPIP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30304') ]
