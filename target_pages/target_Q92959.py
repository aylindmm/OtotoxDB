...
st.set_page_config(page_title="SO2A1", layout="wide")
st.title("Solute carrier organic anion transporter family member 2A1")
st.markdown(f"Uniprot ID: [Q92959](https://www.uniprot.org/uniprotkb/Q92959/)")
st.markdown(f"Protein symbol: SO2A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92959') ]
