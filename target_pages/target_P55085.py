...
st.set_page_config(page_title="PAR2", layout="wide")
st.title("Proteinase-activated receptor 2")
st.markdown(f"Uniprot ID: [P55085](https://www.uniprot.org/uniprotkb/P55085/)")
st.markdown(f"Protein symbol: PAR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P55085') ]
