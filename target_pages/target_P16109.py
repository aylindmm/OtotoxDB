...
st.set_page_config(page_title="LYAM3", layout="wide")
st.title("P-selectin")
st.markdown(f"Uniprot ID: [P16109](https://www.uniprot.org/uniprotkb/P16109/)")
st.markdown(f"Protein symbol: LYAM3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16109') ]
