...
st.set_page_config(page_title="PLK4", layout="wide")
st.title("Serine/threonine-protein kinase PLK4")
st.markdown(f"Uniprot ID: [O00444](https://www.uniprot.org/uniprotkb/O00444/)")
st.markdown(f"Protein symbol: PLK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00444') ]
