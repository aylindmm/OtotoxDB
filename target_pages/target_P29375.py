...
st.set_page_config(page_title="KDM5A", layout="wide")
st.title("Lysine-specific demethylase 5A")
st.markdown(f"Uniprot ID: [P29375](https://www.uniprot.org/uniprotkb/P29375/)")
st.markdown(f"Protein symbol: KDM5A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29375') ]
