...
st.set_page_config(page_title="KISSR", layout="wide")
st.title("KiSS-1 receptor")
st.markdown(f"Uniprot ID: [Q969F8](https://www.uniprot.org/uniprotkb/Q969F8/)")
st.markdown(f"Protein symbol: KISSR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q969F8') ]
