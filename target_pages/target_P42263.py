...
st.set_page_config(page_title="GRIA3", layout="wide")
st.title("Glutamate receptor 3")
st.markdown(f"Uniprot ID: [P42263](https://www.uniprot.org/uniprotkb/P42263/)")
st.markdown(f"Protein symbol: GRIA3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42263') ]
