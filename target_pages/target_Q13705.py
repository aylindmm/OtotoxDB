...
st.set_page_config(page_title="AVR2B", layout="wide")
st.title("Activin receptor type-2B")
st.markdown(f"Uniprot ID: [Q13705](https://www.uniprot.org/uniprotkb/Q13705/)")
st.markdown(f"Protein symbol: AVR2B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13705') ]
