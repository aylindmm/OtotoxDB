...
st.set_page_config(page_title="TET1", layout="wide")
st.title("Methylcytosine dioxygenase TET1")
st.markdown(f"Uniprot ID: [Q8NFU7](https://www.uniprot.org/uniprotkb/Q8NFU7/)")
st.markdown(f"Protein symbol: TET1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NFU7') ]
