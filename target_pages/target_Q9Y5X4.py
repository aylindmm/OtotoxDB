...
st.set_page_config(page_title="NR2E3", layout="wide")
st.title("Photoreceptor-specific nuclear receptor")
st.markdown(f"Uniprot ID: [Q9Y5X4](https://www.uniprot.org/uniprotkb/Q9Y5X4/)")
st.markdown(f"Protein symbol: NR2E3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y5X4') ]
