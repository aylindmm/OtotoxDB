...
st.set_page_config(page_title="ERR3", layout="wide")
st.title("Estrogen-related receptor gamma")
st.markdown(f"Uniprot ID: [P62508](https://www.uniprot.org/uniprotkb/P62508/)")
st.markdown(f"Protein symbol: ERR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P62508') ]
