...
st.set_page_config(page_title="HDAC4", layout="wide")
st.title("Histone deacetylase 4 [653-1084,H976Y]")
st.markdown(f"Uniprot ID: [P56524](https://www.uniprot.org/uniprotkb/P56524/)")
st.markdown(f"Protein symbol: HDAC4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P56524') ]
