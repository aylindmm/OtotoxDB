...
st.set_page_config(page_title="MK03", layout="wide")
st.title("Mitogen-activated protein kinase 3")
st.markdown(f"Uniprot ID: [P27361](https://www.uniprot.org/uniprotkb/P27361/)")
st.markdown(f"Protein symbol: MK03")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27361') ]
