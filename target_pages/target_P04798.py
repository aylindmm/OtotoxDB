...
st.set_page_config(page_title="CP1A1", layout="wide")
st.title("Cytochrome P450 1A1")
st.markdown(f"Uniprot ID: [P04798](https://www.uniprot.org/uniprotkb/P04798/)")
st.markdown(f"Protein symbol: CP1A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04798') ]
