...
st.set_page_config(page_title="5HT2B", layout="wide")
st.title("5-hydroxytryptamine receptor 2B")
st.markdown(f"Uniprot ID: [P41595](https://www.uniprot.org/uniprotkb/P41595/)")
st.markdown(f"Protein symbol: 5HT2B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41595') ]
