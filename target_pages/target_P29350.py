...
st.set_page_config(page_title="PTN6", layout="wide")
st.title("Tyrosine-protein phosphatase non-receptor type 6")
st.markdown(f"Uniprot ID: [P29350](https://www.uniprot.org/uniprotkb/P29350/)")
st.markdown(f"Protein symbol: PTN6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29350') ]
