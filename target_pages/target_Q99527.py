...
st.set_page_config(page_title="GPER1", layout="wide")
st.title("G-protein coupled estrogen receptor 1")
st.markdown(f"Uniprot ID: [Q99527](https://www.uniprot.org/uniprotkb/Q99527/)")
st.markdown(f"Protein symbol: GPER1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99527') ]
