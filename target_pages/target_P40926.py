...
st.set_page_config(page_title="MDHM", layout="wide")
st.title("Malate dehydrogenase, mitochondrial")
st.markdown(f"Uniprot ID: [P40926](https://www.uniprot.org/uniprotkb/P40926/)")
st.markdown(f"Protein symbol: MDHM")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P40926') ]
