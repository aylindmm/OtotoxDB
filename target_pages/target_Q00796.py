...
st.set_page_config(page_title="DHSO", layout="wide")
st.title("Sorbitol dehydrogenase")
st.markdown(f"Uniprot ID: [Q00796](https://www.uniprot.org/uniprotkb/Q00796/)")
st.markdown(f"Protein symbol: DHSO")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00796') ]
