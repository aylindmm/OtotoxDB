...
st.set_page_config(page_title="CATL1", layout="wide")
st.title("Procathepsin L")
st.markdown(f"Uniprot ID: [P07711](https://www.uniprot.org/uniprotkb/P07711/)")
st.markdown(f"Protein symbol: CATL1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07711') ]
