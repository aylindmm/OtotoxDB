...
st.set_page_config(page_title="PDIA1", layout="wide")
st.title("Protein disulfide-isomerase")
st.markdown(f"Uniprot ID: [P07237](https://www.uniprot.org/uniprotkb/P07237/)")
st.markdown(f"Protein symbol: PDIA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07237') ]
