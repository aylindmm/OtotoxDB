...
st.set_page_config(page_title="DCK", layout="wide")
st.title("Deoxycytidine kinase")
st.markdown(f"Uniprot ID: [P27707](https://www.uniprot.org/uniprotkb/P27707/)")
st.markdown(f"Protein symbol: DCK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27707') ]
