...
st.set_page_config(page_title="SIR3", layout="wide")
st.title("NAD-dependent protein deacetylase sirtuin-3, mitochondrial")
st.markdown(f"Uniprot ID: [Q9NTG7](https://www.uniprot.org/uniprotkb/Q9NTG7/)")
st.markdown(f"Protein symbol: SIR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NTG7') ]
