...
st.set_page_config(page_title="BCL9", layout="wide")
st.title("B-cell CLL/lymphoma 9 protein")
st.markdown(f"Uniprot ID: [O00512](https://www.uniprot.org/uniprotkb/O00512/)")
st.markdown(f"Protein symbol: BCL9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00512') ]
