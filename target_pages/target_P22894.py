...
st.set_page_config(page_title="MMP8", layout="wide")
st.title("Neutrophil collagenase")
st.markdown(f"Uniprot ID: [P22894](https://www.uniprot.org/uniprotkb/P22894/)")
st.markdown(f"Protein symbol: MMP8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22894') ]
