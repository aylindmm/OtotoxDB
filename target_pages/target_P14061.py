...
st.set_page_config(page_title="DHB1", layout="wide")
st.title("17-beta-hydroxysteroid dehydrogenase type 1")
st.markdown(f"Uniprot ID: [P14061](https://www.uniprot.org/uniprotkb/P14061/)")
st.markdown(f"Protein symbol: DHB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14061') ]
