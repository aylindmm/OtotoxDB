...
st.set_page_config(page_title="AA2BR", layout="wide")
st.title("Adenosine receptor A2b")
st.markdown(f"Uniprot ID: [P29275](https://www.uniprot.org/uniprotkb/P29275/)")
st.markdown(f"Protein symbol: AA2BR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29275') ]
