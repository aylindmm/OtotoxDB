...
st.set_page_config(page_title="RXRB", layout="wide")
st.title("Retinoic acid receptor RXR-beta")
st.markdown(f"Uniprot ID: [P28702](https://www.uniprot.org/uniprotkb/P28702/)")
st.markdown(f"Protein symbol: RXRB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28702') ]
