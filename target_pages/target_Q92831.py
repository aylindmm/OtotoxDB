...
st.set_page_config(page_title="KAT2B", layout="wide")
st.title("Histone acetyltransferase KAT2B")
st.markdown(f"Uniprot ID: [Q92831](https://www.uniprot.org/uniprotkb/Q92831/)")
st.markdown(f"Protein symbol: KAT2B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92831') ]
