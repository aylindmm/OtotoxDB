...
st.set_page_config(page_title="HPSE", layout="wide")
st.title("Heparanase")
st.markdown(f"Uniprot ID: [Q9Y251](https://www.uniprot.org/uniprotkb/Q9Y251/)")
st.markdown(f"Protein symbol: HPSE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y251') ]
