...
st.set_page_config(page_title="PYGM", layout="wide")
st.title("Glycogen phosphorylase, muscle form")
st.markdown(f"Uniprot ID: [P11217](https://www.uniprot.org/uniprotkb/P11217/)")
st.markdown(f"Protein symbol: PYGM")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11217') ]
