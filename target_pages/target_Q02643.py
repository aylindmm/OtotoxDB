...
st.set_page_config(page_title="GHRHR", layout="wide")
st.title("Growth hormone-releasing hormone receptor")
st.markdown(f"Uniprot ID: [Q02643](https://www.uniprot.org/uniprotkb/Q02643/)")
st.markdown(f"Protein symbol: GHRHR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02643') ]
