...
st.set_page_config(page_title="MMP26", layout="wide")
st.title("Matrix metalloproteinase-26")
st.markdown(f"Uniprot ID: [Q9NRE1](https://www.uniprot.org/uniprotkb/Q9NRE1/)")
st.markdown(f"Protein symbol: MMP26")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NRE1') ]
