...
st.set_page_config(page_title="ABCBB", layout="wide")
st.title("Bile salt export pump")
st.markdown(f"Uniprot ID: [O95342](https://www.uniprot.org/uniprotkb/O95342/)")
st.markdown(f"Protein symbol: ABCBB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95342') ]
