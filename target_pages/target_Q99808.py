...
st.set_page_config(page_title="S29A1", layout="wide")
st.title("Equilibrative nucleoside transporter 1")
st.markdown(f"Uniprot ID: [Q99808](https://www.uniprot.org/uniprotkb/Q99808/)")
st.markdown(f"Protein symbol: S29A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99808') ]
