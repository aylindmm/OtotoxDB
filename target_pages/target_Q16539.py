...
st.set_page_config(page_title="MK14", layout="wide")
st.title("Mitogen-activated protein kinase 14")
st.markdown(f"Uniprot ID: [Q16539](https://www.uniprot.org/uniprotkb/Q16539/)")
st.markdown(f"Protein symbol: MK14")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16539') ]
