...
st.set_page_config(page_title="NTRK1", layout="wide")
st.title("High affinity nerve growth factor receptor")
st.markdown(f"Uniprot ID: [P04629](https://www.uniprot.org/uniprotkb/P04629/)")
st.markdown(f"Protein symbol: NTRK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04629') ]
