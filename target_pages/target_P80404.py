...
st.set_page_config(page_title="GABT", layout="wide")
st.title("4-aminobutyrate aminotransferase, mitochondrial")
st.markdown(f"Uniprot ID: [P80404](https://www.uniprot.org/uniprotkb/P80404/)")
st.markdown(f"Protein symbol: GABT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P80404') ]
