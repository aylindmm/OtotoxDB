...
st.set_page_config(page_title="KPCE", layout="wide")
st.title("Protein kinase C epsilon type")
st.markdown(f"Uniprot ID: [Q02156](https://www.uniprot.org/uniprotkb/Q02156/)")
st.markdown(f"Protein symbol: KPCE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02156') ]
