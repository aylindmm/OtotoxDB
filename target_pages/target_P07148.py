...
st.set_page_config(page_title="FABPL", layout="wide")
st.title("Fatty acid-binding protein, liver [T94A]")
st.markdown(f"Uniprot ID: [P07148](https://www.uniprot.org/uniprotkb/P07148/)")
st.markdown(f"Protein symbol: FABPL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07148') ]
