...
st.set_page_config(page_title="NPBW1", layout="wide")
st.title("Neuropeptides B/W receptor type 1")
st.markdown(f"Uniprot ID: [P48145](https://www.uniprot.org/uniprotkb/P48145/)")
st.markdown(f"Protein symbol: NPBW1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48145') ]
