...
st.set_page_config(page_title="M3K3", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 3")
st.markdown(f"Uniprot ID: [Q99759](https://www.uniprot.org/uniprotkb/Q99759/)")
st.markdown(f"Protein symbol: M3K3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99759') ]
