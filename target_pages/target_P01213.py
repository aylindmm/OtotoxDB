...
st.set_page_config(page_title="PDYN", layout="wide")
st.title("Proenkephalin-B")
st.markdown(f"Uniprot ID: [P01213](https://www.uniprot.org/uniprotkb/P01213/)")
st.markdown(f"Protein symbol: PDYN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P01213') ]
