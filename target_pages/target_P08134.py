...
st.set_page_config(page_title="RHOC", layout="wide")
st.title("Rho-related GTP-binding protein RhoC")
st.markdown(f"Uniprot ID: [P08134](https://www.uniprot.org/uniprotkb/P08134/)")
st.markdown(f"Protein symbol: RHOC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08134') ]
