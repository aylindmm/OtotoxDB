...
st.set_page_config(page_title="MP2K3", layout="wide")
st.title("Dual specificity mitogen-activated protein kinase kinase 3")
st.markdown(f"Uniprot ID: [P46734](https://www.uniprot.org/uniprotkb/P46734/)")
st.markdown(f"Protein symbol: MP2K3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P46734') ]
