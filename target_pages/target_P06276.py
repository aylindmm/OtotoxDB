...
st.set_page_config(page_title="CHLE", layout="wide")
st.title("Cholinesterase")
st.markdown(f"Uniprot ID: [P06276](https://www.uniprot.org/uniprotkb/P06276/)")
st.markdown(f"Protein symbol: CHLE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P06276') ]
