...
st.set_page_config(page_title="ADA2A", layout="wide")
st.title("Alpha-2A adrenergic receptor")
st.markdown(f"Uniprot ID: [P08913](https://www.uniprot.org/uniprotkb/P08913/)")
st.markdown(f"Protein symbol: ADA2A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08913') ]
