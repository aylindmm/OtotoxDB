...
st.set_page_config(page_title="KCNH2", layout="wide")
st.title("Potassium voltage-gated channel subfamily H member 2")
st.markdown(f"Uniprot ID: [Q12809](https://www.uniprot.org/uniprotkb/Q12809/)")
st.markdown(f"Protein symbol: KCNH2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q12809') ]
