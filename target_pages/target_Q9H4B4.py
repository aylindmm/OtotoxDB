...
st.set_page_config(page_title="PLK3", layout="wide")
st.title("Serine/threonine-protein kinase PLK3")
st.markdown(f"Uniprot ID: [Q9H4B4](https://www.uniprot.org/uniprotkb/Q9H4B4/)")
st.markdown(f"Protein symbol: PLK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H4B4') ]
