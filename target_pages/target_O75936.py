...
st.set_page_config(page_title="BODG", layout="wide")
st.title("Gamma-butyrobetaine dioxygenase")
st.markdown(f"Uniprot ID: [O75936](https://www.uniprot.org/uniprotkb/O75936/)")
st.markdown(f"Protein symbol: BODG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75936') ]
