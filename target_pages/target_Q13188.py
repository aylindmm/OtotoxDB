...
st.set_page_config(page_title="STK3", layout="wide")
st.title("Serine/threonine-protein kinase 3")
st.markdown(f"Uniprot ID: [Q13188](https://www.uniprot.org/uniprotkb/Q13188/)")
st.markdown(f"Protein symbol: STK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13188') ]
