...
st.set_page_config(page_title="ACM4", layout="wide")
st.title("Muscarinic acetylcholine receptor M4")
st.markdown(f"Uniprot ID: [P08173](https://www.uniprot.org/uniprotkb/P08173/)")
st.markdown(f"Protein symbol: ACM4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08173') ]
