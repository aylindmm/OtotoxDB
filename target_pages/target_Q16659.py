...
st.set_page_config(page_title="MK06", layout="wide")
st.title("Mitogen-activated protein kinase 6")
st.markdown(f"Uniprot ID: [Q16659](https://www.uniprot.org/uniprotkb/Q16659/)")
st.markdown(f"Protein symbol: MK06")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16659') ]
