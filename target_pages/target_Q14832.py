...
st.set_page_config(page_title="GRM3", layout="wide")
st.title("Metabotropic glutamate receptor 3")
st.markdown(f"Uniprot ID: [Q14832](https://www.uniprot.org/uniprotkb/Q14832/)")
st.markdown(f"Protein symbol: GRM3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14832') ]
