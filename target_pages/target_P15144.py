...
st.set_page_config(page_title="AMPN", layout="wide")
st.title("Aminopeptidase N")
st.markdown(f"Uniprot ID: [P15144](https://www.uniprot.org/uniprotkb/P15144/)")
st.markdown(f"Protein symbol: AMPN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15144') ]
