...
st.set_page_config(page_title="CATL2", layout="wide")
st.title("Cathepsin L2")
st.markdown(f"Uniprot ID: [O60911](https://www.uniprot.org/uniprotkb/O60911/)")
st.markdown(f"Protein symbol: CATL2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60911') ]
