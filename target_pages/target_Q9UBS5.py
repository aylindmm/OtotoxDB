...
st.set_page_config(page_title="GABR1", layout="wide")
st.title("Gamma-aminobutyric acid type B receptor subunit 1/2")
st.markdown(f"Uniprot ID: [Q9UBS5](https://www.uniprot.org/uniprotkb/Q9UBS5/)")
st.markdown(f"Protein symbol: GABR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UBS5') ]
