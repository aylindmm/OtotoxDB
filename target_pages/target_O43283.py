...
st.set_page_config(page_title="M3K13", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 13")
st.markdown(f"Uniprot ID: [O43283](https://www.uniprot.org/uniprotkb/O43283/)")
st.markdown(f"Protein symbol: M3K13")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43283') ]
