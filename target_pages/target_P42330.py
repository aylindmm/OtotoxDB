...
st.set_page_config(page_title="AK1C3", layout="wide")
st.title("Aldo-keto reductase family 1 member C3")
st.markdown(f"Uniprot ID: [P42330](https://www.uniprot.org/uniprotkb/P42330/)")
st.markdown(f"Protein symbol: AK1C3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42330') ]
