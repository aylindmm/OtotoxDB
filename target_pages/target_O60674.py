...
st.set_page_config(page_title="JAK2", layout="wide")
st.title("Tyrosine-protein kinase JAK2")
st.markdown(f"Uniprot ID: [O60674](https://www.uniprot.org/uniprotkb/O60674/)")
st.markdown(f"Protein symbol: JAK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60674') ]
