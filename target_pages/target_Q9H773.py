...
st.set_page_config(page_title="DCTP1", layout="wide")
st.title("dCTP pyrophosphatase 1")
st.markdown(f"Uniprot ID: [Q9H773](https://www.uniprot.org/uniprotkb/Q9H773/)")
st.markdown(f"Protein symbol: DCTP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H773') ]
