...
st.set_page_config(page_title="SNRK", layout="wide")
st.title("SNF-related serine/threonine-protein kinase")
st.markdown(f"Uniprot ID: [Q9NRH2](https://www.uniprot.org/uniprotkb/Q9NRH2/)")
st.markdown(f"Protein symbol: SNRK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NRH2') ]
