...
st.set_page_config(page_title="IF4G1", layout="wide")
st.title("Eukaryotic translation initiation factor 4 gamma 1")
st.markdown(f"Uniprot ID: [Q04637](https://www.uniprot.org/uniprotkb/Q04637/)")
st.markdown(f"Protein symbol: IF4G1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q04637') ]
