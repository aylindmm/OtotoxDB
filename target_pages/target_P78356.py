...
st.set_page_config(page_title="PI42B", layout="wide")
st.title("Phosphatidylinositol 5-phosphate 4-kinase type-2 beta")
st.markdown(f"Uniprot ID: [P78356](https://www.uniprot.org/uniprotkb/P78356/)")
st.markdown(f"Protein symbol: PI42B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P78356') ]
