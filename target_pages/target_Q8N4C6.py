...
st.set_page_config(page_title="NIN", layout="wide")
st.title("Ninein")
st.markdown(f"Uniprot ID: [Q8N4C6](https://www.uniprot.org/uniprotkb/Q8N4C6/)")
st.markdown(f"Protein symbol: NIN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8N4C6') ]
