...
st.set_page_config(page_title="GGT1", layout="wide")
st.title("Glutathione hydrolase 1 proenzyme")
st.markdown(f"Uniprot ID: [P19440](https://www.uniprot.org/uniprotkb/P19440/)")
st.markdown(f"Protein symbol: GGT1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19440') ]
