...
st.set_page_config(page_title="GGPPS", layout="wide")
st.title("Geranylgeranyl pyrophosphate synthase")
st.markdown(f"Uniprot ID: [O95749](https://www.uniprot.org/uniprotkb/O95749/)")
st.markdown(f"Protein symbol: GGPPS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95749') ]
