...
st.set_page_config(page_title="PI51C", layout="wide")
st.title("Phosphatidylinositol 4-phosphate 5-kinase type-1 gamma")
st.markdown(f"Uniprot ID: [O60331](https://www.uniprot.org/uniprotkb/O60331/)")
st.markdown(f"Protein symbol: PI51C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60331') ]
