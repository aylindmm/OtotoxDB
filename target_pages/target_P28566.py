...
st.set_page_config(page_title="5HT1E", layout="wide")
st.title("5-hydroxytryptamine receptor 1E")
st.markdown(f"Uniprot ID: [P28566](https://www.uniprot.org/uniprotkb/P28566/)")
st.markdown(f"Protein symbol: 5HT1E")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28566') ]
