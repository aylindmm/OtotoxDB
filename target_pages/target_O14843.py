...
st.set_page_config(page_title="FFAR3", layout="wide")
st.title("Free fatty acid receptor 3")
st.markdown(f"Uniprot ID: [O14843](https://www.uniprot.org/uniprotkb/O14843/)")
st.markdown(f"Protein symbol: FFAR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14843') ]
