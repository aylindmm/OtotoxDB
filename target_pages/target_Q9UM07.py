...
st.set_page_config(page_title="PADI4", layout="wide")
st.title("Protein-arginine deiminase type-4")
st.markdown(f"Uniprot ID: [Q9UM07](https://www.uniprot.org/uniprotkb/Q9UM07/)")
st.markdown(f"Protein symbol: PADI4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UM07') ]
