...
st.set_page_config(page_title="ABD12", layout="wide")
st.title("Lysophosphatidylserine lipase ABHD12")
st.markdown(f"Uniprot ID: [Q8N2K0](https://www.uniprot.org/uniprotkb/Q8N2K0/)")
st.markdown(f"Protein symbol: ABD12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8N2K0') ]
