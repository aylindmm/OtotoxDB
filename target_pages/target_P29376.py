...
st.set_page_config(page_title="LTK", layout="wide")
st.title("Leukocyte tyrosine kinase receptor")
st.markdown(f"Uniprot ID: [P29376](https://www.uniprot.org/uniprotkb/P29376/)")
st.markdown(f"Protein symbol: LTK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29376') ]
