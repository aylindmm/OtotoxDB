...
st.set_page_config(page_title="MYG", layout="wide")
st.title("Myoglobin")
st.markdown(f"Uniprot ID: [P02144](https://www.uniprot.org/uniprotkb/P02144/)")
st.markdown(f"Protein symbol: MYG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P02144') ]
