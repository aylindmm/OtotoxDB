...
st.set_page_config(page_title="PA24C", layout="wide")
st.title("Cytosolic phospholipase A2 gamma")
st.markdown(f"Uniprot ID: [Q9UP65](https://www.uniprot.org/uniprotkb/Q9UP65/)")
st.markdown(f"Protein symbol: PA24C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UP65') ]
