...
st.set_page_config(page_title="COQ8A", layout="wide")
st.title("Atypical kinase COQ8A, mitochondrial")
st.markdown(f"Uniprot ID: [Q8NI60](https://www.uniprot.org/uniprotkb/Q8NI60/)")
st.markdown(f"Protein symbol: COQ8A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NI60') ]
