...
st.set_page_config(page_title="CD38", layout="wide")
st.title("ADP-ribosyl cyclase/cyclic ADP-ribose hydrolase 1")
st.markdown(f"Uniprot ID: [P28907](https://www.uniprot.org/uniprotkb/P28907/)")
st.markdown(f"Protein symbol: CD38")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28907') ]
