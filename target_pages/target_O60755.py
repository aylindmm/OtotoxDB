...
st.set_page_config(page_title="GALR3", layout="wide")
st.title("Galanin receptor type 3")
st.markdown(f"Uniprot ID: [O60755](https://www.uniprot.org/uniprotkb/O60755/)")
st.markdown(f"Protein symbol: GALR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60755') ]
