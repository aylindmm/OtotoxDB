...
st.set_page_config(page_title="GLPK", layout="wide")
st.title("Glycerol kinase")
st.markdown(f"Uniprot ID: [P32189](https://www.uniprot.org/uniprotkb/P32189/)")
st.markdown(f"Protein symbol: GLPK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32189') ]
