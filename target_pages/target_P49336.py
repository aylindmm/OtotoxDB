...
st.set_page_config(page_title="CDK8", layout="wide")
st.title("Cyclin-dependent kinase 8")
st.markdown(f"Uniprot ID: [P49336](https://www.uniprot.org/uniprotkb/P49336/)")
st.markdown(f"Protein symbol: CDK8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49336') ]
