...
st.set_page_config(page_title="CATD", layout="wide")
st.title("Cathepsin D")
st.markdown(f"Uniprot ID: [P07339](https://www.uniprot.org/uniprotkb/P07339/)")
st.markdown(f"Protein symbol: CATD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07339') ]
