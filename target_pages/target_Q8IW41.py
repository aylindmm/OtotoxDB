...
st.set_page_config(page_title="MAPK5", layout="wide")
st.title("MAP kinase-activated protein kinase 5")
st.markdown(f"Uniprot ID: [Q8IW41](https://www.uniprot.org/uniprotkb/Q8IW41/)")
st.markdown(f"Protein symbol: MAPK5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IW41') ]
