...
st.set_page_config(page_title="SAE1", layout="wide")
st.title("SUMO-activating enzyme subunit 1")
st.markdown(f"Uniprot ID: [Q9UBE0](https://www.uniprot.org/uniprotkb/Q9UBE0/)")
st.markdown(f"Protein symbol: SAE1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UBE0') ]
