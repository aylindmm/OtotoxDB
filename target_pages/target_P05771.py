...
st.set_page_config(page_title="KPCB", layout="wide")
st.title("Protein kinase C beta type")
st.markdown(f"Uniprot ID: [P05771](https://www.uniprot.org/uniprotkb/P05771/)")
st.markdown(f"Protein symbol: KPCB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05771') ]
