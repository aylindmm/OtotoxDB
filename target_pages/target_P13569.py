...
st.set_page_config(page_title="CFTR", layout="wide")
st.title("Cystic fibrosis transmembrane conductance regulator")
st.markdown(f"Uniprot ID: [P13569](https://www.uniprot.org/uniprotkb/P13569/)")
st.markdown(f"Protein symbol: CFTR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P13569') ]
