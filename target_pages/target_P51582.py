...
st.set_page_config(page_title="P2RY4", layout="wide")
st.title("P2Y purinoceptor 4")
st.markdown(f"Uniprot ID: [P51582](https://www.uniprot.org/uniprotkb/P51582/)")
st.markdown(f"Protein symbol: P2RY4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51582') ]
