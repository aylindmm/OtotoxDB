...
st.set_page_config(page_title="ACM2", layout="wide")
st.title("Muscarinic acetylcholine receptor M2")
st.markdown(f"Uniprot ID: [P08172](https://www.uniprot.org/uniprotkb/P08172/)")
st.markdown(f"Protein symbol: ACM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08172') ]
