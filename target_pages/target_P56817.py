...
st.set_page_config(page_title="BACE1", layout="wide")
st.title("Beta-secretase 1")
st.markdown(f"Uniprot ID: [P56817](https://www.uniprot.org/uniprotkb/P56817/)")
st.markdown(f"Protein symbol: BACE1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P56817') ]
