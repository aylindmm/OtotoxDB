...
st.set_page_config(page_title="PNPH", layout="wide")
st.title("Purine nucleoside phosphorylase")
st.markdown(f"Uniprot ID: [P00491](https://www.uniprot.org/uniprotkb/P00491/)")
st.markdown(f"Protein symbol: PNPH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00491') ]
