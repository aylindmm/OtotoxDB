...
st.set_page_config(page_title="ATR", layout="wide")
st.title("Serine/threonine-protein kinase ATR")
st.markdown(f"Uniprot ID: [Q13535](https://www.uniprot.org/uniprotkb/Q13535/)")
st.markdown(f"Protein symbol: ATR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13535') ]
