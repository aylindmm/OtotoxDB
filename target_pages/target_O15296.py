...
st.set_page_config(page_title="LX15B", layout="wide")
st.title("Polyunsaturated fatty acid lipoxygenase ALOX15B")
st.markdown(f"Uniprot ID: [O15296](https://www.uniprot.org/uniprotkb/O15296/)")
st.markdown(f"Protein symbol: LX15B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15296') ]
