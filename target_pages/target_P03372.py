...
st.set_page_config(page_title="ESR1", layout="wide")
st.title("Estrogen receptor")
st.markdown(f"Uniprot ID: [P03372](https://www.uniprot.org/uniprotkb/P03372/)")
st.markdown(f"Protein symbol: ESR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P03372') ]
