...
st.set_page_config(page_title="RIR1", layout="wide")
st.title("Ribonucleoside-diphosphate reductase large subunit/subunit M2")
st.markdown(f"Uniprot ID: [P23921](https://www.uniprot.org/uniprotkb/P23921/)")
st.markdown(f"Protein symbol: RIR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23921') ]
