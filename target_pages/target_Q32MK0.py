...
st.set_page_config(page_title="MYLK3", layout="wide")
st.title("Myosin light chain kinase 3")
st.markdown(f"Uniprot ID: [Q32MK0](https://www.uniprot.org/uniprotkb/Q32MK0/)")
st.markdown(f"Protein symbol: MYLK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q32MK0') ]
