...
st.set_page_config(page_title="S22AG", layout="wide")
st.title("Solute carrier family 22 member 16")
st.markdown(f"Uniprot ID: [Q86VW1](https://www.uniprot.org/uniprotkb/Q86VW1/)")
st.markdown(f"Protein symbol: S22AG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86VW1') ]
