...
st.set_page_config(page_title="PDE3A", layout="wide")
st.title("cGMP-inhibited 3',5'-cyclic phosphodiesterase 3A/3B")
st.markdown(f"Uniprot ID: [Q14432](https://www.uniprot.org/uniprotkb/Q14432/)")
st.markdown(f"Protein symbol: PDE3A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14432') ]
