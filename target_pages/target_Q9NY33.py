...
st.set_page_config(page_title="DPP3", layout="wide")
st.title("Dipeptidyl peptidase 3")
st.markdown(f"Uniprot ID: [Q9NY33](https://www.uniprot.org/uniprotkb/Q9NY33/)")
st.markdown(f"Protein symbol: DPP3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NY33') ]
