...
st.set_page_config(page_title="HDA11", layout="wide")
st.title("Histone deacetylase 11")
st.markdown(f"Uniprot ID: [Q96DB2](https://www.uniprot.org/uniprotkb/Q96DB2/)")
st.markdown(f"Protein symbol: HDA11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96DB2') ]
