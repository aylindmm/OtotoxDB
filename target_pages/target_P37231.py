...
st.set_page_config(page_title="PPARG", layout="wide")
st.title("Peroxisome proliferator-activated receptor gamma")
st.markdown(f"Uniprot ID: [P37231](https://www.uniprot.org/uniprotkb/P37231/)")
st.markdown(f"Protein symbol: PPARG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P37231') ]
