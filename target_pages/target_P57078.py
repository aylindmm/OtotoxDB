...
st.set_page_config(page_title="RIPK4", layout="wide")
st.title("Receptor-interacting serine/threonine-protein kinase 4")
st.markdown(f"Uniprot ID: [P57078](https://www.uniprot.org/uniprotkb/P57078/)")
st.markdown(f"Protein symbol: RIPK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P57078') ]
