...
st.set_page_config(page_title="G3P", layout="wide")
st.title("Glyceraldehyde-3-phosphate dehydrogenase")
st.markdown(f"Uniprot ID: [P04406](https://www.uniprot.org/uniprotkb/P04406/)")
st.markdown(f"Protein symbol: G3P")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04406') ]
