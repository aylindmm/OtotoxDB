...
st.set_page_config(page_title="MAK", layout="wide")
st.title("Serine/threonine-protein kinase MAK")
st.markdown(f"Uniprot ID: [P20794](https://www.uniprot.org/uniprotkb/P20794/)")
st.markdown(f"Protein symbol: MAK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20794') ]
