...
st.set_page_config(page_title="EPHB3", layout="wide")
st.title("Ephrin type-B receptor 3")
st.markdown(f"Uniprot ID: [P54753](https://www.uniprot.org/uniprotkb/P54753/)")
st.markdown(f"Protein symbol: EPHB3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P54753') ]
