...
st.set_page_config(page_title="GRM7", layout="wide")
st.title("Metabotropic glutamate receptor 7")
st.markdown(f"Uniprot ID: [Q14831](https://www.uniprot.org/uniprotkb/Q14831/)")
st.markdown(f"Protein symbol: GRM7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14831') ]
