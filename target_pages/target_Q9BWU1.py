...
st.set_page_config(page_title="CDK19", layout="wide")
st.title("Cyclin-dependent kinase 19")
st.markdown(f"Uniprot ID: [Q9BWU1](https://www.uniprot.org/uniprotkb/Q9BWU1/)")
st.markdown(f"Protein symbol: CDK19")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BWU1') ]
