...
st.set_page_config(page_title="STK35", layout="wide")
st.title("Serine/threonine-protein kinase 35")
st.markdown(f"Uniprot ID: [Q8TDR2](https://www.uniprot.org/uniprotkb/Q8TDR2/)")
st.markdown(f"Protein symbol: STK35")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TDR2') ]
