...
st.set_page_config(page_title="PKN1", layout="wide")
st.title("Serine/threonine-protein kinase N1")
st.markdown(f"Uniprot ID: [Q16512](https://www.uniprot.org/uniprotkb/Q16512/)")
st.markdown(f"Protein symbol: PKN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16512') ]
