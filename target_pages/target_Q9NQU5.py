...
st.set_page_config(page_title="PAK6", layout="wide")
st.title("Serine/threonine-protein kinase PAK 6")
st.markdown(f"Uniprot ID: [Q9NQU5](https://www.uniprot.org/uniprotkb/Q9NQU5/)")
st.markdown(f"Protein symbol: PAK6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NQU5') ]
