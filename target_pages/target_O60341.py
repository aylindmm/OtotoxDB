...
st.set_page_config(page_title="KDM1A", layout="wide")
st.title("Lysine-specific histone demethylase 1A")
st.markdown(f"Uniprot ID: [O60341](https://www.uniprot.org/uniprotkb/O60341/)")
st.markdown(f"Protein symbol: KDM1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60341') ]
