...
st.set_page_config(page_title="BRAF", layout="wide")
st.title("Serine/threonine-protein kinase B-raf [410-766,V600E]")
st.markdown(f"Uniprot ID: [P15056](https://www.uniprot.org/uniprotkb/P15056/)")
st.markdown(f"Protein symbol: BRAF")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15056') ]
