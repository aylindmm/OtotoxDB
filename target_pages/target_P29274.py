...
st.set_page_config(page_title="AA2AR", layout="wide")
st.title("Adenosine receptor A2a/A2b")
st.markdown(f"Uniprot ID: [P29274](https://www.uniprot.org/uniprotkb/P29274/)")
st.markdown(f"Protein symbol: AA2AR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29274') ]
