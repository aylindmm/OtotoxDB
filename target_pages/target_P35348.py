...
st.set_page_config(page_title="ADA1A", layout="wide")
st.title("Alpha-1A adrenergic receptor")
st.markdown(f"Uniprot ID: [P35348](https://www.uniprot.org/uniprotkb/P35348/)")
st.markdown(f"Protein symbol: ADA1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35348') ]
