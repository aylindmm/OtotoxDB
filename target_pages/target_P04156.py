...
st.set_page_config(page_title="PRIO", layout="wide")
st.title("Major prion protein")
st.markdown(f"Uniprot ID: [P04156](https://www.uniprot.org/uniprotkb/P04156/)")
st.markdown(f"Protein symbol: PRIO")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04156') ]
