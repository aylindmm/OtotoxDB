...
st.set_page_config(page_title="NOX5", layout="wide")
st.title("NADPH oxidase 5")
st.markdown(f"Uniprot ID: [Q96PH1](https://www.uniprot.org/uniprotkb/Q96PH1/)")
st.markdown(f"Protein symbol: NOX5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96PH1') ]
