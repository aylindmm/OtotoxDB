...
st.set_page_config(page_title="MCL1", layout="wide")
st.title("Induced myeloid leukemia cell differentiation protein Mcl-1")
st.markdown(f"Uniprot ID: [Q07820](https://www.uniprot.org/uniprotkb/Q07820/)")
st.markdown(f"Protein symbol: MCL1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q07820') ]
