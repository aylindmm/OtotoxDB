...
st.set_page_config(page_title="FKBP4", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase FKBP4")
st.markdown(f"Uniprot ID: [Q02790](https://www.uniprot.org/uniprotkb/Q02790/)")
st.markdown(f"Protein symbol: FKBP4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02790') ]
