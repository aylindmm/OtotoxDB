...
st.set_page_config(page_title="TKT", layout="wide")
st.title("Transketolase")
st.markdown(f"Uniprot ID: [P29401](https://www.uniprot.org/uniprotkb/P29401/)")
st.markdown(f"Protein symbol: TKT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29401') ]
