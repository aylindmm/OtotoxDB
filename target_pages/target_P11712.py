...
st.set_page_config(page_title="CP2C9", layout="wide")
st.title("Cytochrome P450 2C9")
st.markdown(f"Uniprot ID: [P11712](https://www.uniprot.org/uniprotkb/P11712/)")
st.markdown(f"Protein symbol: CP2C9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11712') ]
