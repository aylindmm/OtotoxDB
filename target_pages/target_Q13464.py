...
st.set_page_config(page_title="ROCK1", layout="wide")
st.title("Rho-associated protein kinase 1/2")
st.markdown(f"Uniprot ID: [Q13464](https://www.uniprot.org/uniprotkb/Q13464/)")
st.markdown(f"Protein symbol: ROCK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13464') ]
