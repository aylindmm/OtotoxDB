...
st.set_page_config(page_title="AOC3", layout="wide")
st.title("Membrane primary amine oxidase")
st.markdown(f"Uniprot ID: [Q16853](https://www.uniprot.org/uniprotkb/Q16853/)")
st.markdown(f"Protein symbol: AOC3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16853') ]
