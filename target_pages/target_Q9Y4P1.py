...
st.set_page_config(page_title="ATG4B", layout="wide")
st.title("Cysteine protease ATG4B")
st.markdown(f"Uniprot ID: [Q9Y4P1](https://www.uniprot.org/uniprotkb/Q9Y4P1/)")
st.markdown(f"Protein symbol: ATG4B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y4P1') ]
