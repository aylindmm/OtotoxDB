...
st.set_page_config(page_title="CAN1", layout="wide")
st.title("Calpain-1 catalytic subunit")
st.markdown(f"Uniprot ID: [P07384](https://www.uniprot.org/uniprotkb/P07384/)")
st.markdown(f"Protein symbol: CAN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07384') ]
