...
st.set_page_config(page_title="GSTM2", layout="wide")
st.title("Glutathione S-transferase Mu 2")
st.markdown(f"Uniprot ID: [P28161](https://www.uniprot.org/uniprotkb/P28161/)")
st.markdown(f"Protein symbol: GSTM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28161') ]
