...
st.set_page_config(page_title="CDK9", layout="wide")
st.title("Cyclin-dependent kinase 9")
st.markdown(f"Uniprot ID: [P50750](https://www.uniprot.org/uniprotkb/P50750/)")
st.markdown(f"Protein symbol: CDK9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P50750') ]
