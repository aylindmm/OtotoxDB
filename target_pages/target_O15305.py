...
st.set_page_config(page_title="PMM2", layout="wide")
st.title("Phosphomannomutase 2")
st.markdown(f"Uniprot ID: [O15305](https://www.uniprot.org/uniprotkb/O15305/)")
st.markdown(f"Protein symbol: PMM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15305') ]
