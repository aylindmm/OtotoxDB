...
st.set_page_config(page_title="PPIA", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase A")
st.markdown(f"Uniprot ID: [P62937](https://www.uniprot.org/uniprotkb/P62937/)")
st.markdown(f"Protein symbol: PPIA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P62937') ]
