...
st.set_page_config(page_title="CSK22", layout="wide")
st.title("Casein kinase II subunit alpha'")
st.markdown(f"Uniprot ID: [P19784](https://www.uniprot.org/uniprotkb/P19784/)")
st.markdown(f"Protein symbol: CSK22")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19784') ]
