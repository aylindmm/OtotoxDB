...
st.set_page_config(page_title="KDM5C", layout="wide")
st.title("Lysine-specific demethylase 5C")
st.markdown(f"Uniprot ID: [P41229](https://www.uniprot.org/uniprotkb/P41229/)")
st.markdown(f"Protein symbol: KDM5C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41229') ]
