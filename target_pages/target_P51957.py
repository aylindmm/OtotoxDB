...
st.set_page_config(page_title="NEK4", layout="wide")
st.title("Serine/threonine-protein kinase Nek4")
st.markdown(f"Uniprot ID: [P51957](https://www.uniprot.org/uniprotkb/P51957/)")
st.markdown(f"Protein symbol: NEK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51957') ]
