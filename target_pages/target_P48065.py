...
st.set_page_config(page_title="S6A12", layout="wide")
st.title("Sodium- and chloride-dependent betaine transporter")
st.markdown(f"Uniprot ID: [P48065](https://www.uniprot.org/uniprotkb/P48065/)")
st.markdown(f"Protein symbol: S6A12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48065') ]
