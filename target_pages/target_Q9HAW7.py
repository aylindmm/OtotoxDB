...
st.set_page_config(page_title="UD17", layout="wide")
st.title("UDP-glucuronosyltransferase 1A7")
st.markdown(f"Uniprot ID: [Q9HAW7](https://www.uniprot.org/uniprotkb/Q9HAW7/)")
st.markdown(f"Protein symbol: UD17")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HAW7') ]
