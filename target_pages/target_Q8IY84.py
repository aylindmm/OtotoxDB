...
st.set_page_config(page_title="NIM1", layout="wide")
st.title("Serine/threonine-protein kinase NIM1")
st.markdown(f"Uniprot ID: [Q8IY84](https://www.uniprot.org/uniprotkb/Q8IY84/)")
st.markdown(f"Protein symbol: NIM1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IY84') ]
