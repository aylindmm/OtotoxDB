...
st.set_page_config(page_title="SSR5", layout="wide")
st.title("Somatostatin receptor type 5")
st.markdown(f"Uniprot ID: [P35346](https://www.uniprot.org/uniprotkb/P35346/)")
st.markdown(f"Protein symbol: SSR5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35346') ]
