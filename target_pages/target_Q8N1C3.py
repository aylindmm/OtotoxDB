...
st.set_page_config(page_title="GBRG1", layout="wide")
st.title("Gamma-aminobutyric acid receptor subunit alpha-2/beta-2/gamma-1")
st.markdown(f"Uniprot ID: [Q8N1C3](https://www.uniprot.org/uniprotkb/Q8N1C3/)")
st.markdown(f"Protein symbol: GBRG1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8N1C3') ]
