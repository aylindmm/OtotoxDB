...
st.set_page_config(page_title="PERL", layout="wide")
st.title("Lactoperoxidase")
st.markdown(f"Uniprot ID: [P22079](https://www.uniprot.org/uniprotkb/P22079/)")
st.markdown(f"Protein symbol: PERL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22079') ]
