...
st.set_page_config(page_title="THAS", layout="wide")
st.title("Thromboxane-A synthase")
st.markdown(f"Uniprot ID: [P24557](https://www.uniprot.org/uniprotkb/P24557/)")
st.markdown(f"Protein symbol: THAS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24557') ]
