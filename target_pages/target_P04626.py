...
st.set_page_config(page_title="ERBB2", layout="wide")
st.title("Receptor tyrosine-protein kinase erbB-2")
st.markdown(f"Uniprot ID: [P04626](https://www.uniprot.org/uniprotkb/P04626/)")
st.markdown(f"Protein symbol: ERBB2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04626') ]
