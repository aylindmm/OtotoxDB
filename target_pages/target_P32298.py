...
st.set_page_config(page_title="GRK4", layout="wide")
st.title("G protein-coupled receptor kinase 4")
st.markdown(f"Uniprot ID: [P32298](https://www.uniprot.org/uniprotkb/P32298/)")
st.markdown(f"Protein symbol: GRK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32298') ]
