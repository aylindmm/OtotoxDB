...
st.set_page_config(page_title="M3K20", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 20")
st.markdown(f"Uniprot ID: [Q9NYL2](https://www.uniprot.org/uniprotkb/Q9NYL2/)")
st.markdown(f"Protein symbol: M3K20")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NYL2') ]
