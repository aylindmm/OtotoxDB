...
st.set_page_config(page_title="NLRP3", layout="wide")
st.title("NACHT, LRR and PYD domains-containing protein 3")
st.markdown(f"Uniprot ID: [Q96P20](https://www.uniprot.org/uniprotkb/Q96P20/)")
st.markdown(f"Protein symbol: NLRP3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96P20') ]
