...
st.set_page_config(page_title="3BHS1", layout="wide")
st.title("3 beta-hydroxysteroid dehydrogenase/Delta 5-->4-isomerase type 1")
st.markdown(f"Uniprot ID: [P14060](https://www.uniprot.org/uniprotkb/P14060/)")
st.markdown(f"Protein symbol: 3BHS1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14060') ]
