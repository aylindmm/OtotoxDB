...
st.set_page_config(page_title="ANDR", layout="wide")
st.title("Androgen receptor")
st.markdown(f"Uniprot ID: [P10275](https://www.uniprot.org/uniprotkb/P10275/)")
st.markdown(f"Protein symbol: ANDR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10275') ]
