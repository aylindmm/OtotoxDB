...
st.set_page_config(page_title="DUS1", layout="wide")
st.title("Dual specificity protein phosphatase 1")
st.markdown(f"Uniprot ID: [P28562](https://www.uniprot.org/uniprotkb/P28562/)")
st.markdown(f"Protein symbol: DUS1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28562') ]
