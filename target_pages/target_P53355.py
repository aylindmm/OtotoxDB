...
st.set_page_config(page_title="DAPK1", layout="wide")
st.title("Death-associated protein kinase 1")
st.markdown(f"Uniprot ID: [P53355](https://www.uniprot.org/uniprotkb/P53355/)")
st.markdown(f"Protein symbol: DAPK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53355') ]
