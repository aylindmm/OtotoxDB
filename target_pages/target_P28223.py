...
st.set_page_config(page_title="5HT2A", layout="wide")
st.title("5-hydroxytryptamine receptor 2A/2B/2C")
st.markdown(f"Uniprot ID: [P28223](https://www.uniprot.org/uniprotkb/P28223/)")
st.markdown(f"Protein symbol: 5HT2A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28223') ]
