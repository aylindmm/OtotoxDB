...
st.set_page_config(page_title="HIPK2", layout="wide")
st.title("Homeodomain-interacting protein kinase 2")
st.markdown(f"Uniprot ID: [Q9H2X6](https://www.uniprot.org/uniprotkb/Q9H2X6/)")
st.markdown(f"Protein symbol: HIPK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H2X6') ]
