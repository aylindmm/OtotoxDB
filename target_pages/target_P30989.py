...
st.set_page_config(page_title="NTR1", layout="wide")
st.title("Neurotensin receptor type 1")
st.markdown(f"Uniprot ID: [P30989](https://www.uniprot.org/uniprotkb/P30989/)")
st.markdown(f"Protein symbol: NTR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30989') ]
