...
st.set_page_config(page_title="E2AK4", layout="wide")
st.title("eIF-2-alpha kinase GCN2")
st.markdown(f"Uniprot ID: [Q9P2K8](https://www.uniprot.org/uniprotkb/Q9P2K8/)")
st.markdown(f"Protein symbol: E2AK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9P2K8') ]
