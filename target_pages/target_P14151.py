...
st.set_page_config(page_title="LYAM1", layout="wide")
st.title("L-selectin")
st.markdown(f"Uniprot ID: [P14151](https://www.uniprot.org/uniprotkb/P14151/)")
st.markdown(f"Protein symbol: LYAM1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14151') ]
