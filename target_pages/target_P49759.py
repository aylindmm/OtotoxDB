...
st.set_page_config(page_title="CLK1", layout="wide")
st.title("Dual specificity protein kinase CLK1 [R432A]")
st.markdown(f"Uniprot ID: [P49759](https://www.uniprot.org/uniprotkb/P49759/)")
st.markdown(f"Protein symbol: CLK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49759') ]
