...
st.set_page_config(page_title="PGH2", layout="wide")
st.title("Prostaglandin G/H synthase 2")
st.markdown(f"Uniprot ID: [P35354](https://www.uniprot.org/uniprotkb/P35354/)")
st.markdown(f"Protein symbol: PGH2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35354') ]
