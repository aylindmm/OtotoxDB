...
st.set_page_config(page_title="KS6A6", layout="wide")
st.title("Ribosomal protein S6 kinase alpha-6")
st.markdown(f"Uniprot ID: [Q9UK32](https://www.uniprot.org/uniprotkb/Q9UK32/)")
st.markdown(f"Protein symbol: KS6A6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UK32') ]
