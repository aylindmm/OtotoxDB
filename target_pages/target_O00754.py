...
st.set_page_config(page_title="MA2B1", layout="wide")
st.title("Lysosomal alpha-mannosidase")
st.markdown(f"Uniprot ID: [O00754](https://www.uniprot.org/uniprotkb/O00754/)")
st.markdown(f"Protein symbol: MA2B1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00754') ]
