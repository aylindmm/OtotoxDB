...
st.title("Mannose-6-phosphate isomerase")
st.markdown(f"Uniprot ID: [P34949](https://www.uniprot.org/uniprotkb/P34949/)")
st.markdown(f"Protein symbol: MPI")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34949') ]
