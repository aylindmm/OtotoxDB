...
st.set_page_config(page_title="MYLK4", layout="wide")
st.title("Myosin light chain kinase family member 4")
st.markdown(f"Uniprot ID: [Q86YV6](https://www.uniprot.org/uniprotkb/Q86YV6/)")
st.markdown(f"Protein symbol: MYLK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86YV6') ]
