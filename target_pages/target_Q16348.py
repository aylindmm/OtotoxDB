...
st.set_page_config(page_title="S15A2", layout="wide")
st.title("Solute carrier family 15 member 2")
st.markdown(f"Uniprot ID: [Q16348](https://www.uniprot.org/uniprotkb/Q16348/)")
st.markdown(f"Protein symbol: S15A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16348') ]
