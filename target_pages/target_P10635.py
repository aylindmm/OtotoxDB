...
st.set_page_config(page_title="CP2D6", layout="wide")
st.title("Cytochrome P450 2D6")
st.markdown(f"Uniprot ID: [P10635](https://www.uniprot.org/uniprotkb/P10635/)")
st.markdown(f"Protein symbol: CP2D6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10635') ]
