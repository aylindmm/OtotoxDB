...
st.set_page_config(page_title="GALR2", layout="wide")
st.title("Galanin receptor type 2")
st.markdown(f"Uniprot ID: [O43603](https://www.uniprot.org/uniprotkb/O43603/)")
st.markdown(f"Protein symbol: GALR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43603') ]
