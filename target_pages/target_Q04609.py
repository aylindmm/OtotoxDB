...
st.set_page_config(page_title="FOLH1", layout="wide")
st.title("Glutamate carboxypeptidase 2 [44-750]")
st.markdown(f"Uniprot ID: [Q04609](https://www.uniprot.org/uniprotkb/Q04609/)")
st.markdown(f"Protein symbol: FOLH1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q04609') ]
