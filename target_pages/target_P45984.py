...
st.set_page_config(page_title="MK09", layout="wide")
st.title("Mitogen-activated protein kinase 9")
st.markdown(f"Uniprot ID: [P45984](https://www.uniprot.org/uniprotkb/P45984/)")
st.markdown(f"Protein symbol: MK09")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P45984') ]
