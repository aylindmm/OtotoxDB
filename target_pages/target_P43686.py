...
st.set_page_config(page_title="PRS6B", layout="wide")
st.title("26S proteasome regulatory subunit 6B")
st.markdown(f"Uniprot ID: [P43686](https://www.uniprot.org/uniprotkb/P43686/)")
st.markdown(f"Protein symbol: PRS6B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43686') ]
