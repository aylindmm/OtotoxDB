...
st.set_page_config(page_title="FKB1B", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase FKBP1B")
st.markdown(f"Uniprot ID: [P68106](https://www.uniprot.org/uniprotkb/P68106/)")
st.markdown(f"Protein symbol: FKB1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P68106') ]
