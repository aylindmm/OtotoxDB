...
st.set_page_config(page_title="NPY1R", layout="wide")
st.title("Neuropeptide Y receptor type 1")
st.markdown(f"Uniprot ID: [P25929](https://www.uniprot.org/uniprotkb/P25929/)")
st.markdown(f"Protein symbol: NPY1R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25929') ]
