...
st.set_page_config(page_title="KITH", layout="wide")
st.title("Thymidine kinase, cytosolic")
st.markdown(f"Uniprot ID: [P04183](https://www.uniprot.org/uniprotkb/P04183/)")
st.markdown(f"Protein symbol: KITH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04183') ]
