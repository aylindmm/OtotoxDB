...
st.set_page_config(page_title="PPCE", layout="wide")
st.title("Prolyl endopeptidase")
st.markdown(f"Uniprot ID: [P48147](https://www.uniprot.org/uniprotkb/P48147/)")
st.markdown(f"Protein symbol: PPCE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48147') ]
