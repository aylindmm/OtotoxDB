...
st.set_page_config(page_title="PK3CD", layout="wide")
st.title("Phosphatidylinositol 4,5-bisphosphate 3-kinase catalytic subunit delta isoform")
st.markdown(f"Uniprot ID: [O00329](https://www.uniprot.org/uniprotkb/O00329/)")
st.markdown(f"Protein symbol: PK3CD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00329') ]
