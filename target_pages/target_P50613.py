...
st.set_page_config(page_title="CDK7", layout="wide")
st.title("Cyclin-dependent kinase 7")
st.markdown(f"Uniprot ID: [P50613](https://www.uniprot.org/uniprotkb/P50613/)")
st.markdown(f"Protein symbol: CDK7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P50613') ]
