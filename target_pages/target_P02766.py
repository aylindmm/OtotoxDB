...
st.set_page_config(page_title="TTHY", layout="wide")
st.title("Transthyretin")
st.markdown(f"Uniprot ID: [P02766](https://www.uniprot.org/uniprotkb/P02766/)")
st.markdown(f"Protein symbol: TTHY")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P02766') ]
