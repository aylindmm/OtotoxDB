...
st.set_page_config(page_title="RGS19", layout="wide")
st.title("Regulator of G-protein signaling 19")
st.markdown(f"Uniprot ID: [P49795](https://www.uniprot.org/uniprotkb/P49795/)")
st.markdown(f"Protein symbol: RGS19")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49795') ]
