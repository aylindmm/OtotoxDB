...
st.set_page_config(page_title="PI2R", layout="wide")
st.title("Prostacyclin receptor")
st.markdown(f"Uniprot ID: [P43119](https://www.uniprot.org/uniprotkb/P43119/)")
st.markdown(f"Protein symbol: PI2R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43119') ]
