...
st.set_page_config(page_title="EPHB4", layout="wide")
st.title("Ephrin type-B receptor 4")
st.markdown(f"Uniprot ID: [P54760](https://www.uniprot.org/uniprotkb/P54760/)")
st.markdown(f"Protein symbol: EPHB4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P54760') ]
