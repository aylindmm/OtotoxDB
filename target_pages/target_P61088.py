...
st.set_page_config(page_title="UBE2N", layout="wide")
st.title("Ubiquitin-conjugating enzyme E2 N")
st.markdown(f"Uniprot ID: [P61088](https://www.uniprot.org/uniprotkb/P61088/)")
st.markdown(f"Protein symbol: UBE2N")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P61088') ]
