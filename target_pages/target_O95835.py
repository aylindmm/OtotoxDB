...
st.set_page_config(page_title="LATS1", layout="wide")
st.title("Serine/threonine-protein kinase LATS1")
st.markdown(f"Uniprot ID: [O95835](https://www.uniprot.org/uniprotkb/O95835/)")
st.markdown(f"Protein symbol: LATS1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95835') ]
