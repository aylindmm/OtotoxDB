...
st.set_page_config(page_title="PA21B", layout="wide")
st.title("Phospholipase A2")
st.markdown(f"Uniprot ID: [P04054](https://www.uniprot.org/uniprotkb/P04054/)")
st.markdown(f"Protein symbol: PA21B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04054') ]
