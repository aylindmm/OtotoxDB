...
st.set_page_config(page_title="LKHA4", layout="wide")
st.title("Leukotriene A-4 hydrolase")
st.markdown(f"Uniprot ID: [P09960](https://www.uniprot.org/uniprotkb/P09960/)")
st.markdown(f"Protein symbol: LKHA4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09960') ]
