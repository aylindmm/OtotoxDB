...
st.set_page_config(page_title="QPCT", layout="wide")
st.title("Glutaminyl-peptide cyclotransferase")
st.markdown(f"Uniprot ID: [Q16769](https://www.uniprot.org/uniprotkb/Q16769/)")
st.markdown(f"Protein symbol: QPCT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16769') ]
