...
st.set_page_config(page_title="CTRC", layout="wide")
st.title("Chymotrypsin-C")
st.markdown(f"Uniprot ID: [Q99895](https://www.uniprot.org/uniprotkb/Q99895/)")
st.markdown(f"Protein symbol: CTRC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99895') ]
