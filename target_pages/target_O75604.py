...
st.set_page_config(page_title="UBP2", layout="wide")
st.title("Ubiquitin carboxyl-terminal hydrolase 2")
st.markdown(f"Uniprot ID: [O75604](https://www.uniprot.org/uniprotkb/O75604/)")
st.markdown(f"Protein symbol: UBP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75604') ]
