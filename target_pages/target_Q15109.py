...
st.set_page_config(page_title="RAGE", layout="wide")
st.title("Advanced glycosylation end product-specific receptor")
st.markdown(f"Uniprot ID: [Q15109](https://www.uniprot.org/uniprotkb/Q15109/)")
st.markdown(f"Protein symbol: RAGE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15109') ]
