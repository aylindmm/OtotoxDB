...
st.set_page_config(page_title="AK1BA", layout="wide")
st.title("Aldo-keto reductase family 1 member B10")
st.markdown(f"Uniprot ID: [O60218](https://www.uniprot.org/uniprotkb/O60218/)")
st.markdown(f"Protein symbol: AK1BA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60218') ]
