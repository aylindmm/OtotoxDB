...
st.set_page_config(page_title="NTRK3", layout="wide")
st.title("NT-3 growth factor receptor")
st.markdown(f"Uniprot ID: [Q16288](https://www.uniprot.org/uniprotkb/Q16288/)")
st.markdown(f"Protein symbol: NTRK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16288') ]
