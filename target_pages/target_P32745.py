...
st.set_page_config(page_title="SSR3", layout="wide")
st.title("Somatostatin receptor type 3")
st.markdown(f"Uniprot ID: [P32745](https://www.uniprot.org/uniprotkb/P32745/)")
st.markdown(f"Protein symbol: SSR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32745') ]
