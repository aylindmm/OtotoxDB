...
st.set_page_config(page_title="MK11", layout="wide")
st.title("Mitogen-activated protein kinase 11")
st.markdown(f"Uniprot ID: [Q15759](https://www.uniprot.org/uniprotkb/Q15759/)")
st.markdown(f"Protein symbol: MK11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15759') ]
