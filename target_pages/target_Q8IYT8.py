...
st.set_page_config(page_title="ULK2", layout="wide")
st.title("Serine/threonine-protein kinase ULK2")
st.markdown(f"Uniprot ID: [Q8IYT8](https://www.uniprot.org/uniprotkb/Q8IYT8/)")
st.markdown(f"Protein symbol: ULK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IYT8') ]
