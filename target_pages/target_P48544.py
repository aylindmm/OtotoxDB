...
st.set_page_config(page_title="KCNJ5", layout="wide")
st.title("G protein-activated inward rectifier potassium channel 4")
st.markdown(f"Uniprot ID: [P48544](https://www.uniprot.org/uniprotkb/P48544/)")
st.markdown(f"Protein symbol: KCNJ5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48544') ]
