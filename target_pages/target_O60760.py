...
st.set_page_config(page_title="HPGDS", layout="wide")
st.title("Hematopoietic prostaglandin D synthase")
st.markdown(f"Uniprot ID: [O60760](https://www.uniprot.org/uniprotkb/O60760/)")
st.markdown(f"Protein symbol: HPGDS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60760') ]
