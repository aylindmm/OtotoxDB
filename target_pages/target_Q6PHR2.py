...
st.set_page_config(page_title="ULK3", layout="wide")
st.title("Serine/threonine-protein kinase ULK3")
st.markdown(f"Uniprot ID: [Q6PHR2](https://www.uniprot.org/uniprotkb/Q6PHR2/)")
st.markdown(f"Protein symbol: ULK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q6PHR2') ]
