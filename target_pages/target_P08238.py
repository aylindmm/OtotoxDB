...
st.set_page_config(page_title="HS90B", layout="wide")
st.title("Heat shock protein HSP 90-beta")
st.markdown(f"Uniprot ID: [P08238](https://www.uniprot.org/uniprotkb/P08238/)")
st.markdown(f"Protein symbol: HS90B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08238') ]
