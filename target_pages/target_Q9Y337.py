...
st.set_page_config(page_title="KLK5", layout="wide")
st.title("Kallikrein-5")
st.markdown(f"Uniprot ID: [Q9Y337](https://www.uniprot.org/uniprotkb/Q9Y337/)")
st.markdown(f"Protein symbol: KLK5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y337') ]
