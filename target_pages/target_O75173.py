...
st.set_page_config(page_title="ATS4", layout="wide")
st.title("A disintegrin and metalloproteinase with thrombospondin motifs 4")
st.markdown(f"Uniprot ID: [O75173](https://www.uniprot.org/uniprotkb/O75173/)")
st.markdown(f"Protein symbol: ATS4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75173') ]
