...
st.set_page_config(page_title="MYO3A", layout="wide")
st.title("Myosin-IIIa")
st.markdown(f"Uniprot ID: [Q8NEV4](https://www.uniprot.org/uniprotkb/Q8NEV4/)")
st.markdown(f"Protein symbol: MYO3A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NEV4') ]
