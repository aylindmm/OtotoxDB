...
st.set_page_config(page_title="IRAK3", layout="wide")
st.title("Interleukin-1 receptor-associated kinase 3")
st.markdown(f"Uniprot ID: [Q9Y616](https://www.uniprot.org/uniprotkb/Q9Y616/)")
st.markdown(f"Protein symbol: IRAK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y616') ]
