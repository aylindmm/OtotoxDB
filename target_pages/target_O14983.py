...
st.set_page_config(page_title="AT2A1", layout="wide")
st.title("Sarcoplasmic/endoplasmic reticulum calcium ATPase 1")
st.markdown(f"Uniprot ID: [O14983](https://www.uniprot.org/uniprotkb/O14983/)")
st.markdown(f"Protein symbol: AT2A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14983') ]
