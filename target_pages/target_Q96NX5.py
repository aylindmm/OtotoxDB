...
st.set_page_config(page_title="KCC1G", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase type 1G")
st.markdown(f"Uniprot ID: [Q96NX5](https://www.uniprot.org/uniprotkb/Q96NX5/)")
st.markdown(f"Protein symbol: KCC1G")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96NX5') ]
