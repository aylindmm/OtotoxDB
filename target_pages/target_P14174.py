...
st.set_page_config(page_title="MIF", layout="wide")
st.title("Macrophage migration inhibitory factor")
st.markdown(f"Uniprot ID: [P14174](https://www.uniprot.org/uniprotkb/P14174/)")
st.markdown(f"Protein symbol: MIF")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14174') ]
