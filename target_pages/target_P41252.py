...
st.set_page_config(page_title="SYIC", layout="wide")
st.title("Isoleucine--tRNA ligase, cytoplasmic")
st.markdown(f"Uniprot ID: [P41252](https://www.uniprot.org/uniprotkb/P41252/)")
st.markdown(f"Protein symbol: SYIC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41252') ]
