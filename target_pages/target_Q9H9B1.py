...
st.set_page_config(page_title="EHMT1", layout="wide")
st.title("Histone-lysine N-methyltransferase EHMT1")
st.markdown(f"Uniprot ID: [Q9H9B1](https://www.uniprot.org/uniprotkb/Q9H9B1/)")
st.markdown(f"Protein symbol: EHMT1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H9B1') ]
