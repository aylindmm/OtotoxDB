...
st.set_page_config(page_title="PDE7B", layout="wide")
st.title("cAMP-specific 3',5'-cyclic phosphodiesterase 7B [91-450]")
st.markdown(f"Uniprot ID: [Q9NP56](https://www.uniprot.org/uniprotkb/Q9NP56/)")
st.markdown(f"Protein symbol: PDE7B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NP56') ]
