...
st.set_page_config(page_title="C11B1", layout="wide")
st.title("Cytochrome P450 11B1, mitochondrial")
st.markdown(f"Uniprot ID: [P15538](https://www.uniprot.org/uniprotkb/P15538/)")
st.markdown(f"Protein symbol: C11B1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15538') ]
