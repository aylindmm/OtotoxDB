...
st.set_page_config(page_title="OPRM", layout="wide")
st.title("Mu-type opioid receptor")
st.markdown(f"Uniprot ID: [P35372](https://www.uniprot.org/uniprotkb/P35372/)")
st.markdown(f"Protein symbol: OPRM")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35372') ]
