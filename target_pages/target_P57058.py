...
st.set_page_config(page_title="HUNK", layout="wide")
st.title("Hormonally up-regulated neu tumor-associated kinase")
st.markdown(f"Uniprot ID: [P57058](https://www.uniprot.org/uniprotkb/P57058/)")
st.markdown(f"Protein symbol: HUNK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P57058') ]
