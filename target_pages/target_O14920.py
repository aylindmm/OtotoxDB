...
st.set_page_config(page_title="IKKB", layout="wide")
st.title("Inhibitor of nuclear factor kappa-B kinase subunit beta")
st.markdown(f"Uniprot ID: [O14920](https://www.uniprot.org/uniprotkb/O14920/)")
st.markdown(f"Protein symbol: IKKB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14920') ]
