...
st.set_page_config(page_title="CDK1", layout="wide")
st.title("Cyclin-dependent kinase/G2/mitotic-specific cyclin- 1")
st.markdown(f"Uniprot ID: [P06493](https://www.uniprot.org/uniprotkb/P06493/)")
st.markdown(f"Protein symbol: CDK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P06493') ]
