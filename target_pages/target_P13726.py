...
st.set_page_config(page_title="TF", layout="wide")
st.title("Tissue factor")
st.markdown(f"Uniprot ID: [P13726](https://www.uniprot.org/uniprotkb/P13726/)")
st.markdown(f"Protein symbol: TF")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P13726') ]
