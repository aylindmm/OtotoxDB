...
st.set_page_config(page_title="PDE8A", layout="wide")
st.title("High affinity cAMP-specific and IBMX-insensitive 3',5'-cyclic phosphodiesterase 8A")
st.markdown(f"Uniprot ID: [O60658](https://www.uniprot.org/uniprotkb/O60658/)")
st.markdown(f"Protein symbol: PDE8A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60658') ]
