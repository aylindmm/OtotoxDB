...
st.set_page_config(page_title="TGFR2", layout="wide")
st.title("TGF-beta receptor type-2")
st.markdown(f"Uniprot ID: [P37173](https://www.uniprot.org/uniprotkb/P37173/)")
st.markdown(f"Protein symbol: TGFR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P37173') ]
