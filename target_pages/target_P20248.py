...
st.set_page_config(page_title="CCNA2", layout="wide")
st.title("Cyclin-A2")
st.markdown(f"Uniprot ID: [P20248](https://www.uniprot.org/uniprotkb/P20248/)")
st.markdown(f"Protein symbol: CCNA2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20248') ]
