...
st.set_page_config(page_title="RORG", layout="wide")
st.title("Nuclear receptor ROR-gamma")
st.markdown(f"Uniprot ID: [P51449](https://www.uniprot.org/uniprotkb/P51449/)")
st.markdown(f"Protein symbol: RORG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51449') ]
