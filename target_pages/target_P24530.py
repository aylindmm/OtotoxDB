...
st.set_page_config(page_title="EDNRB", layout="wide")
st.title("Endothelin receptor type B")
st.markdown(f"Uniprot ID: [P24530](https://www.uniprot.org/uniprotkb/P24530/)")
st.markdown(f"Protein symbol: EDNRB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24530') ]
