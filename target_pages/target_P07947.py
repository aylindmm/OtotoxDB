...
st.set_page_config(page_title="YES", layout="wide")
st.title("Tyrosine-protein kinase Yes")
st.markdown(f"Uniprot ID: [P07947](https://www.uniprot.org/uniprotkb/P07947/)")
st.markdown(f"Protein symbol: YES")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07947') ]
