...
st.set_page_config(page_title="SRPK2", layout="wide")
st.title("SRSF protein kinase 2")
st.markdown(f"Uniprot ID: [P78362](https://www.uniprot.org/uniprotkb/P78362/)")
st.markdown(f"Protein symbol: SRPK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P78362') ]
