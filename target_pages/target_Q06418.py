...
st.set_page_config(page_title="TYRO3", layout="wide")
st.title("Tyrosine-protein kinase receptor TYRO3")
st.markdown(f"Uniprot ID: [Q06418](https://www.uniprot.org/uniprotkb/Q06418/)")
st.markdown(f"Protein symbol: TYRO3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q06418') ]
