...
st.set_page_config(page_title="RUNX1", layout="wide")
st.title("Runt-related transcription factor 1")
st.markdown(f"Uniprot ID: [Q01196](https://www.uniprot.org/uniprotkb/Q01196/)")
st.markdown(f"Protein symbol: RUNX1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q01196') ]
