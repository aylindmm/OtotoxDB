...
st.set_page_config(page_title="GLRA2", layout="wide")
st.title("Glycine receptor subunit alpha-2")
st.markdown(f"Uniprot ID: [P23416](https://www.uniprot.org/uniprotkb/P23416/)")
st.markdown(f"Protein symbol: GLRA2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23416') ]
