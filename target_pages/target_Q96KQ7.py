...
st.set_page_config(page_title="EHMT2", layout="wide")
st.title("Histone-lysine N-methyltransferase EHMT2")
st.markdown(f"Uniprot ID: [Q96KQ7](https://www.uniprot.org/uniprotkb/Q96KQ7/)")
st.markdown(f"Protein symbol: EHMT2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96KQ7') ]
