...
st.set_page_config(page_title="SC5A2", layout="wide")
st.title("Sodium/glucose cotransporter 2")
st.markdown(f"Uniprot ID: [P31639](https://www.uniprot.org/uniprotkb/P31639/)")
st.markdown(f"Protein symbol: SC5A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P31639') ]
