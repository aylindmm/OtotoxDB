...
st.set_page_config(page_title="GRIA2", layout="wide")
st.title("Glutamate receptor 2")
st.markdown(f"Uniprot ID: [P42262](https://www.uniprot.org/uniprotkb/P42262/)")
st.markdown(f"Protein symbol: GRIA2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42262') ]
