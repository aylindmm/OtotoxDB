...
st.set_page_config(page_title="PP2BA", layout="wide")
st.title("Protein phosphatase 3 catalytic subunit alpha")
st.markdown(f"Uniprot ID: [Q08209](https://www.uniprot.org/uniprotkb/Q08209/)")
st.markdown(f"Protein symbol: PP2BA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q08209') ]
