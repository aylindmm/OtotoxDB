...
st.set_page_config(page_title="PTGES", layout="wide")
st.title("Prostaglandin E synthase")
st.markdown(f"Uniprot ID: [O14684](https://www.uniprot.org/uniprotkb/O14684/)")
st.markdown(f"Protein symbol: PTGES")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14684') ]
