...
st.set_page_config(page_title="M4K3", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase kinase 3")
st.markdown(f"Uniprot ID: [Q8IVH8](https://www.uniprot.org/uniprotkb/Q8IVH8/)")
st.markdown(f"Protein symbol: M4K3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IVH8') ]
