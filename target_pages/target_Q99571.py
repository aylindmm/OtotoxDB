...
st.set_page_config(page_title="P2RX4", layout="wide")
st.title("P2X purinoceptor 4")
st.markdown(f"Uniprot ID: [Q99571](https://www.uniprot.org/uniprotkb/Q99571/)")
st.markdown(f"Protein symbol: P2RX4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99571') ]
