...
st.set_page_config(page_title="PPBI", layout="wide")
st.title("Intestinal-type alkaline phosphatase")
st.markdown(f"Uniprot ID: [P09923](https://www.uniprot.org/uniprotkb/P09923/)")
st.markdown(f"Protein symbol: PPBI")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09923') ]
