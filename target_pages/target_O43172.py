...
st.set_page_config(page_title="PRP4", layout="wide")
st.title("U4/U6 small nuclear ribonucleoprotein Prp4")
st.markdown(f"Uniprot ID: [O43172](https://www.uniprot.org/uniprotkb/O43172/)")
st.markdown(f"Protein symbol: PRP4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43172') ]
