...
st.set_page_config(page_title="LIMK2", layout="wide")
st.title("LIM domain kinase 2")
st.markdown(f"Uniprot ID: [P53671](https://www.uniprot.org/uniprotkb/P53671/)")
st.markdown(f"Protein symbol: LIMK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53671') ]
