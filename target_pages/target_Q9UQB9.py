...
st.set_page_config(page_title="AURKC", layout="wide")
st.title("Aurora kinase C")
st.markdown(f"Uniprot ID: [Q9UQB9](https://www.uniprot.org/uniprotkb/Q9UQB9/)")
st.markdown(f"Protein symbol: AURKC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UQB9') ]
