...
st.set_page_config(page_title="5HT1F", layout="wide")
st.title("5-hydroxytryptamine receptor 1F")
st.markdown(f"Uniprot ID: [P30939](https://www.uniprot.org/uniprotkb/P30939/)")
st.markdown(f"Protein symbol: 5HT1F")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30939') ]
