...
st.set_page_config(page_title="PAK5", layout="wide")
st.title("Serine/threonine-protein kinase PAK 5")
st.markdown(f"Uniprot ID: [Q9P286](https://www.uniprot.org/uniprotkb/Q9P286/)")
st.markdown(f"Protein symbol: PAK5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9P286') ]
