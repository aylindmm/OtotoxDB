...
st.set_page_config(page_title="ZAP70", layout="wide")
st.title("Tyrosine-protein kinase ZAP-70")
st.markdown(f"Uniprot ID: [P43403](https://www.uniprot.org/uniprotkb/P43403/)")
st.markdown(f"Protein symbol: ZAP70")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43403') ]
