...
st.set_page_config(page_title="MINK1", layout="wide")
st.title("Misshapen-like kinase 1")
st.markdown(f"Uniprot ID: [Q8N4C8](https://www.uniprot.org/uniprotkb/Q8N4C8/)")
st.markdown(f"Protein symbol: MINK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8N4C8') ]
