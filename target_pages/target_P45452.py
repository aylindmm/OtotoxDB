...
st.set_page_config(page_title="MMP13", layout="wide")
st.title("Collagenase 3")
st.markdown(f"Uniprot ID: [P45452](https://www.uniprot.org/uniprotkb/P45452/)")
st.markdown(f"Protein symbol: MMP13")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P45452') ]
