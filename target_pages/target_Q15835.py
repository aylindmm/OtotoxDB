...
st.set_page_config(page_title="GRK1", layout="wide")
st.title("Rhodopsin kinase GRK1")
st.markdown(f"Uniprot ID: [Q15835](https://www.uniprot.org/uniprotkb/Q15835/)")
st.markdown(f"Protein symbol: GRK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15835') ]
