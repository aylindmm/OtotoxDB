...
st.set_page_config(page_title="NOX1", layout="wide")
st.title("NADPH oxidase 1")
st.markdown(f"Uniprot ID: [Q9Y5S8](https://www.uniprot.org/uniprotkb/Q9Y5S8/)")
st.markdown(f"Protein symbol: NOX1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y5S8') ]
