...
st.set_page_config(page_title="RN5A", layout="wide")
st.title("2-5A-dependent ribonuclease")
st.markdown(f"Uniprot ID: [Q05823](https://www.uniprot.org/uniprotkb/Q05823/)")
st.markdown(f"Protein symbol: RN5A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q05823') ]
