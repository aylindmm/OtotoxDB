...
st.set_page_config(page_title="ACE2", layout="wide")
st.title("Angiotensin-converting enzyme 2")
st.markdown(f"Uniprot ID: [Q9BYF1](https://www.uniprot.org/uniprotkb/Q9BYF1/)")
st.markdown(f"Protein symbol: ACE2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BYF1') ]
