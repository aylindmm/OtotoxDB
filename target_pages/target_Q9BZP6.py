...
st.set_page_config(page_title="CHIA", layout="wide")
st.title("Acidic mammalian chitinase")
st.markdown(f"Uniprot ID: [Q9BZP6](https://www.uniprot.org/uniprotkb/Q9BZP6/)")
st.markdown(f"Protein symbol: CHIA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BZP6') ]
