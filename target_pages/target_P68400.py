...
st.set_page_config(page_title="CSK21", layout="wide")
st.title("Casein kinase II subunit alpha/beta")
st.markdown(f"Uniprot ID: [P68400](https://www.uniprot.org/uniprotkb/P68400/)")
st.markdown(f"Protein symbol: CSK21")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P68400') ]
