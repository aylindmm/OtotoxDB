...
st.set_page_config(page_title="SIR2", layout="wide")
st.title("NAD-dependent protein deacetylase sirtuin-2")
st.markdown(f"Uniprot ID: [Q8IXJ6](https://www.uniprot.org/uniprotkb/Q8IXJ6/)")
st.markdown(f"Protein symbol: SIR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IXJ6') ]
