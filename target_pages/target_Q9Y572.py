...
st.set_page_config(page_title="RIPK3", layout="wide")
st.title("Receptor-interacting serine/threonine-protein kinase 3")
st.markdown(f"Uniprot ID: [Q9Y572](https://www.uniprot.org/uniprotkb/Q9Y572/)")
st.markdown(f"Protein symbol: RIPK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y572') ]
