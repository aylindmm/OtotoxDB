...
st.set_page_config(page_title="AURKB", layout="wide")
st.title("Aurora kinase B")
st.markdown(f"Uniprot ID: [Q96GD4](https://www.uniprot.org/uniprotkb/Q96GD4/)")
st.markdown(f"Protein symbol: AURKB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96GD4') ]
