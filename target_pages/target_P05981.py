...
st.set_page_config(page_title="HEPS", layout="wide")
st.title("Serine protease hepsin")
st.markdown(f"Uniprot ID: [P05981](https://www.uniprot.org/uniprotkb/P05981/)")
st.markdown(f"Protein symbol: HEPS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05981') ]
