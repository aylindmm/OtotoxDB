...
st.set_page_config(page_title="PTN11", layout="wide")
st.title("Tyrosine-protein phosphatase non-receptor type 11")
st.markdown(f"Uniprot ID: [Q06124](https://www.uniprot.org/uniprotkb/Q06124/)")
st.markdown(f"Protein symbol: PTN11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q06124') ]
