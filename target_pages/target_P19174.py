...
st.set_page_config(page_title="PLCG1", layout="wide")
st.title("1-phosphatidylinositol 4,5-bisphosphate phosphodiesterase gamma-1 [1-999,I813T]")
st.markdown(f"Uniprot ID: [P19174](https://www.uniprot.org/uniprotkb/P19174/)")
st.markdown(f"Protein symbol: PLCG1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19174') ]
