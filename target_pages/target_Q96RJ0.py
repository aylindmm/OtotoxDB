...
st.set_page_config(page_title="TAAR1", layout="wide")
st.title("Trace amine-associated receptor 1")
st.markdown(f"Uniprot ID: [Q96RJ0](https://www.uniprot.org/uniprotkb/Q96RJ0/)")
st.markdown(f"Protein symbol: TAAR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96RJ0') ]
