...
st.set_page_config(page_title="CDK17", layout="wide")
st.title("Cyclin-dependent kinase 17")
st.markdown(f"Uniprot ID: [Q00537](https://www.uniprot.org/uniprotkb/Q00537/)")
st.markdown(f"Protein symbol: CDK17")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00537') ]
