...
st.set_page_config(page_title="ACHA3", layout="wide")
st.title("Neuronal acetylcholine receptor subunit alpha-3/beta-4")
st.markdown(f"Uniprot ID: [P32297](https://www.uniprot.org/uniprotkb/P32297/)")
st.markdown(f"Protein symbol: ACHA3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32297') ]
