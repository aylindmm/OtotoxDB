...
st.set_page_config(page_title="LATS2", layout="wide")
st.title("Serine/threonine-protein kinase LATS2")
st.markdown(f"Uniprot ID: [Q9NRM7](https://www.uniprot.org/uniprotkb/Q9NRM7/)")
st.markdown(f"Protein symbol: LATS2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NRM7') ]
