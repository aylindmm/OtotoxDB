...
st.set_page_config(page_title="RARG", layout="wide")
st.title("Retinoic acid receptor gamma [183-417]")
st.markdown(f"Uniprot ID: [P13631](https://www.uniprot.org/uniprotkb/P13631/)")
st.markdown(f"Protein symbol: RARG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P13631') ]
