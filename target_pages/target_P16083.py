...
st.set_page_config(page_title="NQO2", layout="wide")
st.title("Ribosyldihydronicotinamide dehydrogenase [quinone]")
st.markdown(f"Uniprot ID: [P16083](https://www.uniprot.org/uniprotkb/P16083/)")
st.markdown(f"Protein symbol: NQO2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16083') ]
