...
st.set_page_config(page_title="TTK", layout="wide")
st.title("Dual specificity protein kinase TTK")
st.markdown(f"Uniprot ID: [P33981](https://www.uniprot.org/uniprotkb/P33981/)")
st.markdown(f"Protein symbol: TTK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P33981') ]
