...
st.set_page_config(page_title="S47A1", layout="wide")
st.title("Multidrug and toxin extrusion protein 1")
st.markdown(f"Uniprot ID: [Q96FL8](https://www.uniprot.org/uniprotkb/Q96FL8/)")
st.markdown(f"Protein symbol: S47A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96FL8') ]
