...
st.set_page_config(page_title="MRP3", layout="wide")
st.title("ATP-binding cassette sub-family C member 3")
st.markdown(f"Uniprot ID: [O15438](https://www.uniprot.org/uniprotkb/O15438/)")
st.markdown(f"Protein symbol: MRP3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15438') ]
