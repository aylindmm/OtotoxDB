...
st.set_page_config(page_title="DRD3", layout="wide")
st.title("D(3) dopamine receptor")
st.markdown(f"Uniprot ID: [P35462](https://www.uniprot.org/uniprotkb/P35462/)")
st.markdown(f"Protein symbol: DRD3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35462') ]
