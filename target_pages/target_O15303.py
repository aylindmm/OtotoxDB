...
st.set_page_config(page_title="GRM6", layout="wide")
st.title("Metabotropic glutamate receptor 6")
st.markdown(f"Uniprot ID: [O15303](https://www.uniprot.org/uniprotkb/O15303/)")
st.markdown(f"Protein symbol: GRM6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15303') ]
