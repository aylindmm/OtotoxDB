...
st.set_page_config(page_title="NAMPT", layout="wide")
st.title("Nicotinamide phosphoribosyltransferase")
st.markdown(f"Uniprot ID: [P43490](https://www.uniprot.org/uniprotkb/P43490/)")
st.markdown(f"Protein symbol: NAMPT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43490') ]
