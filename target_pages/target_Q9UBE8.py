...
st.set_page_config(page_title="NLK", layout="wide")
st.title("Serine/threonine-protein kinase NLK")
st.markdown(f"Uniprot ID: [Q9UBE8](https://www.uniprot.org/uniprotkb/Q9UBE8/)")
st.markdown(f"Protein symbol: NLK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UBE8') ]
