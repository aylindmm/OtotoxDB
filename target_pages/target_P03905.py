...
st.set_page_config(page_title="NU4M", layout="wide")
st.title("NADH-ubiquinone oxidoreductase chain 4")
st.markdown(f"Uniprot ID: [P03905](https://www.uniprot.org/uniprotkb/P03905/)")
st.markdown(f"Protein symbol: NU4M")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P03905') ]
