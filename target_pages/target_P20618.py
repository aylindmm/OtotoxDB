...
st.set_page_config(page_title="PSB1", layout="wide")
st.title("Proteasome subunit beta type-1")
st.markdown(f"Uniprot ID: [P20618](https://www.uniprot.org/uniprotkb/P20618/)")
st.markdown(f"Protein symbol: PSB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20618') ]
