...
st.set_page_config(page_title="KC1AL", layout="wide")
st.title("Casein kinase I isoform alpha-like")
st.markdown(f"Uniprot ID: [Q8N752](https://www.uniprot.org/uniprotkb/Q8N752/)")
st.markdown(f"Protein symbol: KC1AL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8N752') ]
