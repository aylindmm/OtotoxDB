...
st.set_page_config(page_title="STK10", layout="wide")
st.title("Serine/threonine-protein kinase 10")
st.markdown(f"Uniprot ID: [O94804](https://www.uniprot.org/uniprotkb/O94804/)")
st.markdown(f"Protein symbol: STK10")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O94804') ]
