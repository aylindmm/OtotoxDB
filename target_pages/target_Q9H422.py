...
st.set_page_config(page_title="HIPK3", layout="wide")
st.title("Homeodomain-interacting protein kinase 3")
st.markdown(f"Uniprot ID: [Q9H422](https://www.uniprot.org/uniprotkb/Q9H422/)")
st.markdown(f"Protein symbol: HIPK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H422') ]
