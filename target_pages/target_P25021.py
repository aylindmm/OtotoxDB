...
st.set_page_config(page_title="HRH2", layout="wide")
st.title("Histamine H2 receptor")
st.markdown(f"Uniprot ID: [P25021](https://www.uniprot.org/uniprotkb/P25021/)")
st.markdown(f"Protein symbol: HRH2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25021') ]
