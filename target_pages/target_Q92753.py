...
st.set_page_config(page_title="RORB", layout="wide")
st.title("Nuclear receptor ROR-beta")
st.markdown(f"Uniprot ID: [Q92753](https://www.uniprot.org/uniprotkb/Q92753/)")
st.markdown(f"Protein symbol: RORB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92753') ]
