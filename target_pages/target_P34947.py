...
st.set_page_config(page_title="GRK5", layout="wide")
st.title("G protein-coupled receptor kinase 5")
st.markdown(f"Uniprot ID: [P34947](https://www.uniprot.org/uniprotkb/P34947/)")
st.markdown(f"Protein symbol: GRK5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34947') ]
