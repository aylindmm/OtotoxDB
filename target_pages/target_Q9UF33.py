...
st.set_page_config(page_title="EPHA6", layout="wide")
st.title("Ephrin type-A receptor 6")
st.markdown(f"Uniprot ID: [Q9UF33](https://www.uniprot.org/uniprotkb/Q9UF33/)")
st.markdown(f"Protein symbol: EPHA6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UF33') ]
