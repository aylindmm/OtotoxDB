...
st.set_page_config(page_title="NEUR1", layout="wide")
st.title("Sialidase-1")
st.markdown(f"Uniprot ID: [Q99519](https://www.uniprot.org/uniprotkb/Q99519/)")
st.markdown(f"Protein symbol: NEUR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99519') ]
