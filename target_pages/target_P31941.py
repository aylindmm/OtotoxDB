...
st.set_page_config(page_title="ABC3A", layout="wide")
st.title("DNA dC->dU-editing enzyme APOBEC-3A")
st.markdown(f"Uniprot ID: [P31941](https://www.uniprot.org/uniprotkb/P31941/)")
st.markdown(f"Protein symbol: ABC3A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P31941') ]
