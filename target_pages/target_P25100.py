...
st.set_page_config(page_title="ADA1D", layout="wide")
st.title("Alpha-1D adrenergic receptor")
st.markdown(f"Uniprot ID: [P25100](https://www.uniprot.org/uniprotkb/P25100/)")
st.markdown(f"Protein symbol: ADA1D")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25100') ]
