...
st.set_page_config(page_title="PK3C3", layout="wide")
st.title("Phosphatidylinositol 3-kinase catalytic subunit type 3")
st.markdown(f"Uniprot ID: [Q8NEB9](https://www.uniprot.org/uniprotkb/Q8NEB9/)")
st.markdown(f"Protein symbol: PK3C3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NEB9') ]
