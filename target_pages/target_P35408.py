...
st.set_page_config(page_title="PE2R4", layout="wide")
st.title("Prostaglandin E2 receptor EP4 subtype")
st.markdown(f"Uniprot ID: [P35408](https://www.uniprot.org/uniprotkb/P35408/)")
st.markdown(f"Protein symbol: PE2R4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35408') ]
