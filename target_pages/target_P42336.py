...
st.set_page_config(page_title="PK3CA", layout="wide")
st.title("Phosphatidylinositol 4,5-bisphosphate 3-kinase catalytic subunit alpha isoform")
st.markdown(f"Uniprot ID: [P42336](https://www.uniprot.org/uniprotkb/P42336/)")
st.markdown(f"Protein symbol: PK3CA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42336') ]
