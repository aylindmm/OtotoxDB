...
st.set_page_config(page_title="KCNQ3", layout="wide")
st.title("Potassium voltage-gated channel subfamily KQT member 3")
st.markdown(f"Uniprot ID: [O43525](https://www.uniprot.org/uniprotkb/O43525/)")
st.markdown(f"Protein symbol: KCNQ3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43525') ]
