...
st.set_page_config(page_title="HLAA", layout="wide")
st.title("HLA class I histocompatibility antigen, A alpha chain")
st.markdown(f"Uniprot ID: [P04439](https://www.uniprot.org/uniprotkb/P04439/)")
st.markdown(f"Protein symbol: HLAA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04439') ]
