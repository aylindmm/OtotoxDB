...
st.set_page_config(page_title="EFCE2", layout="wide")
st.title("EEF1AKMT4-ECE2 readthrough transcript protein")
st.markdown(f"Uniprot ID: [P0DPD8](https://www.uniprot.org/uniprotkb/P0DPD8/)")
st.markdown(f"Protein symbol: EFCE2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P0DPD8') ]
