...
st.set_page_config(page_title="TET2", layout="wide")
st.title("Methylcytosine dioxygenase TET2")
st.markdown(f"Uniprot ID: [Q6N021](https://www.uniprot.org/uniprotkb/Q6N021/)")
st.markdown(f"Protein symbol: TET2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q6N021') ]
