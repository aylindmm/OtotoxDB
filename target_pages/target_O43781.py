...
st.set_page_config(page_title="DYRK3", layout="wide")
st.title("Dual specificity tyrosine-phosphorylation-regulated kinase 3")
st.markdown(f"Uniprot ID: [O43781](https://www.uniprot.org/uniprotkb/O43781/)")
st.markdown(f"Protein symbol: DYRK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43781') ]
