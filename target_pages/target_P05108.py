...
st.set_page_config(page_title="CP11A", layout="wide")
st.title("Cholesterol side-chain cleavage enzyme, mitochondrial")
st.markdown(f"Uniprot ID: [P05108](https://www.uniprot.org/uniprotkb/P05108/)")
st.markdown(f"Protein symbol: CP11A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05108') ]
