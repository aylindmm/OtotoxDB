...
st.set_page_config(page_title="CDK13", layout="wide")
st.title("Cyclin-dependent kinase 13")
st.markdown(f"Uniprot ID: [Q14004](https://www.uniprot.org/uniprotkb/Q14004/)")
st.markdown(f"Protein symbol: CDK13")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14004') ]
