...
st.set_page_config(page_title="FKB1A", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase FKBP1A")
st.markdown(f"Uniprot ID: [P62942](https://www.uniprot.org/uniprotkb/P62942/)")
st.markdown(f"Protein symbol: FKB1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P62942') ]
