...
st.set_page_config(page_title="SC5A4", layout="wide")
st.title("Solute carrier family 5 member 4")
st.markdown(f"Uniprot ID: [Q9NY91](https://www.uniprot.org/uniprotkb/Q9NY91/)")
st.markdown(f"Protein symbol: SC5A4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NY91') ]
