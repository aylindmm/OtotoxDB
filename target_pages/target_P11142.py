...
st.set_page_config(page_title="HSP7C", layout="wide")
st.title("Heat shock cognate 71 kDa protein")
st.markdown(f"Uniprot ID: [P11142](https://www.uniprot.org/uniprotkb/P11142/)")
st.markdown(f"Protein symbol: HSP7C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11142') ]
