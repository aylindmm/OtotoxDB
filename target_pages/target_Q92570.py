...
st.set_page_config(page_title="NR4A3", layout="wide")
st.title("Nuclear receptor subfamily 4 group A member 3")
st.markdown(f"Uniprot ID: [Q92570](https://www.uniprot.org/uniprotkb/Q92570/)")
st.markdown(f"Protein symbol: NR4A3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92570') ]
