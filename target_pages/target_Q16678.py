...
st.set_page_config(page_title="CP1B1", layout="wide")
st.title("Cytochrome P450 1B1")
st.markdown(f"Uniprot ID: [Q16678](https://www.uniprot.org/uniprotkb/Q16678/)")
st.markdown(f"Protein symbol: CP1B1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16678') ]
