...
st.set_page_config(page_title="TRPV3", layout="wide")
st.title("Transient receptor potential cation channel subfamily V member 3")
st.markdown(f"Uniprot ID: [Q8NET8](https://www.uniprot.org/uniprotkb/Q8NET8/)")
st.markdown(f"Protein symbol: TRPV3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NET8') ]
