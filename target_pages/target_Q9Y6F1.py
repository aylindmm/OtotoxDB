...
st.set_page_config(page_title="PARP3", layout="wide")
st.title("Protein mono-ADP-ribosyltransferase PARP3 [R100H]")
st.markdown(f"Uniprot ID: [Q9Y6F1](https://www.uniprot.org/uniprotkb/Q9Y6F1/)")
st.markdown(f"Protein symbol: PARP3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y6F1') ]
