...
st.set_page_config(page_title="IDE", layout="wide")
st.title("Insulin-degrading enzyme")
st.markdown(f"Uniprot ID: [P14735](https://www.uniprot.org/uniprotkb/P14735/)")
st.markdown(f"Protein symbol: IDE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14735') ]
