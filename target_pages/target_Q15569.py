...
st.set_page_config(page_title="TESK1", layout="wide")
st.title("Dual specificity testis-specific protein kinase 1")
st.markdown(f"Uniprot ID: [Q15569](https://www.uniprot.org/uniprotkb/Q15569/)")
st.markdown(f"Protein symbol: TESK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15569') ]
