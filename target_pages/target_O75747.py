...
st.set_page_config(page_title="P3C2G", layout="wide")
st.title("Phosphatidylinositol 3-kinase C2 domain-containing subunit gamma")
st.markdown(f"Uniprot ID: [O75747](https://www.uniprot.org/uniprotkb/O75747/)")
st.markdown(f"Protein symbol: P3C2G")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75747') ]
