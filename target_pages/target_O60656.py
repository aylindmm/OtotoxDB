...
st.set_page_config(page_title="UD19", layout="wide")
st.title("UDP-glucuronosyltransferase 1A9")
st.markdown(f"Uniprot ID: [O60656](https://www.uniprot.org/uniprotkb/O60656/)")
st.markdown(f"Protein symbol: UD19")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60656') ]
