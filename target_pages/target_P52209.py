...
st.set_page_config(page_title="6PGD", layout="wide")
st.title("6-phosphogluconate dehydrogenase, decarboxylating")
st.markdown(f"Uniprot ID: [P52209](https://www.uniprot.org/uniprotkb/P52209/)")
st.markdown(f"Protein symbol: 6PGD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P52209') ]
