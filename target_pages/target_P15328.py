...
st.set_page_config(page_title="FOLR1", layout="wide")
st.title("Folate receptor alpha")
st.markdown(f"Uniprot ID: [P15328](https://www.uniprot.org/uniprotkb/P15328/)")
st.markdown(f"Protein symbol: FOLR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15328') ]
