...
st.set_page_config(page_title="CCKAR", layout="wide")
st.title("Cholecystokinin receptor type A/Gastrin/cholecystokinin type B receptor")
st.markdown(f"Uniprot ID: [P32238](https://www.uniprot.org/uniprotkb/P32238/)")
st.markdown(f"Protein symbol: CCKAR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32238') ]
