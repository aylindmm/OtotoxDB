...
st.set_page_config(page_title="HDAC9", layout="wide")
st.title("Histone deacetylase 9")
st.markdown(f"Uniprot ID: [Q9UKV0](https://www.uniprot.org/uniprotkb/Q9UKV0/)")
st.markdown(f"Protein symbol: HDAC9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UKV0') ]
