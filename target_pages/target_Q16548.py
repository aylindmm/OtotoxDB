...
st.set_page_config(page_title="B2LA1", layout="wide")
st.title("Bcl-2-related protein A1")
st.markdown(f"Uniprot ID: [Q16548](https://www.uniprot.org/uniprotkb/Q16548/)")
st.markdown(f"Protein symbol: B2LA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16548') ]
