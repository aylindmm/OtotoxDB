...
st.set_page_config(page_title="T23O", layout="wide")
st.title("Tryptophan 2,3-dioxygenase")
st.markdown(f"Uniprot ID: [P48775](https://www.uniprot.org/uniprotkb/P48775/)")
st.markdown(f"Protein symbol: T23O")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48775') ]
