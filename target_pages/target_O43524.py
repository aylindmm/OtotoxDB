...
st.set_page_config(page_title="FOXO3", layout="wide")
st.title("Forkhead box protein O3")
st.markdown(f"Uniprot ID: [O43524](https://www.uniprot.org/uniprotkb/O43524/)")
st.markdown(f"Protein symbol: FOXO3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43524') ]
