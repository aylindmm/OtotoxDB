...
st.set_page_config(page_title="SCN4A", layout="wide")
st.title("Sodium channel protein type 4 subunit alpha")
st.markdown(f"Uniprot ID: [P35499](https://www.uniprot.org/uniprotkb/P35499/)")
st.markdown(f"Protein symbol: SCN4A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35499') ]
