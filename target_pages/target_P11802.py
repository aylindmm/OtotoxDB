...
st.set_page_config(page_title="CDK4", layout="wide")
st.title("Cyclin-dependent kinase 4/G1/S-specific cyclin-D3")
st.markdown(f"Uniprot ID: [P11802](https://www.uniprot.org/uniprotkb/P11802/)")
st.markdown(f"Protein symbol: CDK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11802') ]
