...
st.set_page_config(page_title="ICAM1", layout="wide")
st.title("Intercellular adhesion molecule 1")
st.markdown(f"Uniprot ID: [P05362](https://www.uniprot.org/uniprotkb/P05362/)")
st.markdown(f"Protein symbol: ICAM1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05362') ]
