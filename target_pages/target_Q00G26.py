...
st.set_page_config(page_title="PLIN5", layout="wide")
st.title("Perilipin-5")
st.markdown(f"Uniprot ID: [Q00G26](https://www.uniprot.org/uniprotkb/Q00G26/)")
st.markdown(f"Protein symbol: PLIN5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00G26') ]
