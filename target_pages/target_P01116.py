...
st.set_page_config(page_title="RASK", layout="wide")
st.title("GTPase KRas")
st.markdown(f"Uniprot ID: [P01116](https://www.uniprot.org/uniprotkb/P01116/)")
st.markdown(f"Protein symbol: RASK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P01116') ]
