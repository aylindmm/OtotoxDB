...
st.set_page_config(page_title="PIN1", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase NIMA-interacting 1")
st.markdown(f"Uniprot ID: [Q13526](https://www.uniprot.org/uniprotkb/Q13526/)")
st.markdown(f"Protein symbol: PIN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13526') ]
