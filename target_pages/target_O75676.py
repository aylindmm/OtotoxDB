...
st.set_page_config(page_title="KS6A4", layout="wide")
st.title("Ribosomal protein S6 kinase alpha-4")
st.markdown(f"Uniprot ID: [O75676](https://www.uniprot.org/uniprotkb/O75676/)")
st.markdown(f"Protein symbol: KS6A4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75676') ]
