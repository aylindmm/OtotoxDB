...
st.set_page_config(page_title="RIOK2", layout="wide")
st.title("Serine/threonine-protein kinase RIO2")
st.markdown(f"Uniprot ID: [Q9BVS4](https://www.uniprot.org/uniprotkb/Q9BVS4/)")
st.markdown(f"Protein symbol: RIOK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BVS4') ]
