...
st.set_page_config(page_title="GRIA1", layout="wide")
st.title("Glutamate receptor 1")
st.markdown(f"Uniprot ID: [P42261](https://www.uniprot.org/uniprotkb/P42261/)")
st.markdown(f"Protein symbol: GRIA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42261') ]
