...
st.set_page_config(page_title="GRIA4", layout="wide")
st.title("Glutamate receptor 4")
st.markdown(f"Uniprot ID: [P48058](https://www.uniprot.org/uniprotkb/P48058/)")
st.markdown(f"Protein symbol: GRIA4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48058') ]
