...
st.set_page_config(page_title="DCLK3", layout="wide")
st.title("Serine/threonine-protein kinase DCLK3")
st.markdown(f"Uniprot ID: [Q9C098](https://www.uniprot.org/uniprotkb/Q9C098/)")
st.markdown(f"Protein symbol: DCLK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9C098') ]
