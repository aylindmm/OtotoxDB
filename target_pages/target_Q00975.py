...
st.set_page_config(page_title="CAC1B", layout="wide")
st.title("Voltage-dependent N-type calcium channel subunit alpha-1B")
st.markdown(f"Uniprot ID: [Q00975](https://www.uniprot.org/uniprotkb/Q00975/)")
st.markdown(f"Protein symbol: CAC1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00975') ]
