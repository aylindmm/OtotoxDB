...
st.set_page_config(page_title="CBP", layout="wide")
st.title("CREB-binding protein/Histone acetyltransferase p300")
st.markdown(f"Uniprot ID: [Q92793](https://www.uniprot.org/uniprotkb/Q92793/)")
st.markdown(f"Protein symbol: CBP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92793') ]
