...
st.set_page_config(page_title="AA3R", layout="wide")
st.title("Adenosine receptor A3")
st.markdown(f"Uniprot ID: [P0DMS8](https://www.uniprot.org/uniprotkb/P0DMS8/)")
st.markdown(f"Protein symbol: AA3R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P0DMS8') ]
