...
st.set_page_config(page_title="DGLA", layout="wide")
st.title("Diacylglycerol lipase-alpha")
st.markdown(f"Uniprot ID: [Q9Y4D2](https://www.uniprot.org/uniprotkb/Q9Y4D2/)")
st.markdown(f"Protein symbol: DGLA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y4D2') ]
