...
st.set_page_config(page_title="APEX1", layout="wide")
st.title("DNA-(apurinic or apyrimidinic site) endonuclease")
st.markdown(f"Uniprot ID: [P27695](https://www.uniprot.org/uniprotkb/P27695/)")
st.markdown(f"Protein symbol: APEX1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27695') ]
