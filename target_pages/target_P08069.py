...
st.set_page_config(page_title="IGF1R", layout="wide")
st.title("Insulin-like growth factor 1 receptor")
st.markdown(f"Uniprot ID: [P08069](https://www.uniprot.org/uniprotkb/P08069/)")
st.markdown(f"Protein symbol: IGF1R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08069') ]
