...
st.set_page_config(page_title="HIPK1", layout="wide")
st.title("Homeodomain-interacting protein kinase 1")
st.markdown(f"Uniprot ID: [Q86Z02](https://www.uniprot.org/uniprotkb/Q86Z02/)")
st.markdown(f"Protein symbol: HIPK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86Z02') ]
