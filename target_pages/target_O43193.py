...
st.set_page_config(page_title="MTLR", layout="wide")
st.title("Motilin receptor")
st.markdown(f"Uniprot ID: [O43193](https://www.uniprot.org/uniprotkb/O43193/)")
st.markdown(f"Protein symbol: MTLR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43193') ]
