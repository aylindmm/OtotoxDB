...
st.set_page_config(page_title="SC6A1", layout="wide")
st.title("Sodium- and chloride-dependent GABA transporter 1")
st.markdown(f"Uniprot ID: [P30531](https://www.uniprot.org/uniprotkb/P30531/)")
st.markdown(f"Protein symbol: SC6A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30531') ]
