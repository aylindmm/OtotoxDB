...
st.set_page_config(page_title="CD5R1", layout="wide")
st.title("Cyclin-dependent kinase 5 activator 1")
st.markdown(f"Uniprot ID: [Q15078](https://www.uniprot.org/uniprotkb/Q15078/)")
st.markdown(f"Protein symbol: CD5R1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15078') ]
