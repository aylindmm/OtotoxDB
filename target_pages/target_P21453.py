...
st.set_page_config(page_title="S1PR1", layout="wide")
st.title("Sphingosine 1-phosphate receptor 1")
st.markdown(f"Uniprot ID: [P21453](https://www.uniprot.org/uniprotkb/P21453/)")
st.markdown(f"Protein symbol: S1PR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21453') ]
