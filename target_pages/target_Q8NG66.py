...
st.set_page_config(page_title="NEK11", layout="wide")
st.title("Serine/threonine-protein kinase Nek11")
st.markdown(f"Uniprot ID: [Q8NG66](https://www.uniprot.org/uniprotkb/Q8NG66/)")
st.markdown(f"Protein symbol: NEK11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NG66') ]
