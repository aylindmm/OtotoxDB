...
st.set_page_config(page_title="DUSTY", layout="wide")
st.title("Dual serine/threonine and tyrosine protein kinase")
st.markdown(f"Uniprot ID: [Q6XUX3](https://www.uniprot.org/uniprotkb/Q6XUX3/)")
st.markdown(f"Protein symbol: DUSTY")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q6XUX3') ]
