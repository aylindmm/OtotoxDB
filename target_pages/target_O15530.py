...
st.set_page_config(page_title="PDPK1", layout="wide")
st.title("3-phosphoinositide-dependent protein kinase 1")
st.markdown(f"Uniprot ID: [O15530](https://www.uniprot.org/uniprotkb/O15530/)")
st.markdown(f"Protein symbol: PDPK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15530') ]
