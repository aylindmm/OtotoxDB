...
st.set_page_config(page_title="HCK", layout="wide")
st.title("Tyrosine-protein kinase HCK")
st.markdown(f"Uniprot ID: [P08631](https://www.uniprot.org/uniprotkb/P08631/)")
st.markdown(f"Protein symbol: HCK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08631') ]
