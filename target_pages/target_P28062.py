...
st.set_page_config(page_title="PSB8", layout="wide")
st.title("Proteasome subunit beta type-8")
st.markdown(f"Uniprot ID: [P28062](https://www.uniprot.org/uniprotkb/P28062/)")
st.markdown(f"Protein symbol: PSB8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28062') ]
