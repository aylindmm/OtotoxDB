...
st.set_page_config(page_title="NUAK1", layout="wide")
st.title("NUAK family SNF1-like kinase 1")
st.markdown(f"Uniprot ID: [O60285](https://www.uniprot.org/uniprotkb/O60285/)")
st.markdown(f"Protein symbol: NUAK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60285') ]
