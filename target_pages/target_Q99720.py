...
st.set_page_config(page_title="SGMR1", layout="wide")
st.title("Sigma non-opioid intracellular receptor 1")
st.markdown(f"Uniprot ID: [Q99720](https://www.uniprot.org/uniprotkb/Q99720/)")
st.markdown(f"Protein symbol: SGMR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99720') ]
