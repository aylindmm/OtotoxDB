...
st.set_page_config(page_title="MET", layout="wide")
st.title("Hepatocyte growth factor receptor")
st.markdown(f"Uniprot ID: [P08581](https://www.uniprot.org/uniprotkb/P08581/)")
st.markdown(f"Protein symbol: MET")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08581') ]
