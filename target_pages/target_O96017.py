...
st.set_page_config(page_title="CHK2", layout="wide")
st.title("Serine/threonine-protein kinase Chk2")
st.markdown(f"Uniprot ID: [O96017](https://www.uniprot.org/uniprotkb/O96017/)")
st.markdown(f"Protein symbol: CHK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O96017') ]
