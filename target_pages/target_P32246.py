...
st.set_page_config(page_title="CCR1", layout="wide")
st.title("C-C chemokine receptor type 1")
st.markdown(f"Uniprot ID: [P32246](https://www.uniprot.org/uniprotkb/P32246/)")
st.markdown(f"Protein symbol: CCR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32246') ]
