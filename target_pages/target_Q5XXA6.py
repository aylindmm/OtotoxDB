...
st.set_page_config(page_title="ANO1", layout="wide")
st.title("Anoctamin-1")
st.markdown(f"Uniprot ID: [Q5XXA6](https://www.uniprot.org/uniprotkb/Q5XXA6/)")
st.markdown(f"Protein symbol: ANO1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q5XXA6') ]
