...
st.set_page_config(page_title="CGL", layout="wide")
st.title("Cystathionine gamma-lyase")
st.markdown(f"Uniprot ID: [P32929](https://www.uniprot.org/uniprotkb/P32929/)")
st.markdown(f"Protein symbol: CGL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32929') ]
