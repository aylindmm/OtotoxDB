...
st.set_page_config(page_title="ERBB3", layout="wide")
st.title("Receptor tyrosine-protein kinase erbB-3")
st.markdown(f"Uniprot ID: [P21860](https://www.uniprot.org/uniprotkb/P21860/)")
st.markdown(f"Protein symbol: ERBB3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21860') ]
