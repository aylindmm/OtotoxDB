...
st.set_page_config(page_title="MUSK", layout="wide")
st.title("Muscle, skeletal receptor tyrosine-protein kinase")
st.markdown(f"Uniprot ID: [O15146](https://www.uniprot.org/uniprotkb/O15146/)")
st.markdown(f"Protein symbol: MUSK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15146') ]
