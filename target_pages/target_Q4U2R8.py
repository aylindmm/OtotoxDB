...
st.set_page_config(page_title="S22A6", layout="wide")
st.title("Solute carrier family 22 member 6")
st.markdown(f"Uniprot ID: [Q4U2R8](https://www.uniprot.org/uniprotkb/Q4U2R8/)")
st.markdown(f"Protein symbol: S22A6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q4U2R8') ]
