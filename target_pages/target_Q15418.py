...
st.set_page_config(page_title="KS6A1", layout="wide")
st.title("Ribosomal protein S6 kinase alpha-1")
st.markdown(f"Uniprot ID: [Q15418](https://www.uniprot.org/uniprotkb/Q15418/)")
st.markdown(f"Protein symbol: KS6A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15418') ]
