...
st.set_page_config(page_title="ABL2", layout="wide")
st.title("Tyrosine-protein kinase ABL2")
st.markdown(f"Uniprot ID: [P42684](https://www.uniprot.org/uniprotkb/P42684/)")
st.markdown(f"Protein symbol: ABL2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42684') ]
