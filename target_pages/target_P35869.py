...
st.set_page_config(page_title="AHR", layout="wide")
st.title("Aryl hydrocarbon receptor")
st.markdown(f"Uniprot ID: [P35869](https://www.uniprot.org/uniprotkb/P35869/)")
st.markdown(f"Protein symbol: AHR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35869') ]
