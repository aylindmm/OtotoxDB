...
st.set_page_config(page_title="ABL1", layout="wide")
st.title("Tyrosine-protein kinase ABL1/ABL2")
st.markdown(f"Uniprot ID: [P00519](https://www.uniprot.org/uniprotkb/P00519/)")
st.markdown(f"Protein symbol: ABL1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00519') ]
