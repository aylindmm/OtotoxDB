...
st.set_page_config(page_title="MMP16", layout="wide")
st.title("Matrix metalloproteinase-16")
st.markdown(f"Uniprot ID: [P51512](https://www.uniprot.org/uniprotkb/P51512/)")
st.markdown(f"Protein symbol: MMP16")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51512') ]
