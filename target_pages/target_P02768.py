...
st.set_page_config(page_title="ALBU", layout="wide")
st.title("Albumin")
st.markdown(f"Uniprot ID: [P02768](https://www.uniprot.org/uniprotkb/P02768/)")
st.markdown(f"Protein symbol: ALBU")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P02768') ]
