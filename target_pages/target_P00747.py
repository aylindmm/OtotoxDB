...
st.set_page_config(page_title="PLMN", layout="wide")
st.title("Plasminogen")
st.markdown(f"Uniprot ID: [P00747](https://www.uniprot.org/uniprotkb/P00747/)")
st.markdown(f"Protein symbol: PLMN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00747') ]
