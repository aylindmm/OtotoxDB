...
st.set_page_config(page_title="ADRB1", layout="wide")
st.title("Beta-1/Beta-2/Beta-3 adrenergic receptor")
st.markdown(f"Uniprot ID: [P08588](https://www.uniprot.org/uniprotkb/P08588/)")
st.markdown(f"Protein symbol: ADRB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08588') ]
