...
st.set_page_config(page_title="AOXA", layout="wide")
st.title("Aldehyde oxidase")
st.markdown(f"Uniprot ID: [Q06278](https://www.uniprot.org/uniprotkb/Q06278/)")
st.markdown(f"Protein symbol: AOXA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q06278') ]
