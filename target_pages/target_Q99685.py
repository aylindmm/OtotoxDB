...
st.set_page_config(page_title="MGLL", layout="wide")
st.title("Monoglyceride lipase")
st.markdown(f"Uniprot ID: [Q99685](https://www.uniprot.org/uniprotkb/Q99685/)")
st.markdown(f"Protein symbol: MGLL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99685') ]
