...
st.set_page_config(page_title="EPHB2", layout="wide")
st.title("Ephrin type-B receptor 2")
st.markdown(f"Uniprot ID: [P29323](https://www.uniprot.org/uniprotkb/P29323/)")
st.markdown(f"Protein symbol: EPHB2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29323') ]
