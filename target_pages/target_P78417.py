...
st.set_page_config(page_title="GSTO1", layout="wide")
st.title("Glutathione S-transferase omega-1")
st.markdown(f"Uniprot ID: [P78417](https://www.uniprot.org/uniprotkb/P78417/)")
st.markdown(f"Protein symbol: GSTO1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P78417') ]
