...
st.set_page_config(page_title="SCNBA", layout="wide")
st.title("Sodium channel protein type 11 subunit alpha")
st.markdown(f"Uniprot ID: [Q9UI33](https://www.uniprot.org/uniprotkb/Q9UI33/)")
st.markdown(f"Protein symbol: SCNBA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UI33') ]
