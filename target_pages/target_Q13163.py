...
st.set_page_config(page_title="MP2K5", layout="wide")
st.title("Dual specificity mitogen-activated protein kinase kinase 5")
st.markdown(f"Uniprot ID: [Q13163](https://www.uniprot.org/uniprotkb/Q13163/)")
st.markdown(f"Protein symbol: MP2K5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13163') ]
