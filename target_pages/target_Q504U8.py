...
st.set_page_config(page_title="Q504U8", layout="wide")
st.title("Receptor protein-tyrosine kinase")
st.markdown(f"Uniprot ID: [Q504U8](https://www.uniprot.org/uniprotkb/Q504U8/)")
st.markdown(f"Protein symbol: Q504U8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q504U8') ]
