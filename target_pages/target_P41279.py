...
st.set_page_config(page_title="M3K8", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 8")
st.markdown(f"Uniprot ID: [P41279](https://www.uniprot.org/uniprotkb/P41279/)")
st.markdown(f"Protein symbol: M3K8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41279') ]
