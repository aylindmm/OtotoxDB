...
st.set_page_config(page_title="STF1", layout="wide")
st.title("Steroidogenic factor 1")
st.markdown(f"Uniprot ID: [Q13285](https://www.uniprot.org/uniprotkb/Q13285/)")
st.markdown(f"Protein symbol: STF1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13285') ]
