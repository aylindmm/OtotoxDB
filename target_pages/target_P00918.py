...
st.set_page_config(page_title="CAH2", layout="wide")
st.title("Carbonic anhydrase 2")
st.markdown(f"Uniprot ID: [P00918](https://www.uniprot.org/uniprotkb/P00918/)")
st.markdown(f"Protein symbol: CAH2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00918') ]
