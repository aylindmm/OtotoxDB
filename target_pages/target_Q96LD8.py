...
st.set_page_config(page_title="SENP8", layout="wide")
st.title("Sentrin-specific protease 8")
st.markdown(f"Uniprot ID: [Q96LD8](https://www.uniprot.org/uniprotkb/Q96LD8/)")
st.markdown(f"Protein symbol: SENP8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96LD8') ]
