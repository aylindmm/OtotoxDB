...
st.set_page_config(page_title="ACK1", layout="wide")
st.title("Activated CDC42 kinase 1")
st.markdown(f"Uniprot ID: [Q07912](https://www.uniprot.org/uniprotkb/Q07912/)")
st.markdown(f"Protein symbol: ACK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q07912') ]
