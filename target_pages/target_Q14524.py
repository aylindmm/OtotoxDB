...
st.set_page_config(page_title="SCN5A", layout="wide")
st.title("Sodium channel protein type 5 subunit alpha")
st.markdown(f"Uniprot ID: [Q14524](https://www.uniprot.org/uniprotkb/Q14524/)")
st.markdown(f"Protein symbol: SCN5A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14524') ]
