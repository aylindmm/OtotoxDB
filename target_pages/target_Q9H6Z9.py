...
st.set_page_config(page_title="EGLN3", layout="wide")
st.title("Prolyl hydroxylase EGLN3")
st.markdown(f"Uniprot ID: [Q9H6Z9](https://www.uniprot.org/uniprotkb/Q9H6Z9/)")
st.markdown(f"Protein symbol: EGLN3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H6Z9') ]
