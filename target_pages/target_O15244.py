...
st.set_page_config(page_title="S22A2", layout="wide")
st.title("Solute carrier family 22 member 2")
st.markdown(f"Uniprot ID: [O15244](https://www.uniprot.org/uniprotkb/O15244/)")
st.markdown(f"Protein symbol: S22A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15244') ]
