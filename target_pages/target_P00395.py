...
st.set_page_config(page_title="COX1", layout="wide")
st.title("Cytochrome c oxidase subunit 1")
st.markdown(f"Uniprot ID: [P00395](https://www.uniprot.org/uniprotkb/P00395/)")
st.markdown(f"Protein symbol: COX1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00395') ]
