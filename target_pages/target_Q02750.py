...
st.set_page_config(page_title="MP2K1", layout="wide")
st.title("Dual specificity mitogen-activated protein kinase kinase 1/RAF proto-oncogene serine/threonine-protein kinase")
st.markdown(f"Uniprot ID: [Q02750](https://www.uniprot.org/uniprotkb/Q02750/)")
st.markdown(f"Protein symbol: MP2K1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02750') ]
