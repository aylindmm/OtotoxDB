...
st.set_page_config(page_title="HIF1A", layout="wide")
st.title("Hypoxia-inducible factor 1-alpha")
st.markdown(f"Uniprot ID: [Q16665](https://www.uniprot.org/uniprotkb/Q16665/)")
st.markdown(f"Protein symbol: HIF1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16665') ]
