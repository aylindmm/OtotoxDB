...
st.set_page_config(page_title="ITK", layout="wide")
st.title("Tyrosine-protein kinase ITK/TSK")
st.markdown(f"Uniprot ID: [Q08881](https://www.uniprot.org/uniprotkb/Q08881/)")
st.markdown(f"Protein symbol: ITK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q08881') ]
