...
st.set_page_config(page_title="PUR9", layout="wide")
st.title("Bifunctional purine biosynthesis protein ATIC")
st.markdown(f"Uniprot ID: [P31939](https://www.uniprot.org/uniprotkb/P31939/)")
st.markdown(f"Protein symbol: PUR9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P31939') ]
