...
st.set_page_config(page_title="ACES", layout="wide")
st.title("Acetylcholinesterase")
st.markdown(f"Uniprot ID: [P22303](https://www.uniprot.org/uniprotkb/P22303/)")
st.markdown(f"Protein symbol: ACES")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22303') ]
