...
st.set_page_config(page_title="PIN4", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase NIMA-interacting 4")
st.markdown(f"Uniprot ID: [Q9Y237](https://www.uniprot.org/uniprotkb/Q9Y237/)")
st.markdown(f"Protein symbol: PIN4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y237') ]
