...
st.set_page_config(page_title="IMA1", layout="wide")
st.title("Importin subunit alpha-1")
st.markdown(f"Uniprot ID: [P52292](https://www.uniprot.org/uniprotkb/P52292/)")
st.markdown(f"Protein symbol: IMA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P52292') ]
