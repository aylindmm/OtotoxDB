...
st.set_page_config(page_title="KS6A3", layout="wide")
st.title("Ribosomal protein S6 kinase alpha-3")
st.markdown(f"Uniprot ID: [P51812](https://www.uniprot.org/uniprotkb/P51812/)")
st.markdown(f"Protein symbol: KS6A3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51812') ]
