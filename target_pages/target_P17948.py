...
st.set_page_config(page_title="VGFR1", layout="wide")
st.title("Vascular endothelial growth factor receptor 1")
st.markdown(f"Uniprot ID: [P17948](https://www.uniprot.org/uniprotkb/P17948/)")
st.markdown(f"Protein symbol: VGFR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P17948') ]
