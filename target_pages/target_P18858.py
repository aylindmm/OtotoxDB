...
st.set_page_config(page_title="DNLI1", layout="wide")
st.title("DNA ligase 1")
st.markdown(f"Uniprot ID: [P18858](https://www.uniprot.org/uniprotkb/P18858/)")
st.markdown(f"Protein symbol: DNLI1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P18858') ]
