...
st.set_page_config(page_title="FDFT", layout="wide")
st.title("Squalene synthase")
st.markdown(f"Uniprot ID: [P37268](https://www.uniprot.org/uniprotkb/P37268/)")
st.markdown(f"Protein symbol: FDFT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P37268') ]
