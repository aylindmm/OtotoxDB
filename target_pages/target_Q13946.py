...
st.set_page_config(page_title="PDE7A", layout="wide")
st.title("High affinity cAMP-specific 3',5'-cyclic phosphodiesterase 7A/cAMP-specific 3',5'-cyclic phosphodiesterase 7B")
st.markdown(f"Uniprot ID: [Q13946](https://www.uniprot.org/uniprotkb/Q13946/)")
st.markdown(f"Protein symbol: PDE7A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13946') ]
