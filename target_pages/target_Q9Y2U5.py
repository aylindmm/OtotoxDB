...
st.set_page_config(page_title="M3K2", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 2")
st.markdown(f"Uniprot ID: [Q9Y2U5](https://www.uniprot.org/uniprotkb/Q9Y2U5/)")
st.markdown(f"Protein symbol: M3K2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2U5') ]
