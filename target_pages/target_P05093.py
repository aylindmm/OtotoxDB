...
st.set_page_config(page_title="CP17A", layout="wide")
st.title("Steroid 17-alpha-hydroxylase/17,20 lyase")
st.markdown(f"Uniprot ID: [P05093](https://www.uniprot.org/uniprotkb/P05093/)")
st.markdown(f"Protein symbol: CP17A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05093') ]
