...
st.set_page_config(page_title="PDE4A", layout="wide")
st.title("cAMP-specific 3',5'-cyclic phosphodiesterase 4A")
st.markdown(f"Uniprot ID: [P27815](https://www.uniprot.org/uniprotkb/P27815/)")
st.markdown(f"Protein symbol: PDE4A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27815') ]
