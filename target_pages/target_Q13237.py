...
st.set_page_config(page_title="KGP2", layout="wide")
st.title("cGMP-dependent protein kinase 2")
st.markdown(f"Uniprot ID: [Q13237](https://www.uniprot.org/uniprotkb/Q13237/)")
st.markdown(f"Protein symbol: KGP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13237') ]
