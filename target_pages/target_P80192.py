...
st.set_page_config(page_title="M3K9", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 9")
st.markdown(f"Uniprot ID: [P80192](https://www.uniprot.org/uniprotkb/P80192/)")
st.markdown(f"Protein symbol: M3K9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P80192') ]
