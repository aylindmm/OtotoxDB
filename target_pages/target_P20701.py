...
st.set_page_config(page_title="ITAL", layout="wide")
st.title("Integrin alpha-L/beta-2")
st.markdown(f"Uniprot ID: [P20701](https://www.uniprot.org/uniprotkb/P20701/)")
st.markdown(f"Protein symbol: ITAL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20701') ]
