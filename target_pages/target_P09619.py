...
st.set_page_config(page_title="PGFRB", layout="wide")
st.title("Platelet-derived growth factor receptor beta")
st.markdown(f"Uniprot ID: [P09619](https://www.uniprot.org/uniprotkb/P09619/)")
st.markdown(f"Protein symbol: PGFRB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09619') ]
