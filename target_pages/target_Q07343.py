...
st.set_page_config(page_title="PDE4B", layout="wide")
st.title("cAMP-specific 3',5'-cyclic phosphodiesterase 4B [316-320,321-700,S319G,N320S,N321H,T322M]")
st.markdown(f"Uniprot ID: [Q07343](https://www.uniprot.org/uniprotkb/Q07343/)")
st.markdown(f"Protein symbol: PDE4B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q07343') ]
