...
st.set_page_config(page_title="PIR", layout="wide")
st.title("Pirin")
st.markdown(f"Uniprot ID: [O00625](https://www.uniprot.org/uniprotkb/O00625/)")
st.markdown(f"Protein symbol: PIR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00625') ]
