...
st.set_page_config(page_title="FNTB", layout="wide")
st.title("Dimer of Protein farnesyltransferase subunit beta")
st.markdown(f"Uniprot ID: [P49356](https://www.uniprot.org/uniprotkb/P49356/)")
st.markdown(f"Protein symbol: FNTB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49356') ]
