...
st.set_page_config(page_title="LDHA", layout="wide")
st.title("L-lactate dehydrogenase A chain")
st.markdown(f"Uniprot ID: [P00338](https://www.uniprot.org/uniprotkb/P00338/)")
st.markdown(f"Protein symbol: LDHA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00338') ]
