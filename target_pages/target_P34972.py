...
st.set_page_config(page_title="CNR2", layout="wide")
st.title("Cannabinoid receptor 2")
st.markdown(f"Uniprot ID: [P34972](https://www.uniprot.org/uniprotkb/P34972/)")
st.markdown(f"Protein symbol: CNR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34972') ]
