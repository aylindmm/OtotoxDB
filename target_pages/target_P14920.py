...
st.set_page_config(page_title="OXDA", layout="wide")
st.title("D-amino-acid oxidase")
st.markdown(f"Uniprot ID: [P14920](https://www.uniprot.org/uniprotkb/P14920/)")
st.markdown(f"Protein symbol: OXDA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14920') ]
