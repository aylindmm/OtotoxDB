...
st.set_page_config(page_title="MRCKG", layout="wide")
st.title("Serine/threonine-protein kinase MRCK gamma")
st.markdown(f"Uniprot ID: [Q6DT37](https://www.uniprot.org/uniprotkb/Q6DT37/)")
st.markdown(f"Protein symbol: MRCKG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q6DT37') ]
