...
st.set_page_config(page_title="EBPL", layout="wide")
st.title("Emopamil-binding protein-like")
st.markdown(f"Uniprot ID: [Q9BY08](https://www.uniprot.org/uniprotkb/Q9BY08/)")
st.markdown(f"Protein symbol: EBPL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BY08') ]
