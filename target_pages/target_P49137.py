...
st.set_page_config(page_title="MAPK2", layout="wide")
st.title("MAP kinase-activated protein kinase 2")
st.markdown(f"Uniprot ID: [P49137](https://www.uniprot.org/uniprotkb/P49137/)")
st.markdown(f"Protein symbol: MAPK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49137') ]
