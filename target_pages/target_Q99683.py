...
st.set_page_config(page_title="M3K5", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 5")
st.markdown(f"Uniprot ID: [Q99683](https://www.uniprot.org/uniprotkb/Q99683/)")
st.markdown(f"Protein symbol: M3K5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99683') ]
