...
st.set_page_config(page_title="GCR", layout="wide")
st.title("Glucocorticoid receptor")
st.markdown(f"Uniprot ID: [P04150](https://www.uniprot.org/uniprotkb/P04150/)")
st.markdown(f"Protein symbol: GCR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04150') ]
