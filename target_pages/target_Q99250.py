...
st.set_page_config(page_title="SCN2A", layout="wide")
st.title("Sodium channel protein type 2 subunit alpha")
st.markdown(f"Uniprot ID: [Q99250](https://www.uniprot.org/uniprotkb/Q99250/)")
st.markdown(f"Protein symbol: SCN2A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99250') ]
