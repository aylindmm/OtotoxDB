...
st.set_page_config(page_title="DYRK4", layout="wide")
st.title("Dual specificity tyrosine-phosphorylation-regulated kinase 4")
st.markdown(f"Uniprot ID: [Q9NR20](https://www.uniprot.org/uniprotkb/Q9NR20/)")
st.markdown(f"Protein symbol: DYRK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NR20') ]
