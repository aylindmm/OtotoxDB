...
st.set_page_config(page_title="CDKL1", layout="wide")
st.title("Cyclin-dependent kinase-like 1 [2-358]")
st.markdown(f"Uniprot ID: [Q00532](https://www.uniprot.org/uniprotkb/Q00532/)")
st.markdown(f"Protein symbol: CDKL1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00532') ]
