...
st.set_page_config(page_title="GBRA1", layout="wide")
st.title("Gamma-aminobutyric acid receptor subunit alpha-1/beta-3/gamma-2")
st.markdown(f"Uniprot ID: [P14867](https://www.uniprot.org/uniprotkb/P14867/)")
st.markdown(f"Protein symbol: GBRA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14867') ]
