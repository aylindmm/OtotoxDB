...
st.set_page_config(page_title="KPCD2", layout="wide")
st.title("Serine/threonine-protein kinase D2")
st.markdown(f"Uniprot ID: [Q9BZL6](https://www.uniprot.org/uniprotkb/Q9BZL6/)")
st.markdown(f"Protein symbol: KPCD2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BZL6') ]
