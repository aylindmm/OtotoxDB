...
st.set_page_config(page_title="5HT2C", layout="wide")
st.title("5-hydroxytryptamine receptor 2C")
st.markdown(f"Uniprot ID: [P28335](https://www.uniprot.org/uniprotkb/P28335/)")
st.markdown(f"Protein symbol: 5HT2C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28335') ]
