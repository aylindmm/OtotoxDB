...
st.set_page_config(page_title="PA2GA", layout="wide")
st.title("Phospholipase A2, membrane associated")
st.markdown(f"Uniprot ID: [P14555](https://www.uniprot.org/uniprotkb/P14555/)")
st.markdown(f"Protein symbol: PA2GA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14555') ]
