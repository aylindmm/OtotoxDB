...
st.set_page_config(page_title="GRIK4", layout="wide")
st.title("Glutamate receptor ionotropic, kainate 4")
st.markdown(f"Uniprot ID: [Q16099](https://www.uniprot.org/uniprotkb/Q16099/)")
st.markdown(f"Protein symbol: GRIK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16099') ]
