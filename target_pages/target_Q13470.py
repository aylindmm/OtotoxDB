...
st.set_page_config(page_title="TNK1", layout="wide")
st.title("Non-receptor tyrosine-protein kinase TNK1")
st.markdown(f"Uniprot ID: [Q13470](https://www.uniprot.org/uniprotkb/Q13470/)")
st.markdown(f"Protein symbol: TNK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13470') ]
