...
st.set_page_config(page_title="S35B2", layout="wide")
st.title("Adenosine 3'-phospho 5'-phosphosulfate transporter 1")
st.markdown(f"Uniprot ID: [Q8TB61](https://www.uniprot.org/uniprotkb/Q8TB61/)")
st.markdown(f"Protein symbol: S35B2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TB61') ]
