...
st.set_page_config(page_title="M3K7", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 7")
st.markdown(f"Uniprot ID: [O43318](https://www.uniprot.org/uniprotkb/O43318/)")
st.markdown(f"Protein symbol: M3K7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43318') ]
