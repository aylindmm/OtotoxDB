...
st.set_page_config(page_title="LYOX", layout="wide")
st.title("Protein-lysine 6-oxidase")
st.markdown(f"Uniprot ID: [P28300](https://www.uniprot.org/uniprotkb/P28300/)")
st.markdown(f"Protein symbol: LYOX")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28300') ]
