...
st.set_page_config(page_title="FKB14", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase FKBP14")
st.markdown(f"Uniprot ID: [Q9NWM8](https://www.uniprot.org/uniprotkb/Q9NWM8/)")
st.markdown(f"Protein symbol: FKB14")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NWM8') ]
