...
st.set_page_config(page_title="EPHA3", layout="wide")
st.title("Ephrin type-A receptor 3 [1-975]")
st.markdown(f"Uniprot ID: [P29320](https://www.uniprot.org/uniprotkb/P29320/)")
st.markdown(f"Protein symbol: EPHA3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29320') ]
