...
st.set_page_config(page_title="EAA1", layout="wide")
st.title("Excitatory amino acid transporter 1")
st.markdown(f"Uniprot ID: [P43003](https://www.uniprot.org/uniprotkb/P43003/)")
st.markdown(f"Protein symbol: EAA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43003') ]
