...
st.set_page_config(page_title="MYO3B", layout="wide")
st.title("Myosin-IIIb")
st.markdown(f"Uniprot ID: [Q8WXR4](https://www.uniprot.org/uniprotkb/Q8WXR4/)")
st.markdown(f"Protein symbol: MYO3B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8WXR4') ]
