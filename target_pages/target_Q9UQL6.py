...
st.set_page_config(page_title="HDAC5", layout="wide")
st.title("Histone deacetylase 5")
st.markdown(f"Uniprot ID: [Q9UQL6](https://www.uniprot.org/uniprotkb/Q9UQL6/)")
st.markdown(f"Protein symbol: HDAC5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UQL6') ]
