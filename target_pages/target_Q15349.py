...
st.set_page_config(page_title="KS6A2", layout="wide")
st.title("Ribosomal protein S6 kinase alpha-2")
st.markdown(f"Uniprot ID: [Q15349](https://www.uniprot.org/uniprotkb/Q15349/)")
st.markdown(f"Protein symbol: KS6A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15349') ]
