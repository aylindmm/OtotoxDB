...
st.set_page_config(page_title="ARGI1", layout="wide")
st.title("Arginase-1")
st.markdown(f"Uniprot ID: [P05089](https://www.uniprot.org/uniprotkb/P05089/)")
st.markdown(f"Protein symbol: ARGI1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05089') ]
