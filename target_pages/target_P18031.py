...
st.set_page_config(page_title="PTN1", layout="wide")
st.title("Tyrosine-protein phosphatase non-receptor type 1")
st.markdown(f"Uniprot ID: [P18031](https://www.uniprot.org/uniprotkb/P18031/)")
st.markdown(f"Protein symbol: PTN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P18031') ]
