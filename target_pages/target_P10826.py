...
st.set_page_config(page_title="RARB", layout="wide")
st.title("Retinoic acid receptor beta [200-419]")
st.markdown(f"Uniprot ID: [P10826](https://www.uniprot.org/uniprotkb/P10826/)")
st.markdown(f"Protein symbol: RARB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10826') ]
