...
st.set_page_config(page_title="KCNJ3", layout="wide")
st.title("G protein-activated inward rectifier potassium channel 1")
st.markdown(f"Uniprot ID: [P48549](https://www.uniprot.org/uniprotkb/P48549/)")
st.markdown(f"Protein symbol: KCNJ3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48549') ]
