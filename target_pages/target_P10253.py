...
st.set_page_config(page_title="LYAG", layout="wide")
st.title("Lysosomal alpha-glucosidase")
st.markdown(f"Uniprot ID: [P10253](https://www.uniprot.org/uniprotkb/P10253/)")
st.markdown(f"Protein symbol: LYAG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10253') ]
