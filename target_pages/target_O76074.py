...
st.set_page_config(page_title="PDE5A", layout="wide")
st.title("cGMP-specific 3',5'-cyclic phosphodiesterase [531-875]")
st.markdown(f"Uniprot ID: [O76074](https://www.uniprot.org/uniprotkb/O76074/)")
st.markdown(f"Protein symbol: PDE5A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O76074') ]
