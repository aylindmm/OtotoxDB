...
st.set_page_config(page_title="SHBG", layout="wide")
st.title("Sex hormone-binding globulin")
st.markdown(f"Uniprot ID: [P04278](https://www.uniprot.org/uniprotkb/P04278/)")
st.markdown(f"Protein symbol: SHBG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04278') ]
