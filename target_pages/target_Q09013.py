...
st.set_page_config(page_title="DMPK", layout="wide")
st.title("Myotonin-protein kinase")
st.markdown(f"Uniprot ID: [Q09013](https://www.uniprot.org/uniprotkb/Q09013/)")
st.markdown(f"Protein symbol: DMPK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q09013') ]
