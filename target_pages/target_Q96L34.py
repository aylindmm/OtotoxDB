...
st.set_page_config(page_title="MARK4", layout="wide")
st.title("MAP/microtubule affinity-regulating kinase 4")
st.markdown(f"Uniprot ID: [Q96L34](https://www.uniprot.org/uniprotkb/Q96L34/)")
st.markdown(f"Protein symbol: MARK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96L34') ]
