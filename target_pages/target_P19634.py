...
st.set_page_config(page_title="SL9A1", layout="wide")
st.title("Sodium/hydrogen exchanger 1")
st.markdown(f"Uniprot ID: [P19634](https://www.uniprot.org/uniprotkb/P19634/)")
st.markdown(f"Protein symbol: SL9A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19634') ]
