...
st.set_page_config(page_title="CASP4", layout="wide")
st.title("Caspase-4")
st.markdown(f"Uniprot ID: [P49662](https://www.uniprot.org/uniprotkb/P49662/)")
st.markdown(f"Protein symbol: CASP4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49662') ]
