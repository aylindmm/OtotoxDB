...
st.set_page_config(page_title="HYAL1", layout="wide")
st.title("Hyaluronidase-1")
st.markdown(f"Uniprot ID: [Q12794](https://www.uniprot.org/uniprotkb/Q12794/)")
st.markdown(f"Protein symbol: HYAL1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q12794') ]
