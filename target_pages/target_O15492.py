...
st.set_page_config(page_title="RGS16", layout="wide")
st.title("Regulator of G-protein signaling 16")
st.markdown(f"Uniprot ID: [O15492](https://www.uniprot.org/uniprotkb/O15492/)")
st.markdown(f"Protein symbol: RGS16")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15492') ]
