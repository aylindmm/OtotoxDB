...
st.set_page_config(page_title="P3C2B", layout="wide")
st.title("Phosphatidylinositol 4-phosphate 3-kinase C2 domain-containing subunit beta")
st.markdown(f"Uniprot ID: [O00750](https://www.uniprot.org/uniprotkb/O00750/)")
st.markdown(f"Protein symbol: P3C2B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00750') ]
