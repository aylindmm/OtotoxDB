...
st.set_page_config(page_title="AL5AP", layout="wide")
st.title("Arachidonate 5-lipoxygenase-activating protein")
st.markdown(f"Uniprot ID: [P20292](https://www.uniprot.org/uniprotkb/P20292/)")
st.markdown(f"Protein symbol: AL5AP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20292') ]
