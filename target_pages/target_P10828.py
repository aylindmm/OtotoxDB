...
st.set_page_config(page_title="THB", layout="wide")
st.title("Thyroid hormone receptor beta")
st.markdown(f"Uniprot ID: [P10828](https://www.uniprot.org/uniprotkb/P10828/)")
st.markdown(f"Protein symbol: THB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10828') ]
