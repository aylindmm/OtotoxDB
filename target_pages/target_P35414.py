...
st.set_page_config(page_title="APJ", layout="wide")
st.title("Apelin receptor")
st.markdown(f"Uniprot ID: [P35414](https://www.uniprot.org/uniprotkb/P35414/)")
st.markdown(f"Protein symbol: APJ")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35414') ]
