...
st.set_page_config(page_title="RAF1", layout="wide")
st.title("RAF proto-oncogene serine/threonine-protein kinase [305-648]")
st.markdown(f"Uniprot ID: [P04049](https://www.uniprot.org/uniprotkb/P04049/)")
st.markdown(f"Protein symbol: RAF1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04049') ]
