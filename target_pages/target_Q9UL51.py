...
st.set_page_config(page_title="HCN2", layout="wide")
st.title("Potassium/sodium hyperpolarization-activated cyclic nucleotide-gated channel 2")
st.markdown(f"Uniprot ID: [Q9UL51](https://www.uniprot.org/uniprotkb/Q9UL51/)")
st.markdown(f"Protein symbol: HCN2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UL51') ]
