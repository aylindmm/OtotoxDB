...
st.set_page_config(page_title="STK39", layout="wide")
st.title("STE20/SPS1-related proline-alanine-rich protein kinase")
st.markdown(f"Uniprot ID: [Q9UEW8](https://www.uniprot.org/uniprotkb/Q9UEW8/)")
st.markdown(f"Protein symbol: STK39")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UEW8') ]
