...
st.set_page_config(page_title="SYK", layout="wide")
st.title("Lysine--tRNA ligase")
st.markdown(f"Uniprot ID: [Q15046](https://www.uniprot.org/uniprotkb/Q15046/)")
st.markdown(f"Protein symbol: SYK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15046') ]
