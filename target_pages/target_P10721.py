...
st.set_page_config(page_title="KIT", layout="wide")
st.title("Mast/stem cell growth factor receptor Kit [V559D]")
st.markdown(f"Uniprot ID: [P10721](https://www.uniprot.org/uniprotkb/P10721/)")
st.markdown(f"Protein symbol: KIT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10721') ]
