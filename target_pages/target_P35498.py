...
st.set_page_config(page_title="SCN1A", layout="wide")
st.title("Sodium channel protein type 1/2/3 subunit alpha")
st.markdown(f"Uniprot ID: [P35498](https://www.uniprot.org/uniprotkb/P35498/)")
st.markdown(f"Protein symbol: SCN1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35498') ]
