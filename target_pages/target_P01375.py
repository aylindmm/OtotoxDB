...
st.set_page_config(page_title="TNFA", layout="wide")
st.title("Tumor necrosis factor")
st.markdown(f"Uniprot ID: [P01375](https://www.uniprot.org/uniprotkb/P01375/)")
st.markdown(f"Protein symbol: TNFA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P01375') ]
