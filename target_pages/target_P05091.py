...
st.set_page_config(page_title="ALDH2", layout="wide")
st.title("Aldehyde dehydrogenase, mitochondrial")
st.markdown(f"Uniprot ID: [P05091](https://www.uniprot.org/uniprotkb/P05091/)")
st.markdown(f"Protein symbol: ALDH2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05091') ]
