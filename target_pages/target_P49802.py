...
st.set_page_config(page_title="RGS7", layout="wide")
st.title("Regulator of G-protein signaling 7")
st.markdown(f"Uniprot ID: [P49802](https://www.uniprot.org/uniprotkb/P49802/)")
st.markdown(f"Protein symbol: RGS7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49802') ]
