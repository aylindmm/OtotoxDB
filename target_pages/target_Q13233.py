...
st.set_page_config(page_title="M3K1", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 1")
st.markdown(f"Uniprot ID: [Q13233](https://www.uniprot.org/uniprotkb/Q13233/)")
st.markdown(f"Protein symbol: M3K1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13233') ]
