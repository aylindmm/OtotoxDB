...
st.set_page_config(page_title="CDC42", layout="wide")
st.title("Cell division control protein 42 homolog/Ras-related C3 botulinum toxin substrate 1")
st.markdown(f"Uniprot ID: [P60953](https://www.uniprot.org/uniprotkb/P60953/)")
st.markdown(f"Protein symbol: CDC42")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P60953') ]
