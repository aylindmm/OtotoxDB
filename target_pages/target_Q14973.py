...
st.set_page_config(page_title="NTCP", layout="wide")
st.title("Sodium/bile acid cotransporter")
st.markdown(f"Uniprot ID: [Q14973](https://www.uniprot.org/uniprotkb/Q14973/)")
st.markdown(f"Protein symbol: NTCP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14973') ]
