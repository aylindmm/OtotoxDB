...
st.set_page_config(page_title="KCNN3", layout="wide")
st.title("Small conductance calcium-activated potassium channel protein 3")
st.markdown(f"Uniprot ID: [Q9UGI6](https://www.uniprot.org/uniprotkb/Q9UGI6/)")
st.markdown(f"Protein symbol: KCNN3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UGI6') ]
