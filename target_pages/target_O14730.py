...
st.set_page_config(page_title="RIOK3", layout="wide")
st.title("Serine/threonine-protein kinase RIO3")
st.markdown(f"Uniprot ID: [O14730](https://www.uniprot.org/uniprotkb/O14730/)")
st.markdown(f"Protein symbol: RIOK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14730') ]
