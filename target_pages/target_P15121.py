...
st.set_page_config(page_title="ALDR", layout="wide")
st.title("Aldo-keto reductase family 1 member B1")
st.markdown(f"Uniprot ID: [P15121](https://www.uniprot.org/uniprotkb/P15121/)")
st.markdown(f"Protein symbol: ALDR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15121') ]
