...
st.set_page_config(page_title="KKCC2", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase kinase 2")
st.markdown(f"Uniprot ID: [Q96RR4](https://www.uniprot.org/uniprotkb/Q96RR4/)")
st.markdown(f"Protein symbol: KKCC2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96RR4') ]
