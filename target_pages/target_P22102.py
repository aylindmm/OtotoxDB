...
st.set_page_config(page_title="PUR2", layout="wide")
st.title("Trifunctional purine biosynthetic protein adenosine-3")
st.markdown(f"Uniprot ID: [P22102](https://www.uniprot.org/uniprotkb/P22102/)")
st.markdown(f"Protein symbol: PUR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22102') ]
