...
st.set_page_config(page_title="GBRA4", layout="wide")
st.title("Gamma-aminobutyric acid receptor subunit alpha-4")
st.markdown(f"Uniprot ID: [P48169](https://www.uniprot.org/uniprotkb/P48169/)")
st.markdown(f"Protein symbol: GBRA4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48169') ]
