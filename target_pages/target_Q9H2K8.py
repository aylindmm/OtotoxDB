...
st.set_page_config(page_title="TAOK3", layout="wide")
st.title("Serine/threonine-protein kinase TAO3")
st.markdown(f"Uniprot ID: [Q9H2K8](https://www.uniprot.org/uniprotkb/Q9H2K8/)")
st.markdown(f"Protein symbol: TAOK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H2K8') ]
