...
st.set_page_config(page_title="CTDS1", layout="wide")
st.title("Carboxy-terminal domain RNA polymerase II polypeptide A small phosphatase 1")
st.markdown(f"Uniprot ID: [Q9GZU7](https://www.uniprot.org/uniprotkb/Q9GZU7/)")
st.markdown(f"Protein symbol: CTDS1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9GZU7') ]
