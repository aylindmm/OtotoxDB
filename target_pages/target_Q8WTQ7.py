...
st.set_page_config(page_title="GRK7", layout="wide")
st.title("Rhodopsin kinase GRK7")
st.markdown(f"Uniprot ID: [Q8WTQ7](https://www.uniprot.org/uniprotkb/Q8WTQ7/)")
st.markdown(f"Protein symbol: GRK7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8WTQ7') ]
