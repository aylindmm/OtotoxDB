...
st.set_page_config(page_title="FNTA", layout="wide")
st.title("Protein farnesyltransferase subunit beta/geranylgeranyltransferase type-1 subunit alpha")
st.markdown(f"Uniprot ID: [P49354](https://www.uniprot.org/uniprotkb/P49354/)")
st.markdown(f"Protein symbol: FNTA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49354') ]
