...
st.set_page_config(page_title="FYN", layout="wide")
st.title("Tyrosine-protein kinase Fyn")
st.markdown(f"Uniprot ID: [P06241](https://www.uniprot.org/uniprotkb/P06241/)")
st.markdown(f"Protein symbol: FYN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P06241') ]
