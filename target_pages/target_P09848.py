...
st.set_page_config(page_title="LPH", layout="wide")
st.title("Lactase/phlorizin hydrolase")
st.markdown(f"Uniprot ID: [P09848](https://www.uniprot.org/uniprotkb/P09848/)")
st.markdown(f"Protein symbol: LPH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09848') ]
