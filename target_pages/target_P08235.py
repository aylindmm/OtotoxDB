...
st.set_page_config(page_title="MCR", layout="wide")
st.title("Mineralocorticoid receptor")
st.markdown(f"Uniprot ID: [P08235](https://www.uniprot.org/uniprotkb/P08235/)")
st.markdown(f"Protein symbol: MCR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08235') ]
