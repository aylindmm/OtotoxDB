...
st.set_page_config(page_title="AAK1", layout="wide")
st.title("AP2-associated protein kinase 1")
st.markdown(f"Uniprot ID: [Q2M2I8](https://www.uniprot.org/uniprotkb/Q2M2I8/)")
st.markdown(f"Protein symbol: AAK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q2M2I8') ]
