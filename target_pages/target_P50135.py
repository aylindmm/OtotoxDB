...
st.set_page_config(page_title="HNMT", layout="wide")
st.title("Histamine N-methyltransferase")
st.markdown(f"Uniprot ID: [P50135](https://www.uniprot.org/uniprotkb/P50135/)")
st.markdown(f"Protein symbol: HNMT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P50135') ]
