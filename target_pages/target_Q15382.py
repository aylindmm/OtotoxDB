...
st.set_page_config(page_title="RHEB", layout="wide")
st.title("GTP-binding protein Rheb")
st.markdown(f"Uniprot ID: [Q15382](https://www.uniprot.org/uniprotkb/Q15382/)")
st.markdown(f"Protein symbol: RHEB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15382') ]
