...
st.set_page_config(page_title="ERR1", layout="wide")
st.title("Steroid hormone receptor ERR1")
st.markdown(f"Uniprot ID: [P11474](https://www.uniprot.org/uniprotkb/P11474/)")
st.markdown(f"Protein symbol: ERR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11474') ]
