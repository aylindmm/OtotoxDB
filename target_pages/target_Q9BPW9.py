...
st.set_page_config(page_title="DHRS9", layout="wide")
st.title("Dehydrogenase/reductase SDR family member 9")
st.markdown(f"Uniprot ID: [Q9BPW9](https://www.uniprot.org/uniprotkb/Q9BPW9/)")
st.markdown(f"Protein symbol: DHRS9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BPW9') ]
