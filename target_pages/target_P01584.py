...
st.set_page_config(page_title="IL1B", layout="wide")
st.title("Interleukin-1 beta")
st.markdown(f"Uniprot ID: [P01584](https://www.uniprot.org/uniprotkb/P01584/)")
st.markdown(f"Protein symbol: IL1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P01584') ]
