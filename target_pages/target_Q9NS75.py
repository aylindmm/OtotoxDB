...
st.set_page_config(page_title="CLTR2", layout="wide")
st.title("Cysteinyl leukotriene receptor 2")
st.markdown(f"Uniprot ID: [Q9NS75](https://www.uniprot.org/uniprotkb/Q9NS75/)")
st.markdown(f"Protein symbol: CLTR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NS75') ]
