...
st.set_page_config(page_title="CILK1", layout="wide")
st.title("Serine/threonine-protein kinase ICK")
st.markdown(f"Uniprot ID: [Q9UPZ9](https://www.uniprot.org/uniprotkb/Q9UPZ9/)")
st.markdown(f"Protein symbol: CILK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UPZ9') ]
