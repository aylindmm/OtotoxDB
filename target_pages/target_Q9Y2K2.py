...
st.set_page_config(page_title="SIK3", layout="wide")
st.title("Serine/threonine-protein kinase SIK3 [59-1321]")
st.markdown(f"Uniprot ID: [Q9Y2K2](https://www.uniprot.org/uniprotkb/Q9Y2K2/)")
st.markdown(f"Protein symbol: SIK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2K2') ]
