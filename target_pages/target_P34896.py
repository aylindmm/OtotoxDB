...
st.set_page_config(page_title="GLYC", layout="wide")
st.title("Serine hydroxymethyltransferase, cytosolic")
st.markdown(f"Uniprot ID: [P34896](https://www.uniprot.org/uniprotkb/P34896/)")
st.markdown(f"Protein symbol: GLYC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34896') ]
