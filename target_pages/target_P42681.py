...
st.set_page_config(page_title="TXK", layout="wide")
st.title("Tyrosine-protein kinase TXK")
st.markdown(f"Uniprot ID: [P42681](https://www.uniprot.org/uniprotkb/P42681/)")
st.markdown(f"Protein symbol: TXK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42681') ]
