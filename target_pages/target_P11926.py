...
st.set_page_config(page_title="DCOR", layout="wide")
st.title("Ornithine decarboxylase")
st.markdown(f"Uniprot ID: [P11926](https://www.uniprot.org/uniprotkb/P11926/)")
st.markdown(f"Protein symbol: DCOR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11926') ]
