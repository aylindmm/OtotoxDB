...
st.set_page_config(page_title="A4", layout="wide")
st.title("Amyloid-beta precursor protein")
st.markdown(f"Uniprot ID: [P05067](https://www.uniprot.org/uniprotkb/P05067/)")
st.markdown(f"Protein symbol: A4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05067') ]
