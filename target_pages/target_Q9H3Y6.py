...
st.set_page_config(page_title="SRMS", layout="wide")
st.title("Tyrosine-protein kinase Srms")
st.markdown(f"Uniprot ID: [Q9H3Y6](https://www.uniprot.org/uniprotkb/Q9H3Y6/)")
st.markdown(f"Protein symbol: SRMS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H3Y6') ]
