...
st.set_page_config(page_title="LOX12", layout="wide")
st.title("Polyunsaturated fatty acid lipoxygenase ALOX12")
st.markdown(f"Uniprot ID: [P18054](https://www.uniprot.org/uniprotkb/P18054/)")
st.markdown(f"Protein symbol: LOX12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P18054') ]
