...
st.set_page_config(page_title="FGFR1", layout="wide")
st.title("Fibroblast growth factor receptor 1")
st.markdown(f"Uniprot ID: [P11362](https://www.uniprot.org/uniprotkb/P11362/)")
st.markdown(f"Protein symbol: FGFR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11362') ]
