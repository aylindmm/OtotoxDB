...
st.set_page_config(page_title="5HT1D", layout="wide")
st.title("5-hydroxytryptamine receptor 1D")
st.markdown(f"Uniprot ID: [P28221](https://www.uniprot.org/uniprotkb/P28221/)")
st.markdown(f"Protein symbol: 5HT1D")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28221') ]
