...
st.set_page_config(page_title="HSF1", layout="wide")
st.title("Heat shock factor protein 1")
st.markdown(f"Uniprot ID: [Q00613](https://www.uniprot.org/uniprotkb/Q00613/)")
st.markdown(f"Protein symbol: HSF1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00613') ]
