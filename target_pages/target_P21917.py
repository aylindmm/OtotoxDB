...
st.set_page_config(page_title="DRD4", layout="wide")
st.title("D(4) dopamine receptor")
st.markdown(f"Uniprot ID: [P21917](https://www.uniprot.org/uniprotkb/P21917/)")
st.markdown(f"Protein symbol: DRD4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21917') ]
