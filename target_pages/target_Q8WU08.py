...
st.set_page_config(page_title="ST32A", layout="wide")
st.title("Serine/threonine-protein kinase 32A")
st.markdown(f"Uniprot ID: [Q8WU08](https://www.uniprot.org/uniprotkb/Q8WU08/)")
st.markdown(f"Protein symbol: ST32A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8WU08') ]
