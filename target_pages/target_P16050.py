...
st.set_page_config(page_title="LOX15", layout="wide")
st.title("Polyunsaturated fatty acid lipoxygenase ALOX15")
st.markdown(f"Uniprot ID: [P16050](https://www.uniprot.org/uniprotkb/P16050/)")
st.markdown(f"Protein symbol: LOX15")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16050') ]
