...
st.set_page_config(page_title="PDE8B", layout="wide")
st.title("High affinity cAMP-specific and IBMX-insensitive 3',5'-cyclic phosphodiesterase 8B")
st.markdown(f"Uniprot ID: [O95263](https://www.uniprot.org/uniprotkb/O95263/)")
st.markdown(f"Protein symbol: PDE8B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95263') ]
