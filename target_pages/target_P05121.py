...
st.set_page_config(page_title="PAI1", layout="wide")
st.title("Plasminogen activator inhibitor 1")
st.markdown(f"Uniprot ID: [P05121](https://www.uniprot.org/uniprotkb/P05121/)")
st.markdown(f"Protein symbol: PAI1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05121') ]
