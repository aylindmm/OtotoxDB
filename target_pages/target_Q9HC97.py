...
st.set_page_config(page_title="GPR35", layout="wide")
st.title("G-protein coupled receptor 35")
st.markdown(f"Uniprot ID: [Q9HC97](https://www.uniprot.org/uniprotkb/Q9HC97/)")
st.markdown(f"Protein symbol: GPR35")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HC97') ]
