...
st.set_page_config(page_title="M3K11", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 11")
st.markdown(f"Uniprot ID: [Q16584](https://www.uniprot.org/uniprotkb/Q16584/)")
st.markdown(f"Protein symbol: M3K11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16584') ]
