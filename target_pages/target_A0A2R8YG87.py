...
st.set_page_config(page_title="A0A2R8YG87", layout="wide")
st.title("Chymotrypsinogen B")
st.markdown(f"Uniprot ID: [A0A2R8YG87](https://www.uniprot.org/uniprotkb/A0A2R8YG87/)")
st.markdown(f"Protein symbol: A0A2R8YG87")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'A0A2R8YG87') ]
