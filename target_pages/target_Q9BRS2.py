...
st.set_page_config(page_title="RIOK1", layout="wide")
st.title("Serine/threonine-protein kinase RIO1")
st.markdown(f"Uniprot ID: [Q9BRS2](https://www.uniprot.org/uniprotkb/Q9BRS2/)")
st.markdown(f"Protein symbol: RIOK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BRS2') ]
