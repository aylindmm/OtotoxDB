...
st.set_page_config(page_title="ABCG2", layout="wide")
st.title("Broad substrate specificity ATP-binding cassette transporter ABCG2")
st.markdown(f"Uniprot ID: [Q9UNQ0](https://www.uniprot.org/uniprotkb/Q9UNQ0/)")
st.markdown(f"Protein symbol: ABCG2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UNQ0') ]
