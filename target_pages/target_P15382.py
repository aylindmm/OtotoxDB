...
st.set_page_config(page_title="KCNE1", layout="wide")
st.title("Potassium voltage-gated channel subfamily E/KQT member 1")
st.markdown(f"Uniprot ID: [P15382](https://www.uniprot.org/uniprotkb/P15382/)")
st.markdown(f"Protein symbol: KCNE1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15382') ]
