...
st.set_page_config(page_title="CAC1C", layout="wide")
st.title("Voltage-dependent L-type calcium channel subunit alpha-1C/alpha-1D/alpha-1F/alpha-1S")
st.markdown(f"Uniprot ID: [Q13936](https://www.uniprot.org/uniprotkb/Q13936/)")
st.markdown(f"Protein symbol: CAC1C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13936') ]
