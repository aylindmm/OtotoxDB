...
st.set_page_config(page_title="UBP7", layout="wide")
st.title("Ubiquitin carboxyl-terminal hydrolase 7")
st.markdown(f"Uniprot ID: [Q93009](https://www.uniprot.org/uniprotkb/Q93009/)")
st.markdown(f"Protein symbol: UBP7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q93009') ]
