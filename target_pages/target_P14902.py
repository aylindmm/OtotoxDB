...
st.set_page_config(page_title="I23O1", layout="wide")
st.title("Indoleamine 2,3-dioxygenase 1")
st.markdown(f"Uniprot ID: [P14902](https://www.uniprot.org/uniprotkb/P14902/)")
st.markdown(f"Protein symbol: I23O1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14902') ]
