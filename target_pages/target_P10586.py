...
st.set_page_config(page_title="PTPRF", layout="wide")
st.title("Receptor-type tyrosine-protein phosphatase F")
st.markdown(f"Uniprot ID: [P10586](https://www.uniprot.org/uniprotkb/P10586/)")
st.markdown(f"Protein symbol: PTPRF")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10586') ]
