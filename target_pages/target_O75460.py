...
st.set_page_config(page_title="ERN1", layout="wide")
st.title("Serine/threonine-protein kinase/endoribonuclease IRE1")
st.markdown(f"Uniprot ID: [O75460](https://www.uniprot.org/uniprotkb/O75460/)")
st.markdown(f"Protein symbol: ERN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75460') ]
