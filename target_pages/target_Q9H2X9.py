...
st.set_page_config(page_title="S12A5", layout="wide")
st.title("Solute carrier family 12 member 5")
st.markdown(f"Uniprot ID: [Q9H2X9](https://www.uniprot.org/uniprotkb/Q9H2X9/)")
st.markdown(f"Protein symbol: S12A5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H2X9') ]
