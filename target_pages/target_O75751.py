...
st.set_page_config(page_title="S22A3", layout="wide")
st.title("Solute carrier family 22 member 3")
st.markdown(f"Uniprot ID: [O75751](https://www.uniprot.org/uniprotkb/O75751/)")
st.markdown(f"Protein symbol: S22A3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75751') ]
