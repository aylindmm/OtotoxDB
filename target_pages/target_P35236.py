...
st.set_page_config(page_title="PTN7", layout="wide")
st.title("Tyrosine-protein phosphatase non-receptor type 7")
st.markdown(f"Uniprot ID: [P35236](https://www.uniprot.org/uniprotkb/P35236/)")
st.markdown(f"Protein symbol: PTN7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35236') ]
