...
st.set_page_config(page_title="OXSR1", layout="wide")
st.title("Serine/threonine-protein kinase OSR1")
st.markdown(f"Uniprot ID: [O95747](https://www.uniprot.org/uniprotkb/O95747/)")
st.markdown(f"Protein symbol: OXSR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95747') ]
