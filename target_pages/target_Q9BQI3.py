...
st.set_page_config(page_title="E2AK1", layout="wide")
st.title("Eukaryotic translation initiation factor 2-alpha kinase 1")
st.markdown(f"Uniprot ID: [Q9BQI3](https://www.uniprot.org/uniprotkb/Q9BQI3/)")
st.markdown(f"Protein symbol: E2AK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BQI3') ]
