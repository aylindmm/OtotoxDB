...
st.set_page_config(page_title="NEK7", layout="wide")
st.title("Serine/threonine-protein kinase Nek7")
st.markdown(f"Uniprot ID: [Q8TDX7](https://www.uniprot.org/uniprotkb/Q8TDX7/)")
st.markdown(f"Protein symbol: NEK7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TDX7') ]
