...
st.set_page_config(page_title="APAF", layout="wide")
st.title("Apoptotic protease-activating factor 1")
st.markdown(f"Uniprot ID: [O14727](https://www.uniprot.org/uniprotkb/O14727/)")
st.markdown(f"Protein symbol: APAF")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14727') ]
