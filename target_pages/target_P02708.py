...
st.set_page_config(page_title="ACHA", layout="wide")
st.title("Acetylcholine receptor subunit alpha/beta/delta/gamma")
st.markdown(f"Uniprot ID: [P02708](https://www.uniprot.org/uniprotkb/P02708/)")
st.markdown(f"Protein symbol: ACHA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P02708') ]
