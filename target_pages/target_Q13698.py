...
st.set_page_config(page_title="CAC1S", layout="wide")
st.title("Voltage-dependent L-type calcium channel subunit alpha-1S")
st.markdown(f"Uniprot ID: [Q13698](https://www.uniprot.org/uniprotkb/Q13698/)")
st.markdown(f"Protein symbol: CAC1S")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13698') ]
