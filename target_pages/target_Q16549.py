...
st.set_page_config(page_title="PCSK7", layout="wide")
st.title("Proprotein convertase subtilisin/kexin type 7")
st.markdown(f"Uniprot ID: [Q16549](https://www.uniprot.org/uniprotkb/Q16549/)")
st.markdown(f"Protein symbol: PCSK7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16549') ]
