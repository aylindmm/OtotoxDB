...
st.set_page_config(page_title="PD2R2", layout="wide")
st.title("Prostaglandin D2 receptor 2")
st.markdown(f"Uniprot ID: [Q9Y5Y4](https://www.uniprot.org/uniprotkb/Q9Y5Y4/)")
st.markdown(f"Protein symbol: PD2R2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y5Y4') ]
