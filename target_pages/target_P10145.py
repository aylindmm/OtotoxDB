...
st.set_page_config(page_title="IL8", layout="wide")
st.title("Interleukin-8")
st.markdown(f"Uniprot ID: [P10145](https://www.uniprot.org/uniprotkb/P10145/)")
st.markdown(f"Protein symbol: IL8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10145') ]
