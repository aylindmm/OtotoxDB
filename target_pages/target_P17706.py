...
st.set_page_config(page_title="PTN2", layout="wide")
st.title("Tyrosine-protein phosphatase non-receptor type 2")
st.markdown(f"Uniprot ID: [P17706](https://www.uniprot.org/uniprotkb/P17706/)")
st.markdown(f"Protein symbol: PTN2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P17706') ]
