...
st.set_page_config(page_title="TRPM6", layout="wide")
st.title("Transient receptor potential cation channel subfamily M member 6")
st.markdown(f"Uniprot ID: [Q9BX84](https://www.uniprot.org/uniprotkb/Q9BX84/)")
st.markdown(f"Protein symbol: TRPM6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BX84') ]
