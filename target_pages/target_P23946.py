...
st.set_page_config(page_title="CMA1", layout="wide")
st.title("Chymase")
st.markdown(f"Uniprot ID: [P23946](https://www.uniprot.org/uniprotkb/P23946/)")
st.markdown(f"Protein symbol: CMA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23946') ]
