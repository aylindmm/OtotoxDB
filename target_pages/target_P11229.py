...
st.set_page_config(page_title="ACM1", layout="wide")
st.title("Muscarinic acetylcholine receptor M1")
st.markdown(f"Uniprot ID: [P11229](https://www.uniprot.org/uniprotkb/P11229/)")
st.markdown(f"Protein symbol: ACM1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11229') ]
