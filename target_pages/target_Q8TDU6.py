...
st.set_page_config(page_title="GPBAR", layout="wide")
st.title("G-protein coupled bile acid receptor 1")
st.markdown(f"Uniprot ID: [Q8TDU6](https://www.uniprot.org/uniprotkb/Q8TDU6/)")
st.markdown(f"Protein symbol: GPBAR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TDU6') ]
