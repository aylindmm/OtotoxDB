...
st.set_page_config(page_title="ALK", layout="wide")
st.title("ALK tyrosine kinase receptor/Nucleophosmin")
st.markdown(f"Uniprot ID: [Q9UM73](https://www.uniprot.org/uniprotkb/Q9UM73/)")
st.markdown(f"Protein symbol: ALK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UM73') ]
