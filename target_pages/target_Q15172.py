...
st.set_page_config(page_title="2A5A", layout="wide")
st.title("Serine/threonine-protein phosphatase 2A 56 kDa regulatory subunit alpha isoform")
st.markdown(f"Uniprot ID: [Q15172](https://www.uniprot.org/uniprotkb/Q15172/)")
st.markdown(f"Protein symbol: 2A5A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15172') ]
