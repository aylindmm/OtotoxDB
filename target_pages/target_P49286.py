...
st.set_page_config(page_title="MTR1B", layout="wide")
st.title("Melatonin receptor type 1B")
st.markdown(f"Uniprot ID: [P49286](https://www.uniprot.org/uniprotkb/P49286/)")
st.markdown(f"Protein symbol: MTR1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49286') ]
