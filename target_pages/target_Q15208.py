...
st.set_page_config(page_title="STK38", layout="wide")
st.title("Serine/threonine-protein kinase 38")
st.markdown(f"Uniprot ID: [Q15208](https://www.uniprot.org/uniprotkb/Q15208/)")
st.markdown(f"Protein symbol: STK38")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15208') ]
