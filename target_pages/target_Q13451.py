...
st.set_page_config(page_title="FKBP5", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase FKBP5")
st.markdown(f"Uniprot ID: [Q13451](https://www.uniprot.org/uniprotkb/Q13451/)")
st.markdown(f"Protein symbol: FKBP5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13451') ]
