...
st.set_page_config(page_title="INSR", layout="wide")
st.title("Insulin receptor")
st.markdown(f"Uniprot ID: [P06213](https://www.uniprot.org/uniprotkb/P06213/)")
st.markdown(f"Protein symbol: INSR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P06213') ]
