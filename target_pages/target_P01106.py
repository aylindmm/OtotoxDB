...
st.set_page_config(page_title="MYC", layout="wide")
st.title("Myc proto-oncogene protein")
st.markdown(f"Uniprot ID: [P01106](https://www.uniprot.org/uniprotkb/P01106/)")
st.markdown(f"Protein symbol: MYC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P01106') ]
