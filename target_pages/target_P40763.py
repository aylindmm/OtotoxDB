...
st.set_page_config(page_title="STAT3", layout="wide")
st.title("Signal transducer and activator of transcription 3 [702-738,740-752]")
st.markdown(f"Uniprot ID: [P40763](https://www.uniprot.org/uniprotkb/P40763/)")
st.markdown(f"Protein symbol: STAT3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P40763') ]
