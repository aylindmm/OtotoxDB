...
st.set_page_config(page_title="CATS", layout="wide")
st.title("Cathepsin S")
st.markdown(f"Uniprot ID: [P25774](https://www.uniprot.org/uniprotkb/P25774/)")
st.markdown(f"Protein symbol: CATS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25774') ]
