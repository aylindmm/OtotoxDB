...
st.set_page_config(page_title="SC6A2", layout="wide")
st.title("Sodium-dependent noradrenaline transporter")
st.markdown(f"Uniprot ID: [P23975](https://www.uniprot.org/uniprotkb/P23975/)")
st.markdown(f"Protein symbol: SC6A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23975') ]
