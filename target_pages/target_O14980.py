...
st.set_page_config(page_title="XPO1", layout="wide")
st.title("Exportin-1")
st.markdown(f"Uniprot ID: [O14980](https://www.uniprot.org/uniprotkb/O14980/)")
st.markdown(f"Protein symbol: XPO1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14980') ]
