...
st.set_page_config(page_title="NEUR2", layout="wide")
st.title("Sialidase-2")
st.markdown(f"Uniprot ID: [Q9Y3R4](https://www.uniprot.org/uniprotkb/Q9Y3R4/)")
st.markdown(f"Protein symbol: NEUR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y3R4') ]
