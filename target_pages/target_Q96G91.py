...
st.set_page_config(page_title="P2Y11", layout="wide")
st.title("P2Y purinoceptor 11")
st.markdown(f"Uniprot ID: [Q96G91](https://www.uniprot.org/uniprotkb/Q96G91/)")
st.markdown(f"Protein symbol: P2Y11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96G91') ]
