...
st.set_page_config(page_title="KPCG", layout="wide")
st.title("Protein kinase C gamma type")
st.markdown(f"Uniprot ID: [P05129](https://www.uniprot.org/uniprotkb/P05129/)")
st.markdown(f"Protein symbol: KPCG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05129') ]
