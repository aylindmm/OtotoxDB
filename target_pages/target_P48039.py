...
st.set_page_config(page_title="MTR1A", layout="wide")
st.title("Melatonin receptor type 1A/1B")
st.markdown(f"Uniprot ID: [P48039](https://www.uniprot.org/uniprotkb/P48039/)")
st.markdown(f"Protein symbol: MTR1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48039') ]
