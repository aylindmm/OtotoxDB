...
st.set_page_config(page_title="DRD1", layout="wide")
st.title("D(1A) dopamine receptor")
st.markdown(f"Uniprot ID: [P21728](https://www.uniprot.org/uniprotkb/P21728/)")
st.markdown(f"Protein symbol: DRD1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21728') ]
