...
st.set_page_config(page_title="TKN1", layout="wide")
st.title("Protachykinin-1")
st.markdown(f"Uniprot ID: [P20366](https://www.uniprot.org/uniprotkb/P20366/)")
st.markdown(f"Protein symbol: TKN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20366') ]
