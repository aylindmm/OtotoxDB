...
st.set_page_config(page_title="BAD", layout="wide")
st.title("Bcl2-associated agonist of cell death")
st.markdown(f"Uniprot ID: [Q92934](https://www.uniprot.org/uniprotkb/Q92934/)")
st.markdown(f"Protein symbol: BAD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92934') ]
