...
st.set_page_config(page_title="PK3CB", layout="wide")
st.title("Phosphatidylinositol 4,5-bisphosphate 3-kinase catalytic subunit beta isoform")
st.markdown(f"Uniprot ID: [P42338](https://www.uniprot.org/uniprotkb/P42338/)")
st.markdown(f"Protein symbol: PK3CB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42338') ]
