...
st.set_page_config(page_title="P2RX3", layout="wide")
st.title("P2X purinoceptor 3")
st.markdown(f"Uniprot ID: [P56373](https://www.uniprot.org/uniprotkb/P56373/)")
st.markdown(f"Protein symbol: P2RX3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P56373') ]
