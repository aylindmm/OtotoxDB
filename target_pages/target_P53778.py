...
st.set_page_config(page_title="MK12", layout="wide")
st.title("Mitogen-activated protein kinase 12")
st.markdown(f"Uniprot ID: [P53778](https://www.uniprot.org/uniprotkb/P53778/)")
st.markdown(f"Protein symbol: MK12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53778') ]
