...
st.set_page_config(page_title="DHB2", layout="wide")
st.title("17-beta-hydroxysteroid dehydrogenase type 2")
st.markdown(f"Uniprot ID: [P37059](https://www.uniprot.org/uniprotkb/P37059/)")
st.markdown(f"Protein symbol: DHB2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P37059') ]
