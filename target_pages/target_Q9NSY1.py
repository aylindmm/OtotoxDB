...
st.set_page_config(page_title="BMP2K", layout="wide")
st.title("BMP-2-inducible protein kinase")
st.markdown(f"Uniprot ID: [Q9NSY1](https://www.uniprot.org/uniprotkb/Q9NSY1/)")
st.markdown(f"Protein symbol: BMP2K")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NSY1') ]
