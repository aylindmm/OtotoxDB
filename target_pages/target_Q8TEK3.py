...
st.set_page_config(page_title="DOT1L", layout="wide")
st.title("Histone-lysine N-methyltransferase, H3 lysine-79 specific")
st.markdown(f"Uniprot ID: [Q8TEK3](https://www.uniprot.org/uniprotkb/Q8TEK3/)")
st.markdown(f"Protein symbol: DOT1L")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TEK3') ]
