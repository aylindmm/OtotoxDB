...
st.set_page_config(page_title="EPHA8", layout="wide")
st.title("Ephrin type-A receptor 8")
st.markdown(f"Uniprot ID: [P29322](https://www.uniprot.org/uniprotkb/P29322/)")
st.markdown(f"Protein symbol: EPHA8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29322') ]
