...
st.set_page_config(page_title="NEK9", layout="wide")
st.title("Serine/threonine-protein kinase Nek9")
st.markdown(f"Uniprot ID: [Q8TD19](https://www.uniprot.org/uniprotkb/Q8TD19/)")
st.markdown(f"Protein symbol: NEK9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TD19') ]
