...
st.set_page_config(page_title="AKT3", layout="wide")
st.title("RAC-gamma serine/threonine-protein kinase")
st.markdown(f"Uniprot ID: [Q9Y243](https://www.uniprot.org/uniprotkb/Q9Y243/)")
st.markdown(f"Protein symbol: AKT3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y243') ]
