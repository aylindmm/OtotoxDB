...
st.set_page_config(page_title="IKKE", layout="wide")
st.title("Inhibitor of nuclear factor kappa-B kinase subunit epsilon")
st.markdown(f"Uniprot ID: [Q14164](https://www.uniprot.org/uniprotkb/Q14164/)")
st.markdown(f"Protein symbol: IKKE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14164') ]
