...
st.set_page_config(page_title="CTNB1", layout="wide")
st.title("Catenin beta-1")
st.markdown(f"Uniprot ID: [P35222](https://www.uniprot.org/uniprotkb/P35222/)")
st.markdown(f"Protein symbol: CTNB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35222') ]
