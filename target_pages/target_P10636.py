...
st.title("Microtubule-associated protein tau")
st.markdown(f"Uniprot ID: [P10636](https://www.uniprot.org/uniprotkb/P10636/)")
st.markdown(f"Protein symbol: TAU")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10636') ]
