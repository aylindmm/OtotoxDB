...
st.set_page_config(page_title="PLK2", layout="wide")
st.title("Serine/threonine-protein kinase PLK2")
st.markdown(f"Uniprot ID: [Q9NYY3](https://www.uniprot.org/uniprotkb/Q9NYY3/)")
st.markdown(f"Protein symbol: PLK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NYY3') ]
