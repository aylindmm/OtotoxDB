...
st.set_page_config(page_title="CP2E1", layout="wide")
st.title("Cytochrome P450 2E1")
st.markdown(f"Uniprot ID: [P05181](https://www.uniprot.org/uniprotkb/P05181/)")
st.markdown(f"Protein symbol: CP2E1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05181') ]
