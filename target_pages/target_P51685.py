...
st.set_page_config(page_title="CCR8", layout="wide")
st.title("C-C chemokine receptor type 8")
st.markdown(f"Uniprot ID: [P51685](https://www.uniprot.org/uniprotkb/P51685/)")
st.markdown(f"Protein symbol: CCR8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51685') ]
