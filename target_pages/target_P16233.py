...
st.set_page_config(page_title="LIPP", layout="wide")
st.title("Pancreatic triacylglycerol lipase")
st.markdown(f"Uniprot ID: [P16233](https://www.uniprot.org/uniprotkb/P16233/)")
st.markdown(f"Protein symbol: LIPP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16233') ]
