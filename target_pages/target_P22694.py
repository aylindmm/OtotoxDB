...
st.set_page_config(page_title="KAPCB", layout="wide")
st.title("cAMP-dependent protein kinase catalytic subunit beta")
st.markdown(f"Uniprot ID: [P22694](https://www.uniprot.org/uniprotkb/P22694/)")
st.markdown(f"Protein symbol: KAPCB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22694') ]
