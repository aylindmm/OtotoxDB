...
st.set_page_config(page_title="METH", layout="wide")
st.title("Methionine synthase")
st.markdown(f"Uniprot ID: [Q99707](https://www.uniprot.org/uniprotkb/Q99707/)")
st.markdown(f"Protein symbol: METH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99707') ]
