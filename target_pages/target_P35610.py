...
st.set_page_config(page_title="SOAT1", layout="wide")
st.title("Sterol O-acyltransferase 1")
st.markdown(f"Uniprot ID: [P35610](https://www.uniprot.org/uniprotkb/P35610/)")
st.markdown(f"Protein symbol: SOAT1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35610') ]
