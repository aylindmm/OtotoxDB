...
st.set_page_config(page_title="DHB3", layout="wide")
st.title("17-beta-hydroxysteroid dehydrogenase type 3")
st.markdown(f"Uniprot ID: [P37058](https://www.uniprot.org/uniprotkb/P37058/)")
st.markdown(f"Protein symbol: DHB3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P37058') ]
