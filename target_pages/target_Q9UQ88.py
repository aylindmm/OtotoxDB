...
st.set_page_config(page_title="CD11A", layout="wide")
st.title("Cyclin-dependent kinase 11A")
st.markdown(f"Uniprot ID: [Q9UQ88](https://www.uniprot.org/uniprotkb/Q9UQ88/)")
st.markdown(f"Protein symbol: CD11A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UQ88') ]
