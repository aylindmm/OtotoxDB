...
st.set_page_config(page_title="AURKA", layout="wide")
st.title("Aurora kinase A")
st.markdown(f"Uniprot ID: [O14965](https://www.uniprot.org/uniprotkb/O14965/)")
st.markdown(f"Protein symbol: AURKA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14965') ]
