...
st.set_page_config(page_title="CDK14", layout="wide")
st.title("Cyclin-dependent kinase 14")
st.markdown(f"Uniprot ID: [O94921](https://www.uniprot.org/uniprotkb/O94921/)")
st.markdown(f"Protein symbol: CDK14")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O94921') ]
