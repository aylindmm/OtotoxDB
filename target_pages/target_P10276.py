...
st.set_page_config(page_title="RARA", layout="wide")
st.title("Retinoic acid receptor alpha [200-419]")
st.markdown(f"Uniprot ID: [P10276](https://www.uniprot.org/uniprotkb/P10276/)")
st.markdown(f"Protein symbol: RARA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10276') ]
