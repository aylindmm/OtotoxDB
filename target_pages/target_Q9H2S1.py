...
st.set_page_config(page_title="KCNN2", layout="wide")
st.title("Small conductance calcium-activated potassium channel protein 2")
st.markdown(f"Uniprot ID: [Q9H2S1](https://www.uniprot.org/uniprotkb/Q9H2S1/)")
st.markdown(f"Protein symbol: KCNN2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H2S1') ]
