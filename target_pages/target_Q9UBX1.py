...
st.set_page_config(page_title="CATF", layout="wide")
st.title("Cathepsin F")
st.markdown(f"Uniprot ID: [Q9UBX1](https://www.uniprot.org/uniprotkb/Q9UBX1/)")
st.markdown(f"Protein symbol: CATF")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UBX1') ]
