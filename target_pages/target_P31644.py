...
st.set_page_config(page_title="GBRA5", layout="wide")
st.title("Gamma-aminobutyric acid receptor subunit alpha-5/beta-2/gamma-2")
st.markdown(f"Uniprot ID: [P31644](https://www.uniprot.org/uniprotkb/P31644/)")
st.markdown(f"Protein symbol: GBRA5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P31644') ]
