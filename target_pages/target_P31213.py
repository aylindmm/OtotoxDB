...
st.set_page_config(page_title="S5A2", layout="wide")
st.title("3-oxo-5-alpha-steroid 4-dehydrogenase 2")
st.markdown(f"Uniprot ID: [P31213](https://www.uniprot.org/uniprotkb/P31213/)")
st.markdown(f"Protein symbol: S5A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P31213') ]
