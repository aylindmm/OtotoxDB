...
st.set_page_config(page_title="UCHL1", layout="wide")
st.title("Ubiquitin carboxyl-terminal hydrolase isozyme L1")
st.markdown(f"Uniprot ID: [P09936](https://www.uniprot.org/uniprotkb/P09936/)")
st.markdown(f"Protein symbol: UCHL1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09936') ]
