...
st.set_page_config(page_title="FLT3", layout="wide")
st.title("Receptor-type tyrosine-protein kinase FLT3 [N841I]")
st.markdown(f"Uniprot ID: [P36888](https://www.uniprot.org/uniprotkb/P36888/)")
st.markdown(f"Protein symbol: FLT3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P36888') ]
