...
st.set_page_config(page_title="CCL2", layout="wide")
st.title("C-C motif chemokine 2")
st.markdown(f"Uniprot ID: [P13500](https://www.uniprot.org/uniprotkb/P13500/)")
st.markdown(f"Protein symbol: CCL2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P13500') ]
