...
st.set_page_config(page_title="TLR7", layout="wide")
st.title("Toll-like receptor 7")
st.markdown(f"Uniprot ID: [Q9NYK1](https://www.uniprot.org/uniprotkb/Q9NYK1/)")
st.markdown(f"Protein symbol: TLR7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NYK1') ]
