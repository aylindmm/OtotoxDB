...
st.set_page_config(page_title="TPA", layout="wide")
st.title("Tissue-type plasminogen activator")
st.markdown(f"Uniprot ID: [P00750](https://www.uniprot.org/uniprotkb/P00750/)")
st.markdown(f"Protein symbol: TPA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00750') ]
