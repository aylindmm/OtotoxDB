...
st.set_page_config(page_title="PDE4D", layout="wide")
st.title("cAMP-specific 3',5'-cyclic phosphodiesterase 4D [372-376,381-715,S375G,I381V,S383G,G384S,V385H,K386M)")
st.markdown(f"Uniprot ID: [Q08499](https://www.uniprot.org/uniprotkb/Q08499/)")
st.markdown(f"Protein symbol: PDE4D")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q08499') ]
