...
st.set_page_config(page_title="MRCKB", layout="wide")
st.title("Serine/threonine-protein kinase MRCK beta")
st.markdown(f"Uniprot ID: [Q9Y5S2](https://www.uniprot.org/uniprotkb/Q9Y5S2/)")
st.markdown(f"Protein symbol: MRCKB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y5S2') ]
