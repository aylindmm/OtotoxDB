...
st.set_page_config(page_title="FPPS", layout="wide")
st.title("Farnesyl pyrophosphate synthase")
st.markdown(f"Uniprot ID: [P14324](https://www.uniprot.org/uniprotkb/P14324/)")
st.markdown(f"Protein symbol: FPPS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14324') ]
