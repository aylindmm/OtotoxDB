...
st.set_page_config(page_title="CSK23", layout="wide")
st.title("Casein kinase II subunit alpha 3")
st.markdown(f"Uniprot ID: [Q8NEV1](https://www.uniprot.org/uniprotkb/Q8NEV1/)")
st.markdown(f"Protein symbol: CSK23")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NEV1') ]
