...
st.set_page_config(page_title="CP2CJ", layout="wide")
st.title("Cytochrome P450 2C19")
st.markdown(f"Uniprot ID: [P33261](https://www.uniprot.org/uniprotkb/P33261/)")
st.markdown(f"Protein symbol: CP2CJ")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P33261') ]
