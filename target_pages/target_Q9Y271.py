...
st.set_page_config(page_title="CLTR1", layout="wide")
st.title("Cysteinyl leukotriene receptor 1")
st.markdown(f"Uniprot ID: [Q9Y271](https://www.uniprot.org/uniprotkb/Q9Y271/)")
st.markdown(f"Protein symbol: CLTR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y271') ]
