...
st.set_page_config(page_title="VRK2", layout="wide")
st.title("Serine/threonine-protein kinase VRK2")
st.markdown(f"Uniprot ID: [Q86Y07](https://www.uniprot.org/uniprotkb/Q86Y07/)")
st.markdown(f"Protein symbol: VRK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86Y07') ]
