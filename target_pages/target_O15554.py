...
st.set_page_config(page_title="KCNN4", layout="wide")
st.title("Intermediate conductance calcium-activated potassium channel protein 4")
st.markdown(f"Uniprot ID: [O15554](https://www.uniprot.org/uniprotkb/O15554/)")
st.markdown(f"Protein symbol: KCNN4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15554') ]
