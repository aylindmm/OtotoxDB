...
st.set_page_config(page_title="ROCK2", layout="wide")
st.title("Rho-associated protein kinase 2")
st.markdown(f"Uniprot ID: [O75116](https://www.uniprot.org/uniprotkb/O75116/)")
st.markdown(f"Protein symbol: ROCK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75116') ]
