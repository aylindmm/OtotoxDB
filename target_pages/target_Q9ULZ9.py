...
st.set_page_config(page_title="MMP17", layout="wide")
st.title("Matrix metalloproteinase-17")
st.markdown(f"Uniprot ID: [Q9ULZ9](https://www.uniprot.org/uniprotkb/Q9ULZ9/)")
st.markdown(f"Protein symbol: MMP17")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9ULZ9') ]
