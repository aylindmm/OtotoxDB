...
st.set_page_config(page_title="ERR2", layout="wide")
st.title("Isoform 1 of Steroid hormone receptor ERR2 (ERRbeta2-delta10)")
st.markdown(f"Uniprot ID: [O95718](https://www.uniprot.org/uniprotkb/O95718/)")
st.markdown(f"Protein symbol: ERR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95718') ]
