...
st.set_page_config(page_title="ANKK1", layout="wide")
st.title("Ankyrin repeat and protein kinase domain-containing protein 1")
st.markdown(f"Uniprot ID: [Q8NFD2](https://www.uniprot.org/uniprotkb/Q8NFD2/)")
st.markdown(f"Protein symbol: ANKK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NFD2') ]
