...
st.set_page_config(page_title="KSYK", layout="wide")
st.title("Tyrosine-protein kinase SYK")
st.markdown(f"Uniprot ID: [P43405](https://www.uniprot.org/uniprotkb/P43405/)")
st.markdown(f"Protein symbol: KSYK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43405') ]
