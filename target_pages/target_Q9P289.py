...
st.set_page_config(page_title="STK26", layout="wide")
st.title("Serine/threonine-protein kinase 26")
st.markdown(f"Uniprot ID: [Q9P289](https://www.uniprot.org/uniprotkb/Q9P289/)")
st.markdown(f"Protein symbol: STK26")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9P289') ]
