...
st.set_page_config(page_title="PSB5", layout="wide")
st.title("Proteasome subunit beta type-5")
st.markdown(f"Uniprot ID: [P28074](https://www.uniprot.org/uniprotkb/P28074/)")
st.markdown(f"Protein symbol: PSB5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28074') ]
