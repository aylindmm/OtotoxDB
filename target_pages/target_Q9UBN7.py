...
st.set_page_config(page_title="HDAC6", layout="wide")
st.title("Histone deacetylase 6")
st.markdown(f"Uniprot ID: [Q9UBN7](https://www.uniprot.org/uniprotkb/Q9UBN7/)")
st.markdown(f"Protein symbol: HDAC6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UBN7') ]
