...
st.set_page_config(page_title="RAD51", layout="wide")
st.title("DNA repair protein RAD51 homolog 1")
st.markdown(f"Uniprot ID: [Q06609](https://www.uniprot.org/uniprotkb/Q06609/)")
st.markdown(f"Protein symbol: RAD51")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q06609') ]
