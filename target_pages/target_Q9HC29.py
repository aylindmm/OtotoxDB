...
st.set_page_config(page_title="NOD2", layout="wide")
st.title("Nucleotide-binding oligomerization domain-containing protein 2")
st.markdown(f"Uniprot ID: [Q9HC29](https://www.uniprot.org/uniprotkb/Q9HC29/)")
st.markdown(f"Protein symbol: NOD2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HC29') ]
