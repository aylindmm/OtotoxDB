...
st.set_page_config(page_title="M3K12", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 12")
st.markdown(f"Uniprot ID: [Q12852](https://www.uniprot.org/uniprotkb/Q12852/)")
st.markdown(f"Protein symbol: M3K12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q12852') ]
