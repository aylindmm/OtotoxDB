...
st.set_page_config(page_title="CP26A", layout="wide")
st.title("Cytochrome P450 26A1")
st.markdown(f"Uniprot ID: [O43174](https://www.uniprot.org/uniprotkb/O43174/)")
st.markdown(f"Protein symbol: CP26A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43174') ]
