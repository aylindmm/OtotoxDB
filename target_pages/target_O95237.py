...
st.set_page_config(page_title="LRAT", layout="wide")
st.title("Lecithin retinol acyltransferase")
st.markdown(f"Uniprot ID: [O95237](https://www.uniprot.org/uniprotkb/O95237/)")
st.markdown(f"Protein symbol: LRAT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95237') ]
