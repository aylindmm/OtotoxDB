...
st.set_page_config(page_title="CP2AD", layout="wide")
st.title("Cytochrome P450 2A13")
st.markdown(f"Uniprot ID: [Q16696](https://www.uniprot.org/uniprotkb/Q16696/)")
st.markdown(f"Protein symbol: CP2AD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16696') ]
