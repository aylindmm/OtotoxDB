...
st.set_page_config(page_title="SYYC", layout="wide")
st.title("Tyrosine--tRNA ligase, cytoplasmic")
st.markdown(f"Uniprot ID: [P54577](https://www.uniprot.org/uniprotkb/P54577/)")
st.markdown(f"Protein symbol: SYYC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P54577') ]
