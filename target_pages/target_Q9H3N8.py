...
st.set_page_config(page_title="HRH4", layout="wide")
st.title("Histamine H4 receptor")
st.markdown(f"Uniprot ID: [Q9H3N8](https://www.uniprot.org/uniprotkb/Q9H3N8/)")
st.markdown(f"Protein symbol: HRH4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H3N8') ]
