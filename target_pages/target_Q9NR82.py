...
st.set_page_config(page_title="KCNQ5", layout="wide")
st.title("Potassium voltage-gated channel subfamily KQT member 5")
st.markdown(f"Uniprot ID: [Q9NR82](https://www.uniprot.org/uniprotkb/Q9NR82/)")
st.markdown(f"Protein symbol: KCNQ5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NR82') ]
