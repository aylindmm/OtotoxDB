...
st.set_page_config(page_title="ST38L", layout="wide")
st.title("Serine/threonine-protein kinase 38-like")
st.markdown(f"Uniprot ID: [Q9Y2H1](https://www.uniprot.org/uniprotkb/Q9Y2H1/)")
st.markdown(f"Protein symbol: ST38L")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2H1') ]
