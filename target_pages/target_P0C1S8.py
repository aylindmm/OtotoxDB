...
st.set_page_config(page_title="WEE2", layout="wide")
st.title("Wee1-like protein kinase 2")
st.markdown(f"Uniprot ID: [P0C1S8](https://www.uniprot.org/uniprotkb/P0C1S8/)")
st.markdown(f"Protein symbol: WEE2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P0C1S8') ]
