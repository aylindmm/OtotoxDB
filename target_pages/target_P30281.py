...
st.set_page_config(page_title="CCND3", layout="wide")
st.title("G1/S-specific cyclin-D3")
st.markdown(f"Uniprot ID: [P30281](https://www.uniprot.org/uniprotkb/P30281/)")
st.markdown(f"Protein symbol: CCND3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30281') ]
