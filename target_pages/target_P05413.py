...
st.set_page_config(page_title="FABPH", layout="wide")
st.title("Fatty acid-binding protein, heart")
st.markdown(f"Uniprot ID: [P05413](https://www.uniprot.org/uniprotkb/P05413/)")
st.markdown(f"Protein symbol: FABPH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05413') ]
