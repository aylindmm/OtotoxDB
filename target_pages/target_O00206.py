...
st.set_page_config(page_title="TLR4", layout="wide")
st.title("Toll-like receptor 4")
st.markdown(f"Uniprot ID: [O00206](https://www.uniprot.org/uniprotkb/O00206/)")
st.markdown(f"Protein symbol: TLR4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00206') ]
