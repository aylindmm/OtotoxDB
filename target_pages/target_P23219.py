...
st.set_page_config(page_title="PGH1", layout="wide")
st.title("Prostaglandin G/H synthase 1 [582-599]")
st.markdown(f"Uniprot ID: [P23219](https://www.uniprot.org/uniprotkb/P23219/)")
st.markdown(f"Protein symbol: PGH1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23219') ]
