...
st.set_page_config(page_title="FA11", layout="wide")
st.title("Coagulation factor XI")
st.markdown(f"Uniprot ID: [P03951](https://www.uniprot.org/uniprotkb/P03951/)")
st.markdown(f"Protein symbol: FA11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P03951') ]
