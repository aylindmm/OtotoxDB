...
st.set_page_config(page_title="TLK1", layout="wide")
st.title("Serine/threonine-protein kinase tousled-like 1")
st.markdown(f"Uniprot ID: [Q9UKI8](https://www.uniprot.org/uniprotkb/Q9UKI8/)")
st.markdown(f"Protein symbol: TLK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UKI8') ]
