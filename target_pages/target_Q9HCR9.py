...
st.set_page_config(page_title="PDE11", layout="wide")
st.title("Isoform 4 of Dual 3',5'-cyclic-AMP and -GMP phosphodiesterase 11A (PDE11A1) 35-489]")
st.markdown(f"Uniprot ID: [Q9HCR9](https://www.uniprot.org/uniprotkb/Q9HCR9/)")
st.markdown(f"Protein symbol: PDE11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HCR9') ]
