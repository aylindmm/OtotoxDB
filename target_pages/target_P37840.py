...
st.set_page_config(page_title="SYUA", layout="wide")
st.title("Alpha-synuclein")
st.markdown(f"Uniprot ID: [P37840](https://www.uniprot.org/uniprotkb/P37840/)")
st.markdown(f"Protein symbol: SYUA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P37840') ]
