...
st.set_page_config(page_title="CPT2", layout="wide")
st.title("Carnitine O-palmitoyltransferase 2, mitochondrial")
st.markdown(f"Uniprot ID: [P23786](https://www.uniprot.org/uniprotkb/P23786/)")
st.markdown(f"Protein symbol: CPT2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23786') ]
