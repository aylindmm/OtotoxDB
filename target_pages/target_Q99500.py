...
st.set_page_config(page_title="S1PR3", layout="wide")
st.title("Sphingosine 1-phosphate receptor 3")
st.markdown(f"Uniprot ID: [Q99500](https://www.uniprot.org/uniprotkb/Q99500/)")
st.markdown(f"Protein symbol: S1PR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99500') ]
