...
st.set_page_config(page_title="EPHA4", layout="wide")
st.title("Ephrin type-A receptor 4")
st.markdown(f"Uniprot ID: [P54764](https://www.uniprot.org/uniprotkb/P54764/)")
st.markdown(f"Protein symbol: EPHA4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P54764') ]
