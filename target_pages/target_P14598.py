...
st.set_page_config(page_title="NCF1", layout="wide")
st.title("Neutrophil cytosol factor 1 [S99G]")
st.markdown(f"Uniprot ID: [P14598](https://www.uniprot.org/uniprotkb/P14598/)")
st.markdown(f"Protein symbol: NCF1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14598') ]
