...
st.set_page_config(page_title="LPAR2", layout="wide")
st.title("Lysophosphatidic acid receptor 2")
st.markdown(f"Uniprot ID: [Q9HBW0](https://www.uniprot.org/uniprotkb/Q9HBW0/)")
st.markdown(f"Protein symbol: LPAR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HBW0') ]
