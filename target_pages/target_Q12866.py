...
st.set_page_config(page_title="MERTK", layout="wide")
st.title("Tyrosine-protein kinase Mer")
st.markdown(f"Uniprot ID: [Q12866](https://www.uniprot.org/uniprotkb/Q12866/)")
st.markdown(f"Protein symbol: MERTK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q12866') ]
