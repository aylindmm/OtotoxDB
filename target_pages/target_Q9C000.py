...
st.set_page_config(page_title="NLRP1", layout="wide")
st.title("NACHT, LRR and PYD domains-containing protein 1")
st.markdown(f"Uniprot ID: [Q9C000](https://www.uniprot.org/uniprotkb/Q9C000/)")
st.markdown(f"Protein symbol: NLRP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9C000') ]
