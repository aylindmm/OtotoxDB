...
st.set_page_config(page_title="GUAD", layout="wide")
st.title("Guanine deaminase")
st.markdown(f"Uniprot ID: [Q9Y2T3](https://www.uniprot.org/uniprotkb/Q9Y2T3/)")
st.markdown(f"Protein symbol: GUAD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2T3') ]
