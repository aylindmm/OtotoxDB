...
st.set_page_config(page_title="AAKB1", layout="wide")
st.title("5'-AMP-activated protein kinase subunit beta-1")
st.markdown(f"Uniprot ID: [Q9Y478](https://www.uniprot.org/uniprotkb/Q9Y478/)")
st.markdown(f"Protein symbol: AAKB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y478') ]
