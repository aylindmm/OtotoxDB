...
st.set_page_config(page_title="MK15", layout="wide")
st.title("Mitogen-activated protein kinase 15")
st.markdown(f"Uniprot ID: [Q8TD08](https://www.uniprot.org/uniprotkb/Q8TD08/)")
st.markdown(f"Protein symbol: MK15")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TD08') ]
