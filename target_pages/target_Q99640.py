...
st.set_page_config(page_title="PMYT1", layout="wide")
st.title("Membrane-associated tyrosine- and threonine-specific cdc2-inhibitory kinase")
st.markdown(f"Uniprot ID: [Q99640](https://www.uniprot.org/uniprotkb/Q99640/)")
st.markdown(f"Protein symbol: PMYT1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99640') ]
