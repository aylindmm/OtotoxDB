...
st.set_page_config(page_title="NMDE4", layout="wide")
st.title("Glutamate receptor ionotropic, NMDA 2D")
st.markdown(f"Uniprot ID: [O15399](https://www.uniprot.org/uniprotkb/O15399/)")
st.markdown(f"Protein symbol: NMDE4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15399') ]
