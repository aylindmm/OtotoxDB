...
st.set_page_config(page_title="KCND3", layout="wide")
st.title("Potassium voltage-gated channel subfamily D member 3")
st.markdown(f"Uniprot ID: [Q9UK17](https://www.uniprot.org/uniprotkb/Q9UK17/)")
st.markdown(f"Protein symbol: KCND3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UK17') ]
