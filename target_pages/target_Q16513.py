...
st.set_page_config(page_title="PKN2", layout="wide")
st.title("Serine/threonine-protein kinase N2")
st.markdown(f"Uniprot ID: [Q16513](https://www.uniprot.org/uniprotkb/Q16513/)")
st.markdown(f"Protein symbol: PKN2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16513') ]
