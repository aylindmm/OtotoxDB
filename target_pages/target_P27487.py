...
st.set_page_config(page_title="DPP4", layout="wide")
st.title("Dipeptidyl peptidase 4")
st.markdown(f"Uniprot ID: [P27487](https://www.uniprot.org/uniprotkb/P27487/)")
st.markdown(f"Protein symbol: DPP4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27487') ]
