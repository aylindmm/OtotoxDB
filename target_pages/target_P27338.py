...
st.set_page_config(page_title="AOFB", layout="wide")
st.title("Amine oxidase [flavin-containing] B [I199F]")
st.markdown(f"Uniprot ID: [P27338](https://www.uniprot.org/uniprotkb/P27338/)")
st.markdown(f"Protein symbol: AOFB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27338') ]
