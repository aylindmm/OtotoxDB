...
st.set_page_config(page_title="CASP1", layout="wide")
st.title("Caspase-1")
st.markdown(f"Uniprot ID: [P29466](https://www.uniprot.org/uniprotkb/P29466/)")
st.markdown(f"Protein symbol: CASP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29466') ]
