...
st.set_page_config(page_title="CHIT1", layout="wide")
st.title("Chitotriosidase-1")
st.markdown(f"Uniprot ID: [Q13231](https://www.uniprot.org/uniprotkb/Q13231/)")
st.markdown(f"Protein symbol: CHIT1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13231') ]
