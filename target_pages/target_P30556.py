...
st.set_page_config(page_title="AGTR1", layout="wide")
st.title("Type-1/Type-2 angiotensin II receptor")
st.markdown(f"Uniprot ID: [P30556](https://www.uniprot.org/uniprotkb/P30556/)")
st.markdown(f"Protein symbol: AGTR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30556') ]
