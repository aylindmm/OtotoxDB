...
st.set_page_config(page_title="TMPS2", layout="wide")
st.title("Transmembrane protease serine 2")
st.markdown(f"Uniprot ID: [O15393](https://www.uniprot.org/uniprotkb/O15393/)")
st.markdown(f"Protein symbol: TMPS2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15393') ]
