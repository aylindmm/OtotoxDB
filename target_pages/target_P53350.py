...
st.set_page_config(page_title="PLK1", layout="wide")
st.title("Serine/threonine-protein kinase PLK1")
st.markdown(f"Uniprot ID: [P53350](https://www.uniprot.org/uniprotkb/P53350/)")
st.markdown(f"Protein symbol: PLK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53350') ]
