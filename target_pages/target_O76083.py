...
st.set_page_config(page_title="PDE9A", layout="wide")
st.title("High affinity cGMP-specific 3',5'-cyclic phosphodiesterase 9A [226-593]")
st.markdown(f"Uniprot ID: [O76083](https://www.uniprot.org/uniprotkb/O76083/)")
st.markdown(f"Protein symbol: PDE9A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O76083') ]
