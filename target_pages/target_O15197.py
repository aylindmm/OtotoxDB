...
st.set_page_config(page_title="EPHB6", layout="wide")
st.title("Ephrin type-B receptor 6")
st.markdown(f"Uniprot ID: [O15197](https://www.uniprot.org/uniprotkb/O15197/)")
st.markdown(f"Protein symbol: EPHB6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15197') ]
