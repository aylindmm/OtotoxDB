...
st.set_page_config(page_title="ENASE", layout="wide")
st.title("Cytosolic endo-beta-N-acetylglucosaminidase")
st.markdown(f"Uniprot ID: [Q8NFI3](https://www.uniprot.org/uniprotkb/Q8NFI3/)")
st.markdown(f"Protein symbol: ENASE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NFI3') ]
