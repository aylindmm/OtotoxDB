...
st.set_page_config(page_title="PIM3", layout="wide")
st.title("Serine/threonine-protein kinase pim-3")
st.markdown(f"Uniprot ID: [Q86V86](https://www.uniprot.org/uniprotkb/Q86V86/)")
st.markdown(f"Protein symbol: PIM3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86V86') ]
