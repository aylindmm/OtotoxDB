...
st.set_page_config(page_title="STS", layout="wide")
st.title("Steryl-sulfatase")
st.markdown(f"Uniprot ID: [P08842](https://www.uniprot.org/uniprotkb/P08842/)")
st.markdown(f"Protein symbol: STS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08842') ]
