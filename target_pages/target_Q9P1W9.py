...
st.set_page_config(page_title="PIM2", layout="wide")
st.title("Serine/threonine-protein kinase pim-2")
st.markdown(f"Uniprot ID: [Q9P1W9](https://www.uniprot.org/uniprotkb/Q9P1W9/)")
st.markdown(f"Protein symbol: PIM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9P1W9') ]
