...
st.set_page_config(page_title="PSB2", layout="wide")
st.title("Proteasome subunit beta type-2")
st.markdown(f"Uniprot ID: [P49721](https://www.uniprot.org/uniprotkb/P49721/)")
st.markdown(f"Protein symbol: PSB2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49721') ]
