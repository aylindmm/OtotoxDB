...
st.set_page_config(page_title="COT2", layout="wide")
st.title("COUP transcription factor 2")
st.markdown(f"Uniprot ID: [P24468](https://www.uniprot.org/uniprotkb/P24468/)")
st.markdown(f"Protein symbol: COT2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24468') ]
