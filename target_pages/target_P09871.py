...
st.set_page_config(page_title="C1S", layout="wide")
st.title("Complement C1s subcomponent")
st.markdown(f"Uniprot ID: [P09871](https://www.uniprot.org/uniprotkb/P09871/)")
st.markdown(f"Protein symbol: C1S")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09871') ]
