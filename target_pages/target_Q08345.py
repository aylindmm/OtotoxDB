...
st.set_page_config(page_title="DDR1", layout="wide")
st.title("Epithelial discoidin domain-containing receptor 1")
st.markdown(f"Uniprot ID: [Q08345](https://www.uniprot.org/uniprotkb/Q08345/)")
st.markdown(f"Protein symbol: DDR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q08345') ]
