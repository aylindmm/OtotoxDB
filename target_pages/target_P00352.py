...
st.set_page_config(page_title="AL1A1", layout="wide")
st.title("Aldehyde dehydrogenase 1A1")
st.markdown(f"Uniprot ID: [P00352](https://www.uniprot.org/uniprotkb/P00352/)")
st.markdown(f"Protein symbol: AL1A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00352') ]
