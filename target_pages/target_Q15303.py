...
st.set_page_config(page_title="ERBB4", layout="wide")
st.title("Receptor tyrosine-protein kinase erbB-4")
st.markdown(f"Uniprot ID: [Q15303](https://www.uniprot.org/uniprotkb/Q15303/)")
st.markdown(f"Protein symbol: ERBB4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15303') ]
