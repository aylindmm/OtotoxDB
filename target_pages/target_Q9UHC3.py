...
st.set_page_config(page_title="ASIC3", layout="wide")
st.title("Acid-sensing ion channel 3")
st.markdown(f"Uniprot ID: [Q9UHC3](https://www.uniprot.org/uniprotkb/Q9UHC3/)")
st.markdown(f"Protein symbol: ASIC3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UHC3') ]
