...
st.set_page_config(page_title="UCHL3", layout="wide")
st.title("Ubiquitin carboxyl-terminal hydrolase isozyme L3")
st.markdown(f"Uniprot ID: [P15374](https://www.uniprot.org/uniprotkb/P15374/)")
st.markdown(f"Protein symbol: UCHL3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15374') ]
