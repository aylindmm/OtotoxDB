...
st.set_page_config(page_title="JAK1", layout="wide")
st.title("Tyrosine-protein kinase JAK1/JAK2")
st.markdown(f"Uniprot ID: [P23458](https://www.uniprot.org/uniprotkb/P23458/)")
st.markdown(f"Protein symbol: JAK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23458') ]
