...
st.set_page_config(page_title="SMAD3", layout="wide")
st.title("Mothers against decapentaplegic homolog 3")
st.markdown(f"Uniprot ID: [P84022](https://www.uniprot.org/uniprotkb/P84022/)")
st.markdown(f"Protein symbol: SMAD3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P84022') ]
