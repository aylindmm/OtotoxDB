...
st.set_page_config(page_title="CP1A2", layout="wide")
st.title("Cytochrome P450 1A2")
st.markdown(f"Uniprot ID: [P05177](https://www.uniprot.org/uniprotkb/P05177/)")
st.markdown(f"Protein symbol: CP1A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05177') ]
