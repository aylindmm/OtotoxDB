...
st.set_page_config(page_title="TRPM2", layout="wide")
st.title("Transient receptor potential cation channel subfamily M member 2")
st.markdown(f"Uniprot ID: [O94759](https://www.uniprot.org/uniprotkb/O94759/)")
st.markdown(f"Protein symbol: TRPM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O94759') ]
