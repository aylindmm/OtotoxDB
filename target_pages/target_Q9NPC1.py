...
st.set_page_config(page_title="LT4R2", layout="wide")
st.title("Leukotriene B4 receptor 2")
st.markdown(f"Uniprot ID: [Q9NPC1](https://www.uniprot.org/uniprotkb/Q9NPC1/)")
st.markdown(f"Protein symbol: LT4R2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NPC1') ]
