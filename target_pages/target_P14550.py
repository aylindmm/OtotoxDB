...
st.set_page_config(page_title="AK1A1", layout="wide")
st.title("Aldo-keto reductase family 1 member A1")
st.markdown(f"Uniprot ID: [P14550](https://www.uniprot.org/uniprotkb/P14550/)")
st.markdown(f"Protein symbol: AK1A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14550') ]
