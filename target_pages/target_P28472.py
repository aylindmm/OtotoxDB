...
st.set_page_config(page_title="GBRB3", layout="wide")
st.title("Gamma-aminobutyric acid receptor subunit beta-3")
st.markdown(f"Uniprot ID: [P28472](https://www.uniprot.org/uniprotkb/P28472/)")
st.markdown(f"Protein symbol: GBRB3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28472') ]
