...
st.set_page_config(page_title="IMDH2", layout="wide")
st.title("Inosine-5'-monophosphate dehydrogenase 2")
st.markdown(f"Uniprot ID: [P12268](https://www.uniprot.org/uniprotkb/P12268/)")
st.markdown(f"Protein symbol: IMDH2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P12268') ]
