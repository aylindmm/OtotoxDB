...
st.set_page_config(page_title="MKNK2", layout="wide")
st.title("MAP kinase-interacting serine/threonine-protein kinase 2")
st.markdown(f"Uniprot ID: [Q9HBH9](https://www.uniprot.org/uniprotkb/Q9HBH9/)")
st.markdown(f"Protein symbol: MKNK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HBH9') ]
