...
st.set_page_config(page_title="AK1C2", layout="wide")
st.title("Aldo-keto reductase family 1 member C2")
st.markdown(f"Uniprot ID: [P52895](https://www.uniprot.org/uniprotkb/P52895/)")
st.markdown(f"Protein symbol: AK1C2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P52895') ]
