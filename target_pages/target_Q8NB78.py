...
st.set_page_config(page_title="KDM1B", layout="wide")
st.title("Lysine-specific histone demethylase 2")
st.markdown(f"Uniprot ID: [Q8NB78](https://www.uniprot.org/uniprotkb/Q8NB78/)")
st.markdown(f"Protein symbol: KDM1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NB78') ]
