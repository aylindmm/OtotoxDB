...
st.set_page_config(page_title="XCT", layout="wide")
st.title("Cystine/glutamate transporter")
st.markdown(f"Uniprot ID: [Q9UPY5](https://www.uniprot.org/uniprotkb/Q9UPY5/)")
st.markdown(f"Protein symbol: XCT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UPY5') ]
