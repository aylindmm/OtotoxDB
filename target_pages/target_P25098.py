...
st.set_page_config(page_title="ARBK1", layout="wide")
st.title("Beta-adrenergic receptor kinase 1")
st.markdown(f"Uniprot ID: [P25098](https://www.uniprot.org/uniprotkb/P25098/)")
st.markdown(f"Protein symbol: ARBK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25098') ]
