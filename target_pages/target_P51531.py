...
st.set_page_config(page_title="SMCA2", layout="wide")
st.title("Probable global transcription activator SNF2L2")
st.markdown(f"Uniprot ID: [P51531](https://www.uniprot.org/uniprotkb/P51531/)")
st.markdown(f"Protein symbol: SMCA2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51531') ]
