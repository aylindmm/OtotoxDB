...
st.set_page_config(page_title="GBRA6", layout="wide")
st.title("Gamma-aminobutyric acid receptor subunit alpha-6/beta-3/gamma-2")
st.markdown(f"Uniprot ID: [Q16445](https://www.uniprot.org/uniprotkb/Q16445/)")
st.markdown(f"Protein symbol: GBRA6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16445') ]
