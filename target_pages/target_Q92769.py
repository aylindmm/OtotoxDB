...
st.set_page_config(page_title="HDAC2", layout="wide")
st.title("Histone deacetylase 2")
st.markdown(f"Uniprot ID: [Q92769](https://www.uniprot.org/uniprotkb/Q92769/)")
st.markdown(f"Protein symbol: HDAC2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92769') ]
