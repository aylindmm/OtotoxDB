...
st.set_page_config(page_title="FGFR4", layout="wide")
st.title("Fibroblast growth factor receptor 4")
st.markdown(f"Uniprot ID: [P22455](https://www.uniprot.org/uniprotkb/P22455/)")
st.markdown(f"Protein symbol: FGFR4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22455') ]
