...
st.set_page_config(page_title="PPBN", layout="wide")
st.title("Alkaline phosphatase, germ cell type")
st.markdown(f"Uniprot ID: [P10696](https://www.uniprot.org/uniprotkb/P10696/)")
st.markdown(f"Protein symbol: PPBN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10696') ]
