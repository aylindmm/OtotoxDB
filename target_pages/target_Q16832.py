...
st.set_page_config(page_title="DDR2", layout="wide")
st.title("Discoidin domain-containing receptor 2 [A642S]")
st.markdown(f"Uniprot ID: [Q16832](https://www.uniprot.org/uniprotkb/Q16832/)")
st.markdown(f"Protein symbol: DDR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16832') ]
