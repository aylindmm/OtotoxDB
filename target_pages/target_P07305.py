...
st.set_page_config(page_title="H10", layout="wide")
st.title("Histone H1.0")
st.markdown(f"Uniprot ID: [P07305](https://www.uniprot.org/uniprotkb/P07305/)")
st.markdown(f"Protein symbol: H10")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07305') ]
