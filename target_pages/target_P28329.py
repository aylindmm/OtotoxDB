...
st.set_page_config(page_title="CLAT", layout="wide")
st.title("Choline O-acetyltransferase")
st.markdown(f"Uniprot ID: [P28329](https://www.uniprot.org/uniprotkb/P28329/)")
st.markdown(f"Protein symbol: CLAT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28329') ]
