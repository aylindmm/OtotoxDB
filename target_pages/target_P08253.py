...
st.set_page_config(page_title="MMP2", layout="wide")
st.title("72 kDa type IV collagenase")
st.markdown(f"Uniprot ID: [P08253](https://www.uniprot.org/uniprotkb/P08253/)")
st.markdown(f"Protein symbol: MMP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08253') ]
