...
st.set_page_config(page_title="SSDH", layout="wide")
st.title("Succinate-semialdehyde dehydrogenase, mitochondrial")
st.markdown(f"Uniprot ID: [P51649](https://www.uniprot.org/uniprotkb/P51649/)")
st.markdown(f"Protein symbol: SSDH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51649') ]
