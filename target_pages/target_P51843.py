...
st.set_page_config(page_title="NR0B1", layout="wide")
st.title("Nuclear receptor subfamily 0 group B member 1")
st.markdown(f"Uniprot ID: [P51843](https://www.uniprot.org/uniprotkb/P51843/)")
st.markdown(f"Protein symbol: NR0B1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51843') ]
