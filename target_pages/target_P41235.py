...
st.set_page_config(page_title="HNF4A", layout="wide")
st.title("Hepatocyte nuclear factor 4-alpha")
st.markdown(f"Uniprot ID: [P41235](https://www.uniprot.org/uniprotkb/P41235/)")
st.markdown(f"Protein symbol: HNF4A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41235') ]
