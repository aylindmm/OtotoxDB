...
st.set_page_config(page_title="SENP1", layout="wide")
st.title("Sentrin-specific protease 1")
st.markdown(f"Uniprot ID: [Q9P0U3](https://www.uniprot.org/uniprotkb/Q9P0U3/)")
st.markdown(f"Protein symbol: SENP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9P0U3') ]
