...
st.set_page_config(page_title="CISD1", layout="wide")
st.title("CDGSH iron-sulfur domain-containing protein 1")
st.markdown(f"Uniprot ID: [Q9NZ45](https://www.uniprot.org/uniprotkb/Q9NZ45/)")
st.markdown(f"Protein symbol: CISD1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NZ45') ]
