...
st.set_page_config(page_title="RXFP1", layout="wide")
st.title("Relaxin receptor 1")
st.markdown(f"Uniprot ID: [Q9HBX9](https://www.uniprot.org/uniprotkb/Q9HBX9/)")
st.markdown(f"Protein symbol: RXFP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HBX9') ]
