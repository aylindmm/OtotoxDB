...
st.set_page_config(page_title="CASP5", layout="wide")
st.title("Caspase-5")
st.markdown(f"Uniprot ID: [P51878](https://www.uniprot.org/uniprotkb/P51878/)")
st.markdown(f"Protein symbol: CASP5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51878') ]
