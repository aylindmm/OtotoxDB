...
st.set_page_config(page_title="GRM5", layout="wide")
st.title("Metabotropic glutamate receptor 5")
st.markdown(f"Uniprot ID: [P41594](https://www.uniprot.org/uniprotkb/P41594/)")
st.markdown(f"Protein symbol: GRM5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41594') ]
