...
st.set_page_config(page_title="SC6A3", layout="wide")
st.title("Sodium-dependent dopamine transporter")
st.markdown(f"Uniprot ID: [Q01959](https://www.uniprot.org/uniprotkb/Q01959/)")
st.markdown(f"Protein symbol: SC6A3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q01959') ]
