...
st.set_page_config(page_title="TIE1", layout="wide")
st.title("Tyrosine-protein kinase receptor Tie-1")
st.markdown(f"Uniprot ID: [P35590](https://www.uniprot.org/uniprotkb/P35590/)")
st.markdown(f"Protein symbol: TIE1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35590') ]
