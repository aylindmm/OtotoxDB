...
st.set_page_config(page_title="KIFC1", layout="wide")
st.title("Kinesin-like protein KIFC1")
st.markdown(f"Uniprot ID: [Q9BW19](https://www.uniprot.org/uniprotkb/Q9BW19/)")
st.markdown(f"Protein symbol: KIFC1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BW19') ]
