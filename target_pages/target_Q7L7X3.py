...
st.set_page_config(page_title="TAOK1", layout="wide")
st.title("Serine/threonine-protein kinase TAO1")
st.markdown(f"Uniprot ID: [Q7L7X3](https://www.uniprot.org/uniprotkb/Q7L7X3/)")
st.markdown(f"Protein symbol: TAOK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q7L7X3') ]
