...
st.set_page_config(page_title="AT12A", layout="wide")
st.title("Potassium-transporting ATPase alpha chain 2")
st.markdown(f"Uniprot ID: [P54707](https://www.uniprot.org/uniprotkb/P54707/)")
st.markdown(f"Protein symbol: AT12A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P54707') ]
