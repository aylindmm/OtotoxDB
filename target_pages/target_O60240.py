...
st.set_page_config(page_title="PLIN1", layout="wide")
st.title("Perilipin-1")
st.markdown(f"Uniprot ID: [O60240](https://www.uniprot.org/uniprotkb/O60240/)")
st.markdown(f"Protein symbol: PLIN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60240') ]
