...
st.set_page_config(page_title="NSD1", layout="wide")
st.title("Histone-lysine N-methyltransferase, H3 lysine-36 specific")
st.markdown(f"Uniprot ID: [Q96L73](https://www.uniprot.org/uniprotkb/Q96L73/)")
st.markdown(f"Protein symbol: NSD1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96L73') ]
