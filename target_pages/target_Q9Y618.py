...
st.set_page_config(page_title="NCOR2", layout="wide")
st.title("Isoform 2 of Nuclear receptor corepressor 2 (TRAC-1)")
st.markdown(f"Uniprot ID: [Q9Y618](https://www.uniprot.org/uniprotkb/Q9Y618/)")
st.markdown(f"Protein symbol: NCOR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y618') ]
