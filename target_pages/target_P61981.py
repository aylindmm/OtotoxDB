...
st.set_page_config(page_title="1433G", layout="wide")
st.title("14-3-3 protein gamma")
st.markdown(f"Uniprot ID: [P61981](https://www.uniprot.org/uniprotkb/P61981/)")
st.markdown(f"Protein symbol: 1433G")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P61981') ]
