...
st.set_page_config(page_title="PSIP1", layout="wide")
st.title("PC4 and SFRS1-interacting protein")
st.markdown(f"Uniprot ID: [O75475](https://www.uniprot.org/uniprotkb/O75475/)")
st.markdown(f"Protein symbol: PSIP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75475') ]
