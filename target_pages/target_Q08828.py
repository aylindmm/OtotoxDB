...
st.set_page_config(page_title="ADCY1", layout="wide")
st.title("Adenylate cyclase type 1")
st.markdown(f"Uniprot ID: [Q08828](https://www.uniprot.org/uniprotkb/Q08828/)")
st.markdown(f"Protein symbol: ADCY1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q08828') ]
