...
st.set_page_config(page_title="NK1R", layout="wide")
st.title("Substance-P receptor")
st.markdown(f"Uniprot ID: [P25103](https://www.uniprot.org/uniprotkb/P25103/)")
st.markdown(f"Protein symbol: NK1R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25103') ]
