...
st.set_page_config(page_title="RORA", layout="wide")
st.title("Nuclear receptor ROR-alpha")
st.markdown(f"Uniprot ID: [P35398](https://www.uniprot.org/uniprotkb/P35398/)")
st.markdown(f"Protein symbol: RORA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35398') ]
