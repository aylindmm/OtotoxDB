...
st.set_page_config(page_title="ADK", layout="wide")
st.title("Adenosine kinase")
st.markdown(f"Uniprot ID: [P55263](https://www.uniprot.org/uniprotkb/P55263/)")
st.markdown(f"Protein symbol: ADK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P55263') ]
