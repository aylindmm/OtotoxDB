...
st.set_page_config(page_title="MKNK1", layout="wide")
st.title("MAP kinase-interacting serine/threonine-protein kinase 1")
st.markdown(f"Uniprot ID: [Q9BUB5](https://www.uniprot.org/uniprotkb/Q9BUB5/)")
st.markdown(f"Protein symbol: MKNK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BUB5') ]
