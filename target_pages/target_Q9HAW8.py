...
st.set_page_config(page_title="UD110", layout="wide")
st.title("UDP-glucuronosyltransferase 1A10")
st.markdown(f"Uniprot ID: [Q9HAW8](https://www.uniprot.org/uniprotkb/Q9HAW8/)")
st.markdown(f"Protein symbol: UD110")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HAW8') ]
