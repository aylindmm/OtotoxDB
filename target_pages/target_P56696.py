...
st.set_page_config(page_title="KCNQ4", layout="wide")
st.title("Potassium voltage-gated channel subfamily KQT member 4")
st.markdown(f"Uniprot ID: [P56696](https://www.uniprot.org/uniprotkb/P56696/)")
st.markdown(f"Protein symbol: KCNQ4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P56696') ]
