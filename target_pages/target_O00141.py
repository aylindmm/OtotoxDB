...
st.set_page_config(page_title="SGK1", layout="wide")
st.title("Serine/threonine-protein kinase Sgk1")
st.markdown(f"Uniprot ID: [O00141](https://www.uniprot.org/uniprotkb/O00141/)")
st.markdown(f"Protein symbol: SGK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00141') ]
