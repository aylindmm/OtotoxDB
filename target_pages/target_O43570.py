...
st.set_page_config(page_title="CAH12", layout="wide")
st.title("Carbonic anhydrase 12")
st.markdown(f"Uniprot ID: [O43570](https://www.uniprot.org/uniprotkb/O43570/)")
st.markdown(f"Protein symbol: CAH12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43570') ]
