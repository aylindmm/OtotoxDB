...
st.set_page_config(page_title="GBRA3", layout="wide")
st.title("Gamma-aminobutyric acid receptor subunit alpha-3/beta-3/gamma-2")
st.markdown(f"Uniprot ID: [P34903](https://www.uniprot.org/uniprotkb/P34903/)")
st.markdown(f"Protein symbol: GBRA3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34903') ]
