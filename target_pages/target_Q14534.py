...
st.set_page_config(page_title="ERG1", layout="wide")
st.title("Squalene monooxygenase")
st.markdown(f"Uniprot ID: [Q14534](https://www.uniprot.org/uniprotkb/Q14534/)")
st.markdown(f"Protein symbol: ERG1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14534') ]
