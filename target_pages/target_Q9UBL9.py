...
st.set_page_config(page_title="P2RX2", layout="wide")
st.title("P2X purinoceptor 2")
st.markdown(f"Uniprot ID: [Q9UBL9](https://www.uniprot.org/uniprotkb/Q9UBL9/)")
st.markdown(f"Protein symbol: P2RX2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UBL9') ]
