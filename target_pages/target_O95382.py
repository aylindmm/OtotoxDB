...
st.set_page_config(page_title="M3K6", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 6")
st.markdown(f"Uniprot ID: [O95382](https://www.uniprot.org/uniprotkb/O95382/)")
st.markdown(f"Protein symbol: M3K6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95382') ]
