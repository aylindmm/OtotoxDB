...
st.set_page_config(page_title="LPAR4", layout="wide")
st.title("Lysophosphatidic acid receptor 4")
st.markdown(f"Uniprot ID: [Q99677](https://www.uniprot.org/uniprotkb/Q99677/)")
st.markdown(f"Protein symbol: LPAR4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99677') ]
