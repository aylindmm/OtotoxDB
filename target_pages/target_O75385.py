...
st.set_page_config(page_title="ULK1", layout="wide")
st.title("Serine/threonine-protein kinase ULK1")
st.markdown(f"Uniprot ID: [O75385](https://www.uniprot.org/uniprotkb/O75385/)")
st.markdown(f"Protein symbol: ULK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75385') ]
