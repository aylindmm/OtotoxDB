...
st.set_page_config(page_title="TNI3K", layout="wide")
st.title("Serine/threonine-protein kinase TNNI3K")
st.markdown(f"Uniprot ID: [Q59H18](https://www.uniprot.org/uniprotkb/Q59H18/)")
st.markdown(f"Protein symbol: TNI3K")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q59H18') ]
