...
st.set_page_config(page_title="NQO1", layout="wide")
st.title("NAD(P)H dehydrogenase [quinone] 1")
st.markdown(f"Uniprot ID: [P15559](https://www.uniprot.org/uniprotkb/P15559/)")
st.markdown(f"Protein symbol: NQO1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15559') ]
