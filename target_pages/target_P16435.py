...
st.set_page_config(page_title="NCPR", layout="wide")
st.title("NADPH--cytochrome P450 reductase")
st.markdown(f"Uniprot ID: [P16435](https://www.uniprot.org/uniprotkb/P16435/)")
st.markdown(f"Protein symbol: NCPR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16435') ]
