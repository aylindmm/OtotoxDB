...
st.set_page_config(page_title="KS6B1", layout="wide")
st.title("Ribosomal protein S6 kinase beta-1")
st.markdown(f"Uniprot ID: [P23443](https://www.uniprot.org/uniprotkb/P23443/)")
st.markdown(f"Protein symbol: KS6B1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23443') ]
