...
st.set_page_config(page_title="EF2K", layout="wide")
st.title("Eukaryotic elongation factor 2 kinase")
st.markdown(f"Uniprot ID: [O00418](https://www.uniprot.org/uniprotkb/O00418/)")
st.markdown(f"Protein symbol: EF2K")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00418') ]
