...
st.set_page_config(page_title="VATB2", layout="wide")
st.title("V-type proton ATPase subunit B, brain isoform")
st.markdown(f"Uniprot ID: [P21281](https://www.uniprot.org/uniprotkb/P21281/)")
st.markdown(f"Protein symbol: VATB2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21281') ]
