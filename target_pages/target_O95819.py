...
st.set_page_config(page_title="M4K4", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase kinase 4")
st.markdown(f"Uniprot ID: [O95819](https://www.uniprot.org/uniprotkb/O95819/)")
st.markdown(f"Protein symbol: M4K4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95819') ]
