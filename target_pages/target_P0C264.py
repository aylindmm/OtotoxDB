...
st.set_page_config(page_title="SBK3", layout="wide")
st.title("Uncharacterized serine/threonine-protein kinase SBK3")
st.markdown(f"Uniprot ID: [P0C264](https://www.uniprot.org/uniprotkb/P0C264/)")
st.markdown(f"Protein symbol: SBK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P0C264') ]
