...
st.set_page_config(page_title="SCN8A", layout="wide")
st.title("Sodium channel protein type 8 subunit alpha")
st.markdown(f"Uniprot ID: [Q9UQD0](https://www.uniprot.org/uniprotkb/Q9UQD0/)")
st.markdown(f"Protein symbol: SCN8A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UQD0') ]
