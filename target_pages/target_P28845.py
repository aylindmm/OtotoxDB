...
st.set_page_config(page_title="DHI1", layout="wide")
st.title("11-beta-hydroxysteroid dehydrogenase 1")
st.markdown(f"Uniprot ID: [P28845](https://www.uniprot.org/uniprotkb/P28845/)")
st.markdown(f"Protein symbol: DHI1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28845') ]
