...
st.set_page_config(page_title="CPT1A", layout="wide")
st.title("Carnitine O-palmitoyltransferase 1, liver isoform")
st.markdown(f"Uniprot ID: [P50416](https://www.uniprot.org/uniprotkb/P50416/)")
st.markdown(f"Protein symbol: CPT1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P50416') ]
