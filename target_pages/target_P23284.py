...
st.set_page_config(page_title="PPIB", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase B")
st.markdown(f"Uniprot ID: [P23284](https://www.uniprot.org/uniprotkb/P23284/)")
st.markdown(f"Protein symbol: PPIB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P23284') ]
