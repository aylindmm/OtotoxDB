...
st.set_page_config(page_title="LIMK1", layout="wide")
st.title("LIM domain kinase 1")
st.markdown(f"Uniprot ID: [P53667](https://www.uniprot.org/uniprotkb/P53667/)")
st.markdown(f"Protein symbol: LIMK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53667') ]
