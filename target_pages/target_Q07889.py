...
st.set_page_config(page_title="SOS1", layout="wide")
st.title("Son of sevenless homolog 1")
st.markdown(f"Uniprot ID: [Q07889](https://www.uniprot.org/uniprotkb/Q07889/)")
st.markdown(f"Protein symbol: SOS1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q07889') ]
