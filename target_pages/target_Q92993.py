...
st.set_page_config(page_title="KAT5", layout="wide")
st.title("Histone acetyltransferase KAT5")
st.markdown(f"Uniprot ID: [Q92993](https://www.uniprot.org/uniprotkb/Q92993/)")
st.markdown(f"Protein symbol: KAT5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92993') ]
