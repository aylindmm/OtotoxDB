...
st.set_page_config(page_title="EPHA2", layout="wide")
st.title("Ephrin type-A receptor 2")
st.markdown(f"Uniprot ID: [P29317](https://www.uniprot.org/uniprotkb/P29317/)")
st.markdown(f"Protein symbol: EPHA2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29317') ]
