...
st.set_page_config(page_title="PARP1", layout="wide")
st.title("Poly [ADP-ribose] polymerase 1")
st.markdown(f"Uniprot ID: [P09874](https://www.uniprot.org/uniprotkb/P09874/)")
st.markdown(f"Protein symbol: PARP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09874') ]
