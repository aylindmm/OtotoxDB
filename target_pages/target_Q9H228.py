...
st.set_page_config(page_title="S1PR5", layout="wide")
st.title("Sphingosine 1-phosphate receptor 5")
st.markdown(f"Uniprot ID: [Q9H228](https://www.uniprot.org/uniprotkb/Q9H228/)")
st.markdown(f"Protein symbol: S1PR5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H228') ]
