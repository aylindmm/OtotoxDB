...
st.set_page_config(page_title="ARF1", layout="wide")
st.title("ADP-ribosylation factor 1")
st.markdown(f"Uniprot ID: [P84077](https://www.uniprot.org/uniprotkb/P84077/)")
st.markdown(f"Protein symbol: ARF1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P84077') ]
