...
st.set_page_config(page_title="CA2D2", layout="wide")
st.title("Voltage-dependent calcium channel subunit alpha-2/delta-2")
st.markdown(f"Uniprot ID: [Q9NY47](https://www.uniprot.org/uniprotkb/Q9NY47/)")
st.markdown(f"Protein symbol: CA2D2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NY47') ]
