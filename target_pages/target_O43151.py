...
st.set_page_config(page_title="TET3", layout="wide")
st.title("Methylcytosine dioxygenase TET3")
st.markdown(f"Uniprot ID: [O43151](https://www.uniprot.org/uniprotkb/O43151/)")
st.markdown(f"Protein symbol: TET3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43151') ]
