...
st.set_page_config(page_title="KCC4", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase type IV")
st.markdown(f"Uniprot ID: [Q16566](https://www.uniprot.org/uniprotkb/Q16566/)")
st.markdown(f"Protein symbol: KCC4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16566') ]
