...
st.set_page_config(page_title="TYK2", layout="wide")
st.title("Non-receptor tyrosine-protein kinase TYK2/Tyrosine-protein kinase JAK2")
st.markdown(f"Uniprot ID: [P29597](https://www.uniprot.org/uniprotkb/P29597/)")
st.markdown(f"Protein symbol: TYK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29597') ]
