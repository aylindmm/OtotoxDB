...
st.set_page_config(page_title="ATP4A", layout="wide")
st.title("Potassium-transporting ATPase alpha chain 1/subunit beta")
st.markdown(f"Uniprot ID: [P20648](https://www.uniprot.org/uniprotkb/P20648/)")
st.markdown(f"Protein symbol: ATP4A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20648') ]
