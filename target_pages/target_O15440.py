...
st.set_page_config(page_title="MRP5", layout="wide")
st.title("ATP-binding cassette sub-family C member 5")
st.markdown(f"Uniprot ID: [O15440](https://www.uniprot.org/uniprotkb/O15440/)")
st.markdown(f"Protein symbol: MRP5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15440') ]
