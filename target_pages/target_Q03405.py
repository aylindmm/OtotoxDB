...
st.set_page_config(page_title="UPAR", layout="wide")
st.title("Urokinase plasminogen activator surface receptor")
st.markdown(f"Uniprot ID: [Q03405](https://www.uniprot.org/uniprotkb/Q03405/)")
st.markdown(f"Protein symbol: UPAR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q03405') ]
