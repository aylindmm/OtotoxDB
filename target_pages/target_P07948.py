...
st.set_page_config(page_title="LYN", layout="wide")
st.title("Tyrosine-protein kinase Lyn")
st.markdown(f"Uniprot ID: [P07948](https://www.uniprot.org/uniprotkb/P07948/)")
st.markdown(f"Protein symbol: LYN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07948') ]
