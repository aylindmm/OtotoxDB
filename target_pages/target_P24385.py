...
st.set_page_config(page_title="CCND1", layout="wide")
st.title("Cyclin-dependent kinase 6/G1/S-specific cyclin-D1")
st.markdown(f"Uniprot ID: [P24385](https://www.uniprot.org/uniprotkb/P24385/)")
st.markdown(f"Protein symbol: CCND1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24385') ]
