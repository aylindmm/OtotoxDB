...
st.set_page_config(page_title="NR1I3", layout="wide")
st.title("Nuclear receptor subfamily 1 group I member 3")
st.markdown(f"Uniprot ID: [Q14994](https://www.uniprot.org/uniprotkb/Q14994/)")
st.markdown(f"Protein symbol: NR1I3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14994') ]
