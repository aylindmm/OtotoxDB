...
st.set_page_config(page_title="CY24B", layout="wide")
st.title("Cytochrome b-245 heavy chain")
st.markdown(f"Uniprot ID: [P04839](https://www.uniprot.org/uniprotkb/P04839/)")
st.markdown(f"Protein symbol: CY24B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04839') ]
