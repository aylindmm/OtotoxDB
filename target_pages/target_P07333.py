...
st.set_page_config(page_title="CSF1R", layout="wide")
st.title("Macrophage colony-stimulating factor 1 receptor")
st.markdown(f"Uniprot ID: [P07333](https://www.uniprot.org/uniprotkb/P07333/)")
st.markdown(f"Protein symbol: CSF1R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07333') ]
