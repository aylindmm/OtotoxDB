...
st.set_page_config(page_title="CAC1G", layout="wide")
st.title("Voltage-dependent T-type calcium channel subunit alpha-1G")
st.markdown(f"Uniprot ID: [O43497](https://www.uniprot.org/uniprotkb/O43497/)")
st.markdown(f"Protein symbol: CAC1G")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43497') ]
