...
st.set_page_config(page_title="ST32B", layout="wide")
st.title("Serine/threonine-protein kinase 32B")
st.markdown(f"Uniprot ID: [Q9NY57](https://www.uniprot.org/uniprotkb/Q9NY57/)")
st.markdown(f"Protein symbol: ST32B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NY57') ]
