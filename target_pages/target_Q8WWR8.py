...
st.set_page_config(page_title="NEUR4", layout="wide")
st.title("Sialidase-4")
st.markdown(f"Uniprot ID: [Q8WWR8](https://www.uniprot.org/uniprotkb/Q8WWR8/)")
st.markdown(f"Protein symbol: NEUR4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8WWR8') ]
