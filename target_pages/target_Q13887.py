...
st.set_page_config(page_title="KLF5", layout="wide")
st.title("Krueppel-like factor 5")
st.markdown(f"Uniprot ID: [Q13887](https://www.uniprot.org/uniprotkb/Q13887/)")
st.markdown(f"Protein symbol: KLF5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13887') ]
