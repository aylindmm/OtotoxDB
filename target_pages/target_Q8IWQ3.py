...
st.set_page_config(page_title="BRSK2", layout="wide")
st.title("Serine/threonine-protein kinase BRSK2")
st.markdown(f"Uniprot ID: [Q8IWQ3](https://www.uniprot.org/uniprotkb/Q8IWQ3/)")
st.markdown(f"Protein symbol: BRSK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IWQ3') ]
