...
st.set_page_config(page_title="SRPK1", layout="wide")
st.title("SRSF protein kinase 1")
st.markdown(f"Uniprot ID: [Q96SB4](https://www.uniprot.org/uniprotkb/Q96SB4/)")
st.markdown(f"Protein symbol: SRPK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96SB4') ]
