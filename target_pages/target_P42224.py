...
st.set_page_config(page_title="STAT1", layout="wide")
st.title("Signal transducer and activator of transcription 1-alpha/beta")
st.markdown(f"Uniprot ID: [P42224](https://www.uniprot.org/uniprotkb/P42224/)")
st.markdown(f"Protein symbol: STAT1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42224') ]
