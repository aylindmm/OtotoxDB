...
st.set_page_config(page_title="NF2L2", layout="wide")
st.title("Nuclear factor erythroid 2-related factor 2")
st.markdown(f"Uniprot ID: [Q16236](https://www.uniprot.org/uniprotkb/Q16236/)")
st.markdown(f"Protein symbol: NF2L2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16236') ]
