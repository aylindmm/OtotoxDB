...
st.set_page_config(page_title="MTOR", layout="wide")
st.title("Serine/threonine-protein kinase mTOR")
st.markdown(f"Uniprot ID: [P42345](https://www.uniprot.org/uniprotkb/P42345/)")
st.markdown(f"Protein symbol: MTOR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42345') ]
