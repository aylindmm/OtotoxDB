...
st.set_page_config(page_title="PDE3B", layout="wide")
st.title("cGMP-inhibited 3',5'-cyclic phosphodiesterase 3B [650-1084]")
st.markdown(f"Uniprot ID: [Q13370](https://www.uniprot.org/uniprotkb/Q13370/)")
st.markdown(f"Protein symbol: PDE3B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13370') ]
