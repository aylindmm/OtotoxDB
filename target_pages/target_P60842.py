...
st.set_page_config(page_title="IF4A1", layout="wide")
st.title("Eukaryotic initiation factor 4A-I")
st.markdown(f"Uniprot ID: [P60842](https://www.uniprot.org/uniprotkb/P60842/)")
st.markdown(f"Protein symbol: IF4A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P60842') ]
