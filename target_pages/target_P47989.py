...
st.set_page_config(page_title="XDH", layout="wide")
st.title("Xanthine dehydrogenase/oxidase")
st.markdown(f"Uniprot ID: [P47989](https://www.uniprot.org/uniprotkb/P47989/)")
st.markdown(f"Protein symbol: XDH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P47989') ]
