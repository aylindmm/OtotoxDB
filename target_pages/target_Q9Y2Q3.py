...
st.set_page_config(page_title="GSTK1", layout="wide")
st.title("Glutathione S-transferase kappa 1")
st.markdown(f"Uniprot ID: [Q9Y2Q3](https://www.uniprot.org/uniprotkb/Q9Y2Q3/)")
st.markdown(f"Protein symbol: GSTK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2Q3') ]
