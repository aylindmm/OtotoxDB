...
st.set_page_config(page_title="BMPR2", layout="wide")
st.title("Bone morphogenetic protein receptor type-2")
st.markdown(f"Uniprot ID: [Q13873](https://www.uniprot.org/uniprotkb/Q13873/)")
st.markdown(f"Protein symbol: BMPR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13873') ]
