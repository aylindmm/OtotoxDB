...
st.set_page_config(page_title="KIF11", layout="wide")
st.title("Kinesin-like protein KIF11 [D130V]")
st.markdown(f"Uniprot ID: [P52732](https://www.uniprot.org/uniprotkb/P52732/)")
st.markdown(f"Protein symbol: KIF11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P52732') ]
