...
st.set_page_config(page_title="CASP9", layout="wide")
st.title("Caspase-9")
st.markdown(f"Uniprot ID: [P55211](https://www.uniprot.org/uniprotkb/P55211/)")
st.markdown(f"Protein symbol: CASP9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P55211') ]
