...
st.set_page_config(page_title="NCOR1", layout="wide")
st.title("Nuclear receptor corepressor 1")
st.markdown(f"Uniprot ID: [O75376](https://www.uniprot.org/uniprotkb/O75376/)")
st.markdown(f"Protein symbol: NCOR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75376') ]
