...
st.set_page_config(page_title="S1PR4", layout="wide")
st.title("Sphingosine 1-phosphate receptor 4")
st.markdown(f"Uniprot ID: [O95977](https://www.uniprot.org/uniprotkb/O95977/)")
st.markdown(f"Protein symbol: S1PR4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95977') ]
