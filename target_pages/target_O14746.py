...
st.set_page_config(page_title="TERT", layout="wide")
st.title("Telomerase reverse transcriptase")
st.markdown(f"Uniprot ID: [O14746](https://www.uniprot.org/uniprotkb/O14746/)")
st.markdown(f"Protein symbol: TERT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14746') ]
