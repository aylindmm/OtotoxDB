...
st.set_page_config(page_title="NCOA3", layout="wide")
st.title("Nuclear receptor coactivator 3")
st.markdown(f"Uniprot ID: [Q9Y6Q9](https://www.uniprot.org/uniprotkb/Q9Y6Q9/)")
st.markdown(f"Protein symbol: NCOA3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y6Q9') ]
