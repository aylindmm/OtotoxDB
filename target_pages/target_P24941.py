...
st.set_page_config(page_title="CDK2", layout="wide")
st.title("Cyclin-dependent kinase 2/G1/S-specific cyclin-E1")
st.markdown(f"Uniprot ID: [P24941](https://www.uniprot.org/uniprotkb/P24941/)")
st.markdown(f"Protein symbol: CDK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24941') ]
