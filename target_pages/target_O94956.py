...
st.set_page_config(page_title="SO2B1", layout="wide")
st.title("Solute carrier organic anion transporter family member 2B1")
st.markdown(f"Uniprot ID: [O94956](https://www.uniprot.org/uniprotkb/O94956/)")
st.markdown(f"Protein symbol: SO2B1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O94956') ]
