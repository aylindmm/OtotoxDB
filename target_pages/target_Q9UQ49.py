...
st.set_page_config(page_title="NEUR3", layout="wide")
st.title("Sialidase-3")
st.markdown(f"Uniprot ID: [Q9UQ49](https://www.uniprot.org/uniprotkb/Q9UQ49/)")
st.markdown(f"Protein symbol: NEUR3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UQ49') ]
