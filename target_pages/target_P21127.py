...
st.set_page_config(page_title="CD11B", layout="wide")
st.title("Cyclin-dependent kinase 11B")
st.markdown(f"Uniprot ID: [P21127](https://www.uniprot.org/uniprotkb/P21127/)")
st.markdown(f"Protein symbol: CD11B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21127') ]
