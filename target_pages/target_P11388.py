...
st.set_page_config(page_title="TOP2A", layout="wide")
st.title("DNA topoisomerase 2-alpha/2-beta")
st.markdown(f"Uniprot ID: [P11388](https://www.uniprot.org/uniprotkb/P11388/)")
st.markdown(f"Protein symbol: TOP2A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11388') ]
