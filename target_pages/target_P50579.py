...
st.set_page_config(page_title="MAP2", layout="wide")
st.title("Methionine aminopeptidase 2")
st.markdown(f"Uniprot ID: [P50579](https://www.uniprot.org/uniprotkb/P50579/)")
st.markdown(f"Protein symbol: MAP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P50579') ]
