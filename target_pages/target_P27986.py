...
st.set_page_config(page_title="P85A", layout="wide")
st.title("Phosphatidylinositol 3-kinase regulatory subunit alpha/4,5-bisphosphate 3-kinase catalytic subunit delta isoform")
st.markdown(f"Uniprot ID: [P27986](https://www.uniprot.org/uniprotkb/P27986/)")
st.markdown(f"Protein symbol: P85A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27986') ]
