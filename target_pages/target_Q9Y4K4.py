...
st.set_page_config(page_title="M4K5", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase kinase 5")
st.markdown(f"Uniprot ID: [Q9Y4K4](https://www.uniprot.org/uniprotkb/Q9Y4K4/)")
st.markdown(f"Protein symbol: M4K5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y4K4') ]
