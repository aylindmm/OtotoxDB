...
st.set_page_config(page_title="5HT6R", layout="wide")
st.title("5-hydroxytryptamine receptor 6")
st.markdown(f"Uniprot ID: [P50406](https://www.uniprot.org/uniprotkb/P50406/)")
st.markdown(f"Protein symbol: 5HT6R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P50406') ]
