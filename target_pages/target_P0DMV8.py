...
st.set_page_config(page_title="HS71A", layout="wide")
st.title("Heat shock 70 kDa protein 1A")
st.markdown(f"Uniprot ID: [P0DMV8](https://www.uniprot.org/uniprotkb/P0DMV8/)")
st.markdown(f"Protein symbol: HS71A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P0DMV8') ]
