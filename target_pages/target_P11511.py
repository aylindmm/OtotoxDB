...
st.set_page_config(page_title="CP19A", layout="wide")
st.title("Aromatase")
st.markdown(f"Uniprot ID: [P11511](https://www.uniprot.org/uniprotkb/P11511/)")
st.markdown(f"Protein symbol: CP19A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11511') ]
