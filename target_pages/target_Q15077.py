...
st.set_page_config(page_title="P2RY6", layout="wide")
st.title("P2Y purinoceptor 6")
st.markdown(f"Uniprot ID: [Q15077](https://www.uniprot.org/uniprotkb/Q15077/)")
st.markdown(f"Protein symbol: P2RY6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15077') ]
