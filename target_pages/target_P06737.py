...
st.set_page_config(page_title="PYGL", layout="wide")
st.title("Glycogen phosphorylase, liver form")
st.markdown(f"Uniprot ID: [P06737](https://www.uniprot.org/uniprotkb/P06737/)")
st.markdown(f"Protein symbol: PYGL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P06737') ]
