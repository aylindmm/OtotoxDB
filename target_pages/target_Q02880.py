...
st.set_page_config(page_title="TOP2B", layout="wide")
st.title("DNA topoisomerase 2-beta")
st.markdown(f"Uniprot ID: [Q02880](https://www.uniprot.org/uniprotkb/Q02880/)")
st.markdown(f"Protein symbol: TOP2B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02880') ]
