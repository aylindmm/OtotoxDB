...
st.set_page_config(page_title="CCNT1", layout="wide")
st.title("Cyclin-T1/Cyclin-dependent kinase 9")
st.markdown(f"Uniprot ID: [O60563](https://www.uniprot.org/uniprotkb/O60563/)")
st.markdown(f"Protein symbol: CCNT1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O60563') ]
