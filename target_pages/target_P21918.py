...
st.set_page_config(page_title="DRD5", layout="wide")
st.title("D(1B) dopamine receptor")
st.markdown(f"Uniprot ID: [P21918](https://www.uniprot.org/uniprotkb/P21918/)")
st.markdown(f"Protein symbol: DRD5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21918') ]
