...
st.set_page_config(page_title="CALCA", layout="wide")
st.title("Calcitonin gene-related peptide 1")
st.markdown(f"Uniprot ID: [P06881](https://www.uniprot.org/uniprotkb/P06881/)")
st.markdown(f"Protein symbol: CALCA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P06881') ]
