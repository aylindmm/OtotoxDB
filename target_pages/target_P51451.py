...
st.set_page_config(page_title="BLK", layout="wide")
st.title("Tyrosine-protein kinase Blk")
st.markdown(f"Uniprot ID: [P51451](https://www.uniprot.org/uniprotkb/P51451/)")
st.markdown(f"Protein symbol: BLK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51451') ]
