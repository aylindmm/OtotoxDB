...
st.set_page_config(page_title="FA7", layout="wide")
st.title("Coagulation factor VII/Tissue factor")
st.markdown(f"Uniprot ID: [P08709](https://www.uniprot.org/uniprotkb/P08709/)")
st.markdown(f"Protein symbol: FA7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08709') ]
