...
st.set_page_config(page_title="CCNE1", layout="wide")
st.title("G1/S-specific cyclin-E1")
st.markdown(f"Uniprot ID: [P24864](https://www.uniprot.org/uniprotkb/P24864/)")
st.markdown(f"Protein symbol: CCNE1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24864') ]
