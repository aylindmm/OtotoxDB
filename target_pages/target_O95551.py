...
st.set_page_config(page_title="TYDP2", layout="wide")
st.title("Tyrosyl-DNA phosphodiesterase 2")
st.markdown(f"Uniprot ID: [O95551](https://www.uniprot.org/uniprotkb/O95551/)")
st.markdown(f"Protein symbol: TYDP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95551') ]
