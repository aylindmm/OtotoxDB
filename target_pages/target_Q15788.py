...
st.set_page_config(page_title="NCOA1", layout="wide")
st.title("Nuclear receptor coactivator 1")
st.markdown(f"Uniprot ID: [Q15788](https://www.uniprot.org/uniprotkb/Q15788/)")
st.markdown(f"Protein symbol: NCOA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15788') ]
