...
st.set_page_config(page_title="CP3A4", layout="wide")
st.title("Cytochrome P450 3A4")
st.markdown(f"Uniprot ID: [P08684](https://www.uniprot.org/uniprotkb/P08684/)")
st.markdown(f"Protein symbol: CP3A4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08684') ]
