...
st.set_page_config(page_title="PRUN1", layout="wide")
st.title("Exopolyphosphatase PRUNE1")
st.markdown(f"Uniprot ID: [Q86TP1](https://www.uniprot.org/uniprotkb/Q86TP1/)")
st.markdown(f"Protein symbol: PRUN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86TP1') ]
