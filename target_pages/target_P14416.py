...
st.set_page_config(page_title="DRD2", layout="wide")
st.title("D(2) dopamine receptor")
st.markdown(f"Uniprot ID: [P14416](https://www.uniprot.org/uniprotkb/P14416/)")
st.markdown(f"Protein symbol: DRD2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14416') ]
