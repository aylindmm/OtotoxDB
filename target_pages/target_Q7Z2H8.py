...
st.set_page_config(page_title="S36A1", layout="wide")
st.title("Proton-coupled amino acid transporter 1")
st.markdown(f"Uniprot ID: [Q7Z2H8](https://www.uniprot.org/uniprotkb/Q7Z2H8/)")
st.markdown(f"Protein symbol: S36A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q7Z2H8') ]
