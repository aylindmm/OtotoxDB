...
st.set_page_config(page_title="AK1C1", layout="wide")
st.title("Aldo-keto reductase family 1 member C1")
st.markdown(f"Uniprot ID: [Q04828](https://www.uniprot.org/uniprotkb/Q04828/)")
st.markdown(f"Protein symbol: AK1C1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q04828') ]
