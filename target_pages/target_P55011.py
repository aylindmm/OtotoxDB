...
st.set_page_config(page_title="S12A2", layout="wide")
st.title("Solute carrier family 12 member 2")
st.markdown(f"Uniprot ID: [P55011](https://www.uniprot.org/uniprotkb/P55011/)")
st.markdown(f"Protein symbol: S12A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P55011') ]
