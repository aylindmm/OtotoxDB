...
st.set_page_config(page_title="RET", layout="wide")
st.title("Proto-oncogene tyrosine-protein kinase receptor Ret [1-999,M918T]")
st.markdown(f"Uniprot ID: [P07949](https://www.uniprot.org/uniprotkb/P07949/)")
st.markdown(f"Protein symbol: RET")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07949') ]
