...
st.set_page_config(page_title="RENI", layout="wide")
st.title("Renin")
st.markdown(f"Uniprot ID: [P00797](https://www.uniprot.org/uniprotkb/P00797/)")
st.markdown(f"Protein symbol: RENI")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00797') ]
