...
st.set_page_config(page_title="CSK", layout="wide")
st.title("Tyrosine-protein kinase CSK")
st.markdown(f"Uniprot ID: [P41240](https://www.uniprot.org/uniprotkb/P41240/)")
st.markdown(f"Protein symbol: CSK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41240') ]
