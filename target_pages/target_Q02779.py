...
st.set_page_config(page_title="M3K10", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 10")
st.markdown(f"Uniprot ID: [Q02779](https://www.uniprot.org/uniprotkb/Q02779/)")
st.markdown(f"Protein symbol: M3K10")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02779') ]
