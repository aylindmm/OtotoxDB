...
st.set_page_config(page_title="HS90A", layout="wide")
st.title("Heat shock protein HSP 90-alpha")
st.markdown(f"Uniprot ID: [P07900](https://www.uniprot.org/uniprotkb/P07900/)")
st.markdown(f"Protein symbol: HS90A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07900') ]
