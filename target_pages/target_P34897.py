...
st.set_page_config(page_title="GLYM", layout="wide")
st.title("Serine hydroxymethyltransferase, mitochondrial")
st.markdown(f"Uniprot ID: [P34897](https://www.uniprot.org/uniprotkb/P34897/)")
st.markdown(f"Protein symbol: GLYM")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34897') ]
