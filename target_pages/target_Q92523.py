...
st.set_page_config(page_title="CPT1B", layout="wide")
st.title("Carnitine O-palmitoyltransferase 1, muscle isoform")
st.markdown(f"Uniprot ID: [Q92523](https://www.uniprot.org/uniprotkb/Q92523/)")
st.markdown(f"Protein symbol: CPT1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92523') ]
