...
st.set_page_config(page_title="FFAR4", layout="wide")
st.title("Free fatty acid receptor 4")
st.markdown(f"Uniprot ID: [Q5NUL3](https://www.uniprot.org/uniprotkb/Q5NUL3/)")
st.markdown(f"Protein symbol: FFAR4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q5NUL3') ]
