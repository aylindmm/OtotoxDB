...
st.set_page_config(page_title="CCNH", layout="wide")
st.title("CDK-activating kinase assembly factor MAT1/Cyclin-H/Cyclin-dependent kinase 7")
st.markdown(f"Uniprot ID: [P51946](https://www.uniprot.org/uniprotkb/P51946/)")
st.markdown(f"Protein symbol: CCNH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51946') ]
