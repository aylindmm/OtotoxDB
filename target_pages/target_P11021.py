...
st.set_page_config(page_title="BIP", layout="wide")
st.title("Endoplasmic reticulum chaperone BiP")
st.markdown(f"Uniprot ID: [P11021](https://www.uniprot.org/uniprotkb/P11021/)")
st.markdown(f"Protein symbol: BIP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11021') ]
