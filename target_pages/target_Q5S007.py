...
st.set_page_config(page_title="LRRK2", layout="wide")
st.title("Leucine-rich repeat serine/threonine-protein kinase 2")
st.markdown(f"Uniprot ID: [Q5S007](https://www.uniprot.org/uniprotkb/Q5S007/)")
st.markdown(f"Protein symbol: LRRK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q5S007') ]
