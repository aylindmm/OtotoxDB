...
st.set_page_config(page_title="EGLN1", layout="wide")
st.title("Egl nine homolog 1/Prolyl hydroxylase EGLN2/Prolyl hydroxylase EGLN3/Transmembrane prolyl 4-hydroxylase")
st.markdown(f"Uniprot ID: [Q9GZT9](https://www.uniprot.org/uniprotkb/Q9GZT9/)")
st.markdown(f"Protein symbol: EGLN1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9GZT9') ]
