...
st.set_page_config(page_title="TRY1", layout="wide")
st.title("Trypsin")
st.markdown(f"Uniprot ID: [P07477](https://www.uniprot.org/uniprotkb/P07477/)")
st.markdown(f"Protein symbol: TRY1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07477') ]
