...
st.set_page_config(page_title="MTAP2", layout="wide")
st.title("Microtubule-associated protein 2")
st.markdown(f"Uniprot ID: [P11137](https://www.uniprot.org/uniprotkb/P11137/)")
st.markdown(f"Protein symbol: MTAP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11137') ]
