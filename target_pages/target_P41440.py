...
st.set_page_config(page_title="S19A1", layout="wide")
st.title("Reduced folate transporter")
st.markdown(f"Uniprot ID: [P41440](https://www.uniprot.org/uniprotkb/P41440/)")
st.markdown(f"Protein symbol: S19A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41440') ]
