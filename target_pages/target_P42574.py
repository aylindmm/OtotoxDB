...
st.set_page_config(page_title="CASP3", layout="wide")
st.title("Caspase-3")
st.markdown(f"Uniprot ID: [P42574](https://www.uniprot.org/uniprotkb/P42574/)")
st.markdown(f"Protein symbol: CASP3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42574') ]
