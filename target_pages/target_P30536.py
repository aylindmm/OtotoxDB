...
st.set_page_config(page_title="TSPO", layout="wide")
st.title("Translocator protein")
st.markdown(f"Uniprot ID: [P30536](https://www.uniprot.org/uniprotkb/P30536/)")
st.markdown(f"Protein symbol: TSPO")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30536') ]
