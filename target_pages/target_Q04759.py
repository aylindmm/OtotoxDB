...
st.set_page_config(page_title="KPCT", layout="wide")
st.title("Protein kinase C theta type")
st.markdown(f"Uniprot ID: [Q04759](https://www.uniprot.org/uniprotkb/Q04759/)")
st.markdown(f"Protein symbol: KPCT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q04759') ]
