...
st.set_page_config(page_title="CNR1", layout="wide")
st.title("Cannabinoid receptor 1/2")
st.markdown(f"Uniprot ID: [P21554](https://www.uniprot.org/uniprotkb/P21554/)")
st.markdown(f"Protein symbol: CNR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21554') ]
