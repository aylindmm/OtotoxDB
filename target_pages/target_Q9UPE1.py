...
st.set_page_config(page_title="SRPK3", layout="wide")
st.title("SRSF protein kinase 3")
st.markdown(f"Uniprot ID: [Q9UPE1](https://www.uniprot.org/uniprotkb/Q9UPE1/)")
st.markdown(f"Protein symbol: SRPK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UPE1') ]
