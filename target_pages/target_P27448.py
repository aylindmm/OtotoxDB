...
st.set_page_config(page_title="MARK3", layout="wide")
st.title("MAP/microtubule affinity-regulating kinase 3")
st.markdown(f"Uniprot ID: [P27448](https://www.uniprot.org/uniprotkb/P27448/)")
st.markdown(f"Protein symbol: MARK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27448') ]
