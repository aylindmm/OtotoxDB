...
st.set_page_config(page_title="EGLN2", layout="wide")
st.title("Prolyl hydroxylase EGLN2")
st.markdown(f"Uniprot ID: [Q96KS0](https://www.uniprot.org/uniprotkb/Q96KS0/)")
st.markdown(f"Protein symbol: EGLN2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96KS0') ]
