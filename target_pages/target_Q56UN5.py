...
st.set_page_config(page_title="M3K19", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 19")
st.markdown(f"Uniprot ID: [Q56UN5](https://www.uniprot.org/uniprotkb/Q56UN5/)")
st.markdown(f"Protein symbol: M3K19")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q56UN5') ]
