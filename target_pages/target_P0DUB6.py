...
st.set_page_config(page_title="AMY1A", layout="wide")
st.title("Alpha-amylase 1A")
st.markdown(f"Uniprot ID: [P0DUB6](https://www.uniprot.org/uniprotkb/P0DUB6/)")
st.markdown(f"Protein symbol: AMY1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P0DUB6') ]
