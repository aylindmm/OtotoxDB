...
st.set_page_config(page_title="FOLC", layout="wide")
st.title("Folylpolyglutamate synthase, mitochondrial")
st.markdown(f"Uniprot ID: [Q05932](https://www.uniprot.org/uniprotkb/Q05932/)")
st.markdown(f"Protein symbol: FOLC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q05932') ]
