...
st.set_page_config(page_title="PTK6", layout="wide")
st.title("Protein-tyrosine kinase 6")
st.markdown(f"Uniprot ID: [Q13882](https://www.uniprot.org/uniprotkb/Q13882/)")
st.markdown(f"Protein symbol: PTK6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13882') ]
