...
st.set_page_config(page_title="FPR2", layout="wide")
st.title("N-formyl peptide receptor 2")
st.markdown(f"Uniprot ID: [P25090](https://www.uniprot.org/uniprotkb/P25090/)")
st.markdown(f"Protein symbol: FPR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25090') ]
