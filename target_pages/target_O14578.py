...
st.set_page_config(page_title="CTRO", layout="wide")
st.title("Citron Rho-interacting kinase")
st.markdown(f"Uniprot ID: [O14578](https://www.uniprot.org/uniprotkb/O14578/)")
st.markdown(f"Protein symbol: CTRO")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14578') ]
