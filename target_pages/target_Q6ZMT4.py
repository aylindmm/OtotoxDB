...
st.set_page_config(page_title="KDM7A", layout="wide")
st.title("Lysine-specific demethylase 7A")
st.markdown(f"Uniprot ID: [Q6ZMT4](https://www.uniprot.org/uniprotkb/Q6ZMT4/)")
st.markdown(f"Protein symbol: KDM7A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q6ZMT4') ]
