...
st.set_page_config(page_title="PAK4", layout="wide")
st.title("Serine/threonine-protein kinase PAK 4")
st.markdown(f"Uniprot ID: [O96013](https://www.uniprot.org/uniprotkb/O96013/)")
st.markdown(f"Protein symbol: PAK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O96013') ]
