...
st.set_page_config(page_title="BMX", layout="wide")
st.title("Cytoplasmic tyrosine-protein kinase BMX")
st.markdown(f"Uniprot ID: [P51813](https://www.uniprot.org/uniprotkb/P51813/)")
st.markdown(f"Protein symbol: BMX")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51813') ]
