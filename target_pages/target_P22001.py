...
st.set_page_config(page_title="KCNA3", layout="wide")
st.title("Potassium voltage-gated channel subfamily A member 3")
st.markdown(f"Uniprot ID: [P22001](https://www.uniprot.org/uniprotkb/P22001/)")
st.markdown(f"Protein symbol: KCNA3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22001') ]
