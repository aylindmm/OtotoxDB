...
st.set_page_config(page_title="VCAM1", layout="wide")
st.title("Vascular cell adhesion protein 1")
st.markdown(f"Uniprot ID: [P19320](https://www.uniprot.org/uniprotkb/P19320/)")
st.markdown(f"Protein symbol: VCAM1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19320') ]
