...
st.set_page_config(page_title="NR4A2", layout="wide")
st.title("Nuclear receptor subfamily 4 group A member 2")
st.markdown(f"Uniprot ID: [P43354](https://www.uniprot.org/uniprotkb/P43354/)")
st.markdown(f"Protein symbol: NR4A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43354') ]
