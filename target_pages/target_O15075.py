...
st.set_page_config(page_title="DCLK1", layout="wide")
st.title("Serine/threonine-protein kinase DCLK1")
st.markdown(f"Uniprot ID: [O15075](https://www.uniprot.org/uniprotkb/O15075/)")
st.markdown(f"Protein symbol: DCLK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15075') ]
