...
st.set_page_config(page_title="SIK1", layout="wide")
st.title("Serine/threonine-protein kinase SIK1")
st.markdown(f"Uniprot ID: [P57059](https://www.uniprot.org/uniprotkb/P57059/)")
st.markdown(f"Protein symbol: SIK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P57059') ]
