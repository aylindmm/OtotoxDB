...
st.set_page_config(page_title="S22A7", layout="wide")
st.title("Solute carrier family 22 member 7")
st.markdown(f"Uniprot ID: [Q9Y694](https://www.uniprot.org/uniprotkb/Q9Y694/)")
st.markdown(f"Protein symbol: S22A7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y694') ]
