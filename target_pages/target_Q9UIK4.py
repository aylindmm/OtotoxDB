...
st.set_page_config(page_title="DAPK2", layout="wide")
st.title("Death-associated protein kinase 2")
st.markdown(f"Uniprot ID: [Q9UIK4](https://www.uniprot.org/uniprotkb/Q9UIK4/)")
st.markdown(f"Protein symbol: DAPK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UIK4') ]
