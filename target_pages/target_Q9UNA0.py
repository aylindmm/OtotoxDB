...
st.set_page_config(page_title="ATS5", layout="wide")
st.title("A disintegrin and metalloproteinase with thrombospondin motifs 5")
st.markdown(f"Uniprot ID: [Q9UNA0](https://www.uniprot.org/uniprotkb/Q9UNA0/)")
st.markdown(f"Protein symbol: ATS5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UNA0') ]
