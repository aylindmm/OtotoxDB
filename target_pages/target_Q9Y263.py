...
st.set_page_config(page_title="PLAP", layout="wide")
st.title("Phospholipase A-2-activating protein")
st.markdown(f"Uniprot ID: [Q9Y263](https://www.uniprot.org/uniprotkb/Q9Y263/)")
st.markdown(f"Protein symbol: PLAP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y263') ]
