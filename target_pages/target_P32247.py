...
st.set_page_config(page_title="BRS3", layout="wide")
st.title("Bombesin receptor subtype-3")
st.markdown(f"Uniprot ID: [P32247](https://www.uniprot.org/uniprotkb/P32247/)")
st.markdown(f"Protein symbol: BRS3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32247') ]
