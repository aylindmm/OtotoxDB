...
st.set_page_config(page_title="UBC9", layout="wide")
st.title("SUMO-conjugating enzyme UBC9")
st.markdown(f"Uniprot ID: [P63279](https://www.uniprot.org/uniprotkb/P63279/)")
st.markdown(f"Protein symbol: UBC9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P63279') ]
