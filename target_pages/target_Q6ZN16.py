...
st.set_page_config(page_title="M3K15", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 15")
st.markdown(f"Uniprot ID: [Q6ZN16](https://www.uniprot.org/uniprotkb/Q6ZN16/)")
st.markdown(f"Protein symbol: M3K15")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q6ZN16') ]
