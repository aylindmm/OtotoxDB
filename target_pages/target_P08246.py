...
st.set_page_config(page_title="ELNE", layout="wide")
st.title("Neutrophil elastase")
st.markdown(f"Uniprot ID: [P08246](https://www.uniprot.org/uniprotkb/P08246/)")
st.markdown(f"Protein symbol: ELNE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08246') ]
