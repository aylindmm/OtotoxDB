...
st.set_page_config(page_title="COQ8B", layout="wide")
st.title("Atypical kinase COQ8B, mitochondrial")
st.markdown(f"Uniprot ID: [Q96D53](https://www.uniprot.org/uniprotkb/Q96D53/)")
st.markdown(f"Protein symbol: COQ8B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96D53') ]
