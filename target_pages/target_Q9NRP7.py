...
st.set_page_config(page_title="STK36", layout="wide")
st.title("Serine/threonine-protein kinase 36")
st.markdown(f"Uniprot ID: [Q9NRP7](https://www.uniprot.org/uniprotkb/Q9NRP7/)")
st.markdown(f"Protein symbol: STK36")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NRP7') ]
