...
st.set_page_config(page_title="NMDZ1", layout="wide")
st.title("Glutamate receptor ionotropic, NMDA 1/2B")
st.markdown(f"Uniprot ID: [Q05586](https://www.uniprot.org/uniprotkb/Q05586/)")
st.markdown(f"Protein symbol: NMDZ1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q05586') ]
