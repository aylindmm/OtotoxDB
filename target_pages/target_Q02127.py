...
st.set_page_config(page_title="PYRD", layout="wide")
st.title("Dihydroorotate dehydrogenase (quinone), mitochondrial")
st.markdown(f"Uniprot ID: [Q02127](https://www.uniprot.org/uniprotkb/Q02127/)")
st.markdown(f"Protein symbol: PYRD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02127') ]
