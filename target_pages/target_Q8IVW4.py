...
st.set_page_config(page_title="CDKL3", layout="wide")
st.title("Cyclin-dependent kinase-like 3")
st.markdown(f"Uniprot ID: [Q8IVW4](https://www.uniprot.org/uniprotkb/Q8IVW4/)")
st.markdown(f"Protein symbol: CDKL3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IVW4') ]
