...
st.set_page_config(page_title="DYR1A", layout="wide")
st.title("Dual specificity tyrosine-phosphorylation-regulated kinase 1A")
st.markdown(f"Uniprot ID: [Q13627](https://www.uniprot.org/uniprotkb/Q13627/)")
st.markdown(f"Protein symbol: DYR1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13627') ]
