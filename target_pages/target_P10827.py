...
st.set_page_config(page_title="THA", layout="wide")
st.title("Thyroid hormone receptor alpha")
st.markdown(f"Uniprot ID: [P10827](https://www.uniprot.org/uniprotkb/P10827/)")
st.markdown(f"Protein symbol: THA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P10827') ]
