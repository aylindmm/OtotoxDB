...
st.set_page_config(page_title="GPR18", layout="wide")
st.title("N-arachidonyl glycine receptor")
st.markdown(f"Uniprot ID: [Q14330](https://www.uniprot.org/uniprotkb/Q14330/)")
st.markdown(f"Protein symbol: GPR18")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14330') ]
