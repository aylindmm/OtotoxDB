...
st.set_page_config(page_title="E2AK2", layout="wide")
st.title("Interferon-induced, double-stranded RNA-activated protein kinase")
st.markdown(f"Uniprot ID: [P19525](https://www.uniprot.org/uniprotkb/P19525/)")
st.markdown(f"Protein symbol: E2AK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19525') ]
