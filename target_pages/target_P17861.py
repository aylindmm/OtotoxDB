...
st.set_page_config(page_title="XBP1", layout="wide")
st.title("X-box-binding protein 1")
st.markdown(f"Uniprot ID: [P17861](https://www.uniprot.org/uniprotkb/P17861/)")
st.markdown(f"Protein symbol: XBP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P17861') ]
