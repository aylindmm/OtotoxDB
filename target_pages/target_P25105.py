...
st.set_page_config(page_title="PTAFR", layout="wide")
st.title("Platelet-activating factor receptor")
st.markdown(f"Uniprot ID: [P25105](https://www.uniprot.org/uniprotkb/P25105/)")
st.markdown(f"Protein symbol: PTAFR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25105') ]
