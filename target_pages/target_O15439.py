...
st.set_page_config(page_title="MRP4", layout="wide")
st.title("ATP-binding cassette sub-family C member 4")
st.markdown(f"Uniprot ID: [O15439](https://www.uniprot.org/uniprotkb/O15439/)")
st.markdown(f"Protein symbol: MRP4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15439') ]
