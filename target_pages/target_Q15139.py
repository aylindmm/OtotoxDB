...
st.set_page_config(page_title="KPCD1", layout="wide")
st.title("Serine/threonine-protein kinase D1")
st.markdown(f"Uniprot ID: [Q15139](https://www.uniprot.org/uniprotkb/Q15139/)")
st.markdown(f"Protein symbol: KPCD1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15139') ]
