...
st.set_page_config(page_title="EGFR", layout="wide")
st.title("Epidermal growth factor receptor [G719C]")
st.markdown(f"Uniprot ID: [P00533](https://www.uniprot.org/uniprotkb/P00533/)")
st.markdown(f"Protein symbol: EGFR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00533') ]
