...
st.set_page_config(page_title="TLK2", layout="wide")
st.title("Serine/threonine-protein kinase tousled-like 2")
st.markdown(f"Uniprot ID: [Q86UE8](https://www.uniprot.org/uniprotkb/Q86UE8/)")
st.markdown(f"Protein symbol: TLK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86UE8') ]
