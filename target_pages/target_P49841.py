...
st.set_page_config(page_title="GSK3B", layout="wide")
st.title("Glycogen synthase kinase-3 beta")
st.markdown(f"Uniprot ID: [P49841](https://www.uniprot.org/uniprotkb/P49841/)")
st.markdown(f"Protein symbol: GSK3B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49841') ]
