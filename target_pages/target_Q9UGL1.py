...
st.set_page_config(page_title="KDM5B", layout="wide")
st.title("Lysine-specific demethylase 5B")
st.markdown(f"Uniprot ID: [Q9UGL1](https://www.uniprot.org/uniprotkb/Q9UGL1/)")
st.markdown(f"Protein symbol: KDM5B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UGL1') ]
