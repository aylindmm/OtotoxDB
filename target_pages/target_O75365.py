...
st.set_page_config(page_title="TP4A3", layout="wide")
st.title("Protein tyrosine phosphatase type IVA 3")
st.markdown(f"Uniprot ID: [O75365](https://www.uniprot.org/uniprotkb/O75365/)")
st.markdown(f"Protein symbol: TP4A3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75365') ]
