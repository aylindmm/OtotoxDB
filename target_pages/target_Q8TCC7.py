...
st.set_page_config(page_title="S22A8", layout="wide")
st.title("Solute carrier family 22 member 8")
st.markdown(f"Uniprot ID: [Q8TCC7](https://www.uniprot.org/uniprotkb/Q8TCC7/)")
st.markdown(f"Protein symbol: S22A8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TCC7') ]
