...
st.set_page_config(page_title="EPHA5", layout="wide")
st.title("Ephrin type-A receptor 5")
st.markdown(f"Uniprot ID: [P54756](https://www.uniprot.org/uniprotkb/P54756/)")
st.markdown(f"Protein symbol: EPHA5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P54756') ]
