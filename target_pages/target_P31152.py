...
st.set_page_config(page_title="MK04", layout="wide")
st.title("Mitogen-activated protein kinase 4")
st.markdown(f"Uniprot ID: [P31152](https://www.uniprot.org/uniprotkb/P31152/)")
st.markdown(f"Protein symbol: MK04")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P31152') ]
