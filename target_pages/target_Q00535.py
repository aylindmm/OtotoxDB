...
st.set_page_config(page_title="CDK5", layout="wide")
st.title("Cyclin-dependent kinase 5")
st.markdown(f"Uniprot ID: [Q00535](https://www.uniprot.org/uniprotkb/Q00535/)")
st.markdown(f"Protein symbol: CDK5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00535') ]
