...
st.set_page_config(page_title="MARK2", layout="wide")
st.title("Serine/threonine-protein kinase MARK2")
st.markdown(f"Uniprot ID: [Q7KZI7](https://www.uniprot.org/uniprotkb/Q7KZI7/)")
st.markdown(f"Protein symbol: MARK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q7KZI7') ]
