...
st.set_page_config(page_title="KCC2A", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase type II subunit alpha")
st.markdown(f"Uniprot ID: [Q9UQM7](https://www.uniprot.org/uniprotkb/Q9UQM7/)")
st.markdown(f"Protein symbol: KCC2A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UQM7') ]
