...
st.set_page_config(page_title="SCNNA", layout="wide")
st.title("Amiloride-sensitive sodium channel subunit alpha")
st.markdown(f"Uniprot ID: [P37088](https://www.uniprot.org/uniprotkb/P37088/)")
st.markdown(f"Protein symbol: SCNNA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P37088') ]
