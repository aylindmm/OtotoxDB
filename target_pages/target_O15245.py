...
st.set_page_config(page_title="S22A1", layout="wide")
st.title("Solute carrier family 22 member 1")
st.markdown(f"Uniprot ID: [O15245](https://www.uniprot.org/uniprotkb/O15245/)")
st.markdown(f"Protein symbol: S22A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15245') ]
