...
st.set_page_config(page_title="PHKG2", layout="wide")
st.title("Phosphorylase b kinase gamma catalytic chain, liver/testis isoform")
st.markdown(f"Uniprot ID: [P15735](https://www.uniprot.org/uniprotkb/P15735/)")
st.markdown(f"Protein symbol: PHKG2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P15735') ]
