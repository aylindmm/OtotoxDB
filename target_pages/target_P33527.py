...
st.set_page_config(page_title="MRP1", layout="wide")
st.title("Multidrug resistance-associated protein 1")
st.markdown(f"Uniprot ID: [P33527](https://www.uniprot.org/uniprotkb/P33527/)")
st.markdown(f"Protein symbol: MRP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P33527') ]
