...
st.set_page_config(page_title="UBP47", layout="wide")
st.title("Ubiquitin carboxyl-terminal hydrolase 47")
st.markdown(f"Uniprot ID: [Q96K76](https://www.uniprot.org/uniprotkb/Q96K76/)")
st.markdown(f"Protein symbol: UBP47")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96K76') ]
