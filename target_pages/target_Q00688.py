...
st.set_page_config(page_title="FKBP3", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase FKBP3")
st.markdown(f"Uniprot ID: [Q00688](https://www.uniprot.org/uniprotkb/Q00688/)")
st.markdown(f"Protein symbol: FKBP3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00688') ]
