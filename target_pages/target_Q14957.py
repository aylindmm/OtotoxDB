...
st.set_page_config(page_title="NMDE3", layout="wide")
st.title("Glutamate receptor ionotropic, NMDA 2C")
st.markdown(f"Uniprot ID: [Q14957](https://www.uniprot.org/uniprotkb/Q14957/)")
st.markdown(f"Protein symbol: NMDE3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q14957') ]
