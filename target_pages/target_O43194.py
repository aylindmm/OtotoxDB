...
st.set_page_config(page_title="GPR39", layout="wide")
st.title("G-protein coupled receptor 39")
st.markdown(f"Uniprot ID: [O43194](https://www.uniprot.org/uniprotkb/O43194/)")
st.markdown(f"Protein symbol: GPR39")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43194') ]
