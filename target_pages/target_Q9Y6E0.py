...
st.set_page_config(page_title="STK24", layout="wide")
st.title("Serine/threonine-protein kinase 24")
st.markdown(f"Uniprot ID: [Q9Y6E0](https://www.uniprot.org/uniprotkb/Q9Y6E0/)")
st.markdown(f"Protein symbol: STK24")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y6E0') ]
