...
st.set_page_config(page_title="DAPK3", layout="wide")
st.title("Death-associated protein kinase 3")
st.markdown(f"Uniprot ID: [O43293](https://www.uniprot.org/uniprotkb/O43293/)")
st.markdown(f"Protein symbol: DAPK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43293') ]
