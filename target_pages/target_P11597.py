...
st.set_page_config(page_title="CETP", layout="wide")
st.title("Cholesteryl ester transfer protein")
st.markdown(f"Uniprot ID: [P11597](https://www.uniprot.org/uniprotkb/P11597/)")
st.markdown(f"Protein symbol: CETP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11597') ]
