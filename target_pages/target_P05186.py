...
st.set_page_config(page_title="PPBT", layout="wide")
st.title("Alkaline phosphatase, tissue-nonspecific isozyme")
st.markdown(f"Uniprot ID: [P05186](https://www.uniprot.org/uniprotkb/P05186/)")
st.markdown(f"Protein symbol: PPBT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05186') ]
