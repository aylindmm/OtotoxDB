...
st.set_page_config(page_title="NCOA2", layout="wide")
st.title("Nuclear receptor coactivator 2")
st.markdown(f"Uniprot ID: [Q15596](https://www.uniprot.org/uniprotkb/Q15596/)")
st.markdown(f"Protein symbol: NCOA2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15596') ]
