...
st.set_page_config(page_title="ACM3", layout="wide")
st.title("Muscarinic acetylcholine receptor M3")
st.markdown(f"Uniprot ID: [P20309](https://www.uniprot.org/uniprotkb/P20309/)")
st.markdown(f"Protein symbol: ACM3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P20309') ]
