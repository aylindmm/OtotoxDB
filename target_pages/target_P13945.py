...
st.set_page_config(page_title="ADRB3", layout="wide")
st.title("Beta-3 adrenergic receptor")
st.markdown(f"Uniprot ID: [P13945](https://www.uniprot.org/uniprotkb/P13945/)")
st.markdown(f"Protein symbol: ADRB3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P13945') ]
