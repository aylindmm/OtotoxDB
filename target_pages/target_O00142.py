...
st.set_page_config(page_title="KITM", layout="wide")
st.title("Thymidine kinase 2, mitochondrial")
st.markdown(f"Uniprot ID: [O00142](https://www.uniprot.org/uniprotkb/O00142/)")
st.markdown(f"Protein symbol: KITM")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00142') ]
