...
st.set_page_config(page_title="EP300", layout="wide")
st.title("Histone acetyltransferase p300")
st.markdown(f"Uniprot ID: [Q09472](https://www.uniprot.org/uniprotkb/Q09472/)")
st.markdown(f"Protein symbol: EP300")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q09472') ]
