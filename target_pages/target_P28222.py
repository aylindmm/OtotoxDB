...
st.set_page_config(page_title="5HT1B", layout="wide")
st.title("5-hydroxytryptamine receptor 1B")
st.markdown(f"Uniprot ID: [P28222](https://www.uniprot.org/uniprotkb/P28222/)")
st.markdown(f"Protein symbol: 5HT1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28222') ]
