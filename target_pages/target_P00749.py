...
st.set_page_config(page_title="UROK", layout="wide")
st.title("Urokinase-type plasminogen activator")
st.markdown(f"Uniprot ID: [P00749](https://www.uniprot.org/uniprotkb/P00749/)")
st.markdown(f"Protein symbol: UROK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00749') ]
