...
st.set_page_config(page_title="ACE", layout="wide")
st.title("Angiotensin-converting enzyme")
st.markdown(f"Uniprot ID: [P12821](https://www.uniprot.org/uniprotkb/P12821/)")
st.markdown(f"Protein symbol: ACE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P12821') ]
