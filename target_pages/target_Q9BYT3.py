...
st.set_page_config(page_title="STK33", layout="wide")
st.title("Serine/threonine-protein kinase 33")
st.markdown(f"Uniprot ID: [Q9BYT3](https://www.uniprot.org/uniprotkb/Q9BYT3/)")
st.markdown(f"Protein symbol: STK33")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BYT3') ]
