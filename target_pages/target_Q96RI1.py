...
st.set_page_config(page_title="NR1H4", layout="wide")
st.title("Bile acid receptor")
st.markdown(f"Uniprot ID: [Q96RI1](https://www.uniprot.org/uniprotkb/Q96RI1/)")
st.markdown(f"Protein symbol: NR1H4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96RI1') ]
