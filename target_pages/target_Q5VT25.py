...
st.set_page_config(page_title="MRCKA", layout="wide")
st.title("Serine/threonine-protein kinase MRCK alpha")
st.markdown(f"Uniprot ID: [Q5VT25](https://www.uniprot.org/uniprotkb/Q5VT25/)")
st.markdown(f"Protein symbol: MRCKA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q5VT25') ]
