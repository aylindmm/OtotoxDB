...
st.set_page_config(page_title="DHI2", layout="wide")
st.title("11-beta-hydroxysteroid dehydrogenase type 2")
st.markdown(f"Uniprot ID: [P80365](https://www.uniprot.org/uniprotkb/P80365/)")
st.markdown(f"Protein symbol: DHI2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P80365') ]
