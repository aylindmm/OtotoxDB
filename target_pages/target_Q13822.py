...
st.set_page_config(page_title="ENPP2", layout="wide")
st.title("Ectonucleotide pyrophosphatase/phosphodiesterase family member 2")
st.markdown(f"Uniprot ID: [Q13822](https://www.uniprot.org/uniprotkb/Q13822/)")
st.markdown(f"Protein symbol: ENPP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13822') ]
