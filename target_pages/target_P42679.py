...
st.set_page_config(page_title="MATK", layout="wide")
st.title("Megakaryocyte-associated tyrosine-protein kinase")
st.markdown(f"Uniprot ID: [P42679](https://www.uniprot.org/uniprotkb/P42679/)")
st.markdown(f"Protein symbol: MATK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42679') ]
