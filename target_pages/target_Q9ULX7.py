...
st.set_page_config(page_title="CAH14", layout="wide")
st.title("Carbonic anhydrase 14")
st.markdown(f"Uniprot ID: [Q9ULX7](https://www.uniprot.org/uniprotkb/Q9ULX7/)")
st.markdown(f"Protein symbol: CAH14")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9ULX7') ]
