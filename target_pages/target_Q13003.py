...
st.set_page_config(page_title="GRIK3", layout="wide")
st.title("Glutamate receptor ionotropic, kainate 3")
st.markdown(f"Uniprot ID: [Q13003](https://www.uniprot.org/uniprotkb/Q13003/)")
st.markdown(f"Protein symbol: GRIK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13003') ]
