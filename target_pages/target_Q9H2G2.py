...
st.set_page_config(page_title="SLK", layout="wide")
st.title("STE20-like serine/threonine-protein kinase")
st.markdown(f"Uniprot ID: [Q9H2G2](https://www.uniprot.org/uniprotkb/Q9H2G2/)")
st.markdown(f"Protein symbol: SLK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H2G2') ]
