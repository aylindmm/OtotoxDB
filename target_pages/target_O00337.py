...
st.set_page_config(page_title="S28A1", layout="wide")
st.title("Sodium/nucleoside cotransporter 1")
st.markdown(f"Uniprot ID: [O00337](https://www.uniprot.org/uniprotkb/O00337/)")
st.markdown(f"Protein symbol: S28A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00337') ]
