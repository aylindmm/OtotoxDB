...
st.set_page_config(page_title="GRB2", layout="wide")
st.title("Growth factor receptor-bound protein 2")
st.markdown(f"Uniprot ID: [P62993](https://www.uniprot.org/uniprotkb/P62993/)")
st.markdown(f"Protein symbol: GRB2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P62993') ]
