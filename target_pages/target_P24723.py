...
st.set_page_config(page_title="KPCL", layout="wide")
st.title("Protein kinase C eta type")
st.markdown(f"Uniprot ID: [P24723](https://www.uniprot.org/uniprotkb/P24723/)")
st.markdown(f"Protein symbol: KPCL")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24723') ]
