...
st.set_page_config(page_title="CAH9", layout="wide")
st.title("Carbonic anhydrase 9")
st.markdown(f"Uniprot ID: [Q16790](https://www.uniprot.org/uniprotkb/Q16790/)")
st.markdown(f"Protein symbol: CAH9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16790') ]
