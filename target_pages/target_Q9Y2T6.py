...
st.set_page_config(page_title="GPR55", layout="wide")
st.title("G-protein coupled receptor 55")
st.markdown(f"Uniprot ID: [Q9Y2T6](https://www.uniprot.org/uniprotkb/Q9Y2T6/)")
st.markdown(f"Protein symbol: GPR55")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2T6') ]
