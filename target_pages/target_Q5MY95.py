...
st.set_page_config(page_title="ENTP8", layout="wide")
st.title("Ectonucleoside triphosphate diphosphohydrolase 8")
st.markdown(f"Uniprot ID: [Q5MY95](https://www.uniprot.org/uniprotkb/Q5MY95/)")
st.markdown(f"Protein symbol: ENTP8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q5MY95') ]
