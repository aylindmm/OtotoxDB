...
st.set_page_config(page_title="MAST1", layout="wide")
st.title("Microtubule-associated serine/threonine-protein kinase 1")
st.markdown(f"Uniprot ID: [Q9Y2H9](https://www.uniprot.org/uniprotkb/Q9Y2H9/)")
st.markdown(f"Protein symbol: MAST1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y2H9') ]
