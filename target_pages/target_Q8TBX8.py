...
st.set_page_config(page_title="PI42C", layout="wide")
st.title("Phosphatidylinositol 5-phosphate 4-kinase type-2 gamma")
st.markdown(f"Uniprot ID: [Q8TBX8](https://www.uniprot.org/uniprotkb/Q8TBX8/)")
st.markdown(f"Protein symbol: PI42C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TBX8') ]
