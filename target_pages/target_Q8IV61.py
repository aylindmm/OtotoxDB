...
st.set_page_config(page_title="GRP3", layout="wide")
st.title("Ras guanyl-releasing protein 3")
st.markdown(f"Uniprot ID: [Q8IV61](https://www.uniprot.org/uniprotkb/Q8IV61/)")
st.markdown(f"Protein symbol: GRP3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IV61') ]
