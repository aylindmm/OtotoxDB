...
st.set_page_config(page_title="HDAC8", layout="wide")
st.title("Histone deacetylase 8")
st.markdown(f"Uniprot ID: [Q9BY41](https://www.uniprot.org/uniprotkb/Q9BY41/)")
st.markdown(f"Protein symbol: HDAC8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BY41') ]
