...
st.set_page_config(page_title="M4K1", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase kinase 1")
st.markdown(f"Uniprot ID: [Q92918](https://www.uniprot.org/uniprotkb/Q92918/)")
st.markdown(f"Protein symbol: M4K1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92918') ]
