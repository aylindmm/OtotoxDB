...
st.set_page_config(page_title="B2CL2", layout="wide")
st.title("Bcl-2-like protein 2")
st.markdown(f"Uniprot ID: [Q92843](https://www.uniprot.org/uniprotkb/Q92843/)")
st.markdown(f"Protein symbol: B2CL2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92843') ]
