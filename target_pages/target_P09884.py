...
st.set_page_config(page_title="DPOLA", layout="wide")
st.title("DNA polymerase alpha catalytic subunit")
st.markdown(f"Uniprot ID: [P09884](https://www.uniprot.org/uniprotkb/P09884/)")
st.markdown(f"Protein symbol: DPOLA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09884') ]
