...
st.set_page_config(page_title="CDD", layout="wide")
st.title("Cytidine deaminase")
st.markdown(f"Uniprot ID: [P32320](https://www.uniprot.org/uniprotkb/P32320/)")
st.markdown(f"Protein symbol: CDD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32320') ]
