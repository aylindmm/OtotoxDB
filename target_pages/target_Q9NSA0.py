...
st.set_page_config(page_title="S22AB", layout="wide")
st.title("Solute carrier family 22 member 11")
st.markdown(f"Uniprot ID: [Q9NSA0](https://www.uniprot.org/uniprotkb/Q9NSA0/)")
st.markdown(f"Protein symbol: S22AB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NSA0') ]
