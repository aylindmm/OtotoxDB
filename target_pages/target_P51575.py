...
st.set_page_config(page_title="P2RX1", layout="wide")
st.title("P2X purinoceptor 1")
st.markdown(f"Uniprot ID: [P51575](https://www.uniprot.org/uniprotkb/P51575/)")
st.markdown(f"Protein symbol: P2RX1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51575') ]
