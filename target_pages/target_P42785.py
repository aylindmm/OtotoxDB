...
st.title("Lysosomal Pro-X carboxypeptidase")
st.markdown(f"Uniprot ID: [P42785](https://www.uniprot.org/uniprotkb/P42785/)")
st.markdown(f"Protein symbol: PCP")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42785') ]
