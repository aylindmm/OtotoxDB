...
st.set_page_config(page_title="SBK1", layout="wide")
st.title("Serine/threonine-protein kinase SBK1")
st.markdown(f"Uniprot ID: [Q52WX2](https://www.uniprot.org/uniprotkb/Q52WX2/)")
st.markdown(f"Protein symbol: SBK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q52WX2') ]
