...
st.set_page_config(page_title="MK13", layout="wide")
st.title("Mitogen-activated protein kinase 13")
st.markdown(f"Uniprot ID: [O15264](https://www.uniprot.org/uniprotkb/O15264/)")
st.markdown(f"Protein symbol: MK13")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15264') ]
