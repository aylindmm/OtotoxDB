...
st.set_page_config(page_title="HDAC1", layout="wide")
st.title("Histone deacetylase 1/2/3/8")
st.markdown(f"Uniprot ID: [Q13547](https://www.uniprot.org/uniprotkb/Q13547/)")
st.markdown(f"Protein symbol: HDAC1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13547') ]
