...
st.set_page_config(page_title="KCC1D", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase type 1D")
st.markdown(f"Uniprot ID: [Q8IU85](https://www.uniprot.org/uniprotkb/Q8IU85/)")
st.markdown(f"Protein symbol: KCC1D")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8IU85') ]
