...
st.set_page_config(page_title="RXRA", layout="wide")
st.title("Retinoic acid receptor RXR-alpha")
st.markdown(f"Uniprot ID: [P19793](https://www.uniprot.org/uniprotkb/P19793/)")
st.markdown(f"Protein symbol: RXRA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19793') ]
