...
st.set_page_config(page_title="STK25", layout="wide")
st.title("Serine/threonine-protein kinase 25")
st.markdown(f"Uniprot ID: [O00506](https://www.uniprot.org/uniprotkb/O00506/)")
st.markdown(f"Protein symbol: STK25")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00506') ]
