...
st.set_page_config(page_title="MP2K4", layout="wide")
st.title("Dual specificity mitogen-activated protein kinase kinase 4")
st.markdown(f"Uniprot ID: [P45985](https://www.uniprot.org/uniprotkb/P45985/)")
st.markdown(f"Protein symbol: MP2K4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P45985') ]
