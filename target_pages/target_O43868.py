...
st.set_page_config(page_title="S28A2", layout="wide")
st.title("Sodium/nucleoside cotransporter 2")
st.markdown(f"Uniprot ID: [O43868](https://www.uniprot.org/uniprotkb/O43868/)")
st.markdown(f"Protein symbol: S28A2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43868') ]
