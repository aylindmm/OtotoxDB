...
st.set_page_config(page_title="PPID", layout="wide")
st.title("Peptidyl-prolyl cis-trans isomerase D")
st.markdown(f"Uniprot ID: [Q08752](https://www.uniprot.org/uniprotkb/Q08752/)")
st.markdown(f"Protein symbol: PPID")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q08752') ]
