...
st.set_page_config(page_title="CLK2", layout="wide")
st.title("Dual specificity protein kinase CLK2")
st.markdown(f"Uniprot ID: [P49760](https://www.uniprot.org/uniprotkb/P49760/)")
st.markdown(f"Protein symbol: CLK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49760') ]
