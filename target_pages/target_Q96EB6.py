...
st.set_page_config(page_title="SIR1", layout="wide")
st.title("NAD-dependent protein deacetylase sirtuin-1")
st.markdown(f"Uniprot ID: [Q96EB6](https://www.uniprot.org/uniprotkb/Q96EB6/)")
st.markdown(f"Protein symbol: SIR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96EB6') ]
