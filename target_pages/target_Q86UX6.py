...
st.set_page_config(page_title="ST32C", layout="wide")
st.title("Serine/threonine-protein kinase 32C")
st.markdown(f"Uniprot ID: [Q86UX6](https://www.uniprot.org/uniprotkb/Q86UX6/)")
st.markdown(f"Protein symbol: ST32C")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86UX6') ]
