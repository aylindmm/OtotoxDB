...
st.set_page_config(page_title="KCNQ2", layout="wide")
st.title("Potassium voltage-gated channel subfamily KQT member 2/3")
st.markdown(f"Uniprot ID: [O43526](https://www.uniprot.org/uniprotkb/O43526/)")
st.markdown(f"Protein symbol: KCNQ2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43526') ]
