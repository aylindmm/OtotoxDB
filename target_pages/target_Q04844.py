...
st.set_page_config(page_title="ACHE", layout="wide")
st.title("Acetylcholine receptor subunit epsilon")
st.markdown(f"Uniprot ID: [Q04844](https://www.uniprot.org/uniprotkb/Q04844/)")
st.markdown(f"Protein symbol: ACHE")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q04844') ]
