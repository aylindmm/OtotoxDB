...
st.set_page_config(page_title="NTRK2", layout="wide")
st.title("BDNF/NT-3 growth factors receptor")
st.markdown(f"Uniprot ID: [Q16620](https://www.uniprot.org/uniprotkb/Q16620/)")
st.markdown(f"Protein symbol: NTRK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16620') ]
