...
st.set_page_config(page_title="MP2K2", layout="wide")
st.title("Dual specificity mitogen-activated protein kinase kinase 2")
st.markdown(f"Uniprot ID: [P36507](https://www.uniprot.org/uniprotkb/P36507/)")
st.markdown(f"Protein symbol: MP2K2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P36507') ]
