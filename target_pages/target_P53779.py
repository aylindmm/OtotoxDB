...
st.set_page_config(page_title="MK10", layout="wide")
st.title("Mitogen-activated protein kinase 10/8/9")
st.markdown(f"Uniprot ID: [P53779](https://www.uniprot.org/uniprotkb/P53779/)")
st.markdown(f"Protein symbol: MK10")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53779') ]
