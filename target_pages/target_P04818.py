...
st.set_page_config(page_title="TYSY", layout="wide")
st.title("Thymidylate synthase")
st.markdown(f"Uniprot ID: [P04818](https://www.uniprot.org/uniprotkb/P04818/)")
st.markdown(f"Protein symbol: TYSY")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04818') ]
