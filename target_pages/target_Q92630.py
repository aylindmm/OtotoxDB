...
st.set_page_config(page_title="DYRK2", layout="wide")
st.title("Dual specificity tyrosine-phosphorylation-regulated kinase 2")
st.markdown(f"Uniprot ID: [Q92630](https://www.uniprot.org/uniprotkb/Q92630/)")
st.markdown(f"Protein symbol: DYRK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92630') ]
