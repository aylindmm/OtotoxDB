...
st.set_page_config(page_title="ABC3G", layout="wide")
st.title("DNA dC->dU-editing enzyme APOBEC-3G")
st.markdown(f"Uniprot ID: [Q9HC16](https://www.uniprot.org/uniprotkb/Q9HC16/)")
st.markdown(f"Protein symbol: ABC3G")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HC16') ]
