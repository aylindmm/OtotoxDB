...
st.set_page_config(page_title="PCFT", layout="wide")
st.title("Proton-coupled folate transporter")
st.markdown(f"Uniprot ID: [Q96NT5](https://www.uniprot.org/uniprotkb/Q96NT5/)")
st.markdown(f"Protein symbol: PCFT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96NT5') ]
