...
st.set_page_config(page_title="NOS2", layout="wide")
st.title("Nitric oxide synthase, inducible")
st.markdown(f"Uniprot ID: [P35228](https://www.uniprot.org/uniprotkb/P35228/)")
st.markdown(f"Protein symbol: NOS2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35228') ]
