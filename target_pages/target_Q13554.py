...
st.set_page_config(page_title="KCC2B", layout="wide")
st.title("Calcium/calmodulin-dependent protein kinase type II subunit beta")
st.markdown(f"Uniprot ID: [Q13554](https://www.uniprot.org/uniprotkb/Q13554/)")
st.markdown(f"Protein symbol: KCC2B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13554') ]
