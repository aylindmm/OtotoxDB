...
st.set_page_config(page_title="FPR1", layout="wide")
st.title("fMet-Leu-Phe receptor")
st.markdown(f"Uniprot ID: [P21462](https://www.uniprot.org/uniprotkb/P21462/)")
st.markdown(f"Protein symbol: FPR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21462') ]
