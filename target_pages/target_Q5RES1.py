...
st.set_page_config(page_title="MMP14_PONAB", layout="wide")
st.title("Matrix metalloproteinase-14 [1-36]")
st.markdown(f"Uniprot ID: [Q5RES1](https://www.uniprot.org/uniprotkb/Q5RES1/)")
st.markdown(f"Protein symbol: MMP14_PONAB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q5RES1') ]
