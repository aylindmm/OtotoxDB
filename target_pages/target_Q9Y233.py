...
st.set_page_config(page_title="PDE10", layout="wide")
st.title("cAMP and cAMP-inhibited cGMP 3',5'-cyclic phosphodiesterase 10A [432-779]")
st.markdown(f"Uniprot ID: [Q9Y233](https://www.uniprot.org/uniprotkb/Q9Y233/)")
st.markdown(f"Protein symbol: PDE10")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y233') ]
