...
st.set_page_config(page_title="HDAC3", layout="wide")
st.title("Histone deacetylase 3/Nuclear receptor corepressor 2 (HDAC3/NCoR2)")
st.markdown(f"Uniprot ID: [O15379](https://www.uniprot.org/uniprotkb/O15379/)")
st.markdown(f"Protein symbol: HDAC3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15379') ]
