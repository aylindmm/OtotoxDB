...
st.set_page_config(page_title="ACV1B", layout="wide")
st.title("Activin receptor type-1B")
st.markdown(f"Uniprot ID: [P36896](https://www.uniprot.org/uniprotkb/P36896/)")
st.markdown(f"Protein symbol: ACV1B")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P36896') ]
