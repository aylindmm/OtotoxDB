...
st.set_page_config(page_title="IF4E", layout="wide")
st.title("Eukaryotic translation initiation factor 4E")
st.markdown(f"Uniprot ID: [P06730](https://www.uniprot.org/uniprotkb/P06730/)")
st.markdown(f"Protein symbol: IF4E")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P06730') ]
