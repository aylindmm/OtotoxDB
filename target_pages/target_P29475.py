...
st.set_page_config(page_title="NOS1", layout="wide")
st.title("Nitric oxide synthase, brain")
st.markdown(f"Uniprot ID: [P29475](https://www.uniprot.org/uniprotkb/P29475/)")
st.markdown(f"Protein symbol: NOS1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P29475') ]
