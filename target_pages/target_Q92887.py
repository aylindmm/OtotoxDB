...
st.set_page_config(page_title="MRP2", layout="wide")
st.title("ATP-binding cassette sub-family C member 2")
st.markdown(f"Uniprot ID: [Q92887](https://www.uniprot.org/uniprotkb/Q92887/)")
st.markdown(f"Protein symbol: MRP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92887') ]
