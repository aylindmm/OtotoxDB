...
st.set_page_config(page_title="KDM6A", layout="wide")
st.title("Lysine-specific demethylase 6A")
st.markdown(f"Uniprot ID: [O15550](https://www.uniprot.org/uniprotkb/O15550/)")
st.markdown(f"Protein symbol: KDM6A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15550') ]
