...
st.set_page_config(page_title="CCNB1", layout="wide")
st.title("G2/mitotic-specific cyclin-B1")
st.markdown(f"Uniprot ID: [P14635](https://www.uniprot.org/uniprotkb/P14635/)")
st.markdown(f"Protein symbol: CCNB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14635') ]
