...
st.set_page_config(page_title="P2Y12", layout="wide")
st.title("P2Y purinoceptor 12")
st.markdown(f"Uniprot ID: [Q9H244](https://www.uniprot.org/uniprotkb/Q9H244/)")
st.markdown(f"Protein symbol: P2Y12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H244') ]
