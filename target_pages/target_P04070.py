...
st.set_page_config(page_title="PROC", layout="wide")
st.title("Vitamin K-dependent protein C")
st.markdown(f"Uniprot ID: [P04070](https://www.uniprot.org/uniprotkb/P04070/)")
st.markdown(f"Protein symbol: PROC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04070') ]
