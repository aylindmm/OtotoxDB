...
st.set_page_config(page_title="MYLK", layout="wide")
st.title("Myosin light chain kinase, smooth muscle")
st.markdown(f"Uniprot ID: [Q15746](https://www.uniprot.org/uniprotkb/Q15746/)")
st.markdown(f"Protein symbol: MYLK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15746') ]
