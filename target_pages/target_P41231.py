...
st.set_page_config(page_title="P2RY2", layout="wide")
st.title("P2Y purinoceptor 2")
st.markdown(f"Uniprot ID: [P41231](https://www.uniprot.org/uniprotkb/P41231/)")
st.markdown(f"Protein symbol: P2RY2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P41231') ]
