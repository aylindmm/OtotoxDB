...
st.set_page_config(page_title="KC1G2", layout="wide")
st.title("Casein kinase I isoform gamma-2")
st.markdown(f"Uniprot ID: [P78368](https://www.uniprot.org/uniprotkb/P78368/)")
st.markdown(f"Protein symbol: KC1G2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P78368') ]
