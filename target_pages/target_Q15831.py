...
st.set_page_config(page_title="STK11", layout="wide")
st.title("Serine/threonine-protein kinase STK11")
st.markdown(f"Uniprot ID: [Q15831](https://www.uniprot.org/uniprotkb/Q15831/)")
st.markdown(f"Protein symbol: STK11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15831') ]
