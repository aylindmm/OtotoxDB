...
st.set_page_config(page_title="KC1G3", layout="wide")
st.title("Casein kinase I isoform gamma-3")
st.markdown(f"Uniprot ID: [Q9Y6M4](https://www.uniprot.org/uniprotkb/Q9Y6M4/)")
st.markdown(f"Protein symbol: KC1G3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y6M4') ]
