...
st.set_page_config(page_title="PYGB", layout="wide")
st.title("Glycogen phosphorylase, brain form")
st.markdown(f"Uniprot ID: [P11216](https://www.uniprot.org/uniprotkb/P11216/)")
st.markdown(f"Protein symbol: PYGB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11216') ]
