...
st.set_page_config(page_title="MK01", layout="wide")
st.title("Mitogen-activated protein kinase 1/3")
st.markdown(f"Uniprot ID: [P28482](https://www.uniprot.org/uniprotkb/P28482/)")
st.markdown(f"Protein symbol: MK01")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P28482') ]
