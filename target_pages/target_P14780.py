...
st.set_page_config(page_title="MMP9", layout="wide")
st.title("Matrix metalloproteinase-9")
st.markdown(f"Uniprot ID: [P14780](https://www.uniprot.org/uniprotkb/P14780/)")
st.markdown(f"Protein symbol: MMP9")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14780') ]
