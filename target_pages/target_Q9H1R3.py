...
st.set_page_config(page_title="MYLK2", layout="wide")
st.title("Myosin light chain kinase 2, skeletal/cardiac muscle")
st.markdown(f"Uniprot ID: [Q9H1R3](https://www.uniprot.org/uniprotkb/Q9H1R3/)")
st.markdown(f"Protein symbol: MYLK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9H1R3') ]
