...
st.set_page_config(page_title="KAPCA", layout="wide")
st.title("cAMP-dependent protein kinase catalytic subunit alpha/beta/gamma")
st.markdown(f"Uniprot ID: [P17612](https://www.uniprot.org/uniprotkb/P17612/)")
st.markdown(f"Protein symbol: KAPCA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P17612') ]
