...
st.set_page_config(page_title="HMGB1", layout="wide")
st.title("High mobility group protein B1")
st.markdown(f"Uniprot ID: [P09429](https://www.uniprot.org/uniprotkb/P09429/)")
st.markdown(f"Protein symbol: HMGB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09429') ]
