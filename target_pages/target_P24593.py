...
st.set_page_config(page_title="IBP5", layout="wide")
st.title("Insulin-like growth factor-binding protein 5")
st.markdown(f"Uniprot ID: [P24593](https://www.uniprot.org/uniprotkb/P24593/)")
st.markdown(f"Protein symbol: IBP5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P24593') ]
