...
st.set_page_config(page_title="TGM2", layout="wide")
st.title("Protein-glutamine gamma-glutamyltransferase 2")
st.markdown(f"Uniprot ID: [P21980](https://www.uniprot.org/uniprotkb/P21980/)")
st.markdown(f"Protein symbol: TGM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21980') ]
