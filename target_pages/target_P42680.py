...
st.set_page_config(page_title="TEC", layout="wide")
st.title("Tyrosine-protein kinase Tec")
st.markdown(f"Uniprot ID: [P42680](https://www.uniprot.org/uniprotkb/P42680/)")
st.markdown(f"Protein symbol: TEC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42680') ]
