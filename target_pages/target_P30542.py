...
st.set_page_config(page_title="AA1R", layout="wide")
st.title("Adenosine receptor A1")
st.markdown(f"Uniprot ID: [P30542](https://www.uniprot.org/uniprotkb/P30542/)")
st.markdown(f"Protein symbol: AA1R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30542') ]
