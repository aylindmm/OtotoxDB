...
st.set_page_config(page_title="PHOP1", layout="wide")
st.title("Phosphoethanolamine/phosphocholine phosphatase")
st.markdown(f"Uniprot ID: [Q8TCT1](https://www.uniprot.org/uniprotkb/Q8TCT1/)")
st.markdown(f"Protein symbol: PHOP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TCT1') ]
