...
st.set_page_config(page_title="CATG", layout="wide")
st.title("Cathepsin G")
st.markdown(f"Uniprot ID: [P08311](https://www.uniprot.org/uniprotkb/P08311/)")
st.markdown(f"Protein symbol: CATG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08311') ]
