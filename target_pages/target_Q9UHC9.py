...
st.set_page_config(page_title="NPCL1", layout="wide")
st.title("NPC1-like intracellular cholesterol transporter 1")
st.markdown(f"Uniprot ID: [Q9UHC9](https://www.uniprot.org/uniprotkb/Q9UHC9/)")
st.markdown(f"Protein symbol: NPCL1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UHC9') ]
