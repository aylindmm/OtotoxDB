...
st.set_page_config(page_title="HIPK4", layout="wide")
st.title("Homeodomain-interacting protein kinase 4")
st.markdown(f"Uniprot ID: [Q8NE63](https://www.uniprot.org/uniprotkb/Q8NE63/)")
st.markdown(f"Protein symbol: HIPK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NE63') ]
