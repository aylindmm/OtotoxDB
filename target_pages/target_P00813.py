...
st.set_page_config(page_title="ADA", layout="wide")
st.title("Adenosine deaminase")
st.markdown(f"Uniprot ID: [P00813](https://www.uniprot.org/uniprotkb/P00813/)")
st.markdown(f"Protein symbol: ADA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00813') ]
