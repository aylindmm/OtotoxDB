...
st.set_page_config(page_title="IRAK4", layout="wide")
st.title("Interleukin-1 receptor-associated kinase 4")
st.markdown(f"Uniprot ID: [Q9NWZ3](https://www.uniprot.org/uniprotkb/Q9NWZ3/)")
st.markdown(f"Protein symbol: IRAK4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9NWZ3') ]
