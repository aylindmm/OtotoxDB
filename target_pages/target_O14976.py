...
st.set_page_config(page_title="GAK", layout="wide")
st.title("Cyclin-G-associated kinase")
st.markdown(f"Uniprot ID: [O14976](https://www.uniprot.org/uniprotkb/O14976/)")
st.markdown(f"Protein symbol: GAK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14976') ]
