...
st.set_page_config(page_title="VKOR1", layout="wide")
st.title("Vitamin K epoxide reductase complex subunit 1")
st.markdown(f"Uniprot ID: [Q9BQB6](https://www.uniprot.org/uniprotkb/Q9BQB6/)")
st.markdown(f"Protein symbol: VKOR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BQB6') ]
