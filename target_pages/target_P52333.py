...
st.set_page_config(page_title="JAK3", layout="wide")
st.title("Tyrosine-protein kinase JAK3")
st.markdown(f"Uniprot ID: [P52333](https://www.uniprot.org/uniprotkb/P52333/)")
st.markdown(f"Protein symbol: JAK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P52333') ]
