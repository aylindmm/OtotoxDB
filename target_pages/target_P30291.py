...
st.set_page_config(page_title="WEE1", layout="wide")
st.title("Wee1-like protein kinase")
st.markdown(f"Uniprot ID: [P30291](https://www.uniprot.org/uniprotkb/P30291/)")
st.markdown(f"Protein symbol: WEE1")
...
tar_filtered = target_info[(target_info["Uniprot ID"] == 'P30291') ]
