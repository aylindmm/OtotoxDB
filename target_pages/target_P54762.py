...
st.set_page_config(page_title="EPHB1", layout="wide")
st.title("Ephrin type-B receptor 1")
st.markdown(f"Uniprot ID: [P54762](https://www.uniprot.org/uniprotkb/P54762/)")
st.markdown(f"Protein symbol: EPHB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P54762') ]
