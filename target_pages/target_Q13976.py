...
st.set_page_config(page_title="KGP1", layout="wide")
st.title("cGMP-dependent protein kinase 1")
st.markdown(f"Uniprot ID: [Q13976](https://www.uniprot.org/uniprotkb/Q13976/)")
st.markdown(f"Protein symbol: KGP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13976') ]
