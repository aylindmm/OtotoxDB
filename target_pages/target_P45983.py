...
st.set_page_config(page_title="MK08", layout="wide")
st.title("Mitogen-activated protein kinase 8/9")
st.markdown(f"Uniprot ID: [P45983](https://www.uniprot.org/uniprotkb/P45983/)")
st.markdown(f"Protein symbol: MK08")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P45983') ]
