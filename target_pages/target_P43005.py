...
st.set_page_config(page_title="EAA3", layout="wide")
st.title("Excitatory amino acid transporter 3")
st.markdown(f"Uniprot ID: [P43005](https://www.uniprot.org/uniprotkb/P43005/)")
st.markdown(f"Protein symbol: EAA3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43005') ]
