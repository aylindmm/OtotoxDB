...
st.set_page_config(page_title="SCN7A", layout="wide")
st.title("Sodium channel protein type 7 subunit alpha")
st.markdown(f"Uniprot ID: [Q01118](https://www.uniprot.org/uniprotkb/Q01118/)")
st.markdown(f"Protein symbol: SCN7A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q01118') ]
