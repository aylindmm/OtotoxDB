...
st.set_page_config(page_title="DUS3", layout="wide")
st.title("Dual specificity protein phosphatase 3")
st.markdown(f"Uniprot ID: [P51452](https://www.uniprot.org/uniprotkb/P51452/)")
st.markdown(f"Protein symbol: DUS3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51452') ]
