...
st.set_page_config(page_title="GRK6", layout="wide")
st.title("G protein-coupled receptor kinase 6")
st.markdown(f"Uniprot ID: [P43250](https://www.uniprot.org/uniprotkb/P43250/)")
st.markdown(f"Protein symbol: GRK6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43250') ]
