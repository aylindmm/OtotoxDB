...
st.set_page_config(page_title="5NTD", layout="wide")
st.title("5'-nucleotidase")
st.markdown(f"Uniprot ID: [P21589](https://www.uniprot.org/uniprotkb/P21589/)")
st.markdown(f"Protein symbol: 5NTD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21589') ]
