...
st.set_page_config(page_title="MCLN3", layout="wide")
st.title("Mucolipin-3")
st.markdown(f"Uniprot ID: [Q8TDD5](https://www.uniprot.org/uniprotkb/Q8TDD5/)")
st.markdown(f"Protein symbol: MCLN3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8TDD5') ]
