...
st.set_page_config(page_title="S28A3", layout="wide")
st.title("Solute carrier family 28 member 3")
st.markdown(f"Uniprot ID: [Q9HAS3](https://www.uniprot.org/uniprotkb/Q9HAS3/)")
st.markdown(f"Protein symbol: S28A3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HAS3') ]
