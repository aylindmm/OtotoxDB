...
st.set_page_config(page_title="KC1G1", layout="wide")
st.title("Casein kinase I isoform gamma-1")
st.markdown(f"Uniprot ID: [Q9HCP0](https://www.uniprot.org/uniprotkb/Q9HCP0/)")
st.markdown(f"Protein symbol: KC1G1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HCP0') ]
