...
st.set_page_config(page_title="CELA1", layout="wide")
st.title("Chymotrypsin-like elastase family member 1")
st.markdown(f"Uniprot ID: [Q9UNI1](https://www.uniprot.org/uniprotkb/Q9UNI1/)")
st.markdown(f"Protein symbol: CELA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UNI1') ]
