...
st.set_page_config(page_title="CDK18", layout="wide")
st.title("Cyclin-dependent kinase 18 [3-474]")
st.markdown(f"Uniprot ID: [Q07002](https://www.uniprot.org/uniprotkb/Q07002/)")
st.markdown(f"Protein symbol: CDK18")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q07002') ]
