...
st.set_page_config(page_title="IKKA", layout="wide")
st.title("Inhibitor of nuclear factor kappa-B kinase subunit alpha")
st.markdown(f"Uniprot ID: [O15111](https://www.uniprot.org/uniprotkb/O15111/)")
st.markdown(f"Protein symbol: IKKA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15111') ]
