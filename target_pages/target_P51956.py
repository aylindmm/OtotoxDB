...
st.set_page_config(page_title="NEK3", layout="wide")
st.title("Serine/threonine-protein kinase Nek3")
st.markdown(f"Uniprot ID: [P51956](https://www.uniprot.org/uniprotkb/P51956/)")
st.markdown(f"Protein symbol: NEK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51956') ]
