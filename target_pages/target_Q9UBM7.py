...
st.set_page_config(page_title="DHCR7", layout="wide")
st.title("7-dehydrocholesterol reductase")
st.markdown(f"Uniprot ID: [Q9UBM7](https://www.uniprot.org/uniprotkb/Q9UBM7/)")
st.markdown(f"Protein symbol: DHCR7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UBM7') ]
