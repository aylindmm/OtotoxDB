...
st.set_page_config(page_title="KPCD", layout="wide")
st.title("Protein kinase C delta type")
st.markdown(f"Uniprot ID: [Q05655](https://www.uniprot.org/uniprotkb/Q05655/)")
st.markdown(f"Protein symbol: KPCD")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q05655') ]
