...
st.set_page_config(page_title="SC5A1", layout="wide")
st.title("Sodium/glucose cotransporter 1")
st.markdown(f"Uniprot ID: [P13866](https://www.uniprot.org/uniprotkb/P13866/)")
st.markdown(f"Protein symbol: SC5A1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P13866') ]
