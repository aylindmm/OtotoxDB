...
st.set_page_config(page_title="CDK6", layout="wide")
st.title("Cyclin-dependent kinase 6/G1/S-specific cyclin-D3")
st.markdown(f"Uniprot ID: [Q00534](https://www.uniprot.org/uniprotkb/Q00534/)")
st.markdown(f"Protein symbol: CDK6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00534') ]
