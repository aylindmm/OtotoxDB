...
st.set_page_config(page_title="SGK3", layout="wide")
st.title("Serine/threonine-protein kinase Sgk3")
st.markdown(f"Uniprot ID: [Q96BR1](https://www.uniprot.org/uniprotkb/Q96BR1/)")
st.markdown(f"Protein symbol: SGK3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96BR1') ]
