...
st.set_page_config(page_title="PHKG1", layout="wide")
st.title("Phosphorylase b kinase gamma catalytic chain, skeletal muscle/heart isoform")
st.markdown(f"Uniprot ID: [Q16816](https://www.uniprot.org/uniprotkb/Q16816/)")
st.markdown(f"Protein symbol: PHKG1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16816') ]
