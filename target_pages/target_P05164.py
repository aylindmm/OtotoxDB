...
st.set_page_config(page_title="PERM", layout="wide")
st.title("Myeloperoxidase")
st.markdown(f"Uniprot ID: [P05164](https://www.uniprot.org/uniprotkb/P05164/)")
st.markdown(f"Protein symbol: PERM")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05164') ]
