...
st.set_page_config(page_title="HRH1", layout="wide")
st.title("Histamine H1 receptor")
st.markdown(f"Uniprot ID: [P35367](https://www.uniprot.org/uniprotkb/P35367/)")
st.markdown(f"Protein symbol: HRH1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35367') ]
