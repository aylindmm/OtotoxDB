...
st.set_page_config(page_title="INSRR", layout="wide")
st.title("Insulin receptor-related protein")
st.markdown(f"Uniprot ID: [P14616](https://www.uniprot.org/uniprotkb/P14616/)")
st.markdown(f"Protein symbol: INSRR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14616') ]
