...
st.set_page_config(page_title="FGFR2", layout="wide")
st.title("Fibroblast growth factor receptor 2")
st.markdown(f"Uniprot ID: [P21802](https://www.uniprot.org/uniprotkb/P21802/)")
st.markdown(f"Protein symbol: FGFR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21802') ]
