...
st.set_page_config(page_title="HDAC7", layout="wide")
st.title("Histone deacetylase 7")
st.markdown(f"Uniprot ID: [Q8WUI4](https://www.uniprot.org/uniprotkb/Q8WUI4/)")
st.markdown(f"Protein symbol: HDAC7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8WUI4') ]
