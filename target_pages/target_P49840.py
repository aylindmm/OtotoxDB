...
st.set_page_config(page_title="GSK3A", layout="wide")
st.title("Glycogen synthase kinase-3 alpha")
st.markdown(f"Uniprot ID: [P49840](https://www.uniprot.org/uniprotkb/P49840/)")
st.markdown(f"Protein symbol: GSK3A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49840') ]
