...
st.set_page_config(page_title="MMP7", layout="wide")
st.title("Matrilysin")
st.markdown(f"Uniprot ID: [P09237](https://www.uniprot.org/uniprotkb/P09237/)")
st.markdown(f"Protein symbol: MMP7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09237') ]
