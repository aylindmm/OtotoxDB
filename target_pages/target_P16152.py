...
st.set_page_config(page_title="CBR1", layout="wide")
st.title("Carbonyl reductase [NADPH] 1")
st.markdown(f"Uniprot ID: [P16152](https://www.uniprot.org/uniprotkb/P16152/)")
st.markdown(f"Protein symbol: CBR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16152') ]
