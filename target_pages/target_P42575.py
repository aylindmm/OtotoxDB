...
st.set_page_config(page_title="CASP2", layout="wide")
st.title("Caspase-2")
st.markdown(f"Uniprot ID: [P42575](https://www.uniprot.org/uniprotkb/P42575/)")
st.markdown(f"Protein symbol: CASP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42575') ]
