...
st.set_page_config(page_title="MOT4", layout="wide")
st.title("Monocarboxylate transporter 4")
st.markdown(f"Uniprot ID: [O15427](https://www.uniprot.org/uniprotkb/O15427/)")
st.markdown(f"Protein symbol: MOT4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O15427') ]
