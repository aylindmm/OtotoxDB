...
st.set_page_config(page_title="RGS8", layout="wide")
st.title("Regulator of G-protein signaling 8")
st.markdown(f"Uniprot ID: [P57771](https://www.uniprot.org/uniprotkb/P57771/)")
st.markdown(f"Protein symbol: RGS8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P57771') ]
