...
st.set_page_config(page_title="PDE2A", layout="wide")
st.title("cGMP-dependent 3',5'-cyclic phosphodiesterase [574-941]")
st.markdown(f"Uniprot ID: [O00408](https://www.uniprot.org/uniprotkb/O00408/)")
st.markdown(f"Protein symbol: PDE2A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00408') ]
