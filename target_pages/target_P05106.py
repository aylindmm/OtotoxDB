...
st.set_page_config(page_title="ITB3", layout="wide")
st.title("Integrin alpha-V/beta-3")
st.markdown(f"Uniprot ID: [P05106](https://www.uniprot.org/uniprotkb/P05106/)")
st.markdown(f"Protein symbol: ITB3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P05106') ]
