...
st.set_page_config(page_title="KS6A5", layout="wide")
st.title("Ribosomal protein S6 kinase alpha-5")
st.markdown(f"Uniprot ID: [O75582](https://www.uniprot.org/uniprotkb/O75582/)")
st.markdown(f"Protein symbol: KS6A5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O75582') ]
