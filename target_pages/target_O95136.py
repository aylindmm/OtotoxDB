...
st.set_page_config(page_title="S1PR2", layout="wide")
st.title("Sphingosine 1-phosphate receptor 2")
st.markdown(f"Uniprot ID: [O95136](https://www.uniprot.org/uniprotkb/O95136/)")
st.markdown(f"Protein symbol: S1PR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O95136') ]
