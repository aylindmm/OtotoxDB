...
st.set_page_config(page_title="DCLK2", layout="wide")
st.title("Serine/threonine-protein kinase DCLK2")
st.markdown(f"Uniprot ID: [Q8N568](https://www.uniprot.org/uniprotkb/Q8N568/)")
st.markdown(f"Protein symbol: DCLK2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8N568') ]
