...
st.set_page_config(page_title="RXRG", layout="wide")
st.title("Retinoic acid receptor RXR-gamma")
st.markdown(f"Uniprot ID: [P48443](https://www.uniprot.org/uniprotkb/P48443/)")
st.markdown(f"Protein symbol: RXRG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48443') ]
