...
st.set_page_config(page_title="KPCA", layout="wide")
st.title("Protein kinase C alpha type")
st.markdown(f"Uniprot ID: [P17252](https://www.uniprot.org/uniprotkb/P17252/)")
st.markdown(f"Protein symbol: KPCA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P17252') ]
