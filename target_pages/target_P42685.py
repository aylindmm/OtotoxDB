...
st.set_page_config(page_title="FRK", layout="wide")
st.title("Tyrosine-protein kinase FRK")
st.markdown(f"Uniprot ID: [P42685](https://www.uniprot.org/uniprotkb/P42685/)")
st.markdown(f"Protein symbol: FRK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P42685') ]
