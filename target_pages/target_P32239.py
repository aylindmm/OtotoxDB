...
st.set_page_config(page_title="GASR", layout="wide")
st.title("Gastrin/cholecystokinin type B receptor")
st.markdown(f"Uniprot ID: [P32239](https://www.uniprot.org/uniprotkb/P32239/)")
st.markdown(f"Protein symbol: GASR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P32239') ]
