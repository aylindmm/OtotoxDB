...
st.set_page_config(page_title="ACHA7", layout="wide")
st.title("Neuronal acetylcholine receptor subunit alpha-7")
st.markdown(f"Uniprot ID: [P36544](https://www.uniprot.org/uniprotkb/P36544/)")
st.markdown(f"Protein symbol: ACHA7")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P36544') ]
