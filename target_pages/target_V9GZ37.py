...
st.set_page_config(page_title="V9GZ37", layout="wide")
st.title("Heat shock 70 kDa protein 1A")
st.markdown(f"Uniprot ID: [V9GZ37](https://www.uniprot.org/uniprotkb/V9GZ37/)")
st.markdown(f"Protein symbol: V9GZ37")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'V9GZ37') ]
