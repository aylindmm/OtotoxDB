...
st.set_page_config(page_title="BTK", layout="wide")
st.title("Tyrosine-protein kinase BTK")
st.markdown(f"Uniprot ID: [Q06187](https://www.uniprot.org/uniprotkb/Q06187/)")
st.markdown(f"Protein symbol: BTK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q06187') ]
