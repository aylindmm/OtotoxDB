...
st.set_page_config(page_title="AOFA", layout="wide")
st.title("Amine oxidase [flavin-containing] A")
st.markdown(f"Uniprot ID: [P21397](https://www.uniprot.org/uniprotkb/P21397/)")
st.markdown(f"Protein symbol: AOFA")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P21397') ]
