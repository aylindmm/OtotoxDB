...
st.set_page_config(page_title="HXK1", layout="wide")
st.title("Hexokinase-1")
st.markdown(f"Uniprot ID: [P19367](https://www.uniprot.org/uniprotkb/P19367/)")
st.markdown(f"Protein symbol: HXK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P19367') ]
