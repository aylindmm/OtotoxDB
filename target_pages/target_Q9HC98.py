...
st.set_page_config(page_title="NEK6", layout="wide")
st.title("Serine/threonine-protein kinase Nek6")
st.markdown(f"Uniprot ID: [Q9HC98](https://www.uniprot.org/uniprotkb/Q9HC98/)")
st.markdown(f"Protein symbol: NEK6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9HC98') ]
