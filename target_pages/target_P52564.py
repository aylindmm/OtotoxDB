...
st.set_page_config(page_title="MP2K6", layout="wide")
st.title("Dual specificity mitogen-activated protein kinase kinase 6")
st.markdown(f"Uniprot ID: [P52564](https://www.uniprot.org/uniprotkb/P52564/)")
st.markdown(f"Protein symbol: MP2K6")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P52564') ]
