...
st.set_page_config(page_title="PON1", layout="wide")
st.title("Serum paraoxonase/arylesterase 1")
st.markdown(f"Uniprot ID: [P27169](https://www.uniprot.org/uniprotkb/P27169/)")
st.markdown(f"Protein symbol: PON1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27169') ]
