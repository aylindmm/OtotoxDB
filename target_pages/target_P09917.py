...
st.set_page_config(page_title="LOX5", layout="wide")
st.title("Polyunsaturated fatty acid 5-lipoxygenase")
st.markdown(f"Uniprot ID: [P09917](https://www.uniprot.org/uniprotkb/P09917/)")
st.markdown(f"Protein symbol: LOX5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P09917') ]
