...
st.set_page_config(page_title="PE2R2", layout="wide")
st.title("Prostaglandin E2 receptor EP2 subtype")
st.markdown(f"Uniprot ID: [P43116](https://www.uniprot.org/uniprotkb/P43116/)")
st.markdown(f"Protein symbol: PE2R2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43116') ]
