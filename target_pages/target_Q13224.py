...
st.set_page_config(page_title="NMDE2", layout="wide")
st.title("Glutamate receptor ionotropic, NMDA 2B")
st.markdown(f"Uniprot ID: [Q13224](https://www.uniprot.org/uniprotkb/Q13224/)")
st.markdown(f"Protein symbol: NMDE2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13224') ]
