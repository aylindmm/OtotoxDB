...
st.set_page_config(page_title="CAC1I", layout="wide")
st.title("Voltage-dependent T-type calcium channel subunit alpha-1I")
st.markdown(f"Uniprot ID: [Q9P0X4](https://www.uniprot.org/uniprotkb/Q9P0X4/)")
st.markdown(f"Protein symbol: CAC1I")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9P0X4') ]
