...
st.set_page_config(page_title="MAP11", layout="wide")
st.title("Methionine aminopeptidase 1")
st.markdown(f"Uniprot ID: [P53582](https://www.uniprot.org/uniprotkb/P53582/)")
st.markdown(f"Protein symbol: MAP11")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P53582') ]
