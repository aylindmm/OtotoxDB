...
st.set_page_config(page_title="TRPV1", layout="wide")
st.title("Transient receptor potential cation channel subfamily V member 1")
st.markdown(f"Uniprot ID: [Q8NER1](https://www.uniprot.org/uniprotkb/Q8NER1/)")
st.markdown(f"Protein symbol: TRPV1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NER1') ]
