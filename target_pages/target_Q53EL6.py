...
st.set_page_config(page_title="PDCD4", layout="wide")
st.title("Programmed cell death protein 4")
st.markdown(f"Uniprot ID: [Q53EL6](https://www.uniprot.org/uniprotkb/Q53EL6/)")
st.markdown(f"Protein symbol: PDCD4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q53EL6') ]
