...
st.set_page_config(page_title="AK1C4", layout="wide")
st.title("Aldo-keto reductase family 1 member C4")
st.markdown(f"Uniprot ID: [P17516](https://www.uniprot.org/uniprotkb/P17516/)")
st.markdown(f"Protein symbol: AK1C4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P17516') ]
