...
st.set_page_config(page_title="CEGT", layout="wide")
st.title("Ceramide glucosyltransferase")
st.markdown(f"Uniprot ID: [Q16739](https://www.uniprot.org/uniprotkb/Q16739/)")
st.markdown(f"Protein symbol: CEGT")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q16739') ]
