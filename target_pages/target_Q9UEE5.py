...
st.set_page_config(page_title="ST17A", layout="wide")
st.title("Serine/threonine-protein kinase 17A")
st.markdown(f"Uniprot ID: [Q9UEE5](https://www.uniprot.org/uniprotkb/Q9UEE5/)")
st.markdown(f"Protein symbol: ST17A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9UEE5') ]
