...
st.set_page_config(page_title="MDR1", layout="wide")
st.title("ATP-dependent translocase ABCB1")
st.markdown(f"Uniprot ID: [P08183](https://www.uniprot.org/uniprotkb/P08183/)")
st.markdown(f"Protein symbol: MDR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08183') ]
