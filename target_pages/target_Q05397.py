...
st.set_page_config(page_title="FAK1", layout="wide")
st.title("Focal adhesion kinase 1")
st.markdown(f"Uniprot ID: [Q05397](https://www.uniprot.org/uniprotkb/Q05397/)")
st.markdown(f"Protein symbol: FAK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q05397') ]
