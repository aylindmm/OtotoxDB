...
st.set_page_config(page_title="TRAP1", layout="wide")
st.title("Heat shock protein 75 kDa, mitochondrial")
st.markdown(f"Uniprot ID: [Q12931](https://www.uniprot.org/uniprotkb/Q12931/)")
st.markdown(f"Protein symbol: TRAP1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q12931') ]
