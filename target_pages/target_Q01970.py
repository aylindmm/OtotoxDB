...
st.set_page_config(page_title="PLCB3", layout="wide")
st.title("1-phosphatidylinositol 4,5-bisphosphate phosphodiesterase beta-3")
st.markdown(f"Uniprot ID: [Q01970](https://www.uniprot.org/uniprotkb/Q01970/)")
st.markdown(f"Protein symbol: PLCB3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q01970') ]
