...
st.set_page_config(page_title="CATB", layout="wide")
st.title("Cathepsin B")
st.markdown(f"Uniprot ID: [P07858](https://www.uniprot.org/uniprotkb/P07858/)")
st.markdown(f"Protein symbol: CATB")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P07858') ]
