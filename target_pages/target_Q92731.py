...
st.set_page_config(page_title="ESR2", layout="wide")
st.title("Estrogen receptor beta")
st.markdown(f"Uniprot ID: [Q92731](https://www.uniprot.org/uniprotkb/Q92731/)")
st.markdown(f"Protein symbol: ESR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q92731') ]
