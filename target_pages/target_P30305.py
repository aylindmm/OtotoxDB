...
st.set_page_config(page_title="MPIP2", layout="wide")
st.title("M-phase inducer phosphatase 2")
st.markdown(f"Uniprot ID: [P30305](https://www.uniprot.org/uniprotkb/P30305/)")
st.markdown(f"Protein symbol: MPIP2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P30305') ]
