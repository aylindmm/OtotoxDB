...
st.set_page_config(page_title="TYRO", layout="wide")
st.title("Tyrosinase")
st.markdown(f"Uniprot ID: [P14679](https://www.uniprot.org/uniprotkb/P14679/)")
st.markdown(f"Protein symbol: TYRO")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14679') ]
