...
st.set_page_config(page_title="GPR17", layout="wide")
st.title("Uracil nucleotide/cysteinyl leukotriene receptor")
st.markdown(f"Uniprot ID: [Q13304](https://www.uniprot.org/uniprotkb/Q13304/)")
st.markdown(f"Protein symbol: GPR17")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13304') ]
