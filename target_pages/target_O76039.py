...
st.set_page_config(page_title="CDKL5", layout="wide")
st.title("Cyclin-dependent kinase-like 5")
st.markdown(f"Uniprot ID: [O76039](https://www.uniprot.org/uniprotkb/O76039/)")
st.markdown(f"Protein symbol: CDKL5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O76039') ]
