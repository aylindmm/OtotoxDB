...
st.set_page_config(page_title="EST2", layout="wide")
st.title("Cocaine esterase")
st.markdown(f"Uniprot ID: [O00748](https://www.uniprot.org/uniprotkb/O00748/)")
st.markdown(f"Protein symbol: EST2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O00748') ]
