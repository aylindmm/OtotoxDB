...
st.set_page_config(page_title="5HT7R", layout="wide")
st.title("5-hydroxytryptamine receptor 7")
st.markdown(f"Uniprot ID: [P34969](https://www.uniprot.org/uniprotkb/P34969/)")
st.markdown(f"Protein symbol: 5HT7R")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34969') ]
