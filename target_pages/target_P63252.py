...
st.set_page_config(page_title="KCNJ2", layout="wide")
st.title("Inward rectifier potassium channel 2")
st.markdown(f"Uniprot ID: [P63252](https://www.uniprot.org/uniprotkb/P63252/)")
st.markdown(f"Protein symbol: KCNJ2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P63252') ]
