...
st.set_page_config(page_title="CXCR2", layout="wide")
st.title("C-X-C chemokine receptor type 2")
st.markdown(f"Uniprot ID: [P25025](https://www.uniprot.org/uniprotkb/P25025/)")
st.markdown(f"Protein symbol: CXCR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P25025') ]
