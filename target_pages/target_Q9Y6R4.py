...
st.set_page_config(page_title="M3K4", layout="wide")
st.title("Mitogen-activated protein kinase kinase kinase 4")
st.markdown(f"Uniprot ID: [Q9Y6R4](https://www.uniprot.org/uniprotkb/Q9Y6R4/)")
st.markdown(f"Protein symbol: M3K4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y6R4') ]
