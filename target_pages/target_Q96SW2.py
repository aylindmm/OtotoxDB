...
st.set_page_config(page_title="CRBN", layout="wide")
st.title("Protein cereblon")
st.markdown(f"Uniprot ID: [Q96SW2](https://www.uniprot.org/uniprotkb/Q96SW2/)")
st.markdown(f"Protein symbol: CRBN")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96SW2') ]
