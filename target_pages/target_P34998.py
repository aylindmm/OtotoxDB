...
st.set_page_config(page_title="CRFR1", layout="wide")
st.title("Corticotropin-releasing factor receptor 1")
st.markdown(f"Uniprot ID: [P34998](https://www.uniprot.org/uniprotkb/P34998/)")
st.markdown(f"Protein symbol: CRFR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P34998') ]
