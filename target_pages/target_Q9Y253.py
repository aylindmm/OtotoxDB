...
st.set_page_config(page_title="POLH", layout="wide")
st.title("DNA polymerase eta")
st.markdown(f"Uniprot ID: [Q9Y253](https://www.uniprot.org/uniprotkb/Q9Y253/)")
st.markdown(f"Protein symbol: POLH")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y253') ]
