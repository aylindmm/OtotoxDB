...
st.set_page_config(page_title="SUIS", layout="wide")
st.title("Sucrase-isomaltase, intestinal")
st.markdown(f"Uniprot ID: [P14410](https://www.uniprot.org/uniprotkb/P14410/)")
st.markdown(f"Protein symbol: SUIS")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P14410') ]
