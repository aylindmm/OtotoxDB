...
st.set_page_config(page_title="CDK15", layout="wide")
st.title("Cyclin-dependent kinase 15")
st.markdown(f"Uniprot ID: [Q96Q40](https://www.uniprot.org/uniprotkb/Q96Q40/)")
st.markdown(f"Protein symbol: CDK15")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q96Q40') ]
