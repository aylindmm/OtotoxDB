...
st.set_page_config(page_title="TIE2", layout="wide")
st.title("Angiopoietin-1 receptor")
st.markdown(f"Uniprot ID: [Q02763](https://www.uniprot.org/uniprotkb/Q02763/)")
st.markdown(f"Protein symbol: TIE2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q02763') ]
