...
st.set_page_config(page_title="ARRB1", layout="wide")
st.title("Beta-arrestin-1")
st.markdown(f"Uniprot ID: [P49407](https://www.uniprot.org/uniprotkb/P49407/)")
st.markdown(f"Protein symbol: ARRB1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P49407') ]
