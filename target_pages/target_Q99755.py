...
st.set_page_config(page_title="PI51A", layout="wide")
st.title("Phosphatidylinositol 4-phosphate 5-kinase type-1 alpha")
st.markdown(f"Uniprot ID: [Q99755](https://www.uniprot.org/uniprotkb/Q99755/)")
st.markdown(f"Protein symbol: PI51A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q99755') ]
