...
st.set_page_config(page_title="KPCD3", layout="wide")
st.title("Serine/threonine-protein kinase D3")
st.markdown(f"Uniprot ID: [O94806](https://www.uniprot.org/uniprotkb/O94806/)")
st.markdown(f"Protein symbol: KPCD3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O94806') ]
