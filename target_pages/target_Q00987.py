...
st.set_page_config(page_title="MDM2", layout="wide")
st.title("E3 ubiquitin-protein ligase Mdm2")
st.markdown(f"Uniprot ID: [Q00987](https://www.uniprot.org/uniprotkb/Q00987/)")
st.markdown(f"Protein symbol: MDM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q00987') ]
