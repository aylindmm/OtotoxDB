...
st.set_page_config(page_title="DDAH1", layout="wide")
st.title("N(G),N(G)-dimethylarginine dimethylaminohydrolase 1")
st.markdown(f"Uniprot ID: [O94760](https://www.uniprot.org/uniprotkb/O94760/)")
st.markdown(f"Protein symbol: DDAH1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O94760') ]
