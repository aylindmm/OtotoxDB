...
st.set_page_config(page_title="FA10", layout="wide")
st.title("Coagulation factor X")
st.markdown(f"Uniprot ID: [P00742](https://www.uniprot.org/uniprotkb/P00742/)")
st.markdown(f"Protein symbol: FA10")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P00742') ]
