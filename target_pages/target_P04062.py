...
st.set_page_config(page_title="GBA1", layout="wide")
st.title("Lysosomal acid glucosylceramidase")
st.markdown(f"Uniprot ID: [P04062](https://www.uniprot.org/uniprotkb/P04062/)")
st.markdown(f"Protein symbol: GBA1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P04062') ]
