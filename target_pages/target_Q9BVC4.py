...
st.set_page_config(page_title="LST8", layout="wide")
st.title("Target of rapamycin complex subunit LST8")
st.markdown(f"Uniprot ID: [Q9BVC4](https://www.uniprot.org/uniprotkb/Q9BVC4/)")
st.markdown(f"Protein symbol: LST8")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9BVC4') ]
