...
st.set_page_config(page_title="CATK", layout="wide")
st.title("Cathepsin K")
st.markdown(f"Uniprot ID: [P43235](https://www.uniprot.org/uniprotkb/P43235/)")
st.markdown(f"Protein symbol: CATK")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P43235') ]
