...
st.set_page_config(page_title="LMBL4", layout="wide")
st.title("Lethal(3)malignant brain tumor-like protein 4")
st.markdown(f"Uniprot ID: [Q8NA19](https://www.uniprot.org/uniprotkb/Q8NA19/)")
st.markdown(f"Protein symbol: LMBL4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q8NA19') ]
