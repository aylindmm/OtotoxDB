...
st.set_page_config(page_title="KDM4E", layout="wide")
st.title("Lysine-specific demethylase 4E")
st.markdown(f"Uniprot ID: [B2RXH2](https://www.uniprot.org/uniprotkb/B2RXH2/)")
st.markdown(f"Protein symbol: KDM4E")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'B2RXH2') ]
