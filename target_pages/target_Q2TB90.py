...
st.set_page_config(page_title="HKDC1", layout="wide")
st.title("Hexokinase HKDC1 [W721R]")
st.markdown(f"Uniprot ID: [Q2TB90](https://www.uniprot.org/uniprotkb/Q2TB90/)")
st.markdown(f"Protein symbol: HKDC1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q2TB90') ]
