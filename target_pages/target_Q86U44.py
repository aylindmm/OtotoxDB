...
st.set_page_config(page_title="MTA70", layout="wide")
st.title("N6-adenosine-methyltransferase catalytic subunit")
st.markdown(f"Uniprot ID: [Q86U44](https://www.uniprot.org/uniprotkb/Q86U44/)")
st.markdown(f"Protein symbol: MTA70")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q86U44') ]
