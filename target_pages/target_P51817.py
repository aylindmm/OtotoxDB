...
st.set_page_config(page_title="PRKX", layout="wide")
st.title("cAMP-dependent protein kinase catalytic subunit PRKX")
st.markdown(f"Uniprot ID: [P51817](https://www.uniprot.org/uniprotkb/P51817/)")
st.markdown(f"Protein symbol: PRKX")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51817') ]
