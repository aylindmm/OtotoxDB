...
st.set_page_config(page_title="HRH3", layout="wide")
st.title("Histamine H3 receptor")
st.markdown(f"Uniprot ID: [Q9Y5N1](https://www.uniprot.org/uniprotkb/Q9Y5N1/)")
st.markdown(f"Protein symbol: HRH3")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q9Y5N1') ]
