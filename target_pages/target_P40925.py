...
st.set_page_config(page_title="MDHC", layout="wide")
st.title("Malate dehydrogenase, cytoplasmic")
st.markdown(f"Uniprot ID: [P40925](https://www.uniprot.org/uniprotkb/P40925/)")
st.markdown(f"Protein symbol: MDHC")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P40925') ]
