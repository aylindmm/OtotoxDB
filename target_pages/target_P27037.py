...
st.set_page_config(page_title="AVR2A", layout="wide")
st.title("Activin receptor type-2A")
st.markdown(f"Uniprot ID: [P27037](https://www.uniprot.org/uniprotkb/P27037/)")
st.markdown(f"Protein symbol: AVR2A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P27037') ]
