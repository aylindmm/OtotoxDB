...
st.set_page_config(page_title="VDR", layout="wide")
st.title("Vitamin D3 receptor")
st.markdown(f"Uniprot ID: [P11473](https://www.uniprot.org/uniprotkb/P11473/)")
st.markdown(f"Protein symbol: VDR")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P11473') ]
