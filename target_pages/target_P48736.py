...
st.set_page_config(page_title="PK3CG", layout="wide")
st.title("Phosphatidylinositol 4,5-bisphosphate 3-kinase catalytic subunit gamma isoform")
st.markdown(f"Uniprot ID: [P48736](https://www.uniprot.org/uniprotkb/P48736/)")
st.markdown(f"Protein symbol: PK3CG")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P48736') ]
