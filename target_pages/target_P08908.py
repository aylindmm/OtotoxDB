...
st.set_page_config(page_title="5HT1A", layout="wide")
st.title("5-hydroxytryptamine receptor 1A")
st.markdown(f"Uniprot ID: [P08908](https://www.uniprot.org/uniprotkb/P08908/)")
st.markdown(f"Protein symbol: 5HT1A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08908') ]
