...
st.set_page_config(page_title="VGFR2", layout="wide")
st.title("Vascular endothelial growth factor receptor 2")
st.markdown(f"Uniprot ID: [P35968](https://www.uniprot.org/uniprotkb/P35968/)")
st.markdown(f"Protein symbol: VGFR2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P35968') ]
