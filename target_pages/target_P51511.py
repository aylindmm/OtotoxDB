...
st.set_page_config(page_title="MMP15", layout="wide")
st.title("Matrix metalloproteinase-15")
st.markdown(f"Uniprot ID: [P51511](https://www.uniprot.org/uniprotkb/P51511/)")
st.markdown(f"Protein symbol: MMP15")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P51511') ]
