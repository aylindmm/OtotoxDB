...
st.set_page_config(page_title="CHK1", layout="wide")
st.title("Serine/threonine-protein kinase Chk1")
st.markdown(f"Uniprot ID: [O14757](https://www.uniprot.org/uniprotkb/O14757/)")
st.markdown(f"Protein symbol: CHK1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O14757') ]
