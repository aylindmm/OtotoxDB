...
st.set_page_config(page_title="CAH4", layout="wide")
st.title("Carbonic anhydrase 4")
st.markdown(f"Uniprot ID: [P22748](https://www.uniprot.org/uniprotkb/P22748/)")
st.markdown(f"Protein symbol: CAH4")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P22748') ]
