...
st.set_page_config(page_title="HDA10", layout="wide")
st.title("Polyamine deacetylase HDAC10")
st.markdown(f"Uniprot ID: [Q969S8](https://www.uniprot.org/uniprotkb/Q969S8/)")
st.markdown(f"Protein symbol: HDA10")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q969S8') ]
