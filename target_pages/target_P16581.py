...
st.set_page_config(page_title="LYAM2", layout="wide")
st.title("E-selectin")
st.markdown(f"Uniprot ID: [P16581](https://www.uniprot.org/uniprotkb/P16581/)")
st.markdown(f"Protein symbol: LYAM2")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P16581') ]
