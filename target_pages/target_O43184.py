...
st.set_page_config(page_title="ADA12", layout="wide")
st.title("Disintegrin and metalloproteinase domain-containing protein 12")
st.markdown(f"Uniprot ID: [O43184](https://www.uniprot.org/uniprotkb/O43184/)")
st.markdown(f"Protein symbol: ADA12")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'O43184') ]
