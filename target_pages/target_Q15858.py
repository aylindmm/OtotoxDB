...
st.set_page_config(page_title="SCN9A", layout="wide")
st.title("Sodium channel protein type 9 subunit alpha")
st.markdown(f"Uniprot ID: [Q15858](https://www.uniprot.org/uniprotkb/Q15858/)")
st.markdown(f"Protein symbol: SCN9A")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15858') ]
