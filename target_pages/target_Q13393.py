...
st.set_page_config(page_title="PLD1", layout="wide")
st.title("Phospholipase D1")
st.markdown(f"Uniprot ID: [Q13393](https://www.uniprot.org/uniprotkb/Q13393/)")
st.markdown(f"Protein symbol: PLD1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q13393') ]
