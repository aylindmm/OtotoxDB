...
st.set_page_config(page_title="ELAV1", layout="wide")
st.title("ELAV-like protein 1")
st.markdown(f"Uniprot ID: [Q15717](https://www.uniprot.org/uniprotkb/Q15717/)")
st.markdown(f"Protein symbol: ELAV1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q15717') ]
