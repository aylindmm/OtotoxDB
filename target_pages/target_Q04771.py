...
st.set_page_config(page_title="ACVR1", layout="wide")
st.title("Activin receptor type-1")
st.markdown(f"Uniprot ID: [Q04771](https://www.uniprot.org/uniprotkb/Q04771/)")
st.markdown(f"Protein symbol: ACVR1")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'Q04771') ]
