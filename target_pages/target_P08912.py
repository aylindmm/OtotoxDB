...
st.set_page_config(page_title="ACM5", layout="wide")
st.title("Muscarinic acetylcholine receptor M5")
st.markdown(f"Uniprot ID: [P08912](https://www.uniprot.org/uniprotkb/P08912/)")
st.markdown(f"Protein symbol: ACM5")
...
tar_filtered = target_info[(target_info['UniProt..SwissProt..Primary.ID.of.Target.Chain'] == 'P08912') ]
