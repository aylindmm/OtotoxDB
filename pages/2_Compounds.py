...
pub_types = st.multiselect(
    "Compound type",
    ["ototoxic", "otoprotective", "undetermined"],
    ["ototoxic", "otoprotective", "undetermined"]
)
...
citation_number = st.slider("Literature score", -25, 25, (-25, 25))
df_filtered = df[df['score'].between(citation_number[0], citation_number[1]) & df['class'].isin(pub_types)]
